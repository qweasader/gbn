...
if(release == "UBUNTU11.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"8.0+build1-0ubuntu0.11.04.3", rls:"UBUNTU11.04"))) {
    report += res;
  }
...
if(release == "UBUNTU11.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"8.0+build1-0ubuntu0.11.10.3", rls:"UBUNTU11.10"))) {
    report += res;
  }
