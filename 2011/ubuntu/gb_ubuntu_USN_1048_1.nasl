...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tomcat6-admin", ver:"6.0.24-2ubuntu1.6", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tomcat6-admin", ver:"6.0.28-2ubuntu1.1", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tomcat6-admin", ver:"6.0.20-2ubuntu2.3", rls:"UBUNTU9.10"))) {
    report += res;
  }
