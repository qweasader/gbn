...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dpkg-dev", ver:"1.15.5.6ubuntu4.5", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dpkg-dev", ver:"1.15.8.4ubuntu3.1", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dpkg-dev", ver:"1.15.4ubuntu2.3", rls:"UBUNTU9.10"))) {
    report += res;
  }
