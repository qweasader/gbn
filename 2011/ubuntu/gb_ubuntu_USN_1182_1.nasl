...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"swat", ver:"2:3.4.7~dfsg-1ubuntu3.7", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"swat", ver:"2:3.5.4~dfsg-1ubuntu8.5", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU11.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"swat", ver:"2:3.5.8~dfsg-1ubuntu2.3", rls:"UBUNTU11.04"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"swat", ver:"3.0.28a-1ubuntu4.15", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
