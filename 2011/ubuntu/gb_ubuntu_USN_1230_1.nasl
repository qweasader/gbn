...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"quassel-core", ver:"0.6.1-0ubuntu1.3", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"quassel-core", ver:"0.7.1-0ubuntu1.2", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU11.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"quassel-core", ver:"0.7.2-0ubuntu2.3", rls:"UBUNTU11.04"))) {
    report += res;
  }
