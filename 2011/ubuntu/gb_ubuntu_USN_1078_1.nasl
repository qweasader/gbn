...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"logwatch", ver:"7.3.6.cvs20090906-1ubuntu2.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"logwatch", ver:"7.3.6.cvs20090906-1ubuntu3.1", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"logwatch", ver:"7.3.6-1ubuntu1.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"logwatch", ver:"7.3.6.cvs20090906-1ubuntu1.1", rls:"UBUNTU9.10"))) {
    report += res;
  }
