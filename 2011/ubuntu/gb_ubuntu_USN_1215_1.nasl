...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apt", ver:"0.7.25.3ubuntu9.7", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apt", ver:"0.8.3ubuntu7.2", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU11.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apt", ver:"0.8.13.2ubuntu4.2", rls:"UBUNTU11.04"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apt", ver:"0.7.9ubuntu17.3", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
