...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dhcp3-client", ver:"3.1.3-2ubuntu3.2", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dhcp3-client", ver:"3.1.3-2ubuntu6.2", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dhcp3-client", ver:"3.1.2-1ubuntu7.3", rls:"UBUNTU9.10"))) {
    report += res;
  }
