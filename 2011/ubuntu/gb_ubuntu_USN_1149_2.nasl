...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"3.6.18+build2+nobinonly-0ubuntu0.10.04.2", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"3.6.18+build2+nobinonly-0ubuntu0.10.10.2", rls:"UBUNTU10.10"))) {
    report += res;
  }
