...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2012-05-25 20:06:00 +0000 (Fri, 25 May 2012)");
...
if(release == "UBUNTU11.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-2.6.38-1209-omap4", ver:"2.6.38-1209.17", rls:"UBUNTU11.04"))) {
    report += res;
  }
