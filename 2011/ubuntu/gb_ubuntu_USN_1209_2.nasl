...
if(release == "UBUNTU11.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libavcodec52", ver:"4:0.6.2-1ubuntu1.1", rls:"UBUNTU11.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libavformat52", ver:"4:0.6.2-1ubuntu1.1", rls:"UBUNTU11.04"))) {
    report += res;
  }
