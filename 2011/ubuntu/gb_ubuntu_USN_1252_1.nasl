...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat6-java", ver:"6.0.24-2ubuntu1.9", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat6-java", ver:"6.0.28-2ubuntu1.5", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU11.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat6-java", ver:"6.0.28-10ubuntu2.2", rls:"UBUNTU11.04"))) {
    report += res;
  }
...
if(release == "UBUNTU11.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat6-java", ver:"6.0.32-5ubuntu1.1", rls:"UBUNTU11.10"))) {
    report += res;
  }
