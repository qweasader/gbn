...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tex-common", ver:"2.06ubuntu0.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tex-common", ver:"2.08ubuntu0.1", rls:"UBUNTU10.10"))) {
    report += res;
  }
