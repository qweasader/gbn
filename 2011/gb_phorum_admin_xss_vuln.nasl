...
if(description)
{
  ...
  script_name("Phorum <= 5.2.18 XSS Vulnerability - Active Check");
  ...
  script_mandatory_keys("phorum/http/detected");
  ...
  script_tag(name:"insight", value:"The flaw is due to an input appended to the URL after
  'admin.php' is not properly sanitised before being returned to the user.");

  script_tag(name:"affected", value:"Phorum version 5.2.18 and probably prior.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/49920");
