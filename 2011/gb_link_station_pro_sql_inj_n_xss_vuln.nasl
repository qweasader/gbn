...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/48948");
  ...
  script_tag(name:"summary", value:"Link Station Pro is prone to SQL injection and cross site scripting vulnerabilities.");
