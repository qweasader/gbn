...
#
# Squid Caching Server CNAME Denial of Service Vulnerability
#
# Authors:
...
if(description)
{
  ...
  script_name("Squid Caching Server CNAME DoS Vulnerability");
  ...
  script_tag(name:"summary", value:"Squid caching server is prone to a denial of service (DoS)
  vulnerability.");

  script_tag(name:"impact", value:"An attacker can exploit this issue to cause an affected
