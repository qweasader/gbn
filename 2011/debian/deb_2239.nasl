...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2239-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2239-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2239-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2239");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libmojolicious-perl' package(s) announced via the DSA-2239-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmojolicious-perl", ver:"0.999926-1+squeeze2", rls:"DEB6"))) {
    report += res;
  }
