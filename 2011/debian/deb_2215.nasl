...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2215-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2215-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2215-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2215");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gitolite' package(s) announced via the DSA-2215-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gitolite", ver:"1.5.4-2+squeeze1", rls:"DEB6"))) {
    report += res;
  }
