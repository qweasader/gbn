...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2147-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2147-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2147-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2147");
  script_xref(name:"URL", value:"https://www.debian.org/security/");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pimd' package(s) announced via the DSA-2147-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pimd", ver:"2.1.0-alpha29.17-8.1lenny1", rls:"DEB5"))) {
    report += res;
  }
