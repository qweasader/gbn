...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2213-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2213-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2213-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2213");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'x11-xserver-utils' package(s) announced via the DSA-2213-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"x11-xserver-utils", ver:"7.3+6", rls:"DEB5"))) {
    report += res;
  }
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"x11-xserver-utils", ver:"7.5+3", rls:"DEB6"))) {
    report += res;
  }
