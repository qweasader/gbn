...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2302-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2302-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2302-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2302");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bcfg2' package(s) announced via the DSA-2302-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bcfg2", ver:"0.9.5.7-1.1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"bcfg2-server", ver:"0.9.5.7-1.1+lenny1", rls:"DEB5"))) {
    report += res;
  }
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bcfg2", ver:"1.0.1-3+squeeze1", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"bcfg2-server", ver:"1.0.1-3+squeeze1", rls:"DEB6"))) {
    report += res;
  }
