...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2316-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2316-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2316-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2316");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'quagga' package(s) announced via the DSA-2316-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"quagga", ver:"0.99.10-1lenny6", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"quagga-doc", ver:"0.99.10-1lenny6", rls:"DEB5"))) {
    report += res;
  }
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"quagga", ver:"0.99.17-2+squeeze3", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"quagga-doc", ver:"0.99.17-2+squeeze3", rls:"DEB6"))) {
    report += res;
  }
