...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2179-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2179-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2179-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2179");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dtc' package(s) announced via the DSA-2179-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dtc-common", ver:"0.29.17-1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dtc-core", ver:"0.29.17-1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dtc-cyrus", ver:"0.29.17-1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dtc-postfix-courier", ver:"0.29.17-1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dtc-stats-daemon", ver:"0.29.17-1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dtc-toaster", ver:"0.29.17-1+lenny1", rls:"DEB5"))) {
    report += res;
  }
