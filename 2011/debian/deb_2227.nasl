...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2227-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2227-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2227-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2227");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'iceape' package(s) announced via the DSA-2227-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"iceape", ver:"2.0.11-5", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"iceape-browser", ver:"2.0.11-5", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"iceape-chatzilla", ver:"2.0.11-5", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"iceape-dbg", ver:"2.0.11-5", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"iceape-dev", ver:"2.0.11-5", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"iceape-mailnews", ver:"2.0.11-5", rls:"DEB6"))) {
    report += res;
  }
