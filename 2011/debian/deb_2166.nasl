...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2166-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2166-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2166-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2166");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium-browser' package(s) announced via the DSA-2166-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"chromium-browser", ver:"6.0.472.63~r59945-5+squeeze2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium-browser-dbg", ver:"6.0.472.63~r59945-5+squeeze2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium-browser-inspector", ver:"6.0.472.63~r59945-5+squeeze2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium-browser-l10n", ver:"6.0.472.63~r59945-5+squeeze2", rls:"DEB6"))) {
    report += res;
  }
