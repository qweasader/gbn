...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2248-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2248-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2248-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2248");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ejabberd' package(s) announced via the DSA-2248-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ejabberd", ver:"2.0.1-6+lenny3", rls:"DEB5"))) {
    report += res;
  }
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ejabberd", ver:"2.1.5-3+squeeze1", rls:"DEB6"))) {
    report += res;
  }
