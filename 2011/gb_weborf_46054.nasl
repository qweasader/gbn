...
if (description)
{
  ...
  script_name("Weborf < 0.12.5 DoS Vulnerability");
  ...
  script_tag(name:"affected", value:"Weborf prior to version 0.12.5.");

  script_tag(name:"solution", value:"Update to version 0.12.5 or later.");

  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/46054");
...
if (version_is_less(version: version, test_version: "0.12.5")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "0.12.5");
