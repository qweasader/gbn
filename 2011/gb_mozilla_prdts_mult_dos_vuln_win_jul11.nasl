...
if(description)
{
  ...
  script_name("Mozilla Products Multiple Denial of Service Vulnerabilities (Jul 2011) - Windows");

  script_xref(name:"URL", value:"http://www.mozilla.org/security/announce/2011/mfsa2011-23.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/48367");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/48368");
  ...
  arbitrary code.");
  script_tag(name:"summary", value:"Mozilla Firefox or Thunderbird is prone to multiple denial of service vulnerabilities.");
