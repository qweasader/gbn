...
if(version_is_equal(version:version, test_version:"1.4.2")) {
  report = report_fixed_ver(installed_version:version, vulnerable_range:"Equal to 1.4.2", install_path:location);
