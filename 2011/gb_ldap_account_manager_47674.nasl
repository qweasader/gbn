...
if (description)
{
  ...
  script_name("LDAP Account Manager <= 3.4.0 XSS Vulnerability - Active Check");
  ...
  script_mandatory_keys("ldap_account_manager/http/detected");

  script_tag(name:"summary", value:"LDAP Account Manager is prone to a cross-site scripting (XSS)
  ...
  script_tag(name:"affected", value:"LDAP Account Manager version 3.4.0 and prior.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/47674");
...
url = dir + "/templates/login.php?selfserviceSaveOk=<script>alert(/vt-xss-test/)</script>";
