...
if(description)
{
  ...
  service (crash) via vectors related to recursion level.");
...
if( version_is_less( version:vers, test_version:"0.97.3" ) ) {
  report = report_fixed_ver( installed_version:vers, fixed_version:"0.97.3", install_path:path );
