...
if(description)
{
  ...
  script_name("OTRS 'AgentTicketZoom' XSS Vulnerability (OSA-2010-03)");
  ...
  affected site when malicious data is being viewed.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw is due to input passed via HTML e-mails is not properly
  sanitised in AgentTicketZoom before being displayed to the user.");
...
if(version_in_range(version:vers, test_version:"2.4.0", test_version2:"2.4.8")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"2.4.9");
