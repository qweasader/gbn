...
if(description)
{
  ...
  script_name("HESK < 2.4.1 Multiple XSS Vulnerabilities - Active Check");

  script_category(ACT_ATTACK);

  script_copyright("Copyright (C) 2011 Greenbone Networks GmbH");
  script_family("Web application abuses");
  script_dependencies("gb_hesk_http_detect.nasl");
  script_mandatory_keys("hesk/http/detected");
  script_require_ports("Services/www", 443);

  script_tag(name:"summary", value:"HESK is prone to multiple cross-site scripting (XSS)
  ...
  script_tag(name:"affected", value:"HESK prior to version 2.4.1.");
