...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/46781");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Inline Gallery' is prone to a cross-site scripting (XSS) vulnerability.");
