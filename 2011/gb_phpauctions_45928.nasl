...
if (description)
{
  ...
  script_name("PHPAuctions 'viewfaqs.php' SQLi Vulnerability - Active Check");
  ...
  script_tag(name:"summary", value:"PHPAuctions is prone to an SQL injection (SQLi) vulnerability
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/45928");
...
foreach dir( make_list_unique( "/phpauctions", "/phpauction", "/auction", http_cgi_dirs( port:port ) ) ) {
  ...
  res = http_get_cache( port:port, item:dir + "/viewfaqs.php" );
  ...
  if( http_vuln_check( port:port, url:url,
                       pattern:"The used SELECT statements have a different number of columns" ) ) {
