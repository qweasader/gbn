...
if(description)
{
  ...
  script_name("Koha < 3.4.2 Multiple XSS Vulnerabilities - Active Check");
  ...
  in 'bib_list' parameter to opac-downloadcart.pl, 'biblionumber' parameter to
  opac-serial-issues.pl, opac-addbybiblionumber.pl, opac-review.pl and 'shelfid' parameter to
  opac-sendshelf.pl and opac-downloadshelf.pl.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to insert
  arbitrary HTML and script code, which will be executed in a user's browser session in the context
  of an affected site.");

  script_tag(name:"affected", value:"Koha version 3.4.1 and prior.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/48895");
...
url = '/cgi-bin/koha/opac-review.pl?biblionumber="<script>alert(document.cookie)</script>';
