...
if(description)
{
  ...
  script_name("Phorum < 5.2.17 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The flaw is due to input passed via the 'real_name' parameter
  to the 'control.php' script is not properly sanitised before being returned to the user.");

  script_tag(name:"impact", value:"Successful exploitation will allow attacker to execute arbitrary
  HTML and script code in a user's browser session in the context of an affected site.");

  script_tag(name:"affected", value:"Phorum prior to version 5.2.17.");

  script_tag(name:"solution", value:"Update to version 5.2.17 or later.");

  script_xref(name:"URL", value:"http://secunia.com/advisories/45787");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/49347");
...
if (version_is_less(version: version, test_version: "5.2.17")) {
