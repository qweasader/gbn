...
if (description)
{
  ...
  script_name("PhotoPost PHP <= 4.8c Multiple XSS Vulnerabilities - Active Check");
  ...
  script_tag(name:"summary", value:"PhotoPost PHP is prone to multiple cross-site scripting (XSS)
  ...
  script_tag(name:"affected", value:"PhotoPost PHP version 4.8c and probably prior.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/46649");
...
url = dir + '/showgallery.php?si="<script>alert(/vt-xss-test/)</script>"';
