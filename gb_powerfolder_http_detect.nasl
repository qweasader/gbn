...
if ((banner =~ "PF-Server-(Name|ID)\s*:.+" && 'name="label_clients"' >< res) ||
    ("powerfolder/util.js" >< res && "Please enable Javascript to use PowerFolder properly" >< res) ||
    (res =~ '<a href="https?://(www\\.)?powerfolder\\.com"' && 'name="label_powered_by"' >< res)) {
  version = "unknown";

  # <!-- Program version: 15.6.102.29 -->
  # <!-- Program version: 11.2.312 -->
