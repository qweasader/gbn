...
#    </p>
#
# or even with a "minimal" Banner like:
#
#    <p class="hdr">
#      Embedded Perl version <b>v5.24.1</b> for <b>Apache/2.4.25 (Debian)</b> process <b>2184</b>,<br />
#      running since Mon Jul 19 11:35:32 2021
#    </p>
if( buf && buf =~ "^HTTP/1\.[01] 200" && egrep( string:buf, pattern:"^\s*(<title>Apache2::Status[^<]+</title>|Embedded Perl version.+for.+Apache)", icase:FALSE ) ) {
  ...
  if( sv[1] ) {
    ...
    # nb: Append the Perl version if it isn't included directly in the Apache banner.
    if( "Perl" >!< sv[2] )
      banner += " Perl/" + sv[1];
