...
if(description)
{
  ...
  script_tag(name:"solution", value:"Update to version 1.4.64 or later.");

  script_xref(name:"URL", value:"https://redmine.lighttpd.net/issues/3134");
  script_xref(name:"URL", value:"https://redmine.lighttpd.net/projects/lighttpd/wiki/Release-1_4_64");
...
if (version_in_range(version: version, test_version: "1.4.46", test_version2: "1.4.63")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.4.64");
