...
if(description)
{
  ...
  script_version("2022-12-23T10:22:17+0000");
  script_cve_id("CVE-2022-44789", "CVE-2022-30975", "CVE-2022-30974");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2022-12-23 10:22:17 +0000 (Fri, 23 Dec 2022)");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:L/AC:L/PR:N/UI:R/S:U/C:N/I:N/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2022-05-26 02:38:00 +0000 (Thu, 26 May 2022)");
