...
if(description)
{
  ...
  script_version("2022-03-24T03:03:43+0000");
  script_tag(name:"last_modification", value:"2022-03-24 03:03:43 +0000 (Thu, 24 Mar 2022)");
  script_tag(name:"creation_date", value:"2022-03-16 08:21:55 +0000 (Wed, 16 Mar 2022)");
  script_tag(name:"cvss_base", value:"5.8");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:P/I:P/A:N");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:N");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2022-03-22 13:44:00 +0000 (Tue, 22 Mar 2022)");
  ...
  script_xref(name:"URL", value:"https://github.com/gogs/gogs/releases/tag/v0.12.5");
  script_xref(name:"URL", value:"https://github.com/gogs/gogs/issues/6754");
  script_xref(name:"URL", value:"https://github.com/gogs/gogs/issues/6810");
