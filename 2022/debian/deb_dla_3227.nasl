...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-06 12:40:32 +0000 (Wed, 06 Jul 2022)");

  script_name("Debian: Security Advisory (DLA-3227-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3227-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ruby-rails-html-sanitizer");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby-rails-html-sanitizer' package(s) announced via the DLA-3227-1 advisory.");
