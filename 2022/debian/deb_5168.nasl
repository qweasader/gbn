...
if(description)
{
  ...
  script_cve_id("CVE-2022-2156", "CVE-2022-2157", "CVE-2022-2158", "CVE-2022-2160", "CVE-2022-2161", "CVE-2022-2162", "CVE-2022-2163", "CVE-2022-2164", "CVE-2022-2165", "CVE-2022-2415", "CVE-2022-4916", "CVE-2022-4917");
  ...
  script_tag(name:"severity_date", value:"2023-08-03 16:40:48 +0000 (Thu, 03 Aug 2023)");

  script_name("Debian: Security Advisory (DSA-5168-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5168-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5168");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5168-1 advisory.");
