...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5174-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5174-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg2' package(s) announced via the DSA-5174-1 advisory.");
