...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3092-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3092-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/dpdk");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dpdk' package(s) announced via the DLA-3092-1 advisory.");
