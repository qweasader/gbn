...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5130-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5130-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5130");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/dpdk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dpdk' package(s) announced via the DSA-5130-1 advisory.");
