...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5271-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5271-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5271");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libxml2");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxml2' package(s) announced via the DSA-5271-1 advisory.");
