...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-10-19 14:09:36 +0000 (Tue, 19 Oct 2021)");

  script_name("Debian: Security Advisory (DSA-5064-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5064-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-nbxmpp' package(s) announced via the DSA-5064-1 advisory.");
