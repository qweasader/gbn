...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5208-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5208-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5208");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/epiphany-browser");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'epiphany-browser' package(s) announced via the DSA-5208-1 advisory.");
