...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-12-20 15:45:09 +0000 (Tue, 20 Dec 2022)");

  script_name("Debian: Security Advisory (DSA-5273-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5273-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5273");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/webkit2gtk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'webkit2gtk' package(s) announced via the DSA-5273-1 advisory.");
