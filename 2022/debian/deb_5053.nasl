...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5053-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5053-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5053");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/pillow");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pillow' package(s) announced via the DSA-5053-1 advisory.");
