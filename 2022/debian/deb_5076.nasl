...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5076-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5076-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5076");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/h2database");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'h2database' package(s) announced via the DSA-5076-1 advisory.");
