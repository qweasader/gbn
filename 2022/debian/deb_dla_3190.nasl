...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3190-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3190-2");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'grub2' package(s) announced via the DLA-3190-2 advisory.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-common", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-coreboot-dbg", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-amd64-bin", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-amd64-dbg", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-amd64-signed-template", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-arm-bin", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-arm-dbg", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-arm64-bin", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-arm64-dbg", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-arm64-signed-template", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-ia32-bin", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-ia32-dbg", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-ia32-signed-template", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-emu-dbg", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-ieee1275-bin", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-ieee1275-dbg", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-pc-bin", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-pc-dbg", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-uboot-bin", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-uboot-dbg", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-xen-bin", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-xen-dbg", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-xen-host", ver:"2.06-3~deb10u3", rls:"DEB10"))) {
    report += res;
  }
