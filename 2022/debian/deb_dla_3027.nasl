...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3027-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3027-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'neutron' package(s) announced via the DLA-3027-1 advisory.");
