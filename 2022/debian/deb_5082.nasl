...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5082-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5082-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5082");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/php7.4");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php7.4' package(s) announced via the DSA-5082-1 advisory.");
