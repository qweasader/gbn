...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5158-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5158-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5158");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-5158-1 advisory.");
...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-l10n-af", ver:"1:91.10.0-1~deb11u1", rls:"DEB11"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-l10n-en-ca", ver:"1:91.10.0-1~deb11u1", rls:"DEB11"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-l10n-lv", ver:"1:91.10.0-1~deb11u1", rls:"DEB11"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-l10n-pa-in", ver:"1:91.10.0-1~deb11u1", rls:"DEB11"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-l10n-th", ver:"1:91.10.0-1~deb11u1", rls:"DEB11"))) {
    report += res;
  }
