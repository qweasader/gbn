...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-10-02 02:39:19 +0000 (Sat, 02 Oct 2021)");

  script_name("Debian: Security Advisory (DSA-5109-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5109-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5109");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/faad2");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'faad2' package(s) announced via the DSA-5109-1 advisory.");
