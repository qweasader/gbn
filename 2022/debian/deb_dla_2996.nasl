...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-07-23 19:45:52 +0000 (Thu, 23 Jul 2020)");

  script_name("Debian: Security Advisory (DLA-2996-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-2996-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mruby");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mruby' package(s) announced via the DLA-2996-1 advisory.");
