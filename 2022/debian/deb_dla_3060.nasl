...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-03-04 20:25:36 +0000 (Fri, 04 Mar 2022)");

  script_name("Debian: Security Advisory (DLA-3060-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3060-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/blender");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'blender' package(s) announced via the DLA-3060-1 advisory.");
