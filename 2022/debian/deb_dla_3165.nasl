...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3165-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3165-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/expat");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'expat' package(s) announced via the DLA-3165-1 advisory.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libexpat1-udeb", ver:"2.2.6-2+deb10u6", rls:"DEB10"))) {
    report += res;
  }
