...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-03-14 18:50:13 +0000 (Mon, 14 Mar 2022)");

  script_name("Debian: Security Advisory (DLA-2965-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-2965-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/cacti");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cacti' package(s) announced via the DLA-2965-1 advisory.");
