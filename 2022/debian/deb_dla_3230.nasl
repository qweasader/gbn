...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-27 14:46:17 +0000 (Wed, 27 Jul 2022)");

  script_name("Debian: Security Advisory (DLA-3230-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3230-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/jqueryui");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jqueryui' package(s) announced via the DLA-3230-1 advisory.");
