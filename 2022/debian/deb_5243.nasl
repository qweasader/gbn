...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5243-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5243-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lighttpd' package(s) announced via the DSA-5243-1 advisory.");
