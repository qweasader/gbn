...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2885-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-2885-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/qtsvg-opensource-src");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qtsvg-opensource-src' package(s) announced via the DLA-2885-1 advisory.");
