...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-12-17 20:22:41 +0000 (Fri, 17 Dec 2021)");

  script_name("Debian: Security Advisory (DSA-5042-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5042-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5042");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/epiphany-browser");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'epiphany-browser' package(s) announced via the DSA-5042-1 advisory.");
