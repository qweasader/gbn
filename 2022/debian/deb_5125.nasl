...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-08-03 16:39:40 +0000 (Thu, 03 Aug 2023)");

  script_name("Debian: Security Advisory (DSA-5125-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5125-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5125");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5125-1 advisory.");
