...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-09-21 18:09:47 +0000 (Wed, 21 Sep 2022)");

  script_name("Debian: Security Advisory (DLA-3117-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3117-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mediawiki");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DLA-3117-1 advisory.");
