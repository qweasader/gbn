...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5098-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5098-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5098");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tryton-server");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tryton-server' package(s) announced via the DSA-5098-1 advisory.");
