...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-27 16:13:14 +0000 (Wed, 27 Jul 2022)");

  script_name("Debian: Security Advisory (DSA-5112-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5112-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5112-1 advisory.");
