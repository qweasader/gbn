...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5145-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5145-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lrzip' package(s) announced via the DSA-5145-1 advisory.");
