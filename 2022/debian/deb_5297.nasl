...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-12-08 16:44:11 +0000 (Thu, 08 Dec 2022)");

  script_name("Debian: Security Advisory (DSA-5297-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5297-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'vlc' package(s) announced via the DSA-5297-1 advisory.");
