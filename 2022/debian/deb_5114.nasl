...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-27 16:09:56 +0000 (Wed, 27 Jul 2022)");

  script_name("Debian: Security Advisory (DSA-5114-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5114-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5114");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-5114-1 advisory.");
