...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5228-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5228-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5228");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gdk-pixbuf");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gdk-pixbuf' package(s) announced via the DSA-5228-1 advisory.");
