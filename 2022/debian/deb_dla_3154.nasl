...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-10-11 19:12:29 +0000 (Tue, 11 Oct 2022)");

  script_name("Debian: Security Advisory (DLA-3154-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3154-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/node-xmldom");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'node-xmldom' package(s) announced via the DLA-3154-1 advisory.");
