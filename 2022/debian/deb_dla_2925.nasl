...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-02-25 14:47:53 +0000 (Fri, 25 Feb 2022)");

  script_name("Debian: Security Advisory (DLA-2925-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-2925-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'drupal7' package(s) announced via the DLA-2925-1 advisory.");
