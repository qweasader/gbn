...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-01-27 19:27:29 +0000 (Thu, 27 Jan 2022)");

  script_name("Debian: Security Advisory (DLA-3221-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3221-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/node-cached-path-relative");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'node-cached-path-relative' package(s) announced via the DLA-3221-1 advisory.");
