...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-06-07 18:26:25 +0000 (Tue, 07 Jun 2022)");

  script_name("Debian: Security Advisory (DSA-5246-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5246-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5246");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mediawiki");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DSA-5246-1 advisory.");
