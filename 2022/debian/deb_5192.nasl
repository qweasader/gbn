...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5192-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5192-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjdk-17' package(s) announced via the DSA-5192-1 advisory.");
