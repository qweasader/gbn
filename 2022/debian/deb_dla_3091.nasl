...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-06-09 13:42:40 +0000 (Thu, 09 Jun 2022)");

  script_name("Debian: Security Advisory (DLA-3091-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3091-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/sofia-sip");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sofia-sip' package(s) announced via the DLA-3091-1 advisory.");
