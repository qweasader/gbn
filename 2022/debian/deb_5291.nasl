...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-29 20:50:37 +0000 (Tue, 29 Nov 2022)");

  script_name("Debian: Security Advisory (DSA-5291-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5291-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mujs' package(s) announced via the DSA-5291-1 advisory.");
