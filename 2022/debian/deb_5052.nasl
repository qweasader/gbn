...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-01-27 18:10:43 +0000 (Thu, 27 Jan 2022)");

  script_name("Debian: Security Advisory (DSA-5052-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5052-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'usbview' package(s) announced via the DSA-5052-1 advisory.");
