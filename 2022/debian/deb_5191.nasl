...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5191-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5191-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5191");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/linux");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux' package(s) announced via the DSA-5191-1 advisory.");
...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"usbip", ver:"2.0+5.10.127-2", rls:"DEB11"))) {
    report += res;
  }
