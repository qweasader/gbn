...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-09-07 17:47:09 +0000 (Wed, 07 Sep 2022)");

  script_name("Debian: Security Advisory (DLA-3107-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3107-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sqlite3' package(s) announced via the DLA-3107-1 advisory.");
