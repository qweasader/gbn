...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-01-19 20:29:37 +0000 (Wed, 19 Jan 2022)");

  script_name("Debian: Security Advisory (DLA-2914-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-2914-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/zabbix");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zabbix' package(s) announced via the DLA-2914-1 advisory.");
