...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-01-14 15:57:27 +0000 (Fri, 14 Jan 2022)");

  script_name("Debian: Security Advisory (DLA-2928-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-2928-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/htmldoc");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'htmldoc' package(s) announced via the DLA-2928-1 advisory.");
