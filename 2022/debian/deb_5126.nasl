...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-08-16 18:15:18 +0000 (Mon, 16 Aug 2021)");

  script_name("Debian: Security Advisory (DSA-5126-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5126-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-5126-1 advisory.");
