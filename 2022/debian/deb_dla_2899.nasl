...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2899-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-2899-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'policykit-1' package(s) announced via the DLA-2899-1 advisory.");
