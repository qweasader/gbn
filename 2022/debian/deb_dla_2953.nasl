...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2953-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-2953-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openssl1.0");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl1.0' package(s) announced via the DLA-2953-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libcrypto1.0.2-udeb", ver:"1.0.2u-1~deb9u7", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl1.0.2-udeb", ver:"1.0.2u-1~deb9u7", rls:"DEB9"))) {
    report += res;
  }
