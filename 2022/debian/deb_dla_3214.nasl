...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-07-14 18:21:31 +0000 (Tue, 14 Jul 2020)");

  script_name("Debian: Security Advisory (DLA-3214-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3214-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libraw");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libraw' package(s) announced via the DLA-3214-1 advisory.");
