...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-12-16 17:09:55 +0000 (Fri, 16 Dec 2022)");

  script_name("Debian: Security Advisory (DSA-5190-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2022/DSA-5190-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'spip' package(s) announced via the DSA-5190-1 advisory.");
