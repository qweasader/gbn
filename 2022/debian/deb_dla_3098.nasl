...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-09-01 20:16:40 +0000 (Thu, 01 Sep 2022)");

  script_name("Debian: Security Advisory (DLA-3098-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2022/DLA-3098-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libmodbus");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libmodbus' package(s) announced via the DLA-3098-1 advisory.");
