...
if(description)
{
  ...
  - No CVE: Prototype pollution via the Gutenberg wordpress/url package

  - CVE-2021-20083: Prototype pollution in a jQuery dependency

  - No CVE: Stored cross-site scripting (XSS), only affecting version 5.9.0 and 5.9.1.");
  ...
  script_xref(name:"URL", value:"https://www.wordfence.com/blog/2022/03/wordpress-5-9-2-security-update-fixes-xss-and-prototype-pollution-vulnerabilities/");
  script_xref(name:"URL", value:"https://packetstormsecurity.com/files/166299/WordPress-Core-5.9.0-5.9.1-Cross-Site-Scripting.html");
