...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2019-03-06 13:00:00 +0000 (Wed, 06 Mar 2019)");
  ...
  script_tag(name:"insight", value:"The plugin is vulnerable to reflected XSS as it echoes the quiz_id
  parameter without proper encoding.");
