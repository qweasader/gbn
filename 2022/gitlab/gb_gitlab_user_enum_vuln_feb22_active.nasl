...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-04 18:22:00 +0000 (Mon, 04 Apr 2022)");
  ...
  script_name("GitLab 13.0.x < 14.6.5, 14.7.x < 14.7.4, 14.8.x < 14.8.2 GraphQL API User Enumeration Vulnerability - Active Check");
