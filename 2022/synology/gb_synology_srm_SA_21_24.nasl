...
if(description)
{
  ...
  script_name("Synology Router Manager 1.2.x OpenSSL Vulnerabilities (Synology-SA-21:24)");
  ...
  script_tag(name:"affected", value:"Synology Router Manager versions 1.2.x.");
