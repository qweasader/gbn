...
if(description)
{
  ...
  script_name("Synology Router Manager (SRM) 1.2.x < 1.2.5-8227-5, 1.3.x < 1.3-9193-1 Multiple Vulnerabilities (Synology-SA-22:06) - Unreliable Remote Version Check");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.114436
if ((version =~ "^1\.2" && (revcomp(a: version, b: "1.2.5-8227") < 0)) ||
    (version =~ "^1\.3" && (revcomp(a: version, b: "1.3-9193") < 0)))
  exit(0);
...
if (version =~ "^1\.2" && (revcomp(a: version, b: "1.2.5-8227-5") < 0)) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.2.5-8227-5" );
  security_message(port: 0, data: report);
  exit(0);
}

if (version =~ "^1\.3" && (revcomp(a: version, b: "1.3-9193-1") < 0)) {
