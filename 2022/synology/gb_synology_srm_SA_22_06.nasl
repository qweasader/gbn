...
if(description)
{
  ...
  script_name("Synology Router Manager 1.2.x < 1.2.5-8227-5, 1.3.x < 1.3-9193-1 Multiple Vulnerabilities (Synology-SA-22:06)");
  ...
  script_tag(name:"affected", value:"Synology Router Manager version 1.2.x prior to 1.2.5-8227-5
