...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) 6.2.x < 6.2.4-25556-3, 7.x < 7.0.1-42218-2 Multiple Vulnerabilities (Synology-SA-22:01) - Remote Known Vulnerable Versions Check");
  ...
  script_tag(name:"affected", value:"Synology DSM version 6.2.x prior to 6.2.4-25556-3 and 7.x prior
  to 7.0.1-42218-2.");

  script_tag(name:"solution", value:"Update to firmware version 6.2.4-25556-3, 7.0.1-42218-2 or
  later.");
