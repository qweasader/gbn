...
if(description)
{
  ...
  script_name("Synology DiskStation Manager 6.2.x, 7.x < 7.0.1-42218 OpenSSL Vulnerabilities (Synology-SA-21:24)");
  ...
  Firmware 7.0.1-42218 includes OpenSSL version 1.1.1l to fix these issues.");

  script_tag(name:"affected", value:"Synology DiskStation Manager version 6.2.x and 7.x prior to
  7.0.1-42218.");
...
if ( ( revcomp( a:version, b:"6.2" ) >= 0 ) && ( revcomp( a:version, b:"7.0.1-42218" ) < 0 ) ) {
