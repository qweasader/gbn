...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-08-10 15:54:00 +0000 (Wed, 10 Aug 2022)");
  ...
  script_name("Synology DiskStation Manager (DSM) 6.2.x < 6.2.4-25556-5, 7.x < 7.0.1-42218-3 OS Command Injection Vulnerability (Synology-SA-22:03) - Remote Known Vulnerable Versions Check");
  ...
  script_tag(name:"affected", value:"Synology DSM version 6.2.x prior to 6.2.4-25556-5 and 7.x prior
  to 7.0.1-42218-3.");

  script_tag(name:"solution", value:"Update to firmware version 6.2.4-25556-5, 7.0.1-42218-3 or
  later.");
