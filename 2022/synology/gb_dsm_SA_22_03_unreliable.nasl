...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) 6.2.x < 6.2.4-25556-5, 7.x < 7.0.1-42218-3 OS Command Injection Vulnerability (Synology-SA-22:03) - Unreliable Remote Version Check");
