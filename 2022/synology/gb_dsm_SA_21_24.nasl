...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) 6.2.x, 7.x < 7.0.1-42218 OpenSSL Vulnerabilities (Synology-SA-21:24)");
  ...
  script_tag(name:"affected", value:"Synology DSM version 6.2.x and 7.x prior to
  7.0.1-42218.");
