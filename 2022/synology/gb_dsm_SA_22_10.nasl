...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) Multiple Samba Vulnerabilities (Synology-SA-22:10)");
  ...
  script_tag(name:"affected", value:"Synology DSM versions 6.2.x.");
