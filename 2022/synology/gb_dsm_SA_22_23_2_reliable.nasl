...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) 7.0.x < 7.0.1-42218-6, 7.1.x < 7.1.1-42962-3 Multiple Vulnerabilities (Synology-SA-22:23) - Remote Known Vulnerable Versions Check");
