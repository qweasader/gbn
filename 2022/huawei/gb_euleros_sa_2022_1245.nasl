...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2022-1245");
...
if(release == "EULEROS-2.0SP10") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libsepol", rpm:"libsepol~3.1~1.h11.eulerosv2r10", rls:"EULEROS-2.0SP10"))) {
    report += res;
  }
