...
if(description)
{
  ...
  script_tag(name:"affected", value:"QNAP QuTS hero version h5.x prior to h5.0.0.1986 build 20220324.");

  script_tag(name:"solution", value:"Update to version h5.0.0.1986 build 20220324.");
...
if ( version_in_range_exclusive( version:version, test_version_lo:"h5.0.0", test_version_up:"h5.0.0.1986" ) ) {
