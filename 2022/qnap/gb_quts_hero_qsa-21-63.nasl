...
if ( version_is_less( version:version, test_version:"h4.5.4.1771" ) ) {
  report = report_fixed_ver( installed_version:version, installed_build:build, fixed_version:"h4.5.4.1771", fixed_build:"20210825" );
  security_message( port:0, data:report );
  exit( 0 );
}

if ( version_is_equal( version:version, test_version:"h4.5.4.1771" ) &&
   ( ! build || version_is_less( version:build, test_version:"20210825" ) ) ) {
  report = report_fixed_ver( installed_version:version, installed_build:build, fixed_version:"h4.5.4.1771", fixed_build:"20210825" );
  security_message( port:0, data:report );
  exit( 0 );
}
