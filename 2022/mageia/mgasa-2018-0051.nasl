...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-30 19:10:36 +0000 (Wed, 30 Jan 2019)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libexif' package(s) announced via the MGASA-2018-0051 advisory.");
...
heap chunk metadata, even other applications' private data) (CVE-2016-6328).");
  ...
  script_tag(name:"affected", value:"'libexif' package(s) on Mageia 5, Mageia 6.");
