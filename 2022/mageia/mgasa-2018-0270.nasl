...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3' package(s) announced via the MGASA-2018-0270 advisory.");
...
to verify that at least one channel is provided (CVE-2017-18207).");
  ...
  script_tag(name:"affected", value:"'python3' package(s) on Mageia 5, Mageia 6.");
