...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache' package(s) announced via the MGASA-2021-0265 advisory.");
...
only. Apache HTTP Server 2.4.47 was never released. (CVE-2021-31618).");
  ...
  script_tag(name:"affected", value:"'apache' package(s) on Mageia 7, Mageia 8.");
