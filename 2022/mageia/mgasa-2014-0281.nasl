...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-21 16:15:47 +0000 (Tue, 21 Jan 2020)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ffmpeg' package(s) announced via the MGASA-2014-0281 advisory.");
...
and several other bugs which were corrected upstream.");
  ...
  script_tag(name:"affected", value:"'ffmpeg' package(s) on Mageia 3.");
