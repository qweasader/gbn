...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer1.0-libav, gstreamer1.0-plugins-good, gstreamer1.0-plugins-ugly' package(s) announced via the MGASA-2021-0187 advisory.");
...
privileges of the target user.");
  ...
  script_tag(name:"affected", value:"'gstreamer1.0-libav, gstreamer1.0-plugins-good, gstreamer1.0-plugins-ugly' package(s) on Mageia 7, Mageia 8.");
