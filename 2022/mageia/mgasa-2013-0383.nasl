...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium-browser-stable' package(s) announced via the MGASA-2013-0383 advisory.");
...
the v8 javascript library (CVE-2013-6640).");
  ...
  script_tag(name:"affected", value:"'chromium-browser-stable' package(s) on Mageia 3.");
