...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'lighttpd' package(s) announced via the MGASA-2013-0334 advisory.");
...
fails, a remote client could trigger a DoS (CVE-2013-4560).");
  ...
  script_tag(name:"affected", value:"'lighttpd' package(s) on Mageia 2, Mageia 3.");
