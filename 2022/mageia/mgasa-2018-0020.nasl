...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libzip' package(s) announced via the MGASA-2018-0020 advisory.");
...
_zip_cdir_grow in zip_dirent.c) via a crafted ZIP archive (CVE-2017-14107).");
  ...
  script_tag(name:"affected", value:"'libzip' package(s) on Mageia 5, Mageia 6.");
