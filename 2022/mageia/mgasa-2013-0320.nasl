...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox-l10n, nspr, nss, rootcerts, sqlite3' package(s) announced via the MGASA-2013-0320 advisory.");
...
to newer versions required by this update.");
  ...
  script_tag(name:"affected", value:"'firefox, firefox-l10n, nspr, nss, rootcerts, sqlite3' package(s) on Mageia 2, Mageia 3.");
