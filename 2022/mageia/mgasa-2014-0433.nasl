...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-02-21 14:57:16 +0000 (Wed, 21 Feb 2018)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'zabbix' package(s) announced via the MGASA-2014-0433 advisory.");
...
send the contents of the specified file to a remote server (CVE-2014-3005).");
  ...
  script_tag(name:"affected", value:"'zabbix' package(s) on Mageia 3, Mageia 4.");
