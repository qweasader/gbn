...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'SDL_image' package(s) announced via the MGASA-2018-0276 advisory.");
...
CVE-2018-3839).");
  ...
  script_tag(name:"affected", value:"'SDL_image' package(s) on Mageia 5, Mageia 6.");
