...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-05-30 18:20:07 +0000 (Tue, 30 May 2017)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium-browser-stable, libwebp' package(s) announced via the MGASA-2017-0317 advisory.");
...
CVE-2017-5110, CVE-2017-6991)");
  ...
  script_tag(name:"affected", value:"'chromium-browser-stable, libwebp' package(s) on Mageia 5, Mageia 6.");
