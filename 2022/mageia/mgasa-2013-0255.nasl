...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'spice' package(s) announced via the MGASA-2013-0255 advisory.");
...
server/red_channel.c to crash the guest (CVE-2013-4130).");
  ...
  script_tag(name:"affected", value:"'spice' package(s) on Mageia 2, Mageia 3.");
