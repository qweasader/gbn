...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'dosbox' package(s) announced via the MGASA-2019-0205 advisory.");
...
files.");
  ...
  script_tag(name:"affected", value:"'dosbox' package(s) on Mageia 6, Mageia 7.");
