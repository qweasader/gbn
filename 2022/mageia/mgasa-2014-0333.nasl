...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the '389-ds-base' package(s) announced via the MGASA-2014-0333 advisory.");
...
issue and other bugs.");
  ...
  script_tag(name:"affected", value:"'389-ds-base' package(s) on Mageia 3, Mageia 4.");
