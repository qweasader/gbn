...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tar' package(s) announced via the MGASA-2021-0233 advisory.");
  ...
  script_tag(name:"affected", value:"'tar' package(s) on Mageia 7, Mageia 8.");
