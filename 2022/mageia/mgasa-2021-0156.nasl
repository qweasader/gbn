...
windowmaker, zbar and transcode (and tainted conter-parts) have been rebuilt.");
  ...
  script_tag(name:"affected", value:"'abydos, blender, converseen, cuneiform-linux, digikam, imagemagick, kxstitch, libopenshot, mgba, pfstools, php-imagick, pythonmagick, sk1, spectacle, synfig, transcode, uniconvertor, windowmaker, xine-lib1.2, zbar' package(s) on Mageia 7, Mageia 8.");
