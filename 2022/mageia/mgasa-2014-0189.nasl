...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.7.0-openjdk, lcms2' package(s) announced via the MGASA-2014-0189 advisory.");
...
patched to correct this flaw.");
  ...
  script_tag(name:"affected", value:"'java-1.7.0-openjdk, lcms2' package(s) on Mageia 3, Mageia 4.");
