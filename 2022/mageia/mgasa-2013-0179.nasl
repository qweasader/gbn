...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'apache-mod_security' package(s) announced via the MGASA-2013-0179 advisory.");
...
'forceRequestBodyVariable' (in phase 1) (CVE-2013-2765).");
  ...
  script_tag(name:"affected", value:"'apache-mod_security' package(s) on Mageia 2, Mageia 3.");
