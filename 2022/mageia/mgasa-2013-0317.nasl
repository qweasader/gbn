...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'x11-server' package(s) announced via the MGASA-2013-0317 advisory.");
...
(CVE-2013-4396).");
  ...
  script_tag(name:"affected", value:"'x11-server' package(s) on Mageia 2, Mageia 3.");
