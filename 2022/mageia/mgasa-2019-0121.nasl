...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'live, mplayer, vlc' package(s) announced via the MGASA-2019-0121 advisory.");
...
Also, VLC has been updated to version 3.0.6.");
  ...
  script_tag(name:"affected", value:"'live, mplayer, vlc' package(s) on Mageia 6.");
