...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ldb, samba, sssd, talloc' package(s) announced via the MGASA-2021-0585 advisory.");
...
details.");
  ...
  script_tag(name:"affected", value:"'ldb, samba, sssd, talloc' package(s) on Mageia 8.");
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"lib64pytalloc-util-devel", rpm:"lib64pytalloc-util-devel~2.3.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64pytalloc-util2", rpm:"lib64pytalloc-util2~2.3.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"lib64talloc-devel", rpm:"lib64talloc-devel~2.3.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64talloc2", rpm:"lib64talloc2~2.3.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libpytalloc-util-devel", rpm:"libpytalloc-util-devel~2.3.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libpytalloc-util2", rpm:"libpytalloc-util2~2.3.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libtalloc-devel", rpm:"libtalloc-devel~2.3.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libtalloc2", rpm:"libtalloc2~2.3.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-talloc", rpm:"python3-talloc~2.3.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"talloc", rpm:"talloc~2.3.2~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
