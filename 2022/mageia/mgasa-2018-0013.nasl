...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer0.10-plugins-bad' package(s) announced via the MGASA-2018-0013 advisory.");
...
(CVE-2016-9809, CVE-2017-5843, CVE-2017-5848).");
  ...
  script_tag(name:"affected", value:"'gstreamer0.10-plugins-bad' package(s) on Mageia 6.");
