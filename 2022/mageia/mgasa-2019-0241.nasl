...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.8.0-openjdk' package(s) announced via the MGASA-2019-0241 advisory.");
...
Missing array bounds check in crypto providers. (CVE-2019-2842)");
  ...
  script_tag(name:"affected", value:"'java-1.8.0-openjdk' package(s) on Mageia 6, Mageia 7.");
