...
application (CVE-2013-1872).");
  ...
  script_tag(name:"affected", value:"'libdmx, libfs, libx11, libxcb, libxcursor, libxext, libxfixes, libxi, libxinerama, libxp, libxrandr, libxrender, libxres, libxt, libxtst, libxv, libxvmc, libxxf86dga, libxxf86vm, mesa, x11-driver-video-openchrome' package(s) on Mageia 3.");
