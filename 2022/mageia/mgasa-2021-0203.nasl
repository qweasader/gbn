...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ldetect-lst, nvidia-current' package(s) announced via the MGASA-2021-0203 advisory.");
...
T600, T1000 and support for newer kernels.");
  ...
  script_tag(name:"affected", value:"'ldetect-lst, nvidia-current' package(s) on Mageia 7, Mageia 8.");
