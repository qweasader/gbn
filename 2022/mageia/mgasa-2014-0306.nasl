...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-03-27 23:48:59 +0000 (Tue, 27 Mar 2018)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gcc' package(s) announced via the MGASA-2014-0306 advisory.");
...
clang++ fails to find cxxabi.h and cxxabi_tweaks.h during build (mga#13543)");
  ...
  script_tag(name:"affected", value:"'gcc' package(s) on Mageia 3, Mageia 4.");
