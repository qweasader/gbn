...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxml2' package(s) announced via the MGASA-2013-0218 advisory.");
...
crash, resulting in a denial of service (CVE-2013-2877).");
  ...
  script_tag(name:"affected", value:"'libxml2' package(s) on Mageia 2, Mageia 3.");
