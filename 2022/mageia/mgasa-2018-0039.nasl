...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-06-06 14:18:38 +0000 (Tue, 06 Jun 2017)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'jbig2dec' package(s) announced via the MGASA-2018-0039 advisory.");
...
file (CVE-2017-9216).");
  ...
  script_tag(name:"affected", value:"'jbig2dec' package(s) on Mageia 5, Mageia 6.");
