...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'samba' package(s) announced via the MGASA-2013-0246 advisory.");
...
consumption) via a malformed packet (CVE-2013-4124).");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on Mageia 2, Mageia 3.");
