...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'db48, db53' package(s) announced via the MGASA-2017-0380 advisory.");
...
with dbenv=NULL, or using the dbm_open() function (CVE-2017-10140).");
  ...
  script_tag(name:"affected", value:"'db48, db53' package(s) on Mageia 5, Mageia 6.");
