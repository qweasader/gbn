...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'harbour' package(s) announced via the MGASA-2014-0355 advisory.");
...
the bundled minilzo to version 2.8.");
  ...
  script_tag(name:"affected", value:"'harbour' package(s) on Mageia 3, Mageia 4.");
