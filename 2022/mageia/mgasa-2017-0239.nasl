...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'spice, spice-protocol' package(s) announced via the MGASA-2017-0239 advisory.");
...
issues.");
  ...
  script_tag(name:"affected", value:"'spice, spice-protocol' package(s) on Mageia 5, Mageia 6.");
