...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-03-19 16:15:26 +0000 (Mon, 19 Mar 2018)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libid3tag' package(s) announced via the MGASA-2018-0223 advisory.");
...
file. (CVE-2017-11551)");
  ...
  script_tag(name:"affected", value:"'libid3tag' package(s) on Mageia 5, Mageia 6.");
