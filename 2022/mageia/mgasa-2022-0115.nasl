...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libpano13' package(s) announced via the MGASA-2022-0115 advisory.");
...
parser.c. (CVE-2021-33293)");
  ...
  script_tag(name:"affected", value:"'libpano13' package(s) on Mageia 8.");
