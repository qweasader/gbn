...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'springframework' package(s) announced via the MGASA-2014-0096 advisory.");
...
vulnerability (CVE-2013-6430).");
  ...
  script_tag(name:"affected", value:"'springframework' package(s) on Mageia 3, Mageia 4.");
