...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'busybox' package(s) announced via the MGASA-2014-0351 advisory.");
...
function, which is affected by this issue.");
  ...
  script_tag(name:"affected", value:"'busybox' package(s) on Mageia 3, Mageia 4.");
