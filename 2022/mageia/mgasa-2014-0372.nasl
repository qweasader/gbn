...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox-l10n, nspr, nss, rootcerts, thunderbird, thunderbird-l10n' package(s) announced via the MGASA-2014-0372 advisory.");
