...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox, firefox-l10n, thunderbird, thunderbird-l10n' package(s) announced via the MGASA-2014-0201 advisory.");
...
cross-site scripting (XSS) attacks (CVE-2014-1530).");
  ...
  script_tag(name:"affected", value:"'firefox, firefox-l10n, thunderbird, thunderbird-l10n' package(s) on Mageia 3, Mageia 4.");
