...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird, thunderbird-l10n, thunderbird-lightning' package(s) announced via the MGASA-2013-0326 advisory.");
...
is compatible with the updated Thunderbird.");
  ...
  script_tag(name:"affected", value:"'thunderbird, thunderbird-l10n, thunderbird-lightning' package(s) on Mageia 2, Mageia 3.");
