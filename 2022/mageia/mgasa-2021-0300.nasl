...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'nettle' package(s) announced via the MGASA-2021-0300 advisory.");
...
nettle package has been patched to fix these issues.");
  ...
  script_tag(name:"affected", value:"'nettle' package(s) on Mageia 7, Mageia 8.");
