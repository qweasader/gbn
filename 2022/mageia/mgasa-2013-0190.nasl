...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mesa' package(s) announced via the MGASA-2013-0190 advisory.");
...
user running the application (CVE-2013-1993).");
  ...
  script_tag(name:"affected", value:"'mesa' package(s) on Mageia 2.");
