...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mediawiki' package(s) announced via the MGASA-2019-0279 advisory.");
...
for more details.");
  ...
  script_tag(name:"affected", value:"'mediawiki' package(s) on Mageia 6, Mageia 7.");
