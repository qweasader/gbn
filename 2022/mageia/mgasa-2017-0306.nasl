...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'augeas' package(s) announced via the MGASA-2017-0306 advisory.");
...
leading to a crash or possible code execution (CVE-2017-7555).");
  ...
  script_tag(name:"affected", value:"'augeas' package(s) on Mageia 5, Mageia 6.");
