...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer1.0-plugins-bad, gstreamer1.0-plugins-base' package(s) announced via the MGASA-2021-0334 advisory.");
...
potentially also lead to memory corruptions.");
  ...
  script_tag(name:"affected", value:"'gstreamer1.0-plugins-bad, gstreamer1.0-plugins-base' package(s) on Mageia 7, Mageia 8.");
