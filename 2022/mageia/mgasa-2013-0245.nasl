...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'evolution-data-server' package(s) announced via the MGASA-2013-0245 advisory.");
...
Evolution encrypting email to an unintended recipient (CVE-2013-4166).");
  ...
  script_tag(name:"affected", value:"'evolution-data-server' package(s) on Mageia 2, Mageia 3.");
