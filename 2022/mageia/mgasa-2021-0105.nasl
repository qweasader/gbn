...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'openldap' package(s) announced via the MGASA-2021-0105 advisory.");
...
to crash, resulting in a denial of service (CVE-2021-27212).");
  ...
  script_tag(name:"affected", value:"'openldap' package(s) on Mageia 7, Mageia 8.");
