...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'SDL_image, mingw-SDL_image' package(s) announced via the MGASA-2018-0170 advisory.");
...
trigger this vulnerability (CVE-2017-2887).");
  ...
  script_tag(name:"affected", value:"'SDL_image, mingw-SDL_image' package(s) on Mageia 5, Mageia 6.");
