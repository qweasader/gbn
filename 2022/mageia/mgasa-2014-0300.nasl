...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'asterisk' package(s) announced via the MGASA-2014-0300 advisory.");
...
(2) incomplete HTTP connections (CVE-2014-4047).");
  ...
  script_tag(name:"affected", value:"'asterisk' package(s) on Mageia 3, Mageia 4.");
