...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'icedtea-web, java-1.7.0-openjdk' package(s) announced via the MGASA-2013-0185 advisory.");
...
phishing attack by providing frame content that spoofed a login ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'icedtea-web, java-1.7.0-openjdk' package(s) on Mageia 2, Mageia 3.");
