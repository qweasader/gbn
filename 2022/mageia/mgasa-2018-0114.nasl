...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'dovecot' package(s) announced via the MGASA-2018-0114 advisory.");
...
due to memory exhaustion. (CVE-2017-15132).");
  ...
  script_tag(name:"affected", value:"'dovecot' package(s) on Mageia 5, Mageia 6.");
