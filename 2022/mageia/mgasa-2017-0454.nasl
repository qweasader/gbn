...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'pcre' package(s) announced via the MGASA-2017-0454 advisory.");
...
impact via a crafted file (CVE-2017-7246).");
  ...
  script_tag(name:"affected", value:"'pcre' package(s) on Mageia 5, Mageia 6.");
