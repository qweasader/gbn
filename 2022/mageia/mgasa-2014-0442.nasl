...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'apt' package(s) announced via the MGASA-2014-0442 advisory.");
...
Mageia 3 to Mageia 5 will not be supported.");
  ...
  script_tag(name:"affected", value:"'apt' package(s) on Mageia 3, Mageia 4.");
