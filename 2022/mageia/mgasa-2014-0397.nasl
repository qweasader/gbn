...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'libvncserver, remmina' package(s) announced via the MGASA-2014-0397 advisory.");
...
issues.");
  ...
  script_tag(name:"affected", value:"'libvncserver, remmina' package(s) on Mageia 3, Mageia 4.");
