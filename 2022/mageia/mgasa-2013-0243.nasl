...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xymon' package(s) announced via the MGASA-2013-0243 advisory.");
...
by the Xymon monitoring system. (CVE-2013-4173)");
  ...
  script_tag(name:"affected", value:"'xymon' package(s) on Mageia 2, Mageia 3.");
