...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php, php-apc, php-gd-bundled' package(s) announced via the MGASA-2013-0264 advisory.");
...
at the same time, which causes errors.");
  ...
  script_tag(name:"affected", value:"'php, php-apc, php-gd-bundled' package(s) on Mageia 2, Mageia 3.");
