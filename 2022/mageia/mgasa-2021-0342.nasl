...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'freeradius' package(s) announced via the MGASA-2021-0342 advisory.");
...
and other bugs. See the upstream release announcements for details.");
  ...
  script_tag(name:"affected", value:"'freeradius' package(s) on Mageia 7, Mageia 8.");
