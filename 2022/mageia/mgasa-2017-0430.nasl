...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-07 15:20:54 +0000 (Mon, 07 Aug 2017)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ghostscript' package(s) announced via the MGASA-2017-0430 advisory.");
...
have unspecified other impact via a crafted document. (CVE-2017-9740)");
  ...
  script_tag(name:"affected", value:"'ghostscript' package(s) on Mageia 5, Mageia 6.");
