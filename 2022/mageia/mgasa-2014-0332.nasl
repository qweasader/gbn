...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kernel-vserver' package(s) announced via the MGASA-2014-0332 advisory.");
...
For other fixes, see the referenced changelogs.");
  ...
  script_tag(name:"affected", value:"'kernel-vserver' package(s) on Mageia 3, Mageia 4.");
