...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'taglib' package(s) announced via the MGASA-2018-0300 advisory.");
...
buffer over-read) via a crafted audio file. (CVE-2018-11439)");
  ...
  script_tag(name:"affected", value:"'taglib' package(s) on Mageia 5, Mageia 6.");
