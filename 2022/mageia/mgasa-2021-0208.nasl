...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-06-11 19:55:08 +0000 (Fri, 11 Jun 2021)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'messagelib' package(s) announced via the MGASA-2021-0208 advisory.");
...
(CVE-2021-31855).");
  ...
  script_tag(name:"affected", value:"'messagelib' package(s) on Mageia 7, Mageia 8.");
