...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php, php-apc, php-gd-bundled, php-timezonedb' package(s) announced via the MGASA-2014-0178 advisory.");
...
Additionally, php-apc has been rebuilt against the updated php packages.");
  ...
  script_tag(name:"affected", value:"'php, php-apc, php-gd-bundled, php-timezonedb' package(s) on Mageia 3, Mageia 4.");
