...
if(description)
{
  ...
  script_version("2022-06-09T04:33:47+0000");
  script_tag(name:"last_modification", value:"2022-06-09 04:33:47 +0000 (Thu, 09 Jun 2022)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ffmpeg, live, mplayer, vlc' package(s) announced via the MGASA-2019-0029 advisory.");
...
fix the RTSP-over-HTTP issues in mplayer.");
  ...
  script_tag(name:"affected", value:"'ffmpeg, live, mplayer, vlc' package(s) on Mageia 6.");
