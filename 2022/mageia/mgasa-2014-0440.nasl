...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'pulseaudio' package(s) announced via the MGASA-2014-0440 advisory.");
...
official final version.");
  ...
  script_tag(name:"affected", value:"'pulseaudio' package(s) on Mageia 3, Mageia 4.");
