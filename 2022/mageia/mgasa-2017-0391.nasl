...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'exiv2' package(s) announced via the MGASA-2017-0391 advisory.");
...
*Invalid memory address dereference in Exiv2::getULong (CVE-2017-14864)");
  ...
  script_tag(name:"affected", value:"'exiv2' package(s) on Mageia 5, Mageia 6.");
