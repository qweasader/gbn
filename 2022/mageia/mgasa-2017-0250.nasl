...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-22 12:07:24 +0000 (Tue, 22 Aug 2017)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kmod-vboxadditions, kmod-virtualbox, virtualbox' package(s) announced via the MGASA-2017-0250 advisory.");
...
For other fixes in this update see the referenced changelog.");
  ...
  script_tag(name:"affected", value:"'kmod-vboxadditions, kmod-virtualbox, virtualbox' package(s) on Mageia 5, Mageia 6.");
