...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-08-29 18:09:06 +0000 (Thu, 29 Aug 2019)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'live, mplayer' package(s) announced via the MGASA-2021-0313 advisory.");
...
The mplayer package has been rebuilt against the updated live package.");
  ...
  script_tag(name:"affected", value:"'live, mplayer' package(s) on Mageia 7, Mageia 8.");
