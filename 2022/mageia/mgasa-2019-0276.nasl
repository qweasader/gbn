...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'poppler' package(s) announced via the MGASA-2019-0276 advisory.");
...
(CVE-2019-10871)");
  ...
  script_tag(name:"affected", value:"'poppler' package(s) on Mageia 6, Mageia 7.");
