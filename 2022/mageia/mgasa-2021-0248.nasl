...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-03-19 20:47:02 +0000 (Fri, 19 Mar 2021)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker-containerd' package(s) announced via the MGASA-2021-0248 advisory.");
...
containerd 1.4.4. (CVE-2021-21334).");
  ...
  script_tag(name:"affected", value:"'docker-containerd' package(s) on Mageia 7, Mageia 8.");
