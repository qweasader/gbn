...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php, php-apc, php-gd-bundled, php-timezonedb' package(s) announced via the MGASA-2014-0324 advisory.");
