...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'git' package(s) announced via the MGASA-2021-0137 advisory.");
...
(CVE-2021-21300).");
  ...
  script_tag(name:"affected", value:"'git' package(s) on Mageia 7, Mageia 8.");
