...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql9.4, postgresql9.6, postgresql11' package(s) announced via the MGASA-2019-0225 advisory.");
...
months. See the upstream release notes for details.");
  ...
  script_tag(name:"affected", value:"'postgresql9.4, postgresql9.6, postgresql11' package(s) on Mageia 6, Mageia 7.");
