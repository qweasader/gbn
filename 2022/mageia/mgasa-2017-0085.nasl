...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'freetype2' package(s) announced via the MGASA-2017-0085 advisory.");
...
(CVE-2016-10244).");
  ...
  script_tag(name:"affected", value:"'freetype2' package(s) on Mageia 5.");
