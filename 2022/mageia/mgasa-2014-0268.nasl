...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat, tomcat6' package(s) announced via the MGASA-2014-0268 advisory.");
...
single Tomcat instance via a crafted web application (CVE-2014-0119).");
  ...
  script_tag(name:"affected", value:"'tomcat, tomcat6' package(s) on Mageia 3, Mageia 4.");
