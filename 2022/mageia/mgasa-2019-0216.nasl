...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-07-26 19:59:07 +0000 (Fri, 26 Jul 2019)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kmod-vboxadditions, kmod-virtualbox, virtualbox' package(s) announced via the MGASA-2019-0216 advisory.");
...
additional products. Successful attacks of this vulnerability can ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'kmod-vboxadditions, kmod-virtualbox, virtualbox' package(s) on Mageia 6, Mageia 7.");
