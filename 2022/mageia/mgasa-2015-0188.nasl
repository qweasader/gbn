...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gstreamer0.10-plugins-bad' package(s) announced via the MGASA-2015-0188 advisory.");
...
(CVE-2015-0797).");
  ...
  script_tag(name:"affected", value:"'gstreamer0.10-plugins-bad' package(s) on Mageia 4.");
