...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'postgresql9.6, postgresql11, postgresql13' package(s) announced via the MGASA-2021-0121 advisory.");
