...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-05-10 15:31:36 +0000 (Mon, 10 May 2021)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'exiv2' package(s) announced via the MGASA-2021-0240 advisory.");
...
DoS due to quadratic complexity in ProcessUTF8Portion. (CVE-2021-32617)");
  ...
  script_tag(name:"affected", value:"'exiv2' package(s) on Mageia 7, Mageia 8.");
