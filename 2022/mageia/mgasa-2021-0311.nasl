...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'file-roller' package(s) announced via the MGASA-2021-0311 advisory.");
...
previous update for Mageia 7 (MGASA-2020-0218). This has been corrected.");
  ...
  script_tag(name:"affected", value:"'file-roller' package(s) on Mageia 7, Mageia 8.");
