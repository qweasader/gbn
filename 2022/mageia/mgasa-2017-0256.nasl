...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-24 16:50:19 +0000 (Thu, 24 Aug 2017)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'krb5' package(s) announced via the MGASA-2017-0256 advisory.");
...
(CVE-2017-11368).");
  ...
  script_tag(name:"affected", value:"'krb5' package(s) on Mageia 5, Mageia 6.");
