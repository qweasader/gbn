...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-SDL2_image, sdl2_image' package(s) announced via the MGASA-2017-0397 advisory.");
...
trigger this vulnerability (CVE-2017-2887).");
  ...
  script_tag(name:"affected", value:"'mingw-SDL2_image, sdl2_image' package(s) on Mageia 5, Mageia 6.");
