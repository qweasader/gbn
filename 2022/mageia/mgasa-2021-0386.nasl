...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3, python-pip, python-setuptools' package(s) announced via the MGASA-2021-0386 advisory.");
...
(CVE-2021-29921).");
  ...
  script_tag(name:"affected", value:"'python3, python-pip, python-setuptools' package(s) on Mageia 8.");
