...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-05-28 15:41:07 +0000 (Fri, 28 May 2021)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gupnp' package(s) announced via the MGASA-2021-0321 advisory.");
...
be used for data exfiltration, data tempering, etc. (CVE-2021-33516)");
  ...
  script_tag(name:"affected", value:"'gupnp' package(s) on Mageia 7, Mageia 8.");
