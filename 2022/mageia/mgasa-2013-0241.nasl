...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-02-03 21:53:36 +0000 (Mon, 03 Feb 2020)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'vlc' package(s) announced via the MGASA-2013-0241 advisory.");
...
* lua http: Fix two xss vulnerabilities (CVE-2013-3565)");
  ...
  script_tag(name:"affected", value:"'vlc' package(s) on Mageia 2, Mageia 3.");
