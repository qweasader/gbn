...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mbedtls' package(s) announced via the MGASA-2018-0038 advisory.");
...
(CVE-2017-14032).");
  ...
  script_tag(name:"affected", value:"'mbedtls' package(s) on Mageia 5, Mageia 6.");
