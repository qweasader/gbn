...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'graphviz' package(s) announced via the MGASA-2018-0307 advisory.");
...
file. (CVE-2018-10196)");
  ...
  script_tag(name:"affected", value:"'graphviz' package(s) on Mageia 5, Mageia 6.");
