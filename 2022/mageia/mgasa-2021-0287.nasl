...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'ldb, samba, sssd' package(s) announced via the MGASA-2021-0287 advisory.");
...
Additionally, the sssd package has been rebuilt for the updated ldb package.");
  ...
  script_tag(name:"affected", value:"'ldb, samba, sssd' package(s) on Mageia 7, Mageia 8.");
