...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-05-17 16:10:36 +0000 (Wed, 17 May 2017)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'kmod-vboxadditions, kmod-virtualbox, virtualbox' package(s) announced via the MGASA-2017-0390 advisory.");
