...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-07-07 17:11:13 +0000 (Wed, 07 Jul 2021)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mediawiki' package(s) announced via the MGASA-2021-0346 advisory.");
...
See upstream release notes for other bugfixes.");
  ...
  script_tag(name:"affected", value:"'mediawiki' package(s) on Mageia 7, Mageia 8.");
