...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'proftpd' package(s) announced via the MGASA-2013-0295 advisory.");
...
the underlying operating system (CVE-2013-4359).");
  ...
  script_tag(name:"affected", value:"'proftpd' package(s) on Mageia 2, Mageia 3.");
