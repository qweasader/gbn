...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'abydos, converseen, imagemagick, libopenshot, mgba, pfstools, php-imagick, sk1, synfig, transcode, uniconvertor, xine-lib1.2' package(s) announced via the MGASA-2021-0013 advisory.");
...
the updated libmagick library.");
  ...
  script_tag(name:"affected", value:"'abydos, converseen, imagemagick, libopenshot, mgba, pfstools, php-imagick, sk1, synfig, transcode, uniconvertor, xine-lib1.2' package(s) on Mageia 7.");
