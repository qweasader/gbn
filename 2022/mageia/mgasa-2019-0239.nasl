...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw-SDL2, sdl2' package(s) announced via the MGASA-2019-0239 advisory.");
...
The 2.0.10 release also provides various features and bug fixes.");
  ...
  script_tag(name:"affected", value:"'mingw-SDL2, sdl2' package(s) on Mageia 6, Mageia 7.");
