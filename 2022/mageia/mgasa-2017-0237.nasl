...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-05-30 19:16:46 +0000 (Tue, 30 May 2017)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups-filters, qpdf' package(s) announced via the MGASA-2017-0237 advisory.");
...
new major version of qpdf.");
  ...
  script_tag(name:"affected", value:"'cups-filters, qpdf' package(s) on Mageia 5, Mageia 6.");
