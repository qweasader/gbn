...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'systemd' package(s) announced via the MGASA-2014-0188 advisory.");
...
updates.");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on Mageia 3, Mageia 4.");
