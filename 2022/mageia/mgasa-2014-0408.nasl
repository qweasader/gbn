...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'torque' package(s) announced via the MGASA-2014-0408 advisory.");
...
This update implements the upstream fixes.");
  ...
  script_tag(name:"affected", value:"'torque' package(s) on Mageia 3, Mageia 4.");
