...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'java-1.8.0-openjdk' package(s) announced via the MGASA-2018-0104 advisory.");
...
components of OpenJDK did not sufficiently validate input ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'java-1.8.0-openjdk' package(s) on Mageia 5, Mageia 6.");
