...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'live, mplayer, vlc' package(s) announced via the MGASA-2014-0296 advisory.");
...
decoding cutting out early (mga#10478).");
  ...
  script_tag(name:"affected", value:"'live, mplayer, vlc' package(s) on Mageia 3, Mageia 4.");
