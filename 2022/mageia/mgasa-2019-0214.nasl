...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gvfs' package(s) announced via the MGASA-2019-0214 advisory.");
...
* daemon/gvfsdaemon.c in gvfsd from GNOME gvfs before 1.38.3, 1.40.x
 ...
 socket without configuring an authorization rule (CVE-2019-12795)");
  ...
  script_tag(name:"affected", value:"'gvfs' package(s) on Mageia 6, Mageia 7.");
