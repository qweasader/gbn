...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-07 18:57:00 +0000 (Mon, 07 Nov 2022)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-aws-5.15, linux-azure, linux-azure-5.15, linux-gcp, linux-gcp-5.15, linux-gke, linux-gke-5.15, linux-gkeop, linux-ibm, linux-kvm, linux-lowlatency' package(s) announced via the USN-5594-1 advisory.");
...
privileges. (CVE-2022-2959)");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-aws-5.15, linux-azure, linux-azure-5.15, linux-gcp, linux-gcp-5.15, linux-gke, linux-gke-5.15, linux-gkeop, linux-ibm, linux-kvm, linux-lowlatency' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
