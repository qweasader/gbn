...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-intel-5.13' package(s) announced via the USN-5362-1 advisory.");
...
the Linux kernel did not ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-intel-5.13' package(s) on Ubuntu 20.04.");
