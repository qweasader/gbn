...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-4336-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-4336-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-4336-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'binutils' package(s) announced via the USN-4336-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-4336-1 fixed several vulnerabilities in GNU binutils. This update provides
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"binutils", ver:"2.26.1-1ubuntu1~16.04.8+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"binutils-multiarch", ver:"2.26.1-1ubuntu1~16.04.8+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
