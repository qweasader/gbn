...
if(release == "UBUNTU21.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"exiv2", ver:"0.27.3-3ubuntu1.6", rls:"UBUNTU21.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libexiv2-27", ver:"0.27.3-3ubuntu1.6", rls:"UBUNTU21.04"))) {
    report += res;
  }
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"exiv2", ver:"0.27.3-3ubuntu4.1", rls:"UBUNTU21.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libexiv2-27", ver:"0.27.3-3ubuntu4.1", rls:"UBUNTU21.10"))) {
    report += res;
  }
