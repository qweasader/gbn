...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-5.13, linux-oracle-5.13' package(s) announced via the USN-5368-1 advisory.");
...
It was discovered that the ARM Trusted Execution Environment ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure-5.13, linux-oracle-5.13' package(s) on Ubuntu 20.04.");
