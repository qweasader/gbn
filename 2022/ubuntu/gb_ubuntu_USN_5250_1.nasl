...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libstrongswan", ver:"5.9.1-1ubuntu3.2", rls:"UBUNTU21.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"strongswan", ver:"5.9.1-1ubuntu3.2", rls:"UBUNTU21.10"))) {
    report += res;
  }
