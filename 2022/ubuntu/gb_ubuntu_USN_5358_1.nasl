...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-azure, linux-gcp, linux-hwe-5.4, linux-hwe-5.13, linux-kvm, linux-oracle, linux-oracle-5.4' package(s) announced via the USN-5358-1 advisory.");
...
code. (CVE-2022-27666)");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-azure, linux-gcp, linux-hwe-5.4, linux-hwe-5.13, linux-kvm, linux-oracle, linux-oracle-5.4' package(s) on Ubuntu 18.04, Ubuntu 20.04, Ubuntu 21.10.");
