...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-07 19:40:16 +0000 (Thu, 07 Apr 2022)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-azure, linux-gcp, linux-gke, linux-ibm, linux-kvm, linux-lowlatency, linux-oracle, linux-raspi' package(s) announced via the USN-5518-1 advisory.");
...
(system crash) or possibly execute arbitrary code. (CVE-2022-33981)");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-azure, linux-gcp, linux-gke, linux-ibm, linux-kvm, linux-lowlatency, linux-oracle, linux-raspi' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1012-raspi", ver:"5.15.0-1012.14", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1012-raspi-nolpae", ver:"5.15.0-1012.14", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"5.15.0.1012.11", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi-nolpae", ver:"5.15.0.1012.11", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
