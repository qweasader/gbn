# SPDX-FileCopyrightText: 2006 Tarik El-Yassem/ITsec Security Services
...
if(description)
{
  ...
  script_add_preference(name:"timelimit value (in seconds)", type:"entry", value:"3600", id:1);
  script_add_preference(name:"sizelimit value", type:"entry", value:"500", id:2);
