...
if(description)
{
  ...
  script_name("WS_FTP Server DoS Vulnerability (Nov 2005)");
  ...
  script_tag(name:"insight", value:"A logged attacker submitting a 'CWD' command along with
  arbitrary characters will deny the ftp service.");

  script_tag(name:"solution", value:"Update to the latest version.");

  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/217");
