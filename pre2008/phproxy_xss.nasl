...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12115");
  script_name("PHProxy XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"PHProxy is prone to a cross-site scripting (XSS) vulnerability.");
