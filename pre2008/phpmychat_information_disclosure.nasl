...
# nb: The /chat/chat isn't a mistake
foreach dir(make_list_unique("/forum", "/forum/chat", "/chat", "/chat/chat", "/", http_cgi_dirs(port:port))) {
  ...
  if("C_DB_NAME" >< res || "C_DB_USER" >< res || "C_DB_PASS" >< res) {
