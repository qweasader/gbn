...
if(description)
{
  ...
  script_name("Unpassworded 'help' account (SSH/Telnet)");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20210121152733/http://www.securityfocus.com/bid/247/");
