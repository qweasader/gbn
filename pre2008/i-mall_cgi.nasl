...
if(description)
{
  ...
  script_version("2023-03-20T10:20:10+0000");
  script_tag(name:"last_modification", value:"2023-03-20 10:20:10 +0000 (Mon, 20 Mar 2023)");
  script_tag(name:"creation_date", value:"2005-11-03 14:08:04 +0100 (Thu, 03 Nov 2005)");
  script_cve_id("CVE-2004-2275");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10626");
  ...
  this script are vulnerable to remote command exacution flaw, due to insufficient user
  input sanitization.");
