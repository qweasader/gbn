...
if(description)
{
  ...
  script_name("Default password 'synnet' for account 'debug' (SSH/Telnet)");
  ...
  script_xref(name:"URL", value:"https://web.archive.org/web/20210121152647/http://www.securityfocus.com/bid/88/");
