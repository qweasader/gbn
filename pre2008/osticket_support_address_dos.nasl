...
if(description)
{
  ...
  script_name("osTicket <= 1.2.7 Support Address DoS Vulnerability");
  ...
  script_tag(name:"summary", value:"The target is running at least one instance of osTicket 1.2.7
  or earlier. Such versions are subject to a denial of service attack in open.php if osTicket is
