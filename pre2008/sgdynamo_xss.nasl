...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/4720");
  script_cve_id("CVE-2002-0375");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:P/A:N");
  script_name("Sgdynamo 'sgdynamo.exe' XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The Sgdynamo 'sgdynamo.exe' script is prone to a cross-site
