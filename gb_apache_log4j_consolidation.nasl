...
if(description)
{
  ...
  script_version("2022-01-21T10:41:17+0000");
  script_tag(name:"last_modification", value:"2022-01-21 10:41:17 +0000 (Fri, 21 Jan 2022)");
  ...
  script_dependencies("gb_apache_log4j_ssh_login_detect.nasl", "gb_apache_log4j_smb_login_detect.nasl");
