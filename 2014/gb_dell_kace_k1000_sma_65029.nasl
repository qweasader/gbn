...
if (description)
{
  ...
  script_name("Quest / Dell KACE K1000 Systems Management Appliance (SMA) <= 5.4.76847 Multiple SQLi Vulnerabilities");
  ...
  script_tag(name:"insight", value:"Quest / Dell KACE K1000 SMA is prone to multiple SQL injection
  ...
  script_tag(name:"affected", value:"Quest / Dell KACE K1000 SMA version 5.4.76847 and prior.");
