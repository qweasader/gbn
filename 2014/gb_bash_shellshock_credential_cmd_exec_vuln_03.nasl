...
if(description)
{
  ...
  script_name("GNU Bash Environment Variable Handling RCE Vulnerability (Shellshock, Linux/Unix SSH Login, CVE-2014-6278) - Active Check");
  ...
  bash continues to process trailing strings. Incomplete fix to CVE-2014-7169, CVE-2014-6271, and
  CVE-2014-6277.");
...
if( "Unsupported use of '='" >< result )
  exit( 99 );

if( "CVE-2014-6278 vulnerable" >< result && "echo CVE-2014-6278 vulnerable" >!< result ) {
