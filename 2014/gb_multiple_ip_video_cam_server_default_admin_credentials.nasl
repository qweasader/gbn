...
if (description)
{
  ...
  script_name("Multiple IP Video/Camera Server Default Admin Credentials (HTTP)");
  ...
  script_tag(name:"summary", value:"The remote IP Video/Camera server web interface is using known default credentials.");
