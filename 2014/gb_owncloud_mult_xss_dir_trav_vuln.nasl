...
5.0.6");
  script_tag(name:"solution", value:"Update to version 4.0.15 or 4.5.11 or 5.0.6 or later.");
...
if(version_in_range(version:version, test_version:"4.0.0", test_version2:"4.0.14")||
   version_in_range(version:version, test_version:"4.5.0", test_version2:"4.5.10")||
