...
if(description)
{
  ...
  script_tag(name:"summary", value:"WordPress ActiveHelper LiveHelp Live Chat Plugin is prone to a cross-site scripting (XSS) vulnerability.");
...
or later.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/68312");
  exit(0);
}
