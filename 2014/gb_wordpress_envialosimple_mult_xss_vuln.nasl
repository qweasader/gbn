...
if(description)
{
  ...
  script_tag(name:"summary", value:"WordPress EnvialoSimple Plugin is prone to multiple cross site scripting vulnerabilities.");
...
version 1.97, and possibly prior.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/69226");
