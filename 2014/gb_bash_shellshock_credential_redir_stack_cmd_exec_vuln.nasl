...
if(description)
{
  ...
  script_name("GNU Bash Environment Variable Handling RCE Vulnerability (Shellshock, Linux/Unix SSH Login, CVE-2014-7186) - Active Check");
  ...
  untrusted input during stacked redirects handling.");
...
if( "In fish, please use" >< result )
  exit( 99 );

if( "CVE-2014-7186 vulnerable, redir_stack" >< result && "echo 'CVE-2014-7186 vulnerable" >!< result ) {
