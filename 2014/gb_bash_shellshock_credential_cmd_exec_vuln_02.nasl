...
if(description)
{
  ...
  script_name("GNU Bash Environment Variable Handling RCE Vulnerability (Shellshock, Linux/Unix SSH Login, CVE-2014-7169) - Active Check");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/70137");
  ...
  bash continues to process trailing strings. Incomplete fix to CVE-2014-6271.");
