...
if(description)
{
  ...
  script_name("Mozilla Thunderbird Multiple XSS Vulnerabilities (Feb 2014) - Mac OS X");

  script_tag(name:"summary", value:"Mozilla Thunderbird is prone to multiple cross site scripting vulnerabilities.");
