...
if(description)
{
  ...
  script_name("Apache Tomcat Information Disclosure Vulnerability (May 2014)");
  ...
  script_tag(name:"insight", value:"The flaw exists if a web application does not properly constrain
  the class loader that accesses the XML parser used with an XSLT stylesheet.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to read
  arbitrary files via a crafted web application that provides an XML external entity declaration
  in conjunction with an entity reference.");

  script_tag(name:"affected", value:"Apache Tomcat before 6.0.40, 7.x before 7.0.54 and 8.x before
  8.0.6.");

  script_tag(name:"solution", value:"Update to version 6.0.40, 7.0.54, 8.0.6 or later.");
