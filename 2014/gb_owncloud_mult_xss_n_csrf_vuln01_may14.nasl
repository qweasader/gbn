...
if (description)
{
  ...
  script_name("ownCloud Multiple XSS & CSRF Vulnerabilities -01 (May 2014)");
...
attacks and execute arbitrary script code in a user's browser.");
  ...
  script_tag(name:"solution", value:"Update to version 4.0.12 or 4.5.7 or later.");
...
if(version_is_less(version:version, test_version:"4.0.12")||
   version_in_range(version:version, test_version:"4.5.0", test_version2:"4.5.6")) {
