...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3044-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3044-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-3044-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3044");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qemu-kvm' package(s) announced via the DSA-3044-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kvm", ver:"1:1.1.2+dfsg-6+deb7u4", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"qemu-kvm", ver:"1.1.2+dfsg-6+deb7u4", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"qemu-kvm-dbg", ver:"1.1.2+dfsg-6+deb7u4", rls:"DEB7"))) {
    report += res;
  }
