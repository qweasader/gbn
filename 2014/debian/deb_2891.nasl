...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-02-10 19:40:09 +0000 (Mon, 10 Feb 2020)");

  script_name("Debian: Security Advisory (DSA-2891-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2891-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-2891-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2891");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki, mediawiki-extensions' package(s) announced via the DSA-2891-1 advisory.");
