...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2956-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2956-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-2956-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2956");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icinga' package(s) announced via the DSA-2956-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"icinga", ver:"1.7.1-7", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"icinga-cgi", ver:"1.7.1-7", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"icinga-common", ver:"1.7.1-7", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"icinga-core", ver:"1.7.1-7", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"icinga-dbg", ver:"1.7.1-7", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"icinga-doc", ver:"1.7.1-7", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"icinga-idoutils", ver:"1.7.1-7", rls:"DEB7"))) {
    report += res;
  }
