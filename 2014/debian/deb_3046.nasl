...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3046-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3046-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-3046-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3046");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DSA-3046-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mediawiki", ver:"1:1.19.20+dfsg-0+deb7u1", rls:"DEB7"))) {
    report += res;
  }
