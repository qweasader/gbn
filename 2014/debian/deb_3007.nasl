...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3007-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3007-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-3007-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3007");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cacti' package(s) announced via the DSA-3007-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cacti", ver:"0.8.8a+dfsg-5+deb7u4", rls:"DEB7"))) {
    report += res;
  }
