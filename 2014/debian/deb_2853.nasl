...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2853-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2853-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-2853-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2853");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'horde3' package(s) announced via the DSA-2853-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"horde3", ver:"3.3.8+debian0-3", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"pear-horde-channel", ver:"3.3.8+debian0-3", rls:"DEB6"))) {
    report += res;
  }
