...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3101-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3101-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-3101-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3101");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'c-icap' package(s) announced via the DSA-3101-1 advisory.");
