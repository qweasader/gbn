...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3005-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3005-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-3005-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3005");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gpgme1.0' package(s) announced via the DSA-3005-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgpgme11", ver:"1.2.0-1.4+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgpgme11-dev", ver:"1.2.0-1.4+deb7u1", rls:"DEB7"))) {
    report += res;
  }
