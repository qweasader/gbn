...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3089-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3089-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-3089-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3089");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jasper' package(s) announced via the DSA-3089-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libjasper-dev", ver:"1.900.1-13+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libjasper-runtime", ver:"1.900.1-13+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libjasper1", ver:"1.900.1-13+deb7u1", rls:"DEB7"))) {
    report += res;
  }
