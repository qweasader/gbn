...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3082-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3082-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-3082-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3082");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'flac' package(s) announced via the DSA-3082-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"flac", ver:"1.2.1-6+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libflac++-dev", ver:"1.2.1-6+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libflac++6", ver:"1.2.1-6+deb7u1", rls:"DEB7"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libflac-doc", ver:"1.2.1-6+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libflac8", ver:"1.2.1-6+deb7u1", rls:"DEB7"))) {
    report += res;
  }
