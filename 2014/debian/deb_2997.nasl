...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2997-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2997-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-2997-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2997");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'reportbug' package(s) announced via the DSA-2997-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-reportbug", ver:"6.4.4+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"reportbug", ver:"6.4.4+deb7u1", rls:"DEB7"))) {
    report += res;
  }
