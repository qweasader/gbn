...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2839-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2839-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-2839-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2839");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'spice' package(s) announced via the DSA-2839-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libspice-server-dev", ver:"0.11.0-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libspice-server1", ver:"0.11.0-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"spice-client", ver:"0.11.0-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }
