...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2884-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2884-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-2884-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2884");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libyaml' package(s) announced via the DSA-2884-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libyaml-0-2", ver:"0.1.3-1+deb6u4", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libyaml-dev", ver:"0.1.3-1+deb6u4", rls:"DEB6"))) {
    report += res;
  }
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libyaml-0-2", ver:"0.1.4-2+deb7u4", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libyaml-0-2-dbg", ver:"0.1.4-2+deb7u4", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libyaml-dev", ver:"0.1.4-2+deb7u4", rls:"DEB7"))) {
    report += res;
  }
