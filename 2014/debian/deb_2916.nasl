...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2916-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2916-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-2916-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2916");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libmms' package(s) announced via the DSA-2916-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmms-dev", ver:"0.6-1+squeeze2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmms0", ver:"0.6-1+squeeze2", rls:"DEB6"))) {
    report += res;
  }
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmms-dev", ver:"0.6.2-3+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmms0", ver:"0.6.2-3+deb7u1", rls:"DEB7"))) {
    report += res;
  }
