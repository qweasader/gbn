...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3103-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3103-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-3103-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3103");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libyaml-libyaml-perl' package(s) announced via the DSA-3103-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libyaml-libyaml-perl", ver:"0.38-3+deb7u3", rls:"DEB7"))) {
    report += res;
  }
