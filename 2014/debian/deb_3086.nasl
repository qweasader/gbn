...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3086-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3086-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-3086-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3086");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tcpdump' package(s) announced via the DSA-3086-1 advisory.");
