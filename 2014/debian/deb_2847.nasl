...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2847-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2847-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-2847-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2847");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'drupal7' package(s) announced via the DSA-2847-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"drupal7", ver:"7.14-2+deb7u2", rls:"DEB7"))) {
    report += res;
  }
