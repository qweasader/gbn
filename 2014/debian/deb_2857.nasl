...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-22 16:15:27 +0000 (Wed, 22 Jan 2020)");

  script_name("Debian: Security Advisory (DSA-2857-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2857-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-2857-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2857");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libspring-java' package(s) announced via the DSA-2857-1 advisory.");
