...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2945-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2945-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-2945-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2945");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chkrootkit' package(s) announced via the DSA-2945-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"chkrootkit", ver:"0.49-4.1+deb7u2", rls:"DEB7"))) {
    report += res;
  }
