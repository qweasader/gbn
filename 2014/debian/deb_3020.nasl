...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3020-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3020-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2014/DSA-3020-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3020");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'acpi-support' package(s) announced via the DSA-3020-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"acpi-fakekey", ver:"0.140-5+deb7u3", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"acpi-support", ver:"0.140-5+deb7u3", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"acpi-support-base", ver:"0.140-5+deb7u3", rls:"DEB7"))) {
    report += res;
  }
