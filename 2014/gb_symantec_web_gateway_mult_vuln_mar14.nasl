...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/65404");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/65405");
  ...
  script_tag(name:"summary", value:"Symantec Web Gateway is prone to cross-site scripting and SQL injection vulnerabilities.");
