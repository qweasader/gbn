...
if(description)
{
  ...
  script_name("Oracle Java SE 8.x Multiple Vulnerabilities (cpuapr2014) - Linux");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66886");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66908");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66913");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 8.x.");

  script_tag(name:"solution", value:"Update to version 8 Update 5 or later.");
...
if(version_in_range(version:vers, test_version:"1.8.0", test_version2:"1.8.0.4")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"8 Update 5 (1.8.0.5)", install_path:path);
