...
if(description)
{
  ...
  script_name("Oracle Java SE 5.x, 6.x, 7.x, 8.x Multiple Vulnerabilities (cpuapr2014) - Windows");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66856");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66866");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66873");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66879");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66881");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66903");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66909");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66911");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66914");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66916");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66920");
  ...
  script_tag(name:"affected", value:"Oracle Java SE versions 5.x, 6.x, 7.x and 8.x.");
...
if(version_in_range(version:vers, test_version:"1.5.0", test_version2:"1.5.0.61") ||
   version_in_range(version:vers, test_version:"1.6.0", test_version2:"1.6.0.71") ||
