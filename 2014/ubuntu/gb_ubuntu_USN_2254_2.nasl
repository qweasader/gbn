...
if(release == "UBUNTU13.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"php5-fpm", ver:"5.5.3+dfsg-1ubuntu2.5", rls:"UBUNTU13.10"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"php5-fpm", ver:"5.5.9+dfsg-1ubuntu4.2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
