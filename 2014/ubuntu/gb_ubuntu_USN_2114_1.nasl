...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-46-generic", ver:"3.5.0-46.70", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-46-highbank", ver:"3.5.0-46.70", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-46-omap", ver:"3.5.0-46.70", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-46-powerpc-smp", ver:"3.5.0-46.70", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-46-powerpc64-smp", ver:"3.5.0-46.70", rls:"UBUNTU12.10"))) {
    report += res;
  }
