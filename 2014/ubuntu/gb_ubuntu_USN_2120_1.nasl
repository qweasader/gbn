...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-8.4", ver:"8.4.20-0ubuntu010.04", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-9.1", ver:"9.1.12-0ubuntu0.12.04", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-9.1", ver:"9.1.12-0ubuntu0.12.10", rls:"UBUNTU12.10"))) {
    report += res;
  }
...
if(release == "UBUNTU13.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-9.1", ver:"9.1.12-0ubuntu0.13.10", rls:"UBUNTU13.10"))) {
    report += res;
  }
