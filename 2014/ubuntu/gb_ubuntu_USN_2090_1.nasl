...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"munin", ver:"1.4.6-3ubuntu3.4", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"munin", ver:"2.0.2-1ubuntu2.3", rls:"UBUNTU12.10"))) {
    report += res;
  }
...
if(release == "UBUNTU13.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"munin", ver:"2.0.17-2ubuntu1.1", rls:"UBUNTU13.10"))) {
    report += res;
  }
