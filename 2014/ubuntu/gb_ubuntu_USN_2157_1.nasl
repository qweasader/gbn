...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"clamav", ver:"0.98.1+dfsg-4ubuntu1~ubuntu12.04.2", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"clamav", ver:"0.98.1+dfsg-4ubuntu1~ubuntu12.10.2", rls:"UBUNTU12.10"))) {
    report += res;
  }
...
if(release == "UBUNTU13.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"clamav", ver:"0.98.1+dfsg-4ubuntu1~ubuntu13.10.2", rls:"UBUNTU13.10"))) {
    report += res;
  }
