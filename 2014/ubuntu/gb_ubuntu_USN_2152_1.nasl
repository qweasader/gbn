...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2.2-bin", ver:"2.2.14-5ubuntu8.13", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2.2-bin", ver:"2.2.22-1ubuntu1.5", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2.2-bin", ver:"2.2.22-6ubuntu2.4", rls:"UBUNTU12.10"))) {
    report += res;
  }
...
if(release == "UBUNTU13.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache2.2-bin", ver:"2.4.6-2ubuntu2.2", rls:"UBUNTU13.10"))) {
    report += res;
  }
