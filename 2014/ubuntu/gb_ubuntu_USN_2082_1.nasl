...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups-client", ver:"1.6.1-0ubuntu11.5", rls:"UBUNTU12.10"))) {
    report += res;
  }
...
if(release == "UBUNTU13.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups-client", ver:"1.6.2-1ubuntu8", rls:"UBUNTU13.04"))) {
    report += res;
  }
...
if(release == "UBUNTU13.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups-client", ver:"1.7.0~rc1-0ubuntu5.2", rls:"UBUNTU13.10"))) {
    report += res;
  }
