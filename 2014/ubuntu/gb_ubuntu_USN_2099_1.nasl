...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"perl-modules", ver:"5.10.1-8ubuntu2.4", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"perl-modules", ver:"5.14.2-6ubuntu2.4", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"perl-modules", ver:"5.14.2-13ubuntu0.3", rls:"UBUNTU12.10"))) {
    report += res;
  }
