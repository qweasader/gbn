...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:4.2.7-0ubuntu1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:4.3.3-0ubuntu1", rls:"UBUNTU14.10"))) {
    report += res;
  }
