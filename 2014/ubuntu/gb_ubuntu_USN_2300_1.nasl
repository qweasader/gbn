...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liblzo2-2", ver:"2.06-1ubuntu0.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liblzo2-2", ver:"2.06-1.2ubuntu1.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
