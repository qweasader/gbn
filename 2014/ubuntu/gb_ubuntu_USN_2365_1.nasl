...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libvncserver0", ver:"0.9.8.2-2ubuntu1.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libvncserver0", ver:"0.9.9+dfsg-1ubuntu1.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
