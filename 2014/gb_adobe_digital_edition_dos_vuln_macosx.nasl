...
if(description)
{
  ...
  script_name("Adobe Digital Edition < 3.0 DoS Vulnerability - Mac OS X");

  script_tag(name:"summary", value:"Adobe Digital Edition is prone to a denial of service (DoS)
  vulnerability.");
  ...
  denial of service or execute an arbitrary code.");

  script_tag(name:"affected", value:"Adobe Digital Edition version 2.0.1 and prior.");
...
if(version_is_less_equal(version:vers, test_version:"2.0.1")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"3.0");
