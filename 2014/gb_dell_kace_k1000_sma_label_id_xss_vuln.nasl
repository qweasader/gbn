...
if(description)
{
  ...
  script_name("Quest / Dell KACE K1000 Systems Management Appliance (SMA) <= 5.5.90545 XSS Vulnerability (SOL120154)");
  ...
  script_tag(name:"insight", value:"The flaw is in adminui/user_list.php script which fails to
  properly sanitizing user-supplied input to LABEL_ID parameter.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to execute
  arbitrary scripts.");

  script_tag(name:"affected", value:"Quest / Dell KACE K1000 SMA version 5.5.90545 and probably
  prior.");
...
if (version_is_less_equal(version: vers, test_version: "5.5.90545")) {
