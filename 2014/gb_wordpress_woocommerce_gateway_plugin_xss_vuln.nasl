...
if(description)
{
  ...
  script_tag(name:"summary", value:"WordPress WooCommerce SagePay Direct Payment Gateway Plugin is prone to a cross-site scripting (XSS) vulnerability.");
...
0.1.6.7 or later.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/65355");
