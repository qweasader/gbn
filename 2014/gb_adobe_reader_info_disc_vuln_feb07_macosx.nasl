...
if(description)
{
  ...
  script_name("Adobe Reader 'file://' URL Information Disclosure Vulnerability (Feb 2007) - Mac OS X");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/22753");
