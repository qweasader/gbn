...
if(description)
{
  ...
  script_tag(name:"summary", value:"Adobe Reader is prone to information disclosure and denial of service vulnerabilities.");
...
attack and the disclosure of sensitive information.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12989");
