...
if(description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Uploader' is prone to multiple vulnerabilities.");
...
compromise a vulnerable system.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/58285");
