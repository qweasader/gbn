...
if(description)
{
  ...
  script_name("MantisBT < 1.2.16 Multiple SQLi Vulnerabilities");
  ...
  script_tag(name:"summary", value:"There are multiple SQL injection (SQLi) vulnerabilities in
  MantisBT which allow a remote attacker to access or modify data.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"solution", value:"Update to version 1.2.16 or later.");
  ...
  script_tag(name:"affected", value:"MantisBT 1.2.15 and prior.");
...
if (version_is_less(version: version, test_version: "1.2.16")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.2.16", install_path: location);
