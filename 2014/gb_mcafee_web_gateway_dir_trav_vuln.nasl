...
if(description)
{
  ...
  script_tag(name:"summary", value:"McAfee Web Gateway is prone to a directory traversal vulnerability.");
...
information.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/66193");
