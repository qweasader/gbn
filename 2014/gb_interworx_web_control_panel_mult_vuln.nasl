...
if(description)
{
  ...
  script_tag(name:"summary", value:"InterWorx Web Control Panel is prone to information disclosure and xss vulnerability.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/65734");
