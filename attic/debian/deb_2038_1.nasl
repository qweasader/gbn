...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pidgin' package(s) announced via the DSA-2038-1 advisory. [This VT has been merged into the VT 'deb_2038.nasl' (OID: 1.3.6.1.4.1.25623.1.0.67339).]");
