...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DSA-1871-1 advisory. [This VT has been merged into the VT 'deb_1871.nasl' (OID: 1.3.6.1.4.1.25623.1.0.64754).]");
