...
if (description)
{
  ...
  script_tag(name:"summary", value:"The web-based authentication of the connected digital video
  recorder - running on a JAWS/1.0 server - is prone to an authentication bypass vulnerability.
  ...
  script_tag(name:"solution", value:"It is recommended to completely remove the digital video
  recorder from the host system as it might grant an attacker full access to it.");
