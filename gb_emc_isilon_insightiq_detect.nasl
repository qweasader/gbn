...
if ("<title>Isilon InsightIQ</title>" >< res && "Welcome to InsightIQ. Please log in" >< res ) {
  version = "unknown";
  ...
  os_register_and_report(os: "Linux", version: "cpe:/o:linux:kernel", runs_key: "linux",
                         "Dell EMC Isilon InsightIQ Detection (HTTP)");

  register_product(cpe: cpe, location: "/", port: port, service: "www");

  log_message(data: build_detection_report(app: "Dell EMC Isilon InsightIQ", version: version, install: "/",
