...
if (description)
{
  ...
  script_version("2022-03-08T16:31:51+0000");
  script_tag(name:"last_modification", value:"2022-03-08 16:31:51 +0000 (Tue, 08 Mar 2022)");
...
if( found ) {
  ...
  set_kb_item( name:"moxa/mxview/http/port", value:port );
  set_kb_item( name:"moxa/mxview/http/" + port + "/concluded", value:"MXview" );
  set_kb_item( name:"moxa/mxview/http/" + port + "/concludedUrl", value:concludedUrl );
}
