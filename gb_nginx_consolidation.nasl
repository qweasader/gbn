...
if(description)
{
  ...
  script_version("2022-02-03T09:26:44+0000");
  script_tag(name:"last_modification", value:"2022-02-03 09:26:44 +0000 (Thu, 03 Feb 2022)");
...
foreach proto( make_list( "ssh-login", "http" ) ) {
  ...
  foreach install( install_list ) {
    ...
    # nb: There is also cpe:/a:igor_sysoev:nginx but this is deprecated in the NVD and no CVE
    # is referring to it so we're not using that one.
    cpe1 = build_cpe( value: version, exp: "^([0-9.]+)", base: "cpe:/a:nginx:nginx:" );
    cpe2 = build_cpe( value: version, exp: "^([0-9.]+)", base: "cpe:/a:f5:nginx:" );
    if( ! cpe1 ) {
      cpe1 = "cpe:/a:nginx:nginx";
      cpe2 = "cpe:/a:f5:nginx";
    }
    ...
    register_product( cpe: cpe1, location: install, port: port, service: service );
