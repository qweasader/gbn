...
if (description)
{
  ...
  script_xref(name:"URL", value:"https://www.sysaid.com/help-desk-software");
...
foreach dir( make_list_unique( "/sysaid", http_cgi_dirs( port:port ) ) ) {
  ...
  if (buf =~ "^HTTP/1\.[01] 200" &&
      concl = egrep(string: buf, pattern: '(SysAid Help Desk|Software del Servicio de asistencia de SysAid|class="LookLikeLink"> by SysAid|Help Desk Software by[^>]+>SysAid)', icase: FALSE)) {
    version = "unknown";
