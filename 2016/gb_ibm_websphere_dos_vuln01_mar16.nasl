...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server DoS Vulnerability (Mar 2016)");
  ...
  script_tag(name:"insight", value:"The flaw is due to the usage of Load Balancer for IPv4
  Dispatcher component which is vulnerable.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/69301");
