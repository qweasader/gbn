...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Directory Traversal Vulnerability (Jan 2016)");
  ...
  script_tag(name:"insight", value:"The flaw is due to improper validation of crafted files which
  will overwrite arbitrary files.");

  script_tag(name:"affected", value:"IBM WebSphere Application Server version 6.1.x prior to
  6.1.0.47, 7.0.x prior to 7.0.0.25, 8.0.x prior to 8.0.0.5 and 8.5.x prior to 8.5.0.1.");

  script_tag(name:"solution", value:"Update to version 6.1.0.47, 7.0.0.25, 8.0.0.5, 8.5.0.1 or
  later.");
