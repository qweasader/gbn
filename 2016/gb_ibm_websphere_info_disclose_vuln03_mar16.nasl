...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw is due to the failure to restrict access to resources
  located within the web application.");
  ...
  7.0.0.35, 8.0.x prior to 8.0.0.10 and 8.5.x prior to 8.5.5.3.");

  script_tag(name:"solution", value:"Update to version 7.0.0.35, 8.0.0.10, 8.5.5.3 or later.");
