...
if(description)
{
  ...
  script_name("Adobe Flash Player Security Update (APSB16-08) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Flash Player versions before 18.0.0.333 and
  19.x/20.x/21.x before 21.0.0.182.");

  script_tag(name:"solution", value:"Update to version 18.0.0.333, 21.0.0.182 or later.");
...
if(version_in_range(version:vers, test_version:"19.0", test_version2:"21.0.0.181")) {
  fix = "21.0.0.182";
  VULN = TRUE;
}

else if(version_is_less(version:vers, test_version:"18.0.0.333")) {
  fix = "18.0.0.333";
  VULN = TRUE;
}
