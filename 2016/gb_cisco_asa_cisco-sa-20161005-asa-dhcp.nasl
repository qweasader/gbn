...
if (description)
{
  ...
  script_name("Cisco ASA Software DHCP Relay Denial of Service Vulnerability (cisco-sa-20161005-asa-dhcp)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the DHCP Relay feature of Cisco ASA Software
  ...
  script_tag(name:"insight", value:"The vulnerability is due to improper handling of resources
  linked with the DHCP Relay feature. An attacker could exploit this vulnerability by sending DHCP
  packets at specific rates.");

  script_tag(name:"impact", value:"An exploit could allow an attacker to cause an interface to
