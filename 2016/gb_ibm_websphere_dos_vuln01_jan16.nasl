...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw is due to when running the Heartbleed scanning tools
  or if sending specially-crafted Heartbeat messages.");

  script_tag(name:"impact", value:"Successful exploitation will allow a remote attacker to cause a
  denial of service via crafted TLS traffic.");

  script_tag(name:"affected", value:"IBM WebSphere Application Server version 6.1.x through
  6.1.0.47 and 6.0.2.0 through 6.0.2.43");
...
if (version_in_range(version: version, test_version: "6.1", test_version2: "6.1.0.47") ||
    version_in_range(version: version, test_version: "6.0.2", test_version2: "6.0.2.43")) {
