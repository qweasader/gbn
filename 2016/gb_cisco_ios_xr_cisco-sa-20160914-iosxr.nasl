...
if (description)
{
  ...
  script_name("Cisco IOS XR Software for NCS 6000 Series Devices OSPF Packet Processing Denial of Service Vulnerability (cisco-sa-20160914-iosxr)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the OSPFv3 processing of Cisco IOS XR
  ...
  script_tag(name:"insight", value:"The vulnerability is due to insufficient logic in the
