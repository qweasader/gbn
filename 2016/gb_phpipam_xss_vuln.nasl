...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2017-03-08 02:59:00 +0000 (Wed, 08 Mar 2017)");
  ...
  user-supplied data passed to several pages (instructions in app/admin/instructions/preview.php
  subnetId in app/admin/powerDNS/refresh-ptr-records.php).");
