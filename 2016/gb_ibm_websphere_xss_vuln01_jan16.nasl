...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server XSS Vulnerability (swg21647522)");
  ...
  script_tag(name:"insight", value:"The flaw is due to due to improper validation of input in the
  Administrative console.");

  script_tag(name:"impact", value:"Successful exploitation will allow a remote attacker to inject
  script into a victim's web browser within the security context of the hosting web site.");

  script_tag(name:"affected", value:"IBM WebSphere Application Server version 6.1.x prior to
  6.1.0.47.");

  script_tag(name:"solution", value:"Update to version 6.1.0.47 or later.");

  script_xref(name:"URL", value:"http://www-01.ibm.com/support/docview.wss?uid=swg21647522");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/73852");
