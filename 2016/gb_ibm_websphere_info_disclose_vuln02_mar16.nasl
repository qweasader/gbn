...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Information Disclosure Vulnerability (swg21669554)");
  ...
  7.0.0.33, 8.0.x prior to 8.0.0.9 and 8.5.x prior to 8.5.5.2.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/67579");
