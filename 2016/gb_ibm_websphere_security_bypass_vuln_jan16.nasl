...
if(description)
{
  ...
  script_tag(name:"affected", value:"IBM WebSphere Application Server version 6.1.x, 7.0.x prior to
  7.0.0.27, 8.0.x and 8.5.");
...
if (version =~ "^(6\.1|8\.0|8\.5)" ||
    version_in_range_exclusive(version: version, test_version_lo: "7.0", test_version_up: "7.0.0.27")) {
