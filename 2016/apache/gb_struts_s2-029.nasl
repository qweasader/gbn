...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-08-23 15:50:00 +0000 (Fri, 23 Aug 2019)");
...
if(version_in_range(version:vers, test_version:"2.0.0", test_version2:"2.3.24.1")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"2.3.20.3/2.3.24.3/2.3.28", install_path:infos["location"]);
