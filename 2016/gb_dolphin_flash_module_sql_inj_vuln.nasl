...
if(description)
{
  ...
  script_name("Dolphin < 7.3.1 SQLi Vulnerability");
  ...
  script_tag(name:"affected", value:"Dolphin version 7.3.0 and prior.");
...
if (http_vuln_check(port: port, url: url, check_header: TRUE,
                    ...
                    extra_check: make_list("Error saving setting.", "failed", " status="))) {
