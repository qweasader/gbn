...
if (description)
{
  ...
  script_name("Splunk Enterprise 6.3.x < 6.3.5, 6.4.x < 6.4.1 XSS Vulnerability (SP-CAAAPN9)");
  ...
  script_tag(name:"affected", value:"Splunk Enterprise versions 6.4.x and 6.3.x.");
