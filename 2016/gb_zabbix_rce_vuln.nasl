...
if (description)
{
  ...
  script_name("Zabbix 2.2.x < 3.0.4 RCE Vulnerability");
  ...
  script_tag(name:"insight", value:"Zabbix is prone to an authenticated remote code execution
  vulnerability in api_jsonrpc.php.");

  script_tag(name:"impact", value:"An authenticated attacker may execute arbitrary commands.");

  script_tag(name:"affected", value:"Zabbix version 2.2.x through 3.0.3.");
