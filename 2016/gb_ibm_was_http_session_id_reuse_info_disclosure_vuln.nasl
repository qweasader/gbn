...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Information Disclosure Vulnerability (swg21982588)");
  ...
  script_tag(name:"insight", value:"The vulnerability exists when 'HttpSessionIdReuse' is enabled
  in the application.");
  ...
  7.0.0.42, 8.0.x prior to 8.0.0.13, 8.5.x prior to 8.5.5.10 and 9.0.x prior to 9.0.0.1 and
  WebSphere Liberty prior to version 16.0.0.3.");

  script_tag(name:"solution", value:"Update to version 7.0.0.43, 8.0.0.13, 8.5.5.10, 9.0.0.1 (IBM
  WebSphere Application Server) or 16.0.0.3 or later (WebSphere Liberty).");
