...
if(description)
{
  ...
  script_name("Drupal 6.x < 6.38, 7.x < 7.43 Multiple Vulnerabilities (SA-CORE-2016-001) - Linux");
  ...
  script_tag(name:"solution", value:"Update to version 6.38, 7.43 or later.");
