...
if(description)
{
  ...
  script_name("Roundcube Webmail < 1.1.5 CSRF Vulnerability");
  ...
  script_tag(name:"summary", value:"Roundcube Webmail is prone to a cross-site request forgery
  (CSRF) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Exploiting this issue may allow a remote attacker to perform
  certain unauthorized actions and gain access to the affected application. This may lead to perform
