...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Information Disclosure Vulnerability (swg21671835)");
  ...
  script_tag(name:"insight", value:"The flaw is due to an XML External Entity Injection (XXE) error
  when processing XML data.");

  script_tag(name:"impact", value:"Successful exploitation will allow a remote attacker to obtain
  sensitive information, to read arbitrary files.");
