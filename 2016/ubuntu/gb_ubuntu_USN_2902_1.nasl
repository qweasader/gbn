...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgraphite2-3", ver:"1.2.4-1ubuntu1.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgraphite2-3", ver:"1.2.4-3ubuntu1.1", rls:"UBUNTU15.10"))) {
    report += res;
  }
