...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2015-12-24 17:46:35 +0000 (Thu, 24 Dec 2015)");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liboxideqtcore0", ver:"1.11.4-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liboxideqtcore0", ver:"1.11.4-0ubuntu0.15.04.1", rls:"UBUNTU15.04"))) {
    report += res;
  }
...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liboxideqtcore0", ver:"1.11.4-0ubuntu0.15.10.1", rls:"UBUNTU15.10"))) {
    report += res;
  }
