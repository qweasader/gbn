...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid3", ver:"3.1.19-1ubuntu3.12.04.6", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid3", ver:"3.3.8-1ubuntu6.6", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid3", ver:"3.3.8-1ubuntu16.2", rls:"UBUNTU15.10"))) {
    report += res;
  }
