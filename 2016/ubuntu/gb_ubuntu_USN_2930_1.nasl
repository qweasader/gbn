...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-34-generic", ver:"4.2.0-34.39", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-34-generic-lpae", ver:"4.2.0-34.39", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-34-lowlatency", ver:"4.2.0-34.39", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-34-powerpc-e500mc", ver:"4.2.0-34.39", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-34-powerpc-smp", ver:"4.2.0-34.39", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-34-powerpc64-emb", ver:"4.2.0-34.39", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-34-powerpc64-smp", ver:"4.2.0-34.39", rls:"UBUNTU15.10"))) {
    report += res;
  }
