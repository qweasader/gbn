...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpam-modules", ver:"1.1.3-7ubuntu2.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpam-modules", ver:"1.1.8-1ubuntu2.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpam-modules", ver:"1.1.8-3.1ubuntu3.1", rls:"UBUNTU15.10"))) {
    report += res;
  }
