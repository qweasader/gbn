...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-03-17 00:38:21 +0000 (Thu, 17 Mar 2016)");
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"45.0.2+build1-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"45.0.2+build1-0ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"45.0.2+build1-0ubuntu0.15.10.1", rls:"UBUNTU15.10"))) {
    report += res;
  }
