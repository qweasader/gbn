...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cpio", ver:"2.11-7ubuntu3.2", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cpio", ver:"2.11+dfsg-1ubuntu1.2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cpio", ver:"2.11+dfsg-4.1ubuntu1.1", rls:"UBUNTU15.10"))) {
    report += res;
  }
