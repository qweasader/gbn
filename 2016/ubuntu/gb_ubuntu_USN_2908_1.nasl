...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-30-generic", ver:"4.2.0-30.35", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-30-generic-lpae", ver:"4.2.0-30.35", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-30-lowlatency", ver:"4.2.0-30.35", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-30-powerpc-e500mc", ver:"4.2.0-30.35", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-30-powerpc-smp", ver:"4.2.0-30.35", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-30-powerpc64-emb", ver:"4.2.0-30.35", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-30-powerpc64-smp", ver:"4.2.0-30.35", rls:"UBUNTU15.10"))) {
    report += res;
  }
