...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-server", ver:"1:5.9p1-5ubuntu1.9", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-server", ver:"1:6.6p1-2ubuntu2.7", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-server", ver:"1:6.9p1-2ubuntu0.2", rls:"UBUNTU15.10"))) {
    report += res;
  }
