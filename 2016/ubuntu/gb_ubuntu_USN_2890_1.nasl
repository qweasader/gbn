...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-27-generic", ver:"4.2.0-27.32", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-27-generic-lpae", ver:"4.2.0-27.32", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-27-lowlatency", ver:"4.2.0-27.32", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-27-powerpc-e500mc", ver:"4.2.0-27.32", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-27-powerpc-smp", ver:"4.2.0-27.32", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-27-powerpc64-emb", ver:"4.2.0-27.32", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-27-powerpc64-smp", ver:"4.2.0-27.32", rls:"UBUNTU15.10"))) {
    report += res;
  }
