...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-09-22 02:40:45 +0000 (Thu, 22 Sep 2016)");

  script_name("Debian: Security Advisory (DSA-3679-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3679-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3679-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3679");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jackrabbit' package(s) announced via the DSA-3679-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libjackrabbit-java", ver:"2.3.6-1+deb8u2", rls:"DEB8"))) {
    report += res;
  }
