...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-12-16 17:05:50 +0000 (Fri, 16 Dec 2016)");

  script_name("Debian: Security Advisory (DSA-3743-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3743-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3743-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3743");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-bottle' package(s) announced via the DSA-3743-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-bottle", ver:"0.12.7-1+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-bottle-doc", ver:"0.12.7-1+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3-bottle", ver:"0.12.7-1+deb8u1", rls:"DEB8"))) {
    report += res;
  }
