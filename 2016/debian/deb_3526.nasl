...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-02-01 19:04:29 +0000 (Mon, 01 Feb 2016)");

  script_name("Debian: Security Advisory (DSA-3526-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3526-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3526-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3526");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libmatroska' package(s) announced via the DSA-3526-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmatroska-dev", ver:"1.3.0-2+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmatroska5", ver:"1.3.0-2+deb7u1", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmatroska-dev", ver:"1.4.1-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmatroska6", ver:"1.4.1-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
