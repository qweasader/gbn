...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3676-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3676-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3676-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3676");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unadf' package(s) announced via the DSA-3676-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unadf", ver:"0.7.11a-3+deb8u1", rls:"DEB8"))) {
    report += res;
  }
