...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-04-12 22:24:26 +0000 (Tue, 12 Apr 2016)");

  script_name("Debian: Security Advisory (DSA-3498-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3498-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3498-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3498");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'drupal7' package(s) announced via the DSA-3498-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"drupal7", ver:"7.14-2+deb7u12", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"drupal7", ver:"7.32-1+deb8u6", rls:"DEB8"))) {
    report += res;
  }
