...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3495-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3495-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3495-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3495");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xymon' package(s) announced via the DSA-3495-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xymon", ver:"4.3.17-6+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xymon-client", ver:"4.3.17-6+deb8u1", rls:"DEB8"))) {
    report += res;
  }
