...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-04-12 18:38:08 +0000 (Tue, 12 Apr 2016)");

  script_name("Debian: Security Advisory (DSA-3518-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3518-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3518-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3518");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'spip' package(s) announced via the DSA-3518-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"spip", ver:"2.1.17-1+deb7u5", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"spip", ver:"3.0.17-2+deb8u2", rls:"DEB8"))) {
    report += res;
  }
