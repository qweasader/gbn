...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-03-18 17:19:07 +0000 (Fri, 18 Mar 2016)");

  script_name("Debian: Security Advisory (DSA-3513-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3513-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3513-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3513");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium-browser' package(s) announced via the DSA-3513-1 advisory.");
