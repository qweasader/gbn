...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3545-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3545-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3545-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3545");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cgit' package(s) announced via the DSA-3545-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cgit", ver:"0.10.2.git2.0.1-3+deb8u1", rls:"DEB8"))) {
    report += res;
  }
