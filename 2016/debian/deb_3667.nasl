...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-09-26 15:20:44 +0000 (Mon, 26 Sep 2016)");

  script_name("Debian: Security Advisory (DSA-3667-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3667-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3667-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3667");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium-browser' package(s) announced via the DSA-3667-1 advisory.");
