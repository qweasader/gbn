...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-07-14 20:14:09 +0000 (Thu, 14 Jul 2016)");

  script_name("Debian: Security Advisory (DSA-3617-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3617-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3617-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3617");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'horizon' package(s) announced via the DSA-3617-1 advisory.");
