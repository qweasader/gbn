...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3542-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3542-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3542-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3542");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mercurial' package(s) announced via the DSA-3542-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mercurial", ver:"2.2.2-4+deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mercurial-common", ver:"2.2.2-4+deb7u2", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mercurial", ver:"3.1.2-2+deb8u2", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mercurial-common", ver:"3.1.2-2+deb8u2", rls:"DEB8"))) {
    report += res;
  }
