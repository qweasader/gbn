...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-01-10 17:51:12 +0000 (Tue, 10 Jan 2017)");

  script_name("Debian: Security Advisory (DSA-3692-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3692-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3692-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3692");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'freeimage' package(s) announced via the DSA-3692-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfreeimage-dev", ver:"3.15.4-4.2+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfreeimage3", ver:"3.15.4-4.2+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfreeimage3-dbg", ver:"3.15.4-4.2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
