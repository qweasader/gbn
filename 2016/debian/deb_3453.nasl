...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-02-08 22:27:50 +0000 (Mon, 08 Feb 2016)");

  script_name("Debian: Security Advisory (DSA-3453-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3453-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3453-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mariadb-10.0' package(s) announced via the DSA-3453-1 advisory.");
