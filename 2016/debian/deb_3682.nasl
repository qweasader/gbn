...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3682-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3682-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2016/DSA-3682-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3682");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'c-ares' package(s) announced via the DSA-3682-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libc-ares-dev", ver:"1.10.0-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libc-ares2", ver:"1.10.0-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
