...
if(description)
{
  ...
  script_name("Oracle GlassFish Server 2.1.1, 3.0.1 Unspecified Vulnerability (Jul 2016)");
  ...
  script_tag(name:"affected", value:"Oracle GlassFish Server version 2.1.1 and 3.0.1.");

  script_tag(name:"solution", value:"Apply the patches from the referenced advisory.");

  script_xref(name:"URL", value:"http://www.oracle.com/technetwork/security-advisory/cpujul2016-2881720.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/92032");
