...
if (description)
{
  ...
  script_name("Cisco IOS XR Software SCP and SFTP Modules Denial of Service Vulnerability (cisco-sa-20160323-ncs)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the Secure Copy Protocol (SCP) and Secure
  ...
  script_tag(name:"insight", value:"The vulnerability is due to improper setting of permissions on
  ...
  script_tag(name:"impact", value:"An exploit could allow the attacker to overwrite system files
