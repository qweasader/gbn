...
if (description)
{
  ...
  script_name("Cisco Unified Communications Manager Information Disclosure Vulnerability (cisco-sa-20160208-ucm)");
  ...
  script_tag(name:"summary", value:"Cisco Unified Communications Manager (CUCM) is prone to an
  information disclosure vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to an encryption key that can be read
  in plain text.");

  script_tag(name:"impact", value:"An attacker can exploit this issue to obtain sensitive
  information.");

  script_tag(name:"affected", value:"Cisco Unified Communications Manager (CallManager) Releases
  10.5(2.12901.1), 10.5(2.10000.5), 11.0(1.10000.10) and 9.1(2.10000.28).");
