...
if(description)
{
  ...
  script_tag(name:"severity_vector", value:"CVSS:3.0/AV:L/AC:L/PR:H/UI:N/S:C/C:L/I:L/A:L");
  ...
  script_tag(name:"summary", value:"Oracle NetBeans IDE is prone to a directory traversal vulnerability.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/93686");
