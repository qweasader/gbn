...
if (description)
{
  ...
  script_name("Cisco IOS XR Software for Cisco ASR 9001 Aggregation Services Routers Fragmented Packet Denial of Service Vulnerability (cisco-sa-20160810-iosxr)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the driver processing functions of Cisco IOS
  ...
  script_tag(name:"impact", value:"A successful exploit could allow the attacker to cause a memory
