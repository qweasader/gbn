...
if(description)
{
  ...
  information and remote attacker to inject arbitrary web script or HTML.");

  script_tag(name:"affected", value:"IBM WebSphere Application Server version 6.1.x prior to
  6.1.0.47, 7.0.x prior to 7.0.0.29, 8.0.x prior to 8.0.0.7 and 8.5.x prior to 8.5.5.0.");

  script_tag(name:"solution", value:"Update to version 6.1.0.47, 7.0.0.29, 8.0.0.7, 8.5.5.0 or
  later.");

  script_xref(name:"URL", value:"http://www-01.ibm.com/support/docview.wss?uid=swg21644047");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/61941");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/61940");
...
if (version_in_range_exclusive(version: version, test_version_lo: "8.5", test_version_up: "8.5.5.0")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "8.5.5.0");
  security_message(port: 0, data: report);
  exit(0);
}
