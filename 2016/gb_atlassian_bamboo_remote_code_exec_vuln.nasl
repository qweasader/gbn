...
if(description)
{
  ...
  script_name("Atlassian Bamboo Remote Code Execution Vulnerability (Feb 2016)");

  script_tag(name:"summary", value:"Atlassian Bamboo is prone to a remote code execution (RCE) vulnerability.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/83111");
