...
if(description)
{
  ...
  script_name("FreeRDP < 1.1.0-beta+2013071101 DoS Vulnerability - Linux");
  ...
  script_tag(name:"affected", value:"FreeRDP version before 1.1.0-beta+2013071101 on Linux.");

  script_tag(name:"solution", value:"Update to version 1.1.0-beta+2013071101 or later.");
...
if(revcomp(a:version, b:"1.1.0-beta+2013071101") < 0) {
  report = report_fixed_ver(installed_version:version, fixed_version:"1.1.0-beta+2013071101", install_path:location);
