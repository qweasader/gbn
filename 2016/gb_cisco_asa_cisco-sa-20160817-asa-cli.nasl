...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2024-07-02 12:21:48 +0000 (Tue, 02 Jul 2024)");
  ...
  script_name("Cisco Adaptive Security Appliance CLI Remote Code Execution Vulnerability (cisco-sa-20160817-asa-cli)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the command-line interface (CLI) parser of
