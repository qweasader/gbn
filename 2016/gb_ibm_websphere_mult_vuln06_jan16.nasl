...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Multiple Vulnerabilities (swg21661323)");
  ...
  arbitrary web script or HTML and to cause a denial of service (resource consumption).");

  script_tag(name:"affected", value:"IBM WebSphere Application Server version 7.x prior to
  7.0.0.31, 8.0.x prior to 8.0.0.8 and 8.5.x prior to 8.5.5.2.");

  script_tag(name:"solution", value:"Update to version 7.0.0.31, 8.0.0.8, 8.5.5.2 or later.");
