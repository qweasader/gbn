...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server CRLF Injection Vulnerability (swg21982526)");
  ...
  script_tag(name:"insight", value:"The flaw is due to some unspecified error within the
  application.");
  ...
  7.0.0.43, 8.0.x prior to 8.0.0.13 and 8.5.x prior to 8.5.5.10 and WebSphere Liberty version 8.5.x
  prior to 16.0.0.2");

  script_tag(name:"solution", value:"Update to version 7.0.0.43, 8.0.0.13, 8.5.5.10 or later (IBM
  WebSphere Application Server) or 16.0.0.2 or later (WebSphere Liberty).");
...
if (get_kb_item("ibm/websphere/liberty/detected")) {
  if (version_is_less(version: version, test_version: "16.0.0.2")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "16.0.0.2");
