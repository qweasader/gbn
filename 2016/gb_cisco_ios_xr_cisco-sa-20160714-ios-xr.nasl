...
if (description)
{
  ...
  script_name("Cisco IOS XR Software Command Injection Vulnerability (cisco-sa-20160714-ios-xr)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the command-line utility of Cisco IOS XR
  Software could allow an authenticated, local attacker to execute arbitrary commands on the host
  ...
  attacker could exploit this vulnerability by submitting crafted input to a command in a specific
  container.");
