...
if(description)
{
  ...
  7.0.0.29, 8.0.x prior to 8.0.0.7 and 8.5.x prior to 8.5.5.0.");

  script_tag(name:"solution", value:"Update to version 7.0.0.29, 8.0.0.7, 8.5.5.0 or later.");

  script_xref(name:"URL", value:"http://www-01.ibm.com/support/docview.wss?uid=swg21644047");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/60724");
