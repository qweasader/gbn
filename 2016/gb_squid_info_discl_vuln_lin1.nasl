...
if (description)
{
  ...
  script_name("Squid 3.5.x < 3.5.23, 4.0.x < 4.0.17 Information Disclosure Vulnerability (SQUID-2016:10) - Linux");
  ...
  script_tag(name:"insight", value:"Due to incorrect comparison of request headers Squid can
  deliver responses containing private data to clients it should not have reached.");
