...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Security Bypass Vulnerability (swg21681249)");
  ...
  script_tag(name:"insight", value:"The flaw is due to an improper account creation with the
  ...
  script_tag(name:"affected", value:"IBM WebSphere Application Server version 8.0.0.6 prior to
  8.0.0.10 and 8.5.x prior to 8.5.5.3.");

  script_tag(name:"solution", value:"Update to version 8.0.0.10, 8.5.5.3 or later.");

  script_xref(name:"URL", value:"http://www-01.ibm.com/support/docview.wss?uid=swg21681249");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/69296");
...
if (version_in_range_exclusive(version: version, test_version_lo: "8.0.0.6", test_version_up: "8.0.0.10")) {
