...
#
# Squid Poisoning Vulnerability May16 (Windows)
#
# Authors:
...
if(description)
{
  ...
  script_name("Squid Poisoning Vulnerability (SQUID-2016:8) - Windows");

  script_tag(name:"summary", value:"Squid is prone to a cache poisoning vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to an incorrect input validation in HTTP
  Request processing.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to cause
  cache poisoning and to bypass of same-origin security policy.");

  script_tag(name:"affected", value:"Squid version prior to 3.5.18.");

  script_tag(name:"solution", value:"Update to version 3.5.18 or later.");
...
if(version_is_less(version:vers, test_version:"3.5.18")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"3.5.18");
