...
if (description)
{
  ...
  script_name("Cisco Unified Communications Manager SQLi Vulnerability (cisco-sa-20160203-ucm)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the Cisco Unified Communications Manager SQL
  database interface could allow an authenticated, remote attacker to impact the confidentiality of
  the system by executing arbitrary SQL queries.");
  ...
  script_tag(name:"impact", value:"An attacker could exploit this vulnerability by sending crafted
  URLs that contain malicious SQL statements to the affected system. An exploit could allow the
  attacker to determine the presence of certain values in the database.");

  script_tag(name:"affected", value:"Cisco Unified Communications Manager release 10.5(2.13900.9).");
