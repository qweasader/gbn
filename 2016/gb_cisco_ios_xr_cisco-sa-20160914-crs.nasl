...
if (description)
{
  ...
  script_name("Cisco Carrier Routing System IPv6 Denial of Service Vulnerability (cisco-sa-20160914-crs)");
  ...
  script_tag(name:"summary", value:"A vulnerability in IPv6 over MPLS packet processing of Cisco
  IOS XR for Cisco Carrier Routing System (CRS) platforms could allow an unauthenticated, adjacent
  attacker to cause a reload of the affected line card.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to insufficient logic in processing of
  crafted IPv6 over MPLS packets. An attacker could exploit this vulnerability by sending a crafted
  IPv6 over MPLS packet to be processed by an affected device.");
