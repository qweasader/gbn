...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Multiple Vulnerabilities (swg21622444)");
  ...
  - An improper validation of input by virtual member manager (VMM) administrative console.");
  ...
  script_tag(name:"affected", value:"IBM WebSphere Application Server version 6.1 prior to
  6.1.0.47, 7.0.x prior to 7.0.0.27, 8.0.x prior to 8.0.0.6 and 8.5.x prior to 8.5.0.2.");

  script_tag(name:"solution", value:"Update to version 6.1.0.47, 7.0.0.27, 8.0.0.6, 8.5.0.2 or
  later.");
