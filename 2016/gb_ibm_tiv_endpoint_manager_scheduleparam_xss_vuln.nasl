...
if (description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/52514");
...
if(version_is_less(version:version, test_version:"8.2.1175")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"8.2.1175");
