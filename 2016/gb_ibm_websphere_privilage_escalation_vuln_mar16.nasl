...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Privilege Escalation Vulnerability (swg21697368)");
  ...
  script_tag(name:"insight", value:"The flaws is due to when OAuth grant type of password is
  used.");
  ...
  7.0.0.39, 8.0.x prior to 8.0.0.11 and 8.5.x prior to 8.5.5.6 and WebSphere Liberty Profile
  version 8.5.x prior to 8.5.5.5.");
