...
if(description)
{
  ...
  script_name("Oracle Database Server Multiple Unspecified Vulnerabilities -01 (Jul 2016)");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91885");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91894");
...
if(version_is_less(version:ver, test_version:"5.0.4")) {
