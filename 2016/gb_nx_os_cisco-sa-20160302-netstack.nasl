...
if (description)
{
  ...
  script_name("Cisco NX-OS Software TCP Netstack Denial of Service Vulnerability (cisco-sa-20160302-netstack)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the TCP stack of Cisco NX-OS Software could
  allow an unauthenticated, remote attacker to cause a denial of service (DoS) condition.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to improper processing of certain TCP
  ...
  script_tag(name:"impact", value:"An exploit could allow the attacker to cause a reload of the TCP
