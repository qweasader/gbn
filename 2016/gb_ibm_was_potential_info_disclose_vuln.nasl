...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Information Disclosure Vulnerability (swg21990056)");
  ...
  script_tag(name:"insight", value:"The flaw exists due to an improper handling of responses under
  certain conditions.");
  ...
  7.0.0.43, 8.0.x prior to 8.0.0.13, 8.5.x prior to 8.5.5.11, 9.0.x prior to 9.0.0.2 and WebSphere
  Liberty prior to version 16.0.0.3.");

  script_tag(name:"solution", value:"Update to version 7.0.0.43, 8.0.0.13, 8.5.5.11, 9.0.0.2 or
  later (IBM WebSphere Application Server) or version 16.0.0.3 or later (WebSphere Liberty).");
