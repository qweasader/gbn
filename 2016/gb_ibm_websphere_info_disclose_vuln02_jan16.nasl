...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Liberty Information Disclosure Vulnerability (Jan 2016)");
  ...
  script_tag(name:"summary", value:"IBM WebSphere Application Server Liberty is prone to unspecified remote
  information disclosure vulnerability");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw is due to an insecure permissions of files created by
  the Liberty Server.");

  script_tag(name:"impact", value:"Successful exploitation will allow a remote attacker to obtain
  sensitive information.");

  script_tag(name:"affected", value:"IBM WebSphere Application Server Liberty Profile 8.5.x prior
  to 8.5.5.1.");

  script_tag(name:"solution", value:"Update to version 8.5.5.1 or later.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/63786");
