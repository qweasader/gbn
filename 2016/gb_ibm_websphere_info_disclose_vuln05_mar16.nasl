...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Information Disclosure Vulnerability (swg21690185)");
  ...
  script_tag(name:"insight", value:"The flaw is due to a vulnerability in handling cookies.");

  script_tag(name:"impact", value:"Successful exploitation will allow a remote attacker to spoof
  OpenID and OpenID connect cookies.");
