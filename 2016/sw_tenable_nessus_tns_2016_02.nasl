...
if(description)
{
  ...
  script_version("2021-11-08T16:20:55+0000");
  script_cve_id("CVE-2016-82000", "CVE-2016-82001");
  script_tag(name:"cvss_base", value:"2.6");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:H/Au:N/C:N/I:P/A:N");
  script_tag(name:"last_modification", value:"2021-11-08 16:20:55 +0000 (Mon, 08 Nov 2021)");
  script_tag(name:"creation_date", value:"2016-02-16 09:00:00 +0100 (Tue, 16 Feb 2016)");
  script_name("Tenable Nessus Multiple Vulnerabilities (TNS-2016-02)");
  ...
  script_tag(name:"affected", value:"Tenable Nessus versions 5.x and 6.0 through 6.5.4.");

  script_tag(name:"solution", value:"Update to version 6.5.5 or later.");
