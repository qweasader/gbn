...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server CSRF Vulnerability (Jan 2016)");
  ...
  script_tag(name:"insight", value:"The Flaw is due to an improper validation of portlets in the
  administrative console.");

  script_tag(name:"impact", value:"Successful exploitation may allow a remote attacker to hijack
  ...
  6.1.0.47 and 7.0.x prior to 7.0.0.27.");

  script_tag(name:"solution", value:"Update to version 6.1.0.47, 7.0.0.27 or later.");

  script_xref(name:"URL", value:"http://www-01.ibm.com/support/docview.wss?uid=swg21622444");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/57510");
