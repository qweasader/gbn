...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Multiple Vulnerabilities (Feb 2016)");
  ...
  spoofing attacks, to obtain sensitive information that may lead to further attacks.");

  script_tag(name:"affected", value:"IBM WebSphere Application Server version 7.x prior to
  7.0.0.39, 8.0.x prior to 8.0.0.11 and 8.5.x prior to 8.5.5.7.");

  script_tag(name:"solution", value:"Update to version 7.0.0.39, 8.0.0.11, 8.5.5.7 or later.");

  script_xref(name:"URL", value:"http://www-01.ibm.com/support/docview.wss?uid=swg21963275");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/76466");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/76463");
...
if (version_in_range_exclusive(version: version, test_version_lo: "8.5", test_version_up: "8.5.5.7")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "8.5.5.7");
  security_message(port: 0, data: report);
  exit(0);
}
