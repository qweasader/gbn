...
if(description)
{
  ...
  script_name("Cybozu Office < 10.1.0 Buffer Overflow Vulnerability");

  script_tag(name:"summary", value:"Cybozu Office is prone to a buffer overflow vulnerability.");
  ...
  script_tag(name:"affected", value:"Cybozu Office prior to version 10.1.0.");
...
if(version_is_less_equal(version:version, test_version:"10.0.3")) {
