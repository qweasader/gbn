...
if(description)
{
  ...
  script_name("Foxit PhantomPDF Multiple RCE Vulnerabilities");

  script_tag(name:"summary", value:"Foxit PhantomPDF is prone to multiple remote code execution (RCE) vulnerabilities.");
