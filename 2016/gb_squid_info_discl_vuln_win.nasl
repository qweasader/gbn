...
if (description)
{
  ...
  script_name("Squid 3.1 <= 3.5.22, 4.0 <= 4.0.16 Information Disclosure Vulnerability (SQUID-2016:11) - Windows");
  ...
  script_tag(name:"insight", value:"Due to incorrect HTTP conditional request handling Squid
  can deliver responses containing private data to clients it should not have reached.");

  script_tag(name:"impact", value:"A remote attacker may discover private and sensitive information
  about another clients browsing session. Potentially including credentials which allow access to
  further sensitive resources.");

  script_tag(name:"affected", value:"Squid versions 3.1 through 3.5.22 and 4.0 through 4.0.16.");
