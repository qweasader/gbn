...
if(description)
{
  ...
  script_tag(name:"summary", value:"Avast Free Antivirus is prone to a security bypass vulnerability.");
...
if( version =~ "^11" && version_in_range( version:version, test_version:"11.0", test_version2:"11.1.2262" ) ) {
