...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Information Disclosure Vulnerability (Jan 2016)");
  ...
  script_tag(name:"insight", value:"The flaw is due to insufficient validation of requests made to
  the server.");
  ...
  script_tag(name:"solution", value:"Update to version 8.5.5.2 or later.");

  script_xref(name:"URL", value:"http://www-01.ibm.com/support/docview.wss?uid=swg21669554");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/67328");
