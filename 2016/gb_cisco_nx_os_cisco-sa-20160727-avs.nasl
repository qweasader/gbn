...
if (description)
{
  ...
  script_name("Cisco Nexus 1000v Application Virtual Switch Cisco Discovery Protocol Packet Processing Denial of Service Vulnerability (cisco-sa-20160727-avs)");
  ...
  script_tag(name:"summary", value:"A vulnerability in Cisco Discovery Protocol packet processing
  ...
  script_tag(name:"impact", value:"An attacker could exploit this vulnerability by sending a
  ...
  script_xref(name:"URL", value:"https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/cisco-sa-20160727-avs");
