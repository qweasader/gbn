...
if(description)
{
  ...
  script_name("Roundcube Webmail < 1.1.7, 1.2.x < 1.2.3 RCE Vulnerability");
  ...
  script_tag(name:"summary", value:"Roundcube Webmail is prone to a remote code execution (RCE)
  vulnerability.");
  ...
  script_tag(name:"affected", value:"Roundcube Webmail versions prior to 1.1.7 and 1.2.x prior to
  1.2.3 if:
  ...
  script_tag(name:"solution", value:"Update to version 1.1.7, 1.2.3 or later.");
...
if (version_is_less(version: version, test_version: "1.1.7")) {
