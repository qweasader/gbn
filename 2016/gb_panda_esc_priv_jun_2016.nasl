...
if(description)
{
  ...
  script_name("Panda Small Business Protection - Privilege Escalation (Jun 2016) - Windows");
  ...
  script_tag(name:"summary", value:"Panda Small Business Protection is prone to a Privilege Escalation Vulnerability.");
