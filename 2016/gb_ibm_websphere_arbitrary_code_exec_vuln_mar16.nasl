...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Liberty Arbitrary Code Execution Vulnerability (Mar 2016)");
  ...
  script_tag(name:"summary", value:"IBM WebSphere Application Server Liberty is prone to an
  arbitrary code execution vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw is due to improper usage of the Liberty Repository for
  ...
  script_tag(name:"solution", value:"Update to version 8.5.5.3 or later.");
...
if (version_in_range(version: version, test_version: "8.5", test_version2: "8.5.5.2")) {
