...
if(description)
{
  ...
  script_name("Apache Subversion < 1.7.19, 1.8.x < 1.8.11 DoS Vulnerability (Feb 2016)");
  ...
  script_tag(name:"affected", value:"Apache Subversion version 1.x before 1.7.19 and 1.8.x before
  1.8.11.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/71726");
...
if (version_in_range_exclusive(version: version, test_version_lo: "1.0", test_version_up: "1.7.19")) {
