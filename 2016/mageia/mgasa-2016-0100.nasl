...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2016-03-08 05:15:18 +0000 (Tue, 08 Mar 2016)");
  ...
  script_name("Mageia: Security Advisory (MGASA-2016-0100)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2016-0100");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2016-0100.html");
  script_xref(name:"URL", value:"http://lists.opensuse.org/opensuse-updates/2016-02/msg00060.html");
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-2919-1/");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=17872");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'jasper' package(s) announced via the MGASA-2016-0100 advisory.");
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"jasper", rpm:"jasper~1.900.1~20.4.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64jasper-devel", rpm:"lib64jasper-devel~1.900.1~20.4.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64jasper-static-devel", rpm:"lib64jasper-static-devel~1.900.1~20.4.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"lib64jasper1", rpm:"lib64jasper1~1.900.1~20.4.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libjasper-devel", rpm:"libjasper-devel~1.900.1~20.4.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libjasper-static-devel", rpm:"libjasper-static-devel~1.900.1~20.4.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libjasper1", rpm:"libjasper1~1.900.1~20.4.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
