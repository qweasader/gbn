...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-04-28 17:46:33 +0000 (Fri, 28 Apr 2017)");

  script_name("Mageia: Security Advisory (MGASA-2016-0141)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2016-0141");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2016-0141.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=18186");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/pipermail/package-announce/2016-April/181943.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-pillow' package(s) announced via the MGASA-2016-0141 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update fixes an integer overflow in Jpeg2KEncode.c causing a buffer
