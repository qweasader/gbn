...
if(description)
{
  ...
  script_tag(name:"insight", value:"Reflected Cross Site Scripting and Header Injection in Mimetype Query
...
(CVE-2016-1901).");
  ...
  script_tag(name:"affected", value:"'cgit' package(s) on Mageia 5.");
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cgit", rpm:"cgit~0.12~1.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
