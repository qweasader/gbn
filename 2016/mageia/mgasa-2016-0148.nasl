...
if(description)
{
  ...
  script_name("Mageia: Security Advisory (MGASA-2016-0148)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2016-0148");
  ...
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=18231");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid' package(s) announced via the MGASA-2016-0148 advisory.");
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid", rpm:"squid~3.5.17~1.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"squid-cachemgr", rpm:"squid-cachemgr~3.5.17~1.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
