...
if(description)
{
  ...
  script_name("Oracle Database Server Multiple Unspecified Vulnerabilities -07 (Jan 2016)");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/70480");
...
if(version_is_less(version:ver, test_version:"4.2.6")) {
