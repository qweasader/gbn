...
if(description)
{
  ...
  script_name("Oracle Database Server Unspecified Vulnerability -04 (Jan 2016)");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75865");
...
if(version_is_less(version:ver, test_version:"4.2.1")) {
