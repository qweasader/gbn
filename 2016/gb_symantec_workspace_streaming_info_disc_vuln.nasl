...
if(description)
{
  ...
  script_tag(name:"summary", value:"Symantec Symantec Workspace Streaming is prone to an information disclosure vulnerability.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/67189");
