...
if(description)
{
  ...
  script_name("Panda Global Protection - Privilege Escalation (Jun 2016) - Windows");
  ...
  script_tag(name:"summary", value:"Panda Internet Security is prone to a Privilege Escalation Vulnerability.");
