...
if(description)
{
  ...
  script_name("Oracle GlassFish Server 3.0.1 Unspecified Vulnerability (Jul 2016)");
  ...
  script_tag(name:"insight", value:"The flaw exists due to an unspecified error in the
  Administration sub-component.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/92031");
