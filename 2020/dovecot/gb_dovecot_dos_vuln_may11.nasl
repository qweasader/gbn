...
if (version_is_greater_equal(version: version, test_version: "1.2.0") &&
    version_is_less(version: version, test_version: "1.2.17")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.2.17", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}

else if (version_is_greater_equal(version: version, test_version: "2.0.0") &&
         version_is_less(version: version, test_version: "2.0.13")) {
