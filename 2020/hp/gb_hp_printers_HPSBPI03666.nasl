...
if (description)
{
  ...
  script_tag(name:"summary", value:"Multiple HP printers are vulnerable to multiple vulnerabilities
  in the Treck IP stack (Ripple20).");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Multiple potential vulnerabilities may exist in the Treck Inc.
  networking stack used in certain HP and Samsung-branded printers. These may include, but not be
  limited to, denial of service or remote code execution.");
...
cpe_list = make_list("cpe:/o:hp:color_laser_mfp_179fnw_firmware",
                     "cpe:/o:hp:color_laser_mfp_178nw_firmware",
                     "cpe:/o:hp:laser_mfp_137fnw_firmware",
                     "cpe:/o:hp:smart_tank_wireless_450_firmware",
                     "cpe:/o:hp:ink_tank_wireless_410_firmware",
                     "cpe:/o:hp:deskjet_3700_firmware",
                     "cpe:/o:hp:officejet_6950_firmware",
                     "cpe:/o:hp:officejet_3830_firmware",
                     "cpe:/o:hp:deskjet_ink_advantage_3830_firmware",
                     "cpe:/o:hp:deskjet_3630_firmware",
                     "cpe:/o:hp:deskjet_ink_advantage_ultra_4720_firmware",
                     "cpe:/o:hp:deskjet_2700_firmware",
                     "cpe:/o:hp:deskjet_plus_4100_firmware",
                     "cpe:/o:hp:deskjet_2600_firmware",
                     "cpe:/o:hp:officejet_250_mobile_firmware",
                     "cpe:/o:hp:officejet_pro_6968_firmware");
...
if (cpe =~ "^cpe:/o:hp:color_laser_mfp_17[89]") {
...
if (cpe == "cpe:/o:hp:laser_mfp_137fnw_firmware") {
...
if (cpe == "cpe:/o:hp:deskjet_3700_firmware") {
...
if (cpe == "cpe:/o:hp:officejet_6950_firmware") {
...
if (cpe == "cpe:/o:hp:officejet_3830_firmware") {
...
if (cpe == "cpe:/o:hp:deskjet_ink_advantage_3830_firmware") {
...
if (cpe == "cpe:/o:hp:deskjet_3630_firmware") {
...
if (cpe == "cpe:/o:hp:deskjet_ink_advantage_ultra_4720_firmware") {
...
if (cpe == "cpe:/o:hp:deskjet_2700_firmware") {
...
if (cpe == "cpe:/o:hp:deskjet_plus_4100_firmware") {
...
if (cpe == "cpe:/o:hp:officejet_250_mobile_firmware") {
...
if (cpe == "cpe:/o:hp:officejet_pro_6968_firmware") {
