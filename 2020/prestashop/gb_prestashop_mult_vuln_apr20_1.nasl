...
if(description)
{
  ...
  - CVE-2020-5264: Reflected XSS in security compromised page

  - CVE-2020-5288: Improper access control on product attributes page

  - CVE-2020-5293: Improper access control on product page with combinations, attachments and
  specific prices");

  script_tag(name:"affected", value:"PrestaShop versions 1.7.0.0 through 1.7.6.4.");
...
if (!infos = get_app_version_and_location(cpe: CPE, port: port, exit_no_version: TRUE, version_regex: "^1\.7\.[0-9]+"))
  exit(0);
