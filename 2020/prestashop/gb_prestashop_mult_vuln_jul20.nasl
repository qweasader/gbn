...
if(description)
{
  ...
  - CVE-2020-15079: Improper access control

  - CVE-2020-15081: Information exposure in the upload directory

  - CVE-2020-4074: Improper Authentication");

  script_tag(name:"affected", value:"PrestaShop versions 1.5.0.0 through 1.7.6.5.");
