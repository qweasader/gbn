...
if(description)
{
  ...
  script_name("PrestaShop 1.7.5.0 < 1.7.6.8 SQLi Vulnerability");
  ...
  script_tag(name:"summary", value:"PrestaShop is prone to a blind SQL injection (SQLi)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The SQLi flaw exists in the Catalog Product edition page within
  the location parameter.");

  script_tag(name:"affected", value:"PrestaShop versions 1.7.5.0 through 1.7.6.7.");
