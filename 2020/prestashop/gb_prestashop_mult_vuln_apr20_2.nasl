...
if(description)
{
  ...
  script_name("PrestaShop 1.7.6.1 < 1.7.6.5 Multiple XSS Vulnerabilities");
  ...
  script_tag(name:"summary", value:"PrestaShop is prone to multiple cross-site scripting (XSS)
  vulnerabilities.");
  ...
  - CVE-2020-5265: Reflected XSS on AdminAttributesGroups page

  - CVE-2020-5269: Reflected XSS on AdminFeatures page");

  script_tag(name:"affected", value:"PrestaShop versions 1.7.6.1 through 1.7.6.4.");
