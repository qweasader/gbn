...
if(description)
{
  ...
  script_version("2021-12-23T08:45:36+0000");
  script_tag(name:"last_modification", value:"2021-12-23 08:45:36 +0000 (Thu, 23 Dec 2021)");
  ...
  script_name("Webmin <= 1.983 RCE Vulnerability");
  ...
  script_tag(name:"affected", value:"Webmin version 1.983 and prior.");
...
if (version_is_less_equal(version: version, test_version: "1.983")) {
