...
if (description)
{
  ...
  script_name("Squid Security Update Advisory (SQUID-2020:7)");
  ...
  script_tag(name:"affected", value:"Squid versions 2.0 through 2.STABLE9, 3.0 through 3.5.28,
  4.0 through 4.11 and 5.0.1 through 5.0.2.");
