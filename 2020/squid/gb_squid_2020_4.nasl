...
if (description)
{
  ...
  script_name("Squid Security Update Advisory (SQUID-2020:4)");
  ...
  script_tag(name:"affected", value:"Squid versions 2.x, 3.x through 3.5.28, 4.x through 4.10
  and 5.x through 5.0.1.");
