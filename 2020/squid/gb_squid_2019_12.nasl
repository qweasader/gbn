...
if (description)
{
  ...
  script_name("Squid Security Update Advisory (SQUID-2019:12)");
  ...
  - CVE-2019-12519: Stack based buffer overflow vulnerability

  - CVE-2019-12521: Heap buffer overflow vulnerability");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Squid versions 3.x through 3.5.28, 4.x through 4.10 and
  5.x through 5.0.1.");
