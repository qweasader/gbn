...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-02-27 19:09:48 +0000 (Thu, 27 Feb 2020)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2020-1901");
  ...
  script_tag(name:"insight", value:"gdImageClone in gd.c in libgd 2.1.0-rc2 through 2.2.5 has a NULL pointer dereference allowing attackers to crash an application via a specific function call sequence. Only affects PHP when linked with an external libgd (not bundled).(CVE-2018-14553)
