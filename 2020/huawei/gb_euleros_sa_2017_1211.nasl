...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2017-1211");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libICE, libXdmcp, libXpm' package(s) announced via the EulerOS-SA-2017-1211 advisory.");
...
It was discovered that libICE used a weak entropy to generate keys. A local attacker could potentially use this flaw for session hijacking using the information available from the process list. (CVE-2017-2626)");
  ...
  script_tag(name:"affected", value:"'libICE, libXdmcp, libXpm' package(s) on Huawei EulerOS V2.0SP1.");
