...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-04-25 15:44:32 +0000 (Tue, 25 Apr 2017)");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2016-1069");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-rhsm, subscription-manager' package(s) announced via the EulerOS-SA-2016-1069 advisory.");
  ...
  script_tag(name:"affected", value:"'python-rhsm, subscription-manager' package(s) on Huawei EulerOS V2.0SP1.");
