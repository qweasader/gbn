...
if (description)
{
  ...
  script_tag(name:"insight", value:"The vulnerability allows remote attackers to inject arbitrary
  JavaScript or HTML via the view/settings-form.php woe_post_type parameter.");

  script_tag(name:"impact", value:"Successful exploitation of this issue may allow an attacker to
  perform unauthorized actions in the user's security context.");
