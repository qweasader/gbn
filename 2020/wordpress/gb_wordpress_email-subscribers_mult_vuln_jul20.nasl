...
if (description)
{
  ...
  attacker to send forged emails by tricking legitimate users into clicking a crafted link or
  disclose potentially sensitive information from the WordPress database.");
