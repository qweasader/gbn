...
if(description)
{
  ...
  allowing for requests to be forged on behalf of an administrator. The find and replace rules could
  be updated with malicious JavaScript, allowing for that be executed later in the victims browser.");

  script_tag(name:"impact", value:"Successful exploitation would allow an attacker to
  perform actions in the context of an administrator.");

  script_tag(name:"affected", value:"WordPress Real-Time Find and Replace plugin through version
  4.0.1.");
...
CPE = "cpe:/a:infolific:real-time_find_and_replace";
