...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'LifterLMS' is prone to an unauthenticated
  options import vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability could lead to administrator account creation,
  content injection, website redirection and multiple stored XSS (front-end and back-end).");
