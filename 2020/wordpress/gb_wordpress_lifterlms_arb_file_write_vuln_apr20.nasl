...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'LifterLMS' is prone to an arbitrary file
  write vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability allows an attacker to change their profile name
  to a malicious piece of PHP code.");

  script_tag(name:"impact", value:"Successful exploitation allows an attacker to steal personal
  information, change grades, retrieve tests and test answers beforehand, and also forge certificates
  by remotely executing arbitrary PHP code.");
