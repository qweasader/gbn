...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'TC Custom JavaScript' is prone to a
  cross-site scripting (XSS) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"An attacker could send a POST request to any location on a
  vulnerable site with the tccj-update parameter set to Update and the tccj-content parameter set to
  malicious JavaScript, and this JavaScript would display in the footer of every page on the site.");

  script_tag(name:"impact", value:"Successful exploitation would allow an attacker to redirect
  visitors to malvertising sites or steal payment information. Even worse, it is possible for the
  attacker to detect when an administrator visits the site and send a request on their behalf to
  infect files with a backdoor or possibly create a new, malicious administrator user account leading
  to takeover of the entire site.");
...
CPE = "cpe:/a:tc_custom_javascript_project:tc_custom_javascript";
