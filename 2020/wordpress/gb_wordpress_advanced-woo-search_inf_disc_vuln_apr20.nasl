...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2020-05-01 18:23:00 +0000 (Fri, 01 May 2020)");

  script_cve_id("CVE-2020-12070");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Advanced Woo Search' is prone to an
  information disclosure vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The plugin suffers from a sensitive information disclosure
  vulnerability in every ajax search request via the sql field to includes/class-aws-search.php.");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/41496477-0382-4ea0-b800-c2a1b65187c8");

  exit(0);
}

CPE = "cpe:/a:advanced-woo-search:advanced_woo_search";
