...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2278-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2278-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2278-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/squid3");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squid3' package(s) announced via the DLA-2278-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was found that Squid, a high-performance proxy caching server for web clients, has been affected by multiple security vulnerabilities. Due to incorrect input validation and URL request handling it was possible to bypass access restrictions for restricted HTTP servers and to cause a denial-of-service.

For Debian 9 stretch, these problems have been fixed in version 3.5.23-5+deb9u2.
