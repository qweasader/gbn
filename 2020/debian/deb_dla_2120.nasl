...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-06-30 14:00:39 +0000 (Tue, 30 Jun 2020)");

  script_name("Debian: Security Advisory (DLA-2120-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2120-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2120-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'rake' package(s) announced via the DLA-2120-1 advisory.");
