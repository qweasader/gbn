...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-10-29 20:03:43 +0000 (Thu, 29 Oct 2020)");

  script_name("Debian: Security Advisory (DSA-4610-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4610-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4610-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4610");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/webkit2gtk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'webkit2gtk' package(s) announced via the DSA-4610-1 advisory.");
