...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4623-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4623-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4623-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4623");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/postgresql-11");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-11' package(s) announced via the DSA-4623-1 advisory.");
