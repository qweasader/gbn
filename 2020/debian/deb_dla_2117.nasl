...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-02-27 17:23:01 +0000 (Thu, 27 Feb 2020)");

  script_name("Debian: Security Advisory (DLA-2117-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2117-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2117-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zsh' package(s) announced via the DLA-2117-1 advisory.");
