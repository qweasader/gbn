...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2312-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2312-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2312-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libx11");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libx11' package(s) announced via the DLA-2312-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libx11-6-udeb", ver:"2:1.6.4-3+deb9u2", rls:"DEB9"))) {
    report += res;
  }
