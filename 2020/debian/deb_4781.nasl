...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-11-05 14:49:11 +0000 (Thu, 05 Nov 2020)");

  script_name("Debian: Security Advisory (DSA-4781-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4781-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4781-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4781");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/blueman");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'blueman' package(s) announced via the DSA-4781-1 advisory.");
