...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-08-11 14:40:08 +0000 (Tue, 11 Aug 2020)");

  script_name("Debian: Security Advisory (DSA-4756-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4756-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4756-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lilypond' package(s) announced via the DSA-4756-1 advisory.");
