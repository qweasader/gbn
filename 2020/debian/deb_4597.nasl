...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-09-27 19:37:49 +0000 (Fri, 27 Sep 2019)");

  script_name("Debian: Security Advisory (DSA-4597-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4597-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4597-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4597");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/netty");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'netty' package(s) announced via the DSA-4597-1 advisory.");
