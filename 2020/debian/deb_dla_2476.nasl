...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2476-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2476-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2476-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/brotli");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'brotli' package(s) announced via the DLA-2476-1 advisory.");
