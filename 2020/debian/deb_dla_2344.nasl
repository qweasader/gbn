...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-08-26 01:45:17 +0000 (Wed, 26 Aug 2020)");

  script_name("Debian: Security Advisory (DLA-2344-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2344-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2344-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mongodb");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mongodb' package(s) announced via the DLA-2344-1 advisory.");
