...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-12-04 18:00:42 +0000 (Fri, 04 Dec 2020)");

  script_name("Debian: Security Advisory (DLA-2511-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2511-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2511-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/highlight.js");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'highlight.js' package(s) announced via the DLA-2511-1 advisory.");
