...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-05-01 13:29:45 +0000 (Fri, 01 May 2020)");

  script_name("Debian: Security Advisory (DSA-4763-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4763-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4763-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4763");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/teeworlds");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'teeworlds' package(s) announced via the DSA-4763-1 advisory.");
