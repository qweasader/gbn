...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-05-14 15:35:46 +0000 (Thu, 14 May 2020)");

  script_name("Debian: Security Advisory (DSA-4684-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4684-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4684-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4684");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libreswan");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libreswan' package(s) announced via the DSA-4684-1 advisory.");
