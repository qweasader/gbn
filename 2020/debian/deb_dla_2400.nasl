...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-09-11 02:27:26 +0000 (Fri, 11 Sep 2020)");

  script_name("Debian: Security Advisory (DLA-2400-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2400-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2400-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/activemq");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'activemq' package(s) announced via the DLA-2400-1 advisory.");
