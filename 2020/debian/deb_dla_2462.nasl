...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-12-04 22:28:25 +0000 (Fri, 04 Dec 2020)");

  script_name("Debian: Security Advisory (DLA-2462-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2462-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2462-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/cimg");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cimg' package(s) announced via the DLA-2462-1 advisory.");
