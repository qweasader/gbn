...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-08-26 01:33:19 +0000 (Wed, 26 Aug 2020)");

  script_name("Debian: Security Advisory (DLA-2313-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2313-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2313-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'net-snmp' package(s) announced via the DLA-2313-1 advisory.");
