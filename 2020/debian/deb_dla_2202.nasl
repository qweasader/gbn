...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-05-29 14:09:42 +0000 (Fri, 29 May 2020)");

  script_name("Debian: Security Advisory (DLA-2202-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2202-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2202-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ansible' package(s) announced via the DLA-2202-1 advisory.");
