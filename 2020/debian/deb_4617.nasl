...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-08-12 00:32:13 +0000 (Thu, 12 Aug 2021)");

  script_name("Debian: Security Advisory (DSA-4617-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4617-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4617-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4617");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/qtbase-opensource-src");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qtbase-opensource-src' package(s) announced via the DSA-4617-1 advisory.");
