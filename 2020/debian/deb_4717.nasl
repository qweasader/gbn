...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-05-05 16:30:27 +0000 (Tue, 05 May 2020)");

  script_name("Debian: Security Advisory (DSA-4717-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4717-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4717-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4717");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/php7.0");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php7.0' package(s) announced via the DSA-4717-1 advisory.");
