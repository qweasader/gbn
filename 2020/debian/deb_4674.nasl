...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-05-06 20:51:48 +0000 (Wed, 06 May 2020)");

  script_name("Debian: Security Advisory (DSA-4674-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4674-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4674-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4674");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/roundcube");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'roundcube' package(s) announced via the DSA-4674-1 advisory.");
