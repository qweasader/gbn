...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-07-07 15:35:51 +0000 (Tue, 07 Jul 2020)");

  script_name("Debian: Security Advisory (DLA-2271-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2271-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2271-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'coturn' package(s) announced via the DLA-2271-1 advisory.");
