...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-04-01 20:56:34 +0000 (Wed, 01 Apr 2020)");

  script_name("Debian: Security Advisory (DSA-4648-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4648-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4648-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4648");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libpam-krb5");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libpam-krb5' package(s) announced via the DSA-4648-1 advisory.");
