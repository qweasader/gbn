...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-05-14 16:22:58 +0000 (Thu, 14 May 2020)");

  script_name("Debian: Security Advisory (DLA-2211-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2211-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2211-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'log4net' package(s) announced via the DLA-2211-1 advisory.");
