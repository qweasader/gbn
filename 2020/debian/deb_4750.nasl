...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-04-13 16:15:16 +0000 (Mon, 13 Apr 2020)");

  script_name("Debian: Security Advisory (DSA-4750-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4750-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4750-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4750");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nginx");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nginx' package(s) announced via the DSA-4750-1 advisory.");
