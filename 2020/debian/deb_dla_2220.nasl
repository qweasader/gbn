...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2220-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2220-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2220-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cracklib2' package(s) announced via the DLA-2220-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libcrack2-udeb", ver:"2.9.2-1+deb8u1", rls:"DEB8"))) {
    report += res;
  }
