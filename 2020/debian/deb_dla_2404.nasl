...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-07-22 14:43:43 +0000 (Wed, 22 Jul 2020)");

  script_name("Debian: Security Advisory (DLA-2404-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2404-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2404-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/eclipse-wtp");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'eclipse-wtp' package(s) announced via the DLA-2404-1 advisory.");
