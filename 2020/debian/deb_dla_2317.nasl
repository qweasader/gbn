...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-07-02 19:21:39 +0000 (Thu, 02 Jul 2020)");

  script_name("Debian: Security Advisory (DLA-2317-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2317-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2317-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/pillow");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pillow' package(s) announced via the DLA-2317-1 advisory.");
