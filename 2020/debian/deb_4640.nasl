...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-02 15:59:12 +0000 (Thu, 02 Jan 2020)");

  script_name("Debian: Security Advisory (DSA-4640-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4640-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4640-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4640");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/graphicsmagick");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'graphicsmagick' package(s) announced via the DSA-4640-1 advisory.");
