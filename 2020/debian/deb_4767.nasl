...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-08-12 19:14:28 +0000 (Wed, 12 Aug 2020)");

  script_name("Debian: Security Advisory (DSA-4767-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4767-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4767-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4767");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mediawiki");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DSA-4767-1 advisory.");
