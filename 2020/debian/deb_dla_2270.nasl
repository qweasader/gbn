...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-06-26 13:58:17 +0000 (Fri, 26 Jun 2020)");

  script_name("Debian: Security Advisory (DLA-2270-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2270-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2270-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jackson-databind' package(s) announced via the DLA-2270-1 advisory.");
