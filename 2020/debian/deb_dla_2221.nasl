...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-06-12 15:35:08 +0000 (Fri, 12 Jun 2020)");

  script_name("Debian: Security Advisory (DLA-2221-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2221-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2221-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sqlite3' package(s) announced via the DLA-2221-1 advisory.");
