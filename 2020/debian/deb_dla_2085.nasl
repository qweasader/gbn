...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2085-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2085-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2085-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zlib' package(s) announced via the DLA-2085-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"zlib1g-udeb", ver:"1:1.2.8.dfsg-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
