...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-07-10 19:52:11 +0000 (Wed, 10 Jul 2019)");

  script_name("Debian: Security Advisory (DSA-4753-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4753-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4753-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4753");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mupdf");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mupdf' package(s) announced via the DSA-4753-1 advisory.");
