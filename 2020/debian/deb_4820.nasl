...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-12-08 14:05:21 +0000 (Tue, 08 Dec 2020)");

  script_name("Debian: Security Advisory (DSA-4820-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4820-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4820-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4820");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/horizon");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'horizon' package(s) announced via the DSA-4820-1 advisory.");
