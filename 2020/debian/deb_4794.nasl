...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-10-09 19:06:48 +0000 (Fri, 09 Oct 2020)");

  script_name("Debian: Security Advisory (DSA-4794-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4794-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4794-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4794");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mupdf");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mupdf' package(s) announced via the DSA-4794-1 advisory.");
