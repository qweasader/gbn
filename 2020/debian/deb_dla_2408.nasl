...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2408-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2408-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2408-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DLA-2408-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-l10n-cak", ver:"1:78.3.1-2~deb9u1", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-l10n-ka", ver:"1:78.3.1-2~deb9u1", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-l10n-uz", ver:"1:78.3.1-2~deb9u1", rls:"DEB9"))) {
    report += res;
  }
