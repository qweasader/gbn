...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2472-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2472-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2472-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mutt");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mutt' package(s) announced via the DLA-2472-1 advisory.");
