...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-07-13 00:41:41 +0000 (Mon, 13 Jul 2020)");

  script_name("Debian: Security Advisory (DSA-4718-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4718-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4718-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4718");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'thunderbird' package(s) announced via the DSA-4718-1 advisory.");
