...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4725-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4725-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4725-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4725");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/evolution-data-server");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'evolution-data-server' package(s) announced via the DSA-4725-1 advisory.");
