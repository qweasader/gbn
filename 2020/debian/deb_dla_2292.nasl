...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-08-08 16:04:56 +0000 (Thu, 08 Aug 2019)");

  script_name("Debian: Security Advisory (DLA-2292-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2292-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2292-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/milkytracker");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'milkytracker' package(s) announced via the DLA-2292-1 advisory.");
