...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-03-25 16:45:28 +0000 (Wed, 25 Mar 2020)");

  script_name("Debian: Security Advisory (DLA-2162-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2162-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2162-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php-horde-form' package(s) announced via the DLA-2162-1 advisory.");
