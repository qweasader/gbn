...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-01-15 17:41:29 +0000 (Fri, 15 Jan 2021)");

  script_name("Debian: Security Advisory (DSA-4805-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4805-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4805-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4805");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/trafficserver");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'trafficserver' package(s) announced via the DSA-4805-1 advisory.");
