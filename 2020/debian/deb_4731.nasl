...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-06-30 17:36:16 +0000 (Tue, 30 Jun 2020)");

  script_name("Debian: Security Advisory (DSA-4731-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4731-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4731-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4731");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/redis");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'redis' package(s) announced via the DSA-4731-1 advisory.");
