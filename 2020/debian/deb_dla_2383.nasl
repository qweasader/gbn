...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-07-22 17:59:30 +0000 (Mon, 22 Jul 2019)");

  script_name("Debian: Security Advisory (DLA-2383-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2383-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2383-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nfdump");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nfdump' package(s) announced via the DLA-2383-1 advisory.");
