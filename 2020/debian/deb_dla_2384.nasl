...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2384-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2384-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2384-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/yaws");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'yaws' package(s) announced via the DLA-2384-1 advisory.");
