...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-08-28 16:49:49 +0000 (Fri, 28 Aug 2020)");

  script_name("Debian: Security Advisory (DLA-2331-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2331-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2331-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/postgresql-9.6");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-9.6' package(s) announced via the DLA-2331-1 advisory.");
