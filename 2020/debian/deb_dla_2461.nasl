...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-10-19 13:45:16 +0000 (Mon, 19 Oct 2020)");

  script_name("Debian: Security Advisory (DLA-2461-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2461-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2461-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/zabbix");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zabbix' package(s) announced via the DLA-2461-1 advisory.");
