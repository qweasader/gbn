...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-09-15 14:38:50 +0000 (Tue, 15 Sep 2020)");

  script_name("Debian: Security Advisory (DSA-4773-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4773-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4773-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4773");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/yaws");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'yaws' package(s) announced via the DSA-4773-1 advisory.");
