...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-04 15:56:47 +0000 (Fri, 04 Aug 2017)");

  script_name("Debian: Security Advisory (DLA-2163-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2163-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2163-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tinyproxy' package(s) announced via the DLA-2163-1 advisory.");
