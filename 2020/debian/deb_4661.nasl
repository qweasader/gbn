...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4661-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4661-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4661-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4661");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openssl");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl' package(s) announced via the DSA-4661-1 advisory.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libcrypto1.1-udeb", ver:"1.1.1d-0+deb10u3", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl1.1-udeb", ver:"1.1.1d-0+deb10u3", rls:"DEB10"))) {
    report += res;
  }
