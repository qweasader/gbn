...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-02-07 20:55:55 +0000 (Fri, 07 Feb 2020)");

  script_name("Debian: Security Advisory (DLA-2113-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2113-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2113-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cloud-init' package(s) announced via the DLA-2113-1 advisory.");
