...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2097-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2097-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2097-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ppp' package(s) announced via the DLA-2097-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ppp-udeb", ver:"2.4.6-3.1+deb8u1", rls:"DEB8"))) {
    report += res;
  }
