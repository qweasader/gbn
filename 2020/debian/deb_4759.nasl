...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-09-09 12:58:59 +0000 (Wed, 09 Sep 2020)");

  script_name("Debian: Security Advisory (DSA-4759-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4759-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4759-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4759");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ark");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ark' package(s) announced via the DSA-4759-1 advisory.");
