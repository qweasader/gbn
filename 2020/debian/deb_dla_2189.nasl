...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-05-10 19:17:06 +0000 (Wed, 10 May 2017)");

  script_name("Debian: Security Advisory (DLA-2189-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2189-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2189-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'rzip' package(s) announced via the DLA-2189-1 advisory.");
