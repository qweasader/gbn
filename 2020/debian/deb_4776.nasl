...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4776-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4776-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4776-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4776");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mariadb-10.3");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mariadb-10.3' package(s) announced via the DSA-4776-1 advisory.");
