...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-24 15:11:18 +0000 (Fri, 24 Jan 2020)");

  script_name("Debian: Security Advisory (DSA-4601-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4601-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4601-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4601");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ldm");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ldm' package(s) announced via the DSA-4601-1 advisory.");
