...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2115-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2115-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2115-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'proftpd-dfsg' package(s) announced via the DLA-2115-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that there was a use-after-free vulnerability in in the proftpd-dfsg FTP server.
...
For Debian 8 Jessie, these problems have been fixed in version 1.3.5e+r1.3.5-2+deb8u6.
