...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2228-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2228-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2020/DLA-2228-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'json-c' package(s) announced via the DLA-2228-1 advisory.");
...
For Debian 8 Jessie, this problem has been fixed in version 0.11-4+deb8u1.
