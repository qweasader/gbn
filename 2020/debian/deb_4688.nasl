...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-05-20 14:51:11 +0000 (Wed, 20 May 2020)");

  script_name("Debian: Security Advisory (DSA-4688-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4688-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2020/DSA-4688-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4688");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/dpdk");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dpdk' package(s) announced via the DSA-4688-1 advisory.");
