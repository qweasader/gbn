...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libjson0", ver:"0.9-1ubuntu1.4", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libjson-c2", ver:"0.11-3ubuntu1.2+esm3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libjson0", ver:"0.11-3ubuntu1.2+esm3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
