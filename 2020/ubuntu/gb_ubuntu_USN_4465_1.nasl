...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-09-04 14:59:26 +0000 (Fri, 04 Sep 2020)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-5.3, linux-azure-5.3, linux-gke-5.3, linux-hwe' package(s) announced via the USN-4465-1 advisory.");
...
(CVE-2020-15393)");
  ...
  script_tag(name:"affected", value:"'linux-aws-5.3, linux-azure-5.3, linux-gke-5.3, linux-hwe' package(s) on Ubuntu 18.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.3.0-1033-aws", ver:"5.3.0-1033.35", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.3.0.1033.32", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
