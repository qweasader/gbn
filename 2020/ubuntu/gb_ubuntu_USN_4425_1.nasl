...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-azure, linux-azure-5.4, linux-gcp, linux-hwe-5.4, linux-kvm, linux-oracle, linux-raspi, linux-raspi-5.4, linux-riscv' package(s) announced via the USN-4425-1 advisory.");
...
restrictions and execute arbitrary code in the kernel. (CVE-2020-15780)");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-azure, linux-azure-5.4, linux-gcp, linux-hwe-5.4, linux-kvm, linux-oracle, linux-raspi, linux-raspi-5.4, linux-riscv' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1022-azure", ver:"5.4.0-1022.22~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-edge", ver:"5.4.0.1022.6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1015-raspi", ver:"5.4.0-1015.15", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1022-azure", ver:"5.4.0-1022.22", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.4.0.1022.21", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic", ver:"5.4.0.42.45", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi2", ver:"5.4.0.1015.50", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"5.4.0.1015.50", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-virtual", ver:"5.4.0.42.45", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
