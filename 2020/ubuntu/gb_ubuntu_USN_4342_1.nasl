...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-azure, linux-azure-5.3, linux-gcp, linux-gcp-5.3, linux-gke-5.3, linux-hwe, linux-kvm, linux-oracle, linux-oracle-5.3, linux-raspi2, linux-raspi2-5.3' package(s) announced via the USN-4342-1 advisory.");
...
expose sensitive information. (CVE-2020-9383)");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-azure, linux-azure-5.3, linux-gcp, linux-gcp-5.3, linux-gke-5.3, linux-hwe, linux-kvm, linux-oracle, linux-oracle-5.3, linux-raspi2, linux-raspi2-5.3' package(s) on Ubuntu 18.04, Ubuntu 19.10.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.3.0-1016-oracle", ver:"5.3.0-1016.18~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.3.0-1018-gcp", ver:"5.3.0-1018.19~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.3.0-1020-azure", ver:"5.3.0-1020.21~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.3.0.1020.20", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"5.3.0.1018.17", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"5.3.0.1016.17", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.3.0-1016-oracle", ver:"5.3.0-1016.18", rls:"UBUNTU19.10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"5.3.0.1016.31", rls:"UBUNTU19.10"))) {
    report += res;
  }
