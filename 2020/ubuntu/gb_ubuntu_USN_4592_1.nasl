...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-osp1, linux-raspi2-5.3' package(s) announced via the USN-4592-1 advisory.");
...
possibly execute arbitrary code. (CVE-2020-24490)");
  ...
  script_tag(name:"affected", value:"'linux-oem-osp1, linux-raspi2-5.3' package(s) on Ubuntu 18.04.");
