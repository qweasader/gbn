...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-aws-5.3, linux-azure, linux-azure-5.3, linux-gcp, linux-gcp-5.3, linux-gke-5.3, linux-hwe, linux-kvm, linux-oracle, linux-oracle-5.3, linux-raspi2' package(s) announced via the USN-4369-1 advisory.");
...
arbitrary code. (CVE-2020-12657)");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-aws-5.3, linux-azure, linux-azure-5.3, linux-gcp, linux-gcp-5.3, linux-gke-5.3, linux-hwe, linux-kvm, linux-oracle, linux-oracle-5.3, linux-raspi2' package(s) on Ubuntu 18.04, Ubuntu 19.10.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.3.0-1022-azure", ver:"5.3.0-1022.23~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-edge", ver:"5.3.0.1022.22", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.3.0.1022.22", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU19.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.3.0-1022-azure", ver:"5.3.0-1022.23", rls:"UBUNTU19.10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.3.0.1022.41", rls:"UBUNTU19.10"))) {
    report += res;
  }
