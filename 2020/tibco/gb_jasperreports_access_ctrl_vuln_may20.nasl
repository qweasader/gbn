...
if (description)
{
  ...
  script_tag(name:"summary", value:"TIBCO JasperReports is prone to an access control vulnerability
  in the administrative UI component.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"JasperReports contains a vulnerability that theoretically
  allows an unauthenticated attacker to obtain the permissions of a JasperReports Server
  'superuser' for the affected systems. The attacker can theoretically exploit the vulnerability
  consistently, remotely, and without authenticating.");

  script_tag(name:"impact", value:"An unauthenticated user may obtain JasperReports Server
  'superuser' permission, and further might be able to execute arbitrary code with the system
  account that started the affected component.");
