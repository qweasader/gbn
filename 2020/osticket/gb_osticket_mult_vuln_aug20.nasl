...
if (description)
{
  ...
  - CVE-2020-16193: XSS because include/staff/banrule.inc.php has an unvalidated echo
  $info['notes'] call

  - CVE-2020-24917: XSS via a crafted filename to DraftAjaxAPI::_uploadInlineImage() in
  include/ajax.draft.php

  - CVE-2020-24881: SSRF where an attacker can add malicious file to server or perform port
  scanning");
