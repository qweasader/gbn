...
if(version_is_less(version: version, test_version: "4.4.3.1421")) {
  report = report_fixed_ver(installed_version: version, installed_build: build, fixed_version: "4.4.3.1421", fixed_build: "20200907");
  security_message(port: 0, data: report);
  exit(0);
}

if(version_is_equal(version: version, test_version: "4.4.3.1421") &&
          (!build || version_is_less(version: build, test_version: "20200907"))) {
  report = report_fixed_ver(installed_version: version, installed_build: build, fixed_version: "4.4.3.1421", fixed_build: "20200907");
  security_message(port: 0, data: report);
  exit(0);
}
