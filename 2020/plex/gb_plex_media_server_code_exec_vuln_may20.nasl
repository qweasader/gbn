...
if(description)
{
  ...
  script_tag(name:"insight", value:"Deserialization of untrusted data in Plex Media Server allows a
  remote, authenticated attacker to execute arbitrary Python code.");
