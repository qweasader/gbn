...
if (description)
{
  ...
  script_name("Roundcube Webmail < 1.2.11, 1.3.x < 1.3.14, 1.4.x < 1.4.7 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"An issue was discovered in Roundcube Webmail which allows XSS
  via a crafted HTML e-mail message, as demonstrated by a JavaScript payload in the xmlns (aka XML
