...
if(description)
{
  ...
  script_name("TestLink < 1.9.20 Multiple SQLi Vulnerabilities");
  ...
  script_tag(name:"summary", value:"TestLink is prone to multiple SQL injection (SQLi)
  vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"TestLink is prone to multiple authenticated SQLi vulnerabilities.");
