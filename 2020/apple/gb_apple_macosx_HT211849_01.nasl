...
if(description)
{
  ...
  script_cve_id("CVE-2020-9981", "CVE-2020-9968", "CVE-2020-10013", "CVE-2020-9961",
                "CVE-2020-10011", "CVE-2020-9973");
  ...
  or arbitrary code execution etc.");

  script_tag(name:"affected", value:"Apple Mac OS X versions 10.15.x prior to
  10.15.7, 10.14.x prior to 10.14.6 Security Update 2020-005 Mojave, 10.13.x prior
  to Security Update 2020-005 High Sierra.");
