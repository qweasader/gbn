...
if(description)
{
  ...
  script_name("Pi-hole Web Interface < 4.3.3 RCE Vulnerability");
  ...
  script_tag(name:"insight", value:"The flaw exists because the application does not adequately
  validate input in the MAC address validator before reusing it in a shell command.");

  script_tag(name:"impact", value:"The RCE allows an authenticated user to execute arbitrary
  commands on the underlying server with the privileges of the local user running the service.");
