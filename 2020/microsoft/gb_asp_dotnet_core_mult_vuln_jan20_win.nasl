...
if(description)
{
  ...
  script_name("ASP.NET Core 3.0.x < 3.0.2, 3.1.0 Multiple Vulnerabilities (Jan 2020)");
...
if(vers =~ "^3\.0" && version_is_less(version:vers, test_version:"3.0.2"))
  fix = "3.0.2";

else if(vers =~ "^3\.1" && version_is_less(version:vers, test_version:"3.1.1"))
  fix = "3.1.1";
