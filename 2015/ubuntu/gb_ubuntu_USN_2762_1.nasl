...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-30-generic", ver:"3.19.0-30.34", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-30-generic-lpae", ver:"3.19.0-30.34", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-30-lowlatency", ver:"3.19.0-30.34", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-30-powerpc-e500mc", ver:"3.19.0-30.34", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-30-powerpc-smp", ver:"3.19.0-30.34", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-30-powerpc64-emb", ver:"3.19.0-30.34", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-30-powerpc64-smp", ver:"3.19.0-30.34", rls:"UBUNTU15.04"))) {
    report += res;
  }
