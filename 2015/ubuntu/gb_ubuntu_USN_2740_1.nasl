...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libicu48", ver:"4.8.1.1-3ubuntu0.6", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libicu52", ver:"52.1-3ubuntu0.4", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libicu52", ver:"52.1-8ubuntu0.2", rls:"UBUNTU15.04"))) {
    report += res;
  }
