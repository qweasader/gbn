...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libx11-dev", ver:"2:1.4.99.1-0ubuntu2.3", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libxrender1", ver:"1:0.9.6-2ubuntu0.2", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxrender1", ver:"1:0.9.8-1build0.14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxrender1", ver:"1:0.9.8-1build0.14.10.1", rls:"UBUNTU14.10"))) {
    report += res;
  }
