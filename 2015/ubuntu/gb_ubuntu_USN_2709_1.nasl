...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pollinate", ver:"4.7-0ubuntu1.3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pollinate", ver:"4.11-0ubuntu2.1", rls:"UBUNTU15.04"))) {
    report += res;
  }
