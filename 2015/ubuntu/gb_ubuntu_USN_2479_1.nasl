...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rpm", ver:"4.9.1.1-1ubuntu0.3", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rpm", ver:"4.11.1-3ubuntu0.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rpm", ver:"4.11.2-3ubuntu0.1", rls:"UBUNTU14.10"))) {
    report += res;
  }
