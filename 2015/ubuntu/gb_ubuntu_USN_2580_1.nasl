...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tcpdump", ver:"4.2.1-1ubuntu2.2", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tcpdump", ver:"4.5.1-2ubuntu1.2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tcpdump", ver:"4.6.2-1ubuntu1.2", rls:"UBUNTU14.10"))) {
    report += res;
  }
