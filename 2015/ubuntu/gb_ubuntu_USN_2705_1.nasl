...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-keystoneclient", ver:"1:0.7.1-ubuntu1.2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-keystoneclient", ver:"1:1.2.0-0ubuntu1.1", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-keystonemiddleware", ver:"1.5.0-0ubuntu1.1", rls:"UBUNTU15.04"))) {
    report += res;
  }
