...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unity-settings-daemon", ver:"14.04.0+14.04.20150825-0ubuntu2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unity-settings-daemon", ver:"15.04.1+15.04.20150408-0ubuntu1.2", rls:"UBUNTU15.04"))) {
    report += res;
  }
