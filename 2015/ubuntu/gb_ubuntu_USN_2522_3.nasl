...
if(description)
{
  ...
  script_cve_id("CVE-2013-1569", "CVE-2013-2383", "CVE-2013-2384", "CVE-2013-2419", "CVE-2014-6585", "CVE-2014-6591");
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libicu48", ver:"4.8.1.1-3ubuntu0.5", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
