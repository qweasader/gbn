...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:3.5.7-0ubuntu9", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:4.2.8-0ubuntu3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libreoffice-core", ver:"1:4.4.6~rc3-0ubuntu1", rls:"UBUNTU15.04"))) {
    report += res;
  }
