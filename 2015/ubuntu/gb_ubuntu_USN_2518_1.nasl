...
if(release == "UBUNTU14.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-31-generic", ver:"3.16.0-31.41", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-31-generic-lpae", ver:"3.16.0-31.41", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-31-lowlatency", ver:"3.16.0-31.41", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-31-powerpc-e500mc", ver:"3.16.0-31.41", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-31-powerpc-smp", ver:"3.16.0-31.41", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-31-powerpc64-emb", ver:"3.16.0-31.41", rls:"UBUNTU14.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.16.0-31-powerpc64-smp", ver:"3.16.0-31.41", rls:"UBUNTU14.10"))) {
    report += res;
  }
