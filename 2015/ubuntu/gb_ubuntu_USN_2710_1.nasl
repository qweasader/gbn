...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-server", ver:"1:5.9p1-5ubuntu1.6", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-server", ver:"1:6.6p1-2ubuntu2.2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-server", ver:"1:6.7p1-5ubuntu1.2", rls:"UBUNTU15.04"))) {
    report += res;
  }
