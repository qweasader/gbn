...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-22-generic", ver:"3.19.0-22.22", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-22-generic-lpae", ver:"3.19.0-22.22", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-22-lowlatency", ver:"3.19.0-22.22", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-22-powerpc-e500mc", ver:"3.19.0-22.22", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-22-powerpc-smp", ver:"3.19.0-22.22", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-22-powerpc64-emb", ver:"3.19.0-22.22", rls:"UBUNTU15.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.19.0-22-powerpc64-smp", ver:"3.19.0-22.22", rls:"UBUNTU15.04"))) {
    report += res;
  }
