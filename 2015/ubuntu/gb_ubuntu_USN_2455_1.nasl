...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bsd-mailx", ver:"8.1.2-0.20090911cvs-2ubuntu1.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bsd-mailx", ver:"8.1.2-0.20111106cvs-1ubuntu0.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bsd-mailx", ver:"8.1.2-0.20131005cvs-1ubuntu0.14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bsd-mailx", ver:"8.1.2-0.20131005cvs-1ubuntu0.14.10.1", rls:"UBUNTU14.10"))) {
    report += res;
  }
