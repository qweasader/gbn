...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unattended-upgrades", ver:"0.76ubuntu1.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unattended-upgrades", ver:"0.82.1ubuntu2.3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unattended-upgrades", ver:"0.82.8ubuntu0.3", rls:"UBUNTU14.10"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unattended-upgrades", ver:"0.83.6ubuntu1", rls:"UBUNTU15.04"))) {
    report += res;
  }
