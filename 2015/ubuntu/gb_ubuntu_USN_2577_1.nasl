...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"wpasupplicant", ver:"2.1-0ubuntu1.2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"wpasupplicant", ver:"2.1-0ubuntu4.1", rls:"UBUNTU14.10"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"wpasupplicant", ver:"2.1-0ubuntu7.1", rls:"UBUNTU15.04"))) {
    report += res;
  }
