...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-9.1", ver:"9.1.19-0ubuntu0.12.04", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-9.3", ver:"9.3.10-0ubuntu0.14.04", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-9.4", ver:"9.4.5-0ubuntu0.15.04", rls:"UBUNTU15.04"))) {
    report += res;
  }
