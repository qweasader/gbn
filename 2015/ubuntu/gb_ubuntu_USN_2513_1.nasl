...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2015-01-12 20:46:06 +0000 (Mon, 12 Jan 2015)");
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.2.0-77-generic", ver:"3.2.0-77.112", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.2.0-77-generic-pae", ver:"3.2.0-77.112", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.2.0-77-highbank", ver:"3.2.0-77.112", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.2.0-77-omap", ver:"3.2.0-77.112", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.2.0-77-powerpc-smp", ver:"3.2.0-77.112", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.2.0-77-powerpc64-smp", ver:"3.2.0-77.112", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.2.0-77-virtual", ver:"3.2.0-77.112", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
