...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsqlite3-0", ver:"3.7.9-2ubuntu1.2", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsqlite3-0", ver:"3.8.2-1ubuntu2.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU15.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsqlite3-0", ver:"3.8.7.4-1ubuntu0.1", rls:"UBUNTU15.04"))) {
    report += res;
  }
