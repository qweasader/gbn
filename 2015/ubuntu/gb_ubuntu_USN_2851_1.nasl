...
if(release == "UBUNTU15.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-22-generic", ver:"4.2.0-22.27", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-22-generic-lpae", ver:"4.2.0-22.27", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-22-lowlatency", ver:"4.2.0-22.27", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-22-powerpc-e500mc", ver:"4.2.0-22.27", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-22-powerpc-smp", ver:"4.2.0-22.27", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-22-powerpc64-emb", ver:"4.2.0-22.27", rls:"UBUNTU15.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.2.0-22-powerpc64-smp", ver:"4.2.0-22.27", rls:"UBUNTU15.10"))) {
    report += res;
  }
