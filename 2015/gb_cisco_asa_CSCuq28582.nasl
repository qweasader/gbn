...
if (description)
{
  ...
  script_name("Cisco ASA VPN Failover Command Injection Vulnerability (cisco-sa-20141008-asa)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the VPN code of Cisco ASA Software could
  ...
  script_tag(name:"impact", value:"An authenticated, remote attacker could exploit this
  ...
  script_tag(name:"affected", value:"Cisco ASA version 7.2, 8.2, 8.3, 8.4, 8.6, 9.0, 9.1, 9.2 and
  9.3.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "7.2", test_version_up: "7.2.5.15")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.2(5.15)");
...
if (version_in_range_exclusive(version: version, test_version_lo: "9.2", test_version_up: "9.2.2.6")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "9.2(2.6)");
  security_message(port: 0, data: report);
  exit(0);
}
