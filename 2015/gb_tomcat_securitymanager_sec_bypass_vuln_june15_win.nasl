...
if(description)
{
  ...
  script_name("Apache Tomcat SecurityManager Security Bypass Vulnerability (Jun 2015) - Windows");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/74665");
