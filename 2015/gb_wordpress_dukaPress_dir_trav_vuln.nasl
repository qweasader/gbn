...
if(description)
{
  ...
  script_tag(name:"summary", value:"WordPress DukaPress is prone to a directory traversal vulnerability.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/71294");
