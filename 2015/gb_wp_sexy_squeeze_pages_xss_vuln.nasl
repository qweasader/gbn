...
if(description)
{
  ...
  script_tag(name:"summary", value:"WordPress Sexy Squeeze Pages is prone to a cross-site scripting (XSS) vulnerability.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/71511");
