...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-11-08 11:02:17 +0000 (Sun, 08 Nov 2015)");
  ...
  script_tag(name:"severity_date", value:"2017-08-15 13:54:12 +0000 (Tue, 15 Aug 2017)");

  script_name("Mageia: Security Advisory (MGASA-2015-0418)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2015-0418");
  ...
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=17041");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ntp' package(s) announced via the MGASA-2015-0418 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Yves Younan discovered that NTP incorrectly handled logfile and
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ntp", rpm:"ntp~4.2.6p5~24.3.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntp-client", rpm:"ntp-client~4.2.6p5~24.3.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ntp-doc", rpm:"ntp-doc~4.2.6p5~24.3.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
