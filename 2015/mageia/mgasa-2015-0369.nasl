...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2015-10-15 07:41:37 +0000 (Thu, 15 Oct 2015)");
  ...
  script_name("Mageia: Security Advisory (MGASA-2015-0369)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2015-0369");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'qemu' package(s) announced via the MGASA-2015-0369 advisory.");
...
if(release == "MAGEIA5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"qemu", rpm:"qemu~2.1.3~2.6.mga5", rls:"MAGEIA5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qemu-img", rpm:"qemu-img~2.1.3~2.6.mga5", rls:"MAGEIA5"))) {
    report += res;
  }
