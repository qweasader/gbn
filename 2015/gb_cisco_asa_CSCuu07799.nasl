...
if (description)
{
  ...
  script_version("2022-02-16T07:53:09+0000");
  script_tag(name:"last_modification", value:"2022-02-16 07:53:09 +0000 (Wed, 16 Feb 2022)");
  ...
  script_name("Cisco ASA DNS DoS Vulnerability (cisco-sa-20151021-asa-dns2)");
  ...
  processing of DNS packets. An attacker could exploit this vulnerability by sending a crafted
  request to an affected Cisco ASA device to cause it to generate a DNS request packet. The
  attacker would need to spoof the reply packet with a crafted DNS response.");
  ...
  and 9.4 on Cisco ASA 1000V Cloud Firewall, Cisco ASA 5500 Series Adaptive Security Appliances,
  Cisco ASA 5500-X Series Next-Generation Firewalls, Cisco ASA Services Module for Cisco Catalyst
  6500 Series Switches and Cisco 7600 Series Routers, Cisco Adaptive Security Virtual Appliance
  (ASAv), Cisco FirePOWER 9300 ASA Security Module.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "9.4", test_version_up: "9.4.1.5")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "9.4(1.5)");
  security_message(port: 0, data: report);
  exit(0);
}
