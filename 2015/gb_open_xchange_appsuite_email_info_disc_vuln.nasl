...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-26 14:38:00 +0000 (Fri, 26 Apr 2019)");
  script_tag(name:"creation_date", value:"2015-10-09 15:08:44 +0530 (Fri, 09 Oct 2015)");
  script_tag(name:"qod_type", value:"remote_banner");
  script_name("Open-Xchange (OX) App Suite Email Configuration Information Disclosure Vulnerability");
  ...
  script_tag(name:"affected", value:"Open-Xchange (OX) App Suite version 7.4.2");

  script_tag(name:"solution", value:"Update to version 7.4.2-rev9 or later.");
...
if (version =~ "^7\.4\.2" && version_is_less(version: version, test_version: "7.4.2.9")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.4.2-rev9", install_path: location);
