...
if (description)
{
  ...
  script_name("SolarWinds Network Configuration Manager (NCM) < 7.3.2 Multiple SQLi Vulnerabilities");

  script_category(ACT_GATHER_INFO);

  script_copyright("Copyright (C) 2015 Greenbone AG");
  script_family("Web application abuses");
  script_dependencies("gb_orion_ncm_detect.nasl", "gb_solarwinds_orion_ncm_detect_win.nasl");
  script_mandatory_keys("solarwinds/ncm/detected");

  script_tag(name:"summary", value:"SolarWinds Network Configuration Manager (NCM) is prone to
  ...
  script_tag(name:"affected", value:"SolarWinds NCM version 7.3.1 and prior.");

  script_tag(name:"solution", value:"Update to version 7.3.2 or later.");
...
if (version_is_less(version:version, test_version:"7.3.2")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"7.3.2");
