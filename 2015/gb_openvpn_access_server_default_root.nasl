...
if(description)
{
  ...
  script_name("OpenVPN Access Server Default Credentials (SSH)");
  ...
  script_tag(name:"summary", value:"The remote OpenVPN Access Server is using known default credentials.");
