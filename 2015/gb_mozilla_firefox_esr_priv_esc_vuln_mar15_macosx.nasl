...
if(description)
{
  ...
  script_name("Mozilla Firefox ESR SVG Privilege Escalation Vulnerability (Mar 2015) - Mac OS X");

  script_tag(name:"summary", value:"Mozilla Firefox ESR is prone to a privilege escalation vulnerability.");
