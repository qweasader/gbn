...
if (description)
{
  ...
  script_name("Cisco ASA OSPFv2 DoS Vulnerability (Cisco-SA-20150702-CVE-2015-4239)");
  ...
  script_tag(name:"insight", value:"The vulnerability is due to improper handling of OSPFv2
  packets. An attacker could exploit this vulnerability by sending crafted packets to the affected
  system.");

  script_tag(name:"impact", value:"A successful exploit could cause the system to crash, resulting
  in a DoS condition.");

  script_tag(name:"affected", value:"Cisco ASA version 9.3 and 100.13.");

  script_tag(name:"solution", value:"See the referenced vendor advisory for a solution.");

  script_xref(name:"URL", value:"https://tools.cisco.com/security/center/content/CiscoSecurityAdvisory/Cisco-SA-20150702-CVE-2015-4239");
...
if (version_in_range(version: version, test_version: "100.13", test_version2: "100.13.0.21")) {
