...
if(description)
{
  ...
  script_tag(name:"summary", value:"Plain Black WebGUI is prone to a cross-site scripting (XSS) vulnerability.");
...
General solution options are to upgrade to a newer release, disable respective features, remove the product or replace the product by another one.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/72253");
