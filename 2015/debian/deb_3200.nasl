...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-09-20 19:15:47 +0000 (Wed, 20 Sep 2017)");

  script_name("Debian: Security Advisory (DSA-3200-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3200-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3200-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3200");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'drupal7' package(s) announced via the DSA-3200-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"drupal7", ver:"7.14-2+deb7u9", rls:"DEB7"))) {
    report += res;
  }
