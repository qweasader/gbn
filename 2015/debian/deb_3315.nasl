...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3315-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3315-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3315-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3315");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium-browser' package(s) announced via the DSA-3315-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"chromedriver", ver:"44.0.2403.89-1~deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium", ver:"44.0.2403.89-1~deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium-dbg", ver:"44.0.2403.89-1~deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium-inspector", ver:"44.0.2403.89-1~deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium-l10n", ver:"44.0.2403.89-1~deb8u1", rls:"DEB8"))) {
    report += res;
  }
