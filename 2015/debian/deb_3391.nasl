...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3391-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3391-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3391-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3391");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php-horde' package(s) announced via the DSA-3391-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"php-horde", ver:"5.2.1+debian0-2+deb8u2", rls:"DEB8"))) {
    report += res;
  }
