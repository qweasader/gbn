...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3299-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3299-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3299-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3299");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'stunnel4' package(s) announced via the DSA-3299-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"stunnel4", ver:"3:5.06-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
