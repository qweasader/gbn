...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3130-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3130-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3130-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3130");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lsyncd' package(s) announced via the DSA-3130-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lsyncd", ver:"2.0.7-3+deb7u1", rls:"DEB7"))) {
    report += res;
  }
