...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3322-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3322-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3322-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3322");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby-rack' package(s) announced via the DSA-3322-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"librack-ruby", ver:"1.4.1-2.1+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"librack-ruby1.8", ver:"1.4.1-2.1+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"librack-ruby1.9.1", ver:"1.4.1-2.1+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"1.4.1-2.1+deb7u1", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-rack", ver:"1.5.2-3+deb8u1", rls:"DEB8"))) {
    report += res;
  }
