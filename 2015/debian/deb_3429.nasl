...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3429-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3429-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3429-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3429");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'foomatic-filters' package(s) announced via the DSA-3429-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"foomatic-filters", ver:"4.0.17-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"foomatic-filters", ver:"4.0.17-5+deb8u1", rls:"DEB8"))) {
    report += res;
  }
