...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3386-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3386-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3386-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3386");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unzip' package(s) announced via the DSA-3386-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unzip", ver:"6.0-8+deb7u4", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unzip", ver:"6.0-16+deb8u1", rls:"DEB8"))) {
    report += res;
  }
