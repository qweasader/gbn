...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3421-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3421-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3421-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3421");
  script_xref(name:"URL", value:"http://hmarco.org/bugs/CVE-2015-8370-Grub2-authentication-bypass.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'grub2' package(s) announced via the DSA-3421-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-common", ver:"1.99-27+deb7u3", rls:"DEB7"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-amd64", ver:"1.99-27+deb7u3", rls:"DEB7"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-ia32", ver:"1.99-27+deb7u3", rls:"DEB7"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-emu", ver:"1.99-27+deb7u3", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-firmware-qemu", ver:"1.99-27+deb7u3", rls:"DEB7"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-linuxbios", ver:"1.99-27+deb7u3", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-mount-udeb", ver:"1.99-27+deb7u3", rls:"DEB7"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-rescue-pc", ver:"1.99-27+deb7u3", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-common", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-coreboot-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-amd64-bin", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-amd64-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-arm-bin", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-arm-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-arm64-bin", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-arm64-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-ia32-bin", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-efi-ia32-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-emu-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-ieee1275-bin", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-ieee1275-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-pc-bin", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-pc-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-uboot-bin", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-uboot-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-xen-bin", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-xen-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-xen-host", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"grub-yeeloong-bin", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"grub-yeeloong-dbg", ver:"2.02~beta2-22+deb8u1", rls:"DEB8"))) {
    report += res;
  }
