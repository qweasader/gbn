...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3243-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3243-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3243-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3243");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxml-libxml-perl' package(s) announced via the DSA-3243-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxml-libxml-perl", ver:"2.0001+dfsg-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxml-libxml-perl", ver:"2.0116+dfsg-1+deb8u1", rls:"DEB8"))) {
    report += res;
  }
