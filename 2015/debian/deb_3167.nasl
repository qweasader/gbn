...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3167-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3167-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3167-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3167");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sudo' package(s) announced via the DSA-3167-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sudo", ver:"1.8.5p2-1+nmu2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"sudo-ldap", ver:"1.8.5p2-1+nmu2", rls:"DEB7"))) {
    report += res;
  }
