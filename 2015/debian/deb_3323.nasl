...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3323-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3323-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3323-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3323");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icu' package(s) announced via the DSA-3323-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"icu-doc", ver:"4.8.1.1-12+deb7u3", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libicu-dev", ver:"4.8.1.1-12+deb7u3", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libicu48", ver:"4.8.1.1-12+deb7u3", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libicu48-dbg", ver:"4.8.1.1-12+deb7u3", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"icu-devtools", ver:"52.1-8+deb8u2", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"icu-doc", ver:"52.1-8+deb8u2", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libicu-dev", ver:"52.1-8+deb8u2", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libicu52", ver:"52.1-8+deb8u2", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libicu52-dbg", ver:"52.1-8+deb8u2", rls:"DEB8"))) {
    report += res;
  }
