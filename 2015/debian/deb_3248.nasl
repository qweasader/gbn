...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-04-04 16:57:06 +0000 (Tue, 04 Apr 2017)");

  script_name("Debian: Security Advisory (DSA-3248-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3248-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3248-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3248");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libphp-snoopy' package(s) announced via the DSA-3248-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libphp-snoopy", ver:"2.0.0-1~deb7u1", rls:"DEB7"))) {
    report += res;
  }
