...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3204-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3204-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3204-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3204");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DSA-3204-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-django", ver:"1.4.5-1+deb7u11", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-django-doc", ver:"1.4.5-1+deb7u11", rls:"DEB7"))) {
    report += res;
  }
