...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3307-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3307-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3307-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3307");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pdns-recursor' package(s) announced via the DSA-3307-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pdns-recursor", ver:"3.6.2-2+deb8u2", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"pdns-recursor-dbg", ver:"3.6.2-2+deb8u2", rls:"DEB8"))) {
    report += res;
  }
