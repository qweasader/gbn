...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3230-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3230-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3230-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3230");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'django-markupfield' package(s) announced via the DSA-3230-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-django-markupfield", ver:"1.0.2-2+deb7u1", rls:"DEB7"))) {
    report += res;
  }
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-django-markupfield", ver:"1.2.1-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3-django-markupfield", ver:"1.2.1-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
