...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3373-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3373-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3373-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3373");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'owncloud' package(s) announced via the DSA-3373-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"owncloud", ver:"7.0.4+dfsg-4~deb8u3", rls:"DEB8"))) {
    report += res;
  }
