...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3400-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3400-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3400-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3400");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lxc' package(s) announced via the DSA-3400-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lxc", ver:"1:1.0.6-6+deb8u2", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lxc-dbg", ver:"1:1.0.6-6+deb8u2", rls:"DEB8"))) {
    report += res;
  }
