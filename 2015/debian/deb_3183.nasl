...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3183-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3183-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3183-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3183");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'movabletype-opensource' package(s) announced via the DSA-3183-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"movabletype-opensource", ver:"5.1.4+dfsg-4+deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"movabletype-plugin-core", ver:"5.1.4+dfsg-4+deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"movabletype-plugin-zemanta", ver:"5.1.4+dfsg-4+deb7u2", rls:"DEB7"))) {
    report += res;
  }
