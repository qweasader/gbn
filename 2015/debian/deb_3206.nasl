...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3206-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3206-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3206-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3206");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dulwich' package(s) announced via the DSA-3206-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-dulwich", ver:"0.8.5-2+deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-dulwich-dbg", ver:"0.8.5-2+deb7u2", rls:"DEB7"))) {
    report += res;
  }
