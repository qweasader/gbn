...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3190-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3190-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2015/DSA-3190-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3190");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'putty' package(s) announced via the DSA-3190-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pterm", ver:"0.62-9+deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"putty", ver:"0.62-9+deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"putty-doc", ver:"0.62-9+deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"putty-tools", ver:"0.62-9+deb7u2", rls:"DEB7"))) {
    report += res;
  }
