...
if (description)
{
  ...
  script_name("Cisco ASA GPRS Tunneling Protocol Inspection Engine DoS Vulnerability (cisco-sa-20141008-asa)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the GPRS Tunneling Protocol (GTP) inspection
  engine of Cisco ASA Software could allow an unauthenticated, remote attacker to cause the reload
  of an affected system.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to improper handling of GTP packets
  when sent in a specific sequence. An attacker could exploit this vulnerability by sending crafted
  GTP packets through an affected system.");

  script_tag(name:"impact", value:"An exploit could cause the system to reload, resulting in a DoS
  condition.");

  script_tag(name:"affected", value:"Cisco ASA version 8.2, 8.4, 8.7, 9.0 and 9.1.");
