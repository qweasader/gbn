...
if (description)
{
  ...
  script_name("Cisco ASA Message Authentication Code Vulnerability (Cisco-SA-20150714-CVE-2015-4458)");
  ...
  Cavium Networks cryptographic module. Due to this vulnerability, the message authentication code
  (MAC) on a TLS packet is not being checked. An attacker could exploit this vulnerability by
  intercepting encrypted packets in transit and modifying their contents. Such packets would be
  decrypted by the ASA, but the modification would not be detected.");
