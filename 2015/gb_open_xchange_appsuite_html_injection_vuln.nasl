...
if(description)
{
  ...
  script_name("Open-Xchange (OX) App Suite HTML Injection Vulnerability (Oct 2015)");

  script_tag(name:"summary", value:"Open-Xchange (OX) App Suite is prone to html injection vulnerability.");
  ...
  script_tag(name:"solution", value:"Update to version 7.4.1-rev7 or later.");

  script_tag(name:"solution_type", value:"VendorFix");

  script_xref(name:"URL", value:"http://www.securitytracker.com/id/1029650");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/65013");
...
if (version_in_range(version: version, test_version: "7.4.1", test_version2: "7.4.1.6")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.4.1.7", install_path: location);
