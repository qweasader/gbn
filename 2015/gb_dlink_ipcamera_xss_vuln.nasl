...
CPE = "cpe:/o:d-link:dcs-2103_firmware";
...
if(description)
{
  ...
  script_name("D-Link IP Camera DCS-2103 < 1.20 XSS Vulnerability - Active Check");
  ...
  script_tag(name:"summary", value:"D-Link IP Camera DCS-2103 is prone to a cross-site scripting
  (XSS) vulnerability.");
  ...
  script_tag(name:"affected", value:"D-Link IP camera DCS-2103 firmware prior to version 1.20.");
