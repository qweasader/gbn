...
if(description)
{
  ...
  script_tag(name:"summary", value:"Nexus OSS/Pro is prone to a security bypass vulnerability.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/65956");
...
if(version_in_range(version:version, test_version:"2.4.0", test_version2:"2.7.1")) {
