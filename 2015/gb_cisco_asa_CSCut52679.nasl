...
if (description)
{
  ...
  script_name("Cisco ASA OSPFv2 DoS Vulnerability (Cisco-SA-20150707-CVE-2015-4241)");
  ...
  script_tag(name:"summary", value:"Cisco ASA is prone to a OSPFv2 denial of service (DoS)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to improper handling of OSPFv2
  packets. An unauthenticated attacker could exploit this vulnerability by sending crafted packets
  to the affected system.");

  script_tag(name:"impact", value:"A successful exploit could cause the system to crash, resulting
  in a DoS condition.");

  script_tag(name:"affected", value:"Cisco ASA version 9.3.");
