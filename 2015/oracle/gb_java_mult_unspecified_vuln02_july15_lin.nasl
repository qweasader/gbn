...
if(description)
{
  ...
  script_name("Oracle Java SE JRE Multiple Unspecified Vulnerabilities-02 (Jul 2015) - Linux");
...
if(vers =~ "^(1\.(8|7))")
{
  if(version_in_range(version:vers, test_version:"1.7.0", test_version2:"1.7.0.80")||
