...
if (description)
{
  ...
  script_name("Cisco ASA SQL*NET Inspection Engine DoS Vulnerability (cisco-sa-20141008-asa)");
  ...
  script_tag(name:"summary", value:"A vulnerability in SQL*Net inspection engine code could allow
  an unauthenticated, remote attacker to cause a reload of the affected system.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to improper handling of crafted SQL
  REDIRECT packets by a system running an affected version of Cisco ASA Software with SQL*Net
  inspection enabled. An unauthenticated, remote attacker could exploit this vulnerability by
  sending a crafted sequence of REDIRECT packets through the targeted system.");

  script_tag(name:"impact", value:"A successful exploit could cause the system to reload, resulting
  in a DoS condition.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "7.2", test_version_up: "7.2.5.13")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.2(5.13)");
