...
if(description)
{
  ...
  system information. The CGI scripts info.cgi, discovery.cgi, status_mgr.cgi, widget_api.cgi,
  wizard_mgr.cgi and app_mgr.cgi give detailed information about the settings and versions of the
  system back.");

  script_tag(name:"impact", value:"An unauthenticated attacker can gain information about the system
  and its configuration which will help to customize further attacks.");
