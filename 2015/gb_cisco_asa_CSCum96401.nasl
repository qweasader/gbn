...
if (description)
{
  ...
  script_name("Cisco ASA IKEv2 DoS Vulnerability (cisco-sa-20141008-asa)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the IKEv2 code of Cisco ASA Software could
  allow an unauthenticated, remote attacker to cause the reload of an affected system.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to improper handling of crafted IKEv2
  packets. An attacker could exploit this vulnerability by sending a crafted packet during the
  establishment of an IKEv2 tunnel.");
  ...
  script_tag(name:"affected", value:"Cisco ASA version 8.4, 8.6, 9.0 and 9.1.");
