...
if(description)
{
  ...
  script_name("K7 Total Security Privilege Escalation Vulnerability (Feb 2015) - Windows");

  script_tag(name:"summary", value:"K7 Total Security is prone to a privilege escalation vulnerability.");
