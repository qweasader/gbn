...
if (description)
{
  ...
  script_name("Cisco ASA VPN XML Parser DoS Vulnerability (cisco-sa-20150408-asa)");
  ...
  parser configuration. An attacker could exploit this vulnerability by sending a crafted XML
  message to the affected system. This vulnerability affects Cisco ASA appliances configured for
  Clientless or AnyConnect SSL VPN and AnyConnect IKEv2 VPN. All other VPN configurations are
  unaffected by this vulnerability. An unauthenticated, remote attacker could exploit this
  vulnerability by sending a crafted XML message to a targeted system.");

  script_tag(name:"impact", value:"A successful exploit could cause the WebVPN component on the
  system to crash, resulting in a DoS condition.");

  script_tag(name:"affected", value:"Cisco ASA version 8.4, 8.6, 9.0, 9.1, 9.2 and 9.3.");
