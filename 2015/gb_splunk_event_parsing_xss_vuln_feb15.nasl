...
if(description)
{
  ...
  script_name("Splunk 6.0.x < 6.0.6, 6.1.x < 6.1.4 XSS Vulnerability");
  ...
  via the vector related to event parsing.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to execute
  arbitrary HTML and script code in a user's browser session in the context of an affected site.");

  script_tag(name:"affected", value:"Splunk version 6.0.x prior to 6.0.6 and 6.1.x prior to 6.1.4.");

  script_tag(name:"solution", value:"Update to version 6.0.6, 6.1.4 or later.");
