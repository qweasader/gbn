...
if(description)
{
  ...
  script_tag(name:"summary", value:"Symantec Workspace Streaming Agent is prone to a local privilege escalation vulnerability.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/73925");
