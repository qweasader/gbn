...
if (description)
{
  ...
  script_name("Cisco ASA Clientless SSL VPN Portal Customization Integrity Vulnerability (cisco-sa-20141008-asa)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the Clientless SSL VPN portal customization
  ...
  script_tag(name:"insight", value:"The vulnerability is due to an improper implementation of
  ...
  script_tag(name:"impact", value:"An exploit could allow the attacker to bypass Clientless SSL VPN
  ...
  script_tag(name:"affected", value:"Cisco ASA version 8.2, 8.3, 8.4, 8.6, 9.0, 9.1 and 9.2.");
...
if (version_in_range_exclusive(version: version, test_version_lo: "9.2", test_version_up: "9.2.2.4")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "9.2(2.4)");
  security_message(port: 0, data: report);
  exit(0);
}
