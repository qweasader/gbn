...
if(description)
{
  ...
  script_name("Open-Xchange (OX) App Suite SVG File Cross Site Scripting Vulnerability");
  ...
  script_tag(name:"solution", value:"Update to version 7.2.2-rev31 or 7.4.0-rev27 or 7.4.1-rev17 or later.");

  script_tag(name:"solution_type", value:"VendorFix");

  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/531005");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/65500");
...
if (version_is_less(version: version, test_version: "7.2.2.31"))
  fix = "7.2.2-rev31";

else if (version_in_range(version: version, test_version: "7.4.0", test_version2: "7.4.0.26"))
  fix = "7.4.0-rev27";

else if (version_in_range(version: version, test_version: "7.4.1", test_version2: "7.4.1.16"))
  fix = "7.4.1-rev17";
