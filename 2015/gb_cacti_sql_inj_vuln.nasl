...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/75984");
...
if (version_is_less(version:version, test_version:"0.8.8e")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "0.8.8e");
