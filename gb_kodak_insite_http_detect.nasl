...
# nb: First pattern have been seen on version 8.0.1.102 and 5.0.5
if (("Kodak InSite" >< res && "CSWStyle_PoweredBy" >< res && "kstrLoginPageURL" >< res) ||
    # nb: This pattern was previously used in 2011/gb_kodak_insite_multiple_xss.nasl. As it is exact
    # enough for our purpose it was kept here just to be sure that we're detecting all variants of
    # the software.
    ("InSite" >< res && "PoweredByKodak" >< res)
   ) {
  version = "unknown";
