...
# Runs only on Linux according to:
# https://oxpedia.org/wiki/index.php?title=AppSuite:OX_System_Requirements#Software_Requirements
os_register_and_report( os:"Linux", cpe:"cpe:/o:linux:kernel", port:port, desc:"Open-Xchange (OX) App Suite Detection (HTTP)", runs_key:"unixoide" );
