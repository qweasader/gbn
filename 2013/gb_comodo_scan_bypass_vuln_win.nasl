...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/34737");
  ...
  script_tag(name:"summary", value:"Comodo Internet Security is prone to scan bypass vulnerability.");
