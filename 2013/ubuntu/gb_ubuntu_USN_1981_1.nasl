...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"hplip", ver:"3.10.2-2ubuntu2.4", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"hplip", ver:"3.12.2-1ubuntu3.3", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"hplip", ver:"3.12.6-3ubuntu4.2", rls:"UBUNTU12.10"))) {
    report += res;
  }
