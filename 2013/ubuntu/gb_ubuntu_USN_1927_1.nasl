...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libimobiledevice3", ver:"1.1.4-1ubuntu3.2", rls:"UBUNTU12.10"))) {
    report += res;
  }
...
if(release == "UBUNTU13.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libimobiledevice3", ver:"1.1.4-1ubuntu6.2", rls:"UBUNTU13.04"))) {
    report += res;
  }
