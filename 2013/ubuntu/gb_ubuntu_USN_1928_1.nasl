...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"puppet-common", ver:"2.7.11-1ubuntu2.4", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"puppet-common", ver:"2.7.18-1ubuntu1.3", rls:"UBUNTU12.10"))) {
    report += res;
  }
...
if(release == "UBUNTU13.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"puppet-common", ver:"2.7.18-4ubuntu1.2", rls:"UBUNTU13.04"))) {
    report += res;
  }
