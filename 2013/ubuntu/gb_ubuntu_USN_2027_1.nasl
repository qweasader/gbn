...
if(description)
{
  ...
  script_mandatory_keys("ssh/login/ubuntu_linux", "ssh/login/packages", re:"ssh/login/release=UBUNTU(13\.04|13\.10)");
...
if(release == "UBUNTU13.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libspice-server1", ver:"0.12.2-0nocelt2expubuntu1.2", rls:"UBUNTU13.04"))) {
    report += res;
  }
...
if(release == "UBUNTU13.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libspice-server1", ver:"0.12.4-0nocelt1ubuntu0.1", rls:"UBUNTU13.10"))) {
    report += res;
  }
