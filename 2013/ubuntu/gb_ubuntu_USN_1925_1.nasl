...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"17.0.8+build1-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"17.0.8+build1-0ubuntu0.12.10.1", rls:"UBUNTU12.10"))) {
    report += res;
  }
...
if(release == "UBUNTU13.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"17.0.8+build1-0ubuntu0.13.04.1", rls:"UBUNTU13.04"))) {
    report += res;
  }
