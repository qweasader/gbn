...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"telepathy-gabble", ver:"0.16.0-0ubuntu3.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"telepathy-gabble", ver:"0.16.1-2ubuntu0.1", rls:"UBUNTU12.10"))) {
    report += res;
  }
...
if(release == "UBUNTU13.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"telepathy-gabble", ver:"0.16.5-0ubuntu1.1", rls:"UBUNTU13.04"))) {
    report += res;
  }
