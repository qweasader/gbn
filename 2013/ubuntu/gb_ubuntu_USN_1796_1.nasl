...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-27-generic", ver:"3.5.0-27.46", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-27-highbank", ver:"3.5.0-27.46", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-27-omap", ver:"3.5.0-27.46", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-27-powerpc-smp", ver:"3.5.0-27.46", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-27-powerpc64-smp", ver:"3.5.0-27.46", rls:"UBUNTU12.10"))) {
    report += res;
  }
