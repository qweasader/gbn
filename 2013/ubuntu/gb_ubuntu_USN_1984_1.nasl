...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3.2", ver:"3.2.3-0ubuntu3.5", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3.2-minimal", ver:"3.2.3-0ubuntu3.5", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3.2", ver:"3.2.3-6ubuntu3.4", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3.2-minimal", ver:"3.2.3-6ubuntu3.4", rls:"UBUNTU12.10"))) {
    report += res;
  }
