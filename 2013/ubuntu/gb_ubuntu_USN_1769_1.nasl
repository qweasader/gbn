...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-26-generic", ver:"3.5.0-26.42", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-26-highbank", ver:"3.5.0-26.42", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-26-omap", ver:"3.5.0-26.42", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-26-powerpc-smp", ver:"3.5.0-26.42", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-26-powerpc64-smp", ver:"3.5.0-26.42", rls:"UBUNTU12.10"))) {
    report += res;
  }
