...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-40-generic", ver:"3.5.0-40.62", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-40-highbank", ver:"3.5.0-40.62", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-40-omap", ver:"3.5.0-40.62", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-40-powerpc-smp", ver:"3.5.0-40.62", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-40-powerpc64-smp", ver:"3.5.0-40.62", rls:"UBUNTU12.10"))) {
    report += res;
  }
