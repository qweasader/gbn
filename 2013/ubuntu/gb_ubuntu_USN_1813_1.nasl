...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-28-generic", ver:"3.5.0-28.48", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-28-highbank", ver:"3.5.0-28.48", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-28-omap", ver:"3.5.0-28.48", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-28-powerpc-smp", ver:"3.5.0-28.48", rls:"UBUNTU12.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-3.5.0-28-powerpc64-smp", ver:"3.5.0-28.48", rls:"UBUNTU12.10"))) {
    report += res;
  }
