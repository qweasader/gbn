...
if(description)
{
  ...
  script_tag(name:"summary", value:"OTRS (Open Ticket Request System) is prone to a spoofing
...
if(version_is_less(version:vers, test_version:"2.4.10") ||
  ...
  report = report_fixed_ver(installed_version:vers, fixed_version:"2.4.10/3.0.3");
