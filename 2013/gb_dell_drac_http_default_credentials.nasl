...
if(description)
{
  ...
  script_name("Dell Remote Access Controller Default Credentials (HTTP)");
  ...
  script_tag(name:"summary", value:"The remote Dell Remote Access Controller is using known default
