...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2794-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2794-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/DSA-2794-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2794");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'spip' package(s) announced via the DSA-2794-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"spip", ver:"2.1.1-3squeeze7", rls:"DEB6"))) {
    report += res;
  }
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"spip", ver:"2.1.17-1+deb7u2", rls:"DEB7"))) {
    report += res;
  }
