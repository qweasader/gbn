...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-08-17 15:32:24 +0000 (Tue, 17 Aug 2021)");

  script_name("Debian: Security Advisory (DSA-2733-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2733-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/DSA-2733-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2733");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'otrs2' package(s) announced via the DSA-2733-1 advisory.");
