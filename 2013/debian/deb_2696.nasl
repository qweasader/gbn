...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-02-26 19:34:22 +0000 (Wed, 26 Feb 2020)");

  script_name("Debian: Security Advisory (DSA-2696-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2696-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/DSA-2696-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2696");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'otrs2' package(s) announced via the DSA-2696-1 advisory.");
