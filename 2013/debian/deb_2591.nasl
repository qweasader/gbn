...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2024-02-15 03:19:58 +0000 (Thu, 15 Feb 2024)");

  script_name("Debian: Security Advisory (DSA-2591-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2591-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2591-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2591");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mahara' package(s) announced via the DSA-2591-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mahara", ver:"1.2.6-2+squeeze6", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mahara-apache2", ver:"1.2.6-2+squeeze6", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mahara-mediaplayer", ver:"1.2.6-2+squeeze6", rls:"DEB6"))) {
    report += res;
  }
