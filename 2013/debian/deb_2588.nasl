...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2588-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2588-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2588-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2588");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icedove' package(s) announced via the DSA-2588-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"icedove", ver:"3.0.11-1+squeeze15", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"icedove-dbg", ver:"3.0.11-1+squeeze15", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"icedove-dev", ver:"3.0.11-1+squeeze15", rls:"DEB6"))) {
    report += res;
  }
