...
if(description)
{
  ...
  script_tag(name:"creation_date", value:"2013-01-12 23:00:00 +0000 (Sat, 12 Jan 2013)");
  script_version("2024-02-01T14:37:10+0000");
  script_tag(name:"last_modification", value:"2024-02-01 14:37:10 +0000 (Thu, 01 Feb 2024)");
  script_tag(name:"cvss_base", value:"1.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:H/Au:N/C:N/I:P/A:N");

  script_name("Debian: Security Advisory (DSA-2606-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2606-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/DSA-2606-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2606");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'proftpd-dfsg' package(s) announced via the DSA-2606-1 advisory.");
