...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2781-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2781-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/DSA-2781-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2781");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-crypto' package(s) announced via the DSA-2781-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-crypto", ver:"2.1.0-2+squeeze2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-crypto-dbg", ver:"2.1.0-2+squeeze2", rls:"DEB6"))) {
    report += res;
  }
