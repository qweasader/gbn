...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2710-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2710-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/DSA-2710-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2710");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xml-security-c' package(s) announced via the DSA-2710-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxml-security-c-dev", ver:"1.5.1-3+squeeze2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libxml-security-c15", ver:"1.5.1-3+squeeze2", rls:"DEB6"))) {
    report += res;
  }
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxml-security-c-dev", ver:"1.6.1-5+deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libxml-security-c16", ver:"1.6.1-5+deb7u1", rls:"DEB7"))) {
    report += res;
  }
