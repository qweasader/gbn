...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2826-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2826-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/DSA-2826-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2826");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'denyhosts' package(s) announced via the DSA-2826-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"denyhosts", ver:"2.6-7+deb6u2", rls:"DEB6"))) {
    report += res;
  }
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"denyhosts", ver:"2.6-10+deb7u2", rls:"DEB7"))) {
    report += res;
  }
