...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2393-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2393-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2393-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2393");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bip' package(s) announced via the DSA-2393-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bip", ver:"0.8.2-1squeeze4", rls:"DEB6"))) {
    report += res;
  }
