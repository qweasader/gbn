...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2457-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2457-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2457-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2457");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'iceweasel' package(s) announced via the DSA-2457-1 advisory.");
