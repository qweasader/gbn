...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2711-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2711-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2013/DSA-2711-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2711");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'haproxy' package(s) announced via the DSA-2711-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"haproxy", ver:"1.4.8-1+squeeze1", rls:"DEB6"))) {
    report += res;
  }
