...
message = script_get_preference("Message", id:8);
...
syslog = script_get_preference("Use Syslog", id:5);

if("yes" >< syslog) {

  syslog_tag = script_get_preference("Syslog tag", id:7);
  syslog_priority = script_get_preference("Syslog priority", id:6);
...
filelog = script_get_preference("Use File", id:2);

if("yes" >< filelog) {
  path = script_get_preference("File name /tmp/", id:3);
  append = script_get_preference("Append to File", id:4);
