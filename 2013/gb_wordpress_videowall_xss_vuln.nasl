...
if(description)
{
  ...
  script_name("WordPress Videowall Plugin XSS Vulnerability");

  script_tag(name:"summary", value:"The WordPress plugin 'Videowall' is prone to a cross-site scripting (XSS) vulnerability.");
