...
if(description)
{
  ...
  script_name("Avocent KVM Default Credentials (HTTP)");

  script_category(ACT_ATTACK);
  script_family("Default Accounts");
  script_copyright("Copyright (C) 2013 Greenbone AG");
  script_dependencies("find_service.nasl", "httpver.nasl", "webmirror.nasl", "DDI_Directory_Scanner.nasl", "gb_php_http_detect.nasl", "gb_default_credentials_options.nasl", "global_settings.nasl");
  ...
  script_tag(name:"vuldetect", value:"This check tries to login via HTTP into the remote KVM as Admin.");
  ...
  script_tag(name:"summary", value:"The remote Avocent KVM is using known default credentials.");
