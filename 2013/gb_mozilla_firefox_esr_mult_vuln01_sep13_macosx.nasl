...
if(description)
{
  ...
  script_name("Mozilla Firefox ESR Multiple Vulnerabilities-01 (Sep 2013) - Mac OS X");
...
if(ffVer =~ "^17\." && version_in_range(version:ffVer, test_version:"17.0", test_version2:"17.0.8")) {
