...
if (description)
{
  ...
  script_name("Novell iManager < 2.7 SP 6 patch 1 Multiple Vulnerabilities");
  ...
  - Does not require multiple steps or explicit confirmation for sensitive transactions.");

  script_tag(name:"impact", value:"Successful exploitation may allow remote attackers to perform
  unauthorized actions and gain access to the affected application. Other attacks are also
  possible.");

  script_tag(name:"affected", value:"Novell iManager prior to version 2.7 SP 6 patch 1.");

  script_tag(name:"solution", value:"Apply the patch.");

  script_xref(name:"URL", value:"https://www.novell.com/support/kb/doc.php?id=7010166");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/59042");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/59450");
