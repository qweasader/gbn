...
if(description)
{
  ...
  script_tag(name:"affected", value:"OTRS versions 2.4.x prior to 2.4.15, 3.0.x prior to 3.0.17 and
  3.1.x prior to 3.1.11.");
...
if(version_in_range(version:vers, test_version:"2.4.0", test_version2:"2.4.14") ||
  ...
  report = report_fixed_ver(installed_version:vers, fixed_version:"2.4.15/3.0.17/3.1.11");
