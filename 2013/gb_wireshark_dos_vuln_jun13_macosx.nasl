...
if(description)
{
  ...
  script_name("Wireshark DCP ETSI Dissector DoS Vulnerability (Jun 2013) - Mac OS X");
  script_xref(name:"URL", value:"http://www.securitytracker.com/id/1028648");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/60504");
...
if(version=~ "^1\.(6|8|10)") {
  if(version == "1.10.0" ||
     version_in_range(version:version, test_version:"1.6.0", test_version2:"1.6.15")||
