...
if(description)
{
  ...
  script_tag(name:"insight", value:"An error exists in AgentTicketSearch.pm which fails to restrict
  the ticket ages that are within the scope of a search.");

  script_tag(name:"solution", value:"Update to version 3.0.0-beta7 or later.");

  script_tag(name:"summary", value:"OTRS (Open Ticket Request System) is prone to a denial of
  service (DoS) vulnerability.");

  script_tag(name:"affected", value:"OTRS versions prior to 3.0.0-beta7.");
