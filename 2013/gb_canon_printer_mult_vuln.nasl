...
if(description)
{
  ...
  script_name("Canon Printer Multiple Vulnerabilities (Jun 2013)");
  ...
  script_tag(name:"summary", value:"Multiple Canon printers are prone to multiple vulnerabilities.");
