...
if(description)
{
  ...
  script_name("Sitecom Devices Hardcoded Credentials (Telnet)");
  ...
  the affected device and perform certain administrative actions.");
  ...
  script_tag(name:"summary", value:"The remote Sitecom Device is using known hardcoded credentials.");
