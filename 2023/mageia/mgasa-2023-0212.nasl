...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xonotic, xonotic-data' package(s) announced via the MGASA-2023-0212 advisory.");
...
See referenced release notes for other changes.");
  ...
  script_tag(name:"affected", value:"'xonotic, xonotic-data' package(s) on Mageia 8.");
...
if(release == "MAGEIA8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xonotic-data", rpm:"xonotic-data~0.8.6~1.mga8", rls:"MAGEIA8"))) {
    report += res;
  }
