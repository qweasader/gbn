...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-08-02 17:30:00 +0000 (Wed, 02 Aug 2023)");
  script_tag(name:"creation_date", value:"2023-05-15 14:44:25 +0530 (Mon, 15 May 2023)");
  script_name("Microsoft Office 2019 Multiple RCE Vulnerabilities (May 2023) - Mac OS X");
  ...
  script_tag(name:"insight", value:"Multiple flaws exist due to an insufficient validation of
  user-supplied input in the Microsoft Office and Microsoft Excel.");
  ...
  script_tag(name:"solution", value:"Update to version 16.73 (Build 23051401) or later.");
...
if(vers =~ "^16\.") {
  if(version_in_range(version:vers, test_version:"16.17.0", test_version2:"16.72.3")) {
    report = report_fixed_ver(installed_version:vers, fixed_version:"16.73 (Build 23051401)");
