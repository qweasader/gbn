...
if(description)
{
  ...
  publication in October 2023 and filed as 'Buffer UnderRead in SSL CN Parsing'.");
  ...
  script_xref(name:"URL", value:"https://megamansec.github.io/Squid-Security-Audit/ssl-bufferunderread.html");
