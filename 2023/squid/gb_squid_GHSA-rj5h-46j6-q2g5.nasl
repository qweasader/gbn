...
if(description)
{
  ...
  publication in October 2023 and filed as 'Use-After-Free in TRACE Requests'.");
  ...
  script_xref(name:"URL", value:"https://megamansec.github.io/Squid-Security-Audit/trace-uaf.html");
