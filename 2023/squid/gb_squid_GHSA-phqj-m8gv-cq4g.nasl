...
if(description)
{
  ...
  publication in October 2023 and filed as 'Buffer Overflow in Digest Authentication'.");
  ...
  script_xref(name:"URL", value:"https://megamansec.github.io/Squid-Security-Audit/digest-overflow.html");
