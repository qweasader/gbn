...
if(description)
{
  ...
  publication in October 2023 and filed as '1-Byte Buffer OverRead in RFC 1123 date/time
  Handling'.");
  ...
  script_xref(name:"URL", value:"https://megamansec.github.io/Squid-Security-Audit/datetime-overflow.html");
