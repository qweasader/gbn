...
if(description)
{
  ...
  script_tag(name:"insight", value:"It was discovered that Linux PTP did not properly perform a length check
...
arbitrary code, or cause a denial of service.");
  ...
  script_tag(name:"affected", value:"'linuxptp' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linuxptp", ver:"1.6-1ubuntu0.1~esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
