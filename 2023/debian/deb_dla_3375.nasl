...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-12-10 02:13:52 +0000 (Sat, 10 Dec 2022)");

  script_name("Debian: Security Advisory (DLA-3375-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3375-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3375-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xrdp' package(s) announced via the DLA-3375-1 advisory.");
