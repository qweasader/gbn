...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-02-28 19:28:05 +0000 (Mon, 28 Feb 2022)");

  script_name("Debian: Security Advisory (DLA-3336-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3336-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3336-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'node-url-parse' package(s) announced via the DLA-3336-1 advisory.");
