...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-05-26 02:13:45 +0000 (Fri, 26 May 2023)");

  script_name("Debian: Security Advisory (DSA-5411-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5411-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5411-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gpac' package(s) announced via the DSA-5411-1 advisory.");
