...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-04-28 19:47:02 +0000 (Thu, 28 Apr 2016)");

  script_name("Debian: Security Advisory (DLA-644-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-644-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-644-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libav' package(s) announced via the DLA-644-1 advisory.");
