...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5313-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5313-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5313");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/hsqldb");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'hsqldb' package(s) announced via the DSA-5313-1 advisory.");
