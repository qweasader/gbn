...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-08-26 02:26:38 +0000 (Sat, 26 Aug 2023)");

  script_name("Debian: Security Advisory (DLA-3557-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3557-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3557-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'memcached' package(s) announced via the DLA-3557-1 advisory.");
