...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2024-01-25 21:37:47 +0000 (Thu, 25 Jan 2024)");

  script_name("Debian: Security Advisory (DSA-1996-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1996-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-1996-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1996");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux-2.6' package(s) announced via the DSA-1996-1 advisory.");
