...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-12-13 18:32:14 +0000 (Tue, 13 Dec 2016)");

  script_name("Debian: Security Advisory (DLA-757-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-757-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-757-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'phpmyadmin' package(s) announced via the DLA-757-1 advisory.");
