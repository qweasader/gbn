...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-02-28 20:21:31 +0000 (Tue, 28 Feb 2023)");

  script_name("Debian: Security Advisory (DLA-3423-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3423-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3423-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'epiphany-browser' package(s) announced via the DLA-3423-1 advisory.");
