...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-12-06 17:24:25 +0000 (Fri, 06 Dec 2019)");

  script_name("Debian: Security Advisory (DLA-68-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-68-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/DLA-68-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'fex' package(s) announced via the DLA-68-1 advisory.");
