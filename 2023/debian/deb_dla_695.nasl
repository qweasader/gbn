...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-01-19 15:30:14 +0000 (Thu, 19 Jan 2017)");

  script_name("Debian: Security Advisory (DLA-695-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-695-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-695-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'spip' package(s) announced via the DLA-695-1 advisory.");
