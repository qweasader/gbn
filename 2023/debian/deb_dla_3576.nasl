...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-10-11 16:12:00 +0000 (Wed, 11 Oct 2023)");

  script_name("Debian: Security Advisory (DLA-3576-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3576-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3576-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gsl");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gsl' package(s) announced via the DLA-3576-1 advisory.");
