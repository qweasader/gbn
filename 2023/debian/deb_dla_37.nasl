...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-37-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-37-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/DLA-37-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'krb5' package(s) announced via the DLA-37-1 advisory.");
