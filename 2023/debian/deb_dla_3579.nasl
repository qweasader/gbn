...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-08-24 21:56:20 +0000 (Thu, 24 Aug 2023)");

  script_name("Debian: Security Advisory (DLA-3579-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3579-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3579-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/elfutils");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'elfutils' package(s) announced via the DLA-3579-1 advisory.");
