...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-10-10 14:54:49 +0000 (Tue, 10 Oct 2017)");

  script_name("Debian: Security Advisory (DLA-297-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-297-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/DLA-297-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wesnoth-1.8' package(s) announced via the DLA-297-1 advisory.");
