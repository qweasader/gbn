...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-08-25 17:15:04 +0000 (Fri, 25 Aug 2023)");

  script_name("Debian: Security Advisory (DLA-3582-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3582-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3582-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ghostscript");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ghostscript' package(s) announced via the DLA-3582-1 advisory.");
