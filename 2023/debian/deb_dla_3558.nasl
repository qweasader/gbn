...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-11-13 15:13:06 +0000 (Mon, 13 Nov 2023)");

  script_name("Debian: Security Advisory (DLA-3558-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3558-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3558-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DLA-3558-1 advisory.");
