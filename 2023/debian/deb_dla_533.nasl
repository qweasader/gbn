...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-07-27 17:53:13 +0000 (Wed, 27 Jul 2016)");

  script_name("Debian: Security Advisory (DLA-533-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-533-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-533-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php5' package(s) announced via the DLA-533-1 advisory.");
