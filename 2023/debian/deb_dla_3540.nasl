...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-04-11 06:24:58 +0000 (Tue, 11 Apr 2023)");

  script_name("Debian: Security Advisory (DLA-3540-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3540-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3540-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mediawiki");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DLA-3540-1 advisory.");
