...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-143-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-143-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/DLA-143-1");
  script_xref(name:"URL", value:"https://www.djangoproject.com/weblog/2015/jan/13/security/");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DLA-143-1 advisory.");
