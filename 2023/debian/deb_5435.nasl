...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-06-21 21:05:39 +0000 (Wed, 21 Jun 2023)");

  script_name("Debian: Security Advisory (DSA-5435-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5435-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5435-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'trafficserver' package(s) announced via the DSA-5435-1 advisory.");
...
For the oldstable distribution (bullseye), these problems have been fixed in version 8.1.7+ds-1~deb11u1.
