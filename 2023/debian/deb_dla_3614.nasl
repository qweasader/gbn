...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3614-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3614-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3614-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/python3.7");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python3.7' package(s) announced via the DLA-3614-1 advisory.");
