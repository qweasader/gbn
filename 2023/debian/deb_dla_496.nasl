...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-03-11 20:11:47 +0000 (Fri, 11 Mar 2016)");

  script_name("Debian: Security Advisory (DLA-496-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-496-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-496-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby-activerecord-3.2' package(s) announced via the DLA-496-1 advisory.");
