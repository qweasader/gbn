...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-10-15 18:15:30 +0000 (Thu, 15 Oct 2020)");

  script_name("Debian: Security Advisory (DLA-678-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-678-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-678-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qemu' package(s) announced via the DLA-678-1 advisory.");
