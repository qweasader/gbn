...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-473-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-473-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-473-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wpa' package(s) announced via the DLA-473-1 advisory.");
