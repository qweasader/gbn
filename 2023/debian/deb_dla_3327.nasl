...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-06-09 14:42:50 +0000 (Wed, 09 Jun 2021)");

  script_name("Debian: Security Advisory (DLA-3327-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3327-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3327-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nss");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nss' package(s) announced via the DLA-3327-1 advisory.");
