...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-731-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-731-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-731-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imagemagick' package(s) announced via the DLA-731-1 advisory.");
...
For Debian 7 Wheezy, these problems have been fixed in version 8:6.7.7.10-5+deb7u8.
