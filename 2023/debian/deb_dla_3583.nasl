...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-09-19 18:53:27 +0000 (Tue, 19 Sep 2023)");

  script_name("Debian: Security Advisory (DLA-3583-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3583-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3583-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/glib2.0");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'glib2.0' package(s) announced via the DLA-3583-1 advisory.");
