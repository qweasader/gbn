...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-477-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-477-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-477-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'librsvg' package(s) announced via the DLA-477-1 advisory.");
