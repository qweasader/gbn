...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-755-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-755-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-755-1");
  script_xref(name:"URL", value:"http://zeroscience.mk/en/vulnerabilities/ZSL-2016-5384.php");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dcmtk' package(s) announced via the DLA-755-1 advisory.");
