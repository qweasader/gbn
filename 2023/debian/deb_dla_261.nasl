...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-25 17:14:06 +0000 (Tue, 25 Jul 2017)");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"aptdaemon", ver:"0.31+bzr413-1.1+deb6u1", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-aptdaemon", ver:"0.31+bzr413-1.1+deb6u1", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-aptdaemon-gtk", ver:"0.31+bzr413-1.1+deb6u1", rls:"DEB6"))) {
    report += res;
  }
