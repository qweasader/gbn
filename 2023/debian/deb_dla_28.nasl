...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-28-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-28-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/DLA-28-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'augeas' package(s) announced via the DLA-28-1 advisory.");
