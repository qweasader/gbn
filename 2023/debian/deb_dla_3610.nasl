...
if(description)
{
  ...
  script_cve_id("CVE-2018-25091", "CVE-2019-11236", "CVE-2019-11324", "CVE-2020-26137", "CVE-2023-43804");
  ...
  script_name("Debian: Security Advisory (DLA-3610-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3610-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3610-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/python-urllib3");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-urllib3' package(s) announced via the DLA-3610-1 advisory.");
