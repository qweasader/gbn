...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5497-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5497-2");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libwebp' package(s) announced via the DSA-5497-2 advisory.");
