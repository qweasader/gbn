...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-599-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-599-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-599-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cracklib2' package(s) announced via the DLA-599-1 advisory.");
