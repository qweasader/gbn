...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-02 20:03:30 +0000 (Thu, 02 Mar 2023)");

  script_name("Debian: Security Advisory (DLA-3343-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3343-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3343-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mono");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mono' package(s) announced via the DLA-3343-1 advisory.");
