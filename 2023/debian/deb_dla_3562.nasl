...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-07-06 18:24:34 +0000 (Thu, 06 Jul 2023)");

  script_name("Debian: Security Advisory (DLA-3562-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3562-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3562-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/orthanc");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'orthanc' package(s) announced via the DLA-3562-1 advisory.");
