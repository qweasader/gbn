...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-07-19 18:30:20 +0000 (Wed, 19 Jul 2023)");

  script_name("Debian: Security Advisory (DLA-3527-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3527-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3527-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/sox");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sox' package(s) announced via the DLA-3527-1 advisory.");
