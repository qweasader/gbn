...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-06-15 19:29:30 +0000 (Fri, 15 Jun 2018)");

  script_name("Debian: Security Advisory (DLA-3522-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3522-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3522-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/hdf5");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'hdf5' package(s) announced via the DLA-3522-1 advisory.");
