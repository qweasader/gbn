...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-04-28 01:05:38 +0000 (Fri, 28 Apr 2023)");

  script_name("Debian: Security Advisory (DLA-3396-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3396-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3396-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'redis' package(s) announced via the DLA-3396-1 advisory.");
