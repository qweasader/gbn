...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5335-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5335-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5335");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openjdk-17");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjdk-17' package(s) announced via the DSA-5335-1 advisory.");
