...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1069-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1069-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1069-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1069");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kernel-source-2.4.18' package(s) announced via the DSA-1069-1 advisory.");
