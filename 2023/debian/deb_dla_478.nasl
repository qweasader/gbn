...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-478-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-478-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-478-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squid3' package(s) announced via the DLA-478-1 advisory.");
