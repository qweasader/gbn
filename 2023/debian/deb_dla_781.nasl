...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-781-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-781-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-781-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'asterisk' package(s) announced via the DLA-781-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Two security vulnerabilities were discovered in Asterisk, an Open Source PBX and telephony toolkit.
...
For Debian 7 Wheezy, these problems have been fixed in version 1:1.8.13.1~dfsg1-3+deb7u5.
