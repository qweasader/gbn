...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-05-02 17:02:42 +0000 (Mon, 02 May 2016)");

  script_name("Debian: Security Advisory (DLA-412-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-412-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-412-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux-2.6' package(s) announced via the DLA-412-1 advisory.");
