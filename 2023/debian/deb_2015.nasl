...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-11-07 19:54:37 +0000 (Thu, 07 Nov 2019)");

  script_name("Debian: Security Advisory (DSA-2015-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2015-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-2015-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2015");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'drbd8, linux-modules-extra-2.6' package(s) announced via the DSA-2015-1 advisory.");
