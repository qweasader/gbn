...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-11-28 19:05:18 +0000 (Tue, 28 Nov 2017)");

  script_name("Debian: Security Advisory (DLA-1168-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1168-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1168-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'graphicsmagick' package(s) announced via the DLA-1168-1 advisory.");
