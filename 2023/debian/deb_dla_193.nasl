...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-193-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-193-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/DLA-193-1");
  script_xref(name:"URL", value:"https://www.eecis.udel.edu/~mills/onwire.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chrony' package(s) announced via the DLA-193-1 advisory.");
