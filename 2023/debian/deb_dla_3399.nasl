...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-28 19:54:34 +0000 (Mon, 28 Nov 2022)");

  script_name("Debian: Security Advisory (DLA-3399-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3399-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3399-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/389-ds-base");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian '389-ds-base' package(s) announced via the DLA-3399-1 advisory.");
