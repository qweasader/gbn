...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-278-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-278-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/DLA-278-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cacti' package(s) announced via the DLA-278-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several SQL injection vulnerabilities were discovered in cacti, a frontend to rrdtool for monitoring systems and service:
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cacti", ver:"0.8.7g-1+squeeze7", rls:"DEB6"))) {
    report += res;
  }
