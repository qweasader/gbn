...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-96-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-96-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/DLA-96-1");
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts/");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjdk-6' package(s) announced via the DLA-96-1 advisory.");
