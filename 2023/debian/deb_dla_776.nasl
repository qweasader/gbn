...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-29 21:00:08 +0000 (Tue, 29 Jan 2019)");

  script_name("Debian: Security Advisory (DLA-776-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-776-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-776-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'samba' package(s) announced via the DLA-776-1 advisory.");
