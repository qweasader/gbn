...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-10-24 16:52:20 +0000 (Tue, 24 Oct 2023)");

  script_name("Debian: Security Advisory (DLA-3618-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3618-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3618-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/node-babel");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'node-babel' package(s) announced via the DLA-3618-1 advisory.");
