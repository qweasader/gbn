...
if(description)
{
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5399-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5399-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'odoo' package(s) announced via the DSA-5399-1 advisory.");
