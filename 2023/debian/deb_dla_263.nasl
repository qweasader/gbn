...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-263-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-263-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/DLA-263-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby1.9.1' package(s) announced via the DLA-263-1 advisory.");
