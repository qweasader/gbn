...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-13 18:02:37 +0000 (Mon, 13 Mar 2023)");

  script_name("Debian: Security Advisory (DSA-5344-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5344-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5344");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/heimdal");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'heimdal' package(s) announced via the DSA-5344-1 advisory.");
