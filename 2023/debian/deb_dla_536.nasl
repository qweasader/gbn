...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-536-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-536-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-536-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wget' package(s) announced via the DLA-536-1 advisory.");
