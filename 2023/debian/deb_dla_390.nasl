...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-390-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-390-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-390-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dbconfig-common' package(s) announced via the DLA-390-1 advisory.");
