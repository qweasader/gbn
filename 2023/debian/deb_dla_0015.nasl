...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2014-07-09 18:25:43 +0000 (Wed, 09 Jul 2014)");

  script_name("Debian: Security Advisory (DLA-0015-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-0015-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/DLA-0015-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux-2.6' package(s) announced via the DLA-0015-1 advisory.");
