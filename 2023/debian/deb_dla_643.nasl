...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-01-11 02:54:46 +0000 (Wed, 11 Jan 2017)");

  script_name("Debian: Security Advisory (DLA-643-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-643-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-643-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chicken' package(s) announced via the DLA-643-1 advisory.");
