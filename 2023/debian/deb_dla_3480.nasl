...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-06-12 16:32:16 +0000 (Mon, 12 Jun 2023)");

  script_name("Debian: Security Advisory (DLA-3480-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3480-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3480-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ruby-redcloth");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby-redcloth' package(s) announced via the DLA-3480-1 advisory.");
