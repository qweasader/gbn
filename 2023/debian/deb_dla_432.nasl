...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-03-09 15:19:41 +0000 (Wed, 09 Mar 2016)");

  script_name("Debian: Security Advisory (DLA-432-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-432-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-432-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-8.4' package(s) announced via the DLA-432-1 advisory.");
