...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-09-20 20:20:55 +0000 (Wed, 20 Sep 2023)");

  script_name("Debian: Security Advisory (DLA-3592-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3592-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3592-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/jetty9");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jetty9' package(s) announced via the DLA-3592-1 advisory.");
