...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-15 12:48:04 +0000 (Wed, 15 Mar 2023)");

  script_name("Debian: Security Advisory (DLA-3470-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3470-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3470-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/owslib");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'owslib' package(s) announced via the DLA-3470-1 advisory.");
