...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-10-12 15:45:16 +0000 (Tue, 12 Oct 2021)");

  script_name("Debian: Security Advisory (DLA-3529-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3529-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3529-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/datatables.js");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'datatables.js' package(s) announced via the DLA-3529-1 advisory.");
