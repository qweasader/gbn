...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-12-30 01:45:08 +0000 (Fri, 30 Dec 2022)");

  script_name("Debian: Security Advisory (DLA-3518-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3518-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3518-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openimageio");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openimageio' package(s) announced via the DLA-3518-1 advisory.");
