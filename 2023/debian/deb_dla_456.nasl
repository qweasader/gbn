...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-456-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-456-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-456-1");
  script_xref(name:"URL", value:"https://www.openssl.org/news/secadv/20160503.txt");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl' package(s) announced via the DLA-456-1 advisory.");
