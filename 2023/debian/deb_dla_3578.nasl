...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-09-08 16:49:04 +0000 (Fri, 08 Sep 2023)");

  script_name("Debian: Security Advisory (DLA-3578-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3578-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3578-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/lldpd");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lldpd' package(s) announced via the DLA-3578-1 advisory.");
