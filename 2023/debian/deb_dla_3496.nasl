...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-04-11 06:05:49 +0000 (Tue, 11 Apr 2023)");

  script_name("Debian: Security Advisory (DLA-3496-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3496-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3496-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/lemonldap-ng");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lemonldap-ng' package(s) announced via the DLA-3496-1 advisory.");
