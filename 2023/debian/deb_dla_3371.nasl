...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-09-28 19:32:43 +0000 (Wed, 28 Sep 2022)");

  script_name("Debian: Security Advisory (DLA-3371-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3371-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3371-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/unbound");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unbound' package(s) announced via the DLA-3371-1 advisory.");
