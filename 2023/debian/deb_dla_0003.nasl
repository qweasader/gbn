...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-0003-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-0003-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/DLA-0003-1");
  script_xref(name:"URL", value:"http://www.openssl.org/news/secadv_20140605.txt");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl' package(s) announced via the DLA-0003-1 advisory.");
