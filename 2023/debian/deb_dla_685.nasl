...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxi-dev", ver:"2:1.6.1-1+deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libxi6", ver:"2:1.6.1-1+deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libxi6-dbg", ver:"2:1.6.1-1+deb7u2", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libxi6-udeb", ver:"2:1.6.1-1+deb7u2", rls:"DEB7"))) {
    report += res;
  }
