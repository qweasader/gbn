...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-19 03:50:16 +0000 (Sun, 19 Mar 2023)");

  script_name("Debian: Security Advisory (DLA-3438-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3438-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3438-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kamailio' package(s) announced via the DLA-3438-1 advisory.");
