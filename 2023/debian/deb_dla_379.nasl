...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2015-12-30 16:13:33 +0000 (Wed, 30 Dec 2015)");

  script_name("Debian: Security Advisory (DLA-379-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-379-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-379-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'samba' package(s) announced via the DLA-379-1 advisory.");
