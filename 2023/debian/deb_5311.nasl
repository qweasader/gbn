...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-12-23 20:34:31 +0000 (Fri, 23 Dec 2022)");

  script_name("Debian: Security Advisory (DSA-5311-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5311-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5311");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/trafficserver");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'trafficserver' package(s) announced via the DSA-5311-1 advisory.");
