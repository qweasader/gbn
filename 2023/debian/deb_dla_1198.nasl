...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-10-25 08:26:36 +0000 (Wed, 25 Oct 2017)");

  script_name("Debian: Security Advisory (DLA-1198-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1198-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1198-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libextractor' package(s) announced via the DLA-1198-1 advisory.");
