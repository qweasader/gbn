...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-12-22 14:33:30 +0000 (Thu, 22 Dec 2022)");

  script_name("Debian: Security Advisory (DLA-3334-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3334-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3334-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/sofia-sip");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sofia-sip' package(s) announced via the DLA-3334-1 advisory.");
