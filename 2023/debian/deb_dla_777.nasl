...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-777-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-777-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-777-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libvncserver' package(s) announced via the DLA-777-1 advisory.");
