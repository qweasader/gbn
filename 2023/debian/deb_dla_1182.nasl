...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-11-29 19:34:35 +0000 (Wed, 29 Nov 2017)");

  script_name("Debian: Security Advisory (DLA-1182-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1182-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1182-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ldns' package(s) announced via the DLA-1182-1 advisory.");
