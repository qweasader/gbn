...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-02-05 20:50:45 +0000 (Wed, 05 Feb 2020)");

  script_name("Debian: Security Advisory (DLA-150-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-150-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/DLA-150-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unzip' package(s) announced via the DLA-150-1 advisory.");
