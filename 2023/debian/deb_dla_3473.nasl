...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-06-13 19:09:09 +0000 (Tue, 13 Jun 2023)");

  script_name("Debian: Security Advisory (DLA-3473-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3473-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3473-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/docker-registry");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'docker-registry' package(s) announced via the DLA-3473-1 advisory.");
