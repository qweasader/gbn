...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-12-21 20:37:32 +0000 (Thu, 21 Dec 2017)");

  script_name("Debian: Security Advisory (DLA-774-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-774-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-774-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-common' package(s) announced via the DLA-774-1 advisory.");
