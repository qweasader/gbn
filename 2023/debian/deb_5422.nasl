...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-10-28 19:38:05 +0000 (Fri, 28 Oct 2022)");

  script_name("Debian: Security Advisory (DSA-5422-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5422-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5422-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jupyter-core' package(s) announced via the DSA-5422-1 advisory.");
