...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5363-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5363-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5363-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5363");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/php7.4");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php7.4' package(s) announced via the DSA-5363-1 advisory.");
