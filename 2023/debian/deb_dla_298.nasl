...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-31 20:48:56 +0000 (Fri, 31 Jan 2020)");

  script_name("Debian: Security Advisory (DLA-298-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-298-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/DLA-298-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'roundup' package(s) announced via the DLA-298-1 advisory.");
