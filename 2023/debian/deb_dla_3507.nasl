...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-07-12 18:09:09 +0000 (Wed, 12 Jul 2023)");

  script_name("Debian: Security Advisory (DLA-3507-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3507-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3507-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/pandoc");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pandoc' package(s) announced via the DLA-3507-1 advisory.");
