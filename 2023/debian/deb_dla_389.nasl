...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-389-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-389-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-389-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'giflib' package(s) announced via the DLA-389-1 advisory.");
