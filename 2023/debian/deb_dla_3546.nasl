...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-05-06 16:32:45 +0000 (Wed, 06 May 2020)");

  script_name("Debian: Security Advisory (DLA-3546-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3546-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3546-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'opendmarc' package(s) announced via the DLA-3546-1 advisory.");
