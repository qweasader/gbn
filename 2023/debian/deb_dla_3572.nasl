...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-23 21:18:09 +0000 (Thu, 23 Jan 2020)");

  script_name("Debian: Security Advisory (DLA-3572-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3572-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3572-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libyang");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libyang' package(s) announced via the DLA-3572-1 advisory.");
