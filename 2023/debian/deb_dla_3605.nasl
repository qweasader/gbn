...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-11-01 19:03:00 +0000 (Wed, 01 Nov 2023)");

  script_name("Debian: Security Advisory (DLA-3605-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3605-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3605-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/grub2");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'grub2' package(s) announced via the DLA-3605-1 advisory.");
