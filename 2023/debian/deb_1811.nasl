...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2009-06-09 18:10:00 +0000 (Tue, 09 Jun 2009)");

  script_name("Debian: Security Advisory (DSA-1811-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1811-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1811-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1811");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cups, cupsys' package(s) announced via the DSA-1811-1 advisory.");
