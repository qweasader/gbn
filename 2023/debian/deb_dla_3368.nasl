...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-08-02 13:39:22 +0000 (Tue, 02 Aug 2022)");

  script_name("Debian: Security Advisory (DLA-3368-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3368-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3368-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libreoffice");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libreoffice' package(s) announced via the DLA-3368-1 advisory.");
