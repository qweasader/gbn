...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-118-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-118-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2014/DLA-118-1");
  script_xref(name:"URL", value:"http://lkml.org/lkml/2014/12/13/81");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux-2.6' package(s) announced via the DLA-118-1 advisory.");
