...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-08-19 19:52:17 +0000 (Fri, 19 Aug 2022)");

  script_name("Debian: Security Advisory (DLA-3380-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3380-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3380-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firmware-nonfree");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firmware-nonfree' package(s) announced via the DLA-3380-1 advisory.");
