...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-449-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-449-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2016/DLA-449-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'botan1.10' package(s) announced via the DLA-449-1 advisory.");
