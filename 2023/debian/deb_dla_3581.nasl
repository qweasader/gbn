...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-3581-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-3581-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2023/DLA-3581-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/flac");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'flac' package(s) announced via the DLA-3581-1 advisory.");
