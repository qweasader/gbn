...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-135-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-135-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2015/DLA-135-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ia32-libs, ia32-libs-gtk' package(s) announced via the DLA-135-1 advisory.");
