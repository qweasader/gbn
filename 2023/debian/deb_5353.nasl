...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-06-09 17:52:00 +0000 (Fri, 09 Jun 2023)");

  script_name("Debian: Security Advisory (DSA-5353-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5353-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5353-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5353");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nss");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nss' package(s) announced via the DSA-5353-1 advisory.");
