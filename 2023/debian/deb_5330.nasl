...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5330-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2023/DSA-5330-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5330");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/curl");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'curl' package(s) announced via the DSA-5330-1 advisory.");
