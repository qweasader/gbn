...
if (description)
{
  ...
  script_tag(name:"affected", value:"MariaDB versions prior to 10.3.37, 10.4.x prior to 10.4.27,
  10.5.x prior to 10.5.18, 10.6.x prior to 10.6.11, 10.7.x prior to 10.7.7, 10.8.x prior to 10.8.6,
  10.9.x prior to 10.9.4, 10.10.x prior to 10.10.2 and 10.11.0.");
...
if (version_is_less(version: version, test_version: "10.3.37")) {
