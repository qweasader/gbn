...
if(description)
{
  ...
  script_name("Mozilla Firefox ESR Security Advisories (MFSA2023-26, MFSA2023-31) - Windows");
...
if(version_is_greater_equal(version:vers, test_version:"115.0") &&
  version_is_less(version:vers, test_version:"115.1")) {
