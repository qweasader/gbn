...
if(description)
{
  ...
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:A/AC:H/PR:N/UI:N/S:U/C:N/I:N/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2023-02-02 16:42:00 +0000 (Thu, 02 Feb 2023)");
  ...
  - Add the following to the 'wp-config.php' file of the instance:
    ...
    define('DISABLE_WP_CRON', true)<semicolon>
...
# - An empty body
# We need to have such a strict check because there are site configurations which throws a 200
