...
if (description)
{
  ...
  script_name("WordPress Paid Memberships Pro Plugin < 2.5.6 SQLi Vulnerability");
  ...
  script_tag(name:"insight", value:"An attacker who can access Paid Membership Pro may obtain and/or
  alter the information stored in the database.");
