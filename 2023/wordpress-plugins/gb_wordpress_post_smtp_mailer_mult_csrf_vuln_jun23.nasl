...
if(description)
{
  ...
  script_cve_id("CVE-2023-3178", "CVE-2023-3179");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Post SMTP Mailer/Email Log Plugin < 2.5.7 Multiple CSRF Vulnerabilities");
  ...
  - CVE-2023-3178: The plugin does not have proper CSRF checks in some AJAX actions, which could
  allow attackers to make logged in users with the manage_postman_smtp capability delete arbitrary
  logs via a CSRF attack.

  - CVE-2023-3179: The plugin does not have proper CSRF checks in some AJAX actions, which could
  allow attackers to make logged in users with the manage_postman_smtp capability resend an email
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/5341cb5d-d204-49e1-b013-f8959461995f");
