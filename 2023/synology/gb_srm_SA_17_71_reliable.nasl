...
if(description)
{
  ...
  script_name("Synology Router Manager (SRM) 1.1.x Path Traversal Vulnerability (Synology-SA-17:71) - Remote Known Vulnerable Versions Check");
  ...
  script_tag(name:"affected", value:"SRM version 1.1.x prior to 1.1.5-6542-4.");
