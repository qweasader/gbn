...
if(description)
{
  ...
  script_name("Synology Router Manager (SRM) 1.1.x Command Injection Vulnerability (Synology-SA-17:79)");
  ...
  script_tag(name:"affected", value:"SRM version 1.1.x prior to 1.1.6-6931.");
