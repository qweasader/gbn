...
if(description)
{
  ...
  script_name("Synology Router Manager (SRM) 1.1.x Multiple Vulnerabilities (Synology-SA-18:48) - Remote Known Vulnerable Versions Check");
  ...
  script_tag(name:"affected", value:"SRM version 1.1.x prior to 1.1.7-6941-2.");
