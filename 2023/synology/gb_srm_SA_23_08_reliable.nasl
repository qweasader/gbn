...
if(description)
{
  ...
  script_name("Synology Router Manager (SRM) 1.2.x, 1.3.x Use of Insufficiently Random Values Vulnerability (Synology-SA-23:08) - Remote Known Vulnerable Versions Check");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.114439
