...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.114441");
  ...
  script_name("Synology Router Manager (SRM) 1.2.x < 1.2.5-8227-10, 1.3.x < 1.3.1-9346-7 Security Bypass Vulnerability (Synology-SA-23:10) - Remote Known Vulnerable Versions Check");
...
# nb: This is checked by VT 1.3.6.1.4.1.25623.1.0.170587
