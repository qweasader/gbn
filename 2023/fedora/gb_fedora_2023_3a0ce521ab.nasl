...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2023-3a0ce521ab)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-3a0ce521ab");
  script_xref(name:"URL", value:"https://forum.ansible.com/t/release-announcement-ansible-community-package-9-1-0/2764");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ansible, ansible-core' package(s) announced via the FEDORA-2023-3a0ce521ab advisory.");
...
[link moved to references]");
  ...
  script_tag(name:"affected", value:"'ansible, ansible-core' package(s) on Fedora 39.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ansible-core-doc", rpm:"ansible-core-doc~2.16.2~1.fc39", rls:"FC39"))) {
    report += res;
  }
