...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2023-d5ab1f0b44)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-d5ab1f0b44");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2241496");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2241498");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'composer' package(s) announced via the FEDORA-2023-d5ab1f0b44 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"**Version 2.6.5** - 2023-10-06
