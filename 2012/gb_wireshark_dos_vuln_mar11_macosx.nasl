...
if(description)
{
  ...
  script_name("Wireshark DoS Vulnerability (Mar 2011) - Mac OS X");
...
if(version_in_range(version:version, test_version:"1.4.0", test_version2:"1.4.3")) {
  report = report_fixed_ver(installed_version:version, vulnerable_range:"1.4.0 - 1.4.3", install_path:location);
