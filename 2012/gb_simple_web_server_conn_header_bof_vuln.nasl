...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/54605");
  ...
  script_tag(name:"summary", value:"Simple Web Server is prone to a buffer overflow vulnerability.");
