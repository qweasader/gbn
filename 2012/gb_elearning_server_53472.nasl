...
if(description)
{
  ...
  script_name("eLearning Server 4G Multiple Vulnerabilities (May 2012) - Active Check");
  ...
  script_tag(name:"summary", value:"eLearning Server 4G is prone to a remote file include (RFI) and
...
foreach dir( make_list_unique( "/", http_cgi_dirs( port:port ) ) ) {
  ...
  res = http_get_cache( port:port, item:dir + "/news.php4" );
