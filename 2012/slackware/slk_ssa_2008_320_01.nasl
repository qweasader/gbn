...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2008-320-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2008-320-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2008&m=slackware-security.366240");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnutls' package(s) announced via the SSA:2008-320-01 advisory.");
...
if(release == "SLK12.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"gnutls", ver:"2.6.2-i486-1_slack12.0", rls:"SLK12.0"))) {
    report += res;
  }
...
if(release == "SLK12.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"gnutls", ver:"2.6.2-i486-1_slack12.1", rls:"SLK12.1"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"gnutls", ver:"2.6.2-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }
