...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2007-200-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2007-200-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2007&m=slackware-security.378219");
  script_xref(name:"URL", value:"http://www.mozilla.org/projects/security/known-vulnerabilities.html#firefox");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the SSA:2007-200-01 advisory.");
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"2.0.0.5-i686-1", rls:"SLK11.0"))) {
    report += res;
  }
...
if(release == "SLK12.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"2.0.0.5-i686-1", rls:"SLK12.0"))) {
    report += res;
  }
