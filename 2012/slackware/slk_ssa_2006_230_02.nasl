...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2006-230-02)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2006-230-02");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2006&m=slackware-security.415725");
  script_xref(name:"URL", value:"http://www.php.net");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php' package(s) announced via the SSA:2006-230-02 advisory.");
...
if(release == "SLK10.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"4.4.4-i486-1_slack10.2", rls:"SLK10.2"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"5.1.5-i486-1_slack10.2", rls:"SLK10.2"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"4.4.4-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"5.1.5-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }
