...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2006-307-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2006-307-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2006&m=slackware-security.453339");
  script_xref(name:"URL", value:"http://www.php.net/UPDATE_5_2.txt");
  script_xref(name:"URL", value:"http://www.php.net/releases/5_2_0.php");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php' package(s) announced via the SSA:2006-307-01 advisory.");
...
if(release == "SLK10.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"4.4.4-i486-2_slack10.2", rls:"SLK10.2"))) {
    report += res;
  }
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"4.4.4-i486-4_slack11.0", rls:"SLK11.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"5.2.0-i486-1", rls:"SLK11.0"))) {
    report += res;
  }
