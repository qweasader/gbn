...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2003-259-02)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2003-259-02");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2003&m=slackware-security.392320");
  script_xref(name:"URL", value:"http://www.proftpd.org");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ProFTPD' package(s) announced via the SSA:2003-259-02 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Upgraded ProFTPD packages are available for Slackware 8.1, 9.0 and
...
n/proftpd-1.2.8p-i486-1.tgz: Upgraded to proftpd-1.2.8p (patched).
 This fixes a security problem in ProFTPD. From [link moved to references]:
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'ProFTPD' package(s) on Slackware 8.1, Slackware 9.0, Slackware current.");
...
if(release == "SLK8.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"proftpd", ver:"1.2.8p-i386-1", rls:"SLK8.1"))) {
    report += res;
  }
...
if(release == "SLK9.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"proftpd", ver:"1.2.8p-i386-1", rls:"SLK9.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"proftpd", ver:"1.2.8p-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }
