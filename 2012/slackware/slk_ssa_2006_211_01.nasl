...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2006-211-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2006-211-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2006&m=slackware-security.387994");
  script_xref(name:"URL", value:"http://dev.mysql.com/doc/refman/4.1/en/news-4-1-21.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mysql' package(s) announced via the SSA:2006-211-01 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'mysql' package(s) on Slackware 10.2.");
...
if(release == "SLK10.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mysql", ver:"4.1.21-i486-1_slack10.2", rls:"SLK10.2"))) {
    report += res;
  }
