...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2003-141-04)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2003-141-04");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2003&m=slackware-security.297133");
  script_xref(name:"URL", value:"http://lists.gnupg.org/pipermail/gnupg-announce/2003q2/000268.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'GnuPG' package(s) announced via the SSA:2003-141-04 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'GnuPG' package(s) on Slackware 9.0.");
...
if(release == "SLK9.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"gnupg", ver:"1.2.2-i386-1", rls:"SLK9.0"))) {
    report += res;
  }
