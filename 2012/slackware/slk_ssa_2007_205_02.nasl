...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2007-205-02)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2007-205-02");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2007&m=slackware-security.383257");
  script_xref(name:"URL", value:"http://www.mozilla.org/projects/security/known-vulnerabilities.html#seamonkey");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'seamonkey' package(s) announced via the SSA:2007-205-02 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'seamonkey' package(s) on Slackware 11.0, Slackware 12.0.");
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"seamonkey", ver:"1.1.3-i486-1_slack11.0", rls:"SLK11.0"))) {
    report += res;
  }
...
if(release == "SLK12.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"seamonkey", ver:"1.1.3-i486-1_slack12.0", rls:"SLK12.0"))) {
    report += res;
  }
