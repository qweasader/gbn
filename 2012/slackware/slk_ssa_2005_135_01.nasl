...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2005-135-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2005-135-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2005&m=slackware-security.446088");
  script_xref(name:"URL", value:"http://www.mozilla.org/projects/security/known-vulnerabilities.html#Mozilla");
  script_xref(name:"URL", value:"http://www.mozilla.org/security/announce/mfsa2005-42.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'Mozilla/Firefox' package(s) announced via the SSA:2005-135-01 advisory.");
...
if(release == "SLK10.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla", ver:"1.7.8-i486-1", rls:"SLK10.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-plugins", ver:"1.7.8-noarch-1", rls:"SLK10.0"))) {
    report += res;
  }
...
if(release == "SLK10.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla", ver:"1.7.8-i486-1", rls:"SLK10.1"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-plugins", ver:"1.7.8-noarch-1", rls:"SLK10.1"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"jre-symlink", ver:"1.0.4-noarch-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla", ver:"1.7.8-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"1.0.4-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }
