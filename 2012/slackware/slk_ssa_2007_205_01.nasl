...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2007-205-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2007-205-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2007&m=slackware-security.371349");
  script_xref(name:"URL", value:"http://www.mozilla.org/projects/security/known-vulnerabilities.html#thunderbird");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'thunderbird' package(s) announced via the SSA:2007-205-01 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'thunderbird' package(s) on Slackware 11.0, Slackware 12.0.");
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"2.0.0.5-i686-1", rls:"SLK11.0"))) {
    report += res;
  }
...
if(release == "SLK12.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-thunderbird", ver:"2.0.0.5-i686-1", rls:"SLK12.0"))) {
    report += res;
  }
