...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2009-086-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2009-086-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2009&m=slackware-security.351329");
  script_xref(name:"URL", value:"http://www.mozilla.org/security/known-vulnerabilities/firefox30.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mozilla-firefox' package(s) announced via the SSA:2009-086-01 advisory.");
...
+--------------------------+
patches/packages/mozilla-firefox-3.0.8-i686-1.tgz:
...
if(release == "SLK12.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"3.0.8-i686-1", rls:"SLK12.2"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"3.0.8-i686-1", rls:"SLKcurrent"))) {
    report += res;
  }
