...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2003-337-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2003-337-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2003&m=slackware-security.399741");
  script_xref(name:"URL", value:"http://rsync.samba.org");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'rsync' package(s) announced via the SSA:2003-337-01 advisory.");
...
if(release == "SLK8.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"rsync", ver:"2.5.7-i386-1", rls:"SLK8.1"))) {
    report += res;
  }
...
if(release == "SLK9.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"rsync", ver:"2.5.7-i386-1", rls:"SLK9.0"))) {
    report += res;
  }
...
if(release == "SLK9.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"rsync", ver:"2.5.7-i486-1", rls:"SLK9.1"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"rsync", ver:"2.5.7-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }
