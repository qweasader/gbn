...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2007-213-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2007-213-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2007&m=slackware-security.370381");
  script_xref(name:"URL", value:"http://www.mozilla.org/projects/security/known-vulnerabilities.html#firefox");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the SSA:2007-213-01 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'firefox' package(s) on Slackware 11.0, Slackware 12.0.");
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"2.0.0.6-i686-1", rls:"SLK11.0"))) {
    report += res;
  }
...
if(release == "SLK12.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mozilla-firefox", ver:"2.0.0.6-i686-1", rls:"SLK12.0"))) {
    report += res;
  }
