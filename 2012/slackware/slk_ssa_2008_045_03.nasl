...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2008-045-03)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2008-045-03");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2008&m=slackware-security.335136");
  script_xref(name:"URL", value:"http://bugs.php.net/43010");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php' package(s) announced via the SSA:2008-045-03 advisory.");
...
if(release == "SLK10.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"4.4.8-i486-1_slack10.2", rls:"SLK10.2"))) {
    report += res;
  }
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"php", ver:"4.4.8-i486-1_slack11.0", rls:"SLK11.0"))) {
    report += res;
  }
