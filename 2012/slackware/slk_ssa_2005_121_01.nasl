...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2005-121-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2005-121-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2005&m=slackware-security.453597");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'infozip' package(s) announced via the SSA:2005-121-01 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'infozip' package(s) on Slackware 8.1, Slackware 9.0, Slackware 9.1, Slackware 10.0, Slackware 10.1, Slackware current.");
...
if(release == "SLK10.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"infozip", ver:"5.52-i486-1", rls:"SLK10.0"))) {
    report += res;
  }
...
if(release == "SLK10.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"infozip", ver:"5.52-i486-1", rls:"SLK10.1"))) {
    report += res;
  }
...
if(release == "SLK8.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"infozip", ver:"5.52-i486-1", rls:"SLK8.1"))) {
    report += res;
  }
...
if(release == "SLK9.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"infozip", ver:"5.52-i486-1", rls:"SLK9.0"))) {
    report += res;
  }
...
if(release == "SLK9.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"infozip", ver:"5.52-i486-1", rls:"SLK9.1"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"infozip", ver:"5.52-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }
