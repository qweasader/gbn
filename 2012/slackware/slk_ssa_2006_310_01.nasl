...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2006-310-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2006-310-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2006&m=slackware-security.566955");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind' package(s) announced via the SSA:2006-310-01 advisory.");
...
if(release == "SLK10.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.2.6_P2-i486-1_slack10.0", rls:"SLK10.0"))) {
    report += res;
  }
...
if(release == "SLK10.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.3.2_P2-i486-1_slack10.1", rls:"SLK10.1"))) {
    report += res;
  }
...
if(release == "SLK10.2") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.3.2_P2-i486-1_slack10.2", rls:"SLK10.2"))) {
    report += res;
  }
...
if(release == "SLK11.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.3.2_P2-i486-1_slack11.0", rls:"SLK11.0"))) {
    report += res;
  }
...
if(release == "SLK8.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.2.6_P2-i386-1_slack8.1", rls:"SLK8.1"))) {
    report += res;
  }
...
if(release == "SLK9.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.2.6_P2-i386-1_slack9.0", rls:"SLK9.0"))) {
    report += res;
  }
...
if(release == "SLK9.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"bind", ver:"9.2.6_P2-i486-1_slack9.1", rls:"SLK9.1"))) {
    report += res;
  }
