...
if(description)
{
  ...
  script_name("Slackware: Security Advisory (SSA:2004-026-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2004-026-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2004&m=slackware-security.361158");
  script_xref(name:"URL", value:"http://security.e-matters.de/advisories/012004.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'GAIM' package(s) announced via the SSA:2004-026-01 advisory.");
...
+--------------------------+");
  ...
  script_tag(name:"affected", value:"'GAIM' package(s) on Slackware 9.0, Slackware 9.1, Slackware current.");
...
if(release == "SLK9.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"gaim", ver:"0.75-i386-1", rls:"SLK9.0"))) {
    report += res;
  }
...
if(release == "SLK9.1") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"gaim", ver:"0.75-i486-1", rls:"SLK9.1"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"gaim", ver:"0.75-i486-1", rls:"SLKcurrent"))) {
    report += res;
  }
