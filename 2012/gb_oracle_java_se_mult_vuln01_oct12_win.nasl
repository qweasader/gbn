...
if(description)
{
  ...
  script_name("Oracle Java SE JRE Multiple Unspecified Vulnerabilities - 01 - (Oct 2012) - Windows");
  script_xref(name:"URL", value:"http://secunia.com/advisories/50949/");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/56059");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/56061");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/56081");
