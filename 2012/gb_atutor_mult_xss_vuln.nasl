...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/51423");
  ...
  script_tag(name:"summary", value:"Atutor is prone to multiple cross site scripting vulnerabilities.");
