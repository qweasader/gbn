...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/55160");
  ...
  script_tag(name:"summary", value:"HP iNode Management Center is prone to multiple vulnerabilities.");
