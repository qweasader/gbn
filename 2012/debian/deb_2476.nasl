...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2476-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2476-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2476-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2476");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pidgin-otr' package(s) announced via the DSA-2476-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pidgin-otr", ver:"3.2.0-5+squeeze1", rls:"DEB6"))) {
    report += res;
  }
