...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2415-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2415-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2415-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2415");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libmodplug' package(s) announced via the DSA-2415-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmodplug-dev", ver:"1:0.8.8.1-1+squeeze2", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmodplug1", ver:"1:0.8.8.1-1+squeeze2", rls:"DEB6"))) {
    report += res;
  }
