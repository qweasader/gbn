...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2453-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2453");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gajim", ver:"0.13.4-3+squeeze2", rls:"DEB6"))) {
    report += res;
  }
