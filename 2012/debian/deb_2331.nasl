...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2331-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2331-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2331-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2331");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tor' package(s) announced via the DSA-2331-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tor", ver:"0.2.1.31-1~lenny+1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tor-dbg", ver:"0.2.1.31-1~lenny+1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tor-geoipdb", ver:"0.2.1.31-1~lenny+1", rls:"DEB5"))) {
    report += res;
  }
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tor", ver:"0.2.1.31-1", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tor-dbg", ver:"0.2.1.31-1", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tor-geoipdb", ver:"0.2.1.31-1", rls:"DEB6"))) {
    report += res;
  }
