...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2477-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2477-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2477-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2477");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sympa' package(s) announced via the DSA-2477-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sympa", ver:"6.0.1+dfsg-4+squeeze1", rls:"DEB6"))) {
    report += res;
  }
