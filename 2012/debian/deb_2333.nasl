...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2333-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2333-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2011/DSA-2333-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2333");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'phpldapadmin' package(s) announced via the DSA-2333-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"phpldapadmin", ver:"1.1.0.5-6+lenny2", rls:"DEB5"))) {
    report += res;
  }
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"phpldapadmin", ver:"1.2.0.5-2+squeeze1", rls:"DEB6"))) {
    report += res;
  }
