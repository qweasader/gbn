...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2578-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2578-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2578-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2578");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'rssh' package(s) announced via the DSA-2578-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rssh", ver:"2.3.2-13squeeze3", rls:"DEB6"))) {
    report += res;
  }
