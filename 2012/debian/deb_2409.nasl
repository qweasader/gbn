...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2409-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2409-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2409-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2409");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'devscripts' package(s) announced via the DSA-2409-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"devscripts", ver:"2.10.69+squeeze2", rls:"DEB6"))) {
    report += res;
  }
