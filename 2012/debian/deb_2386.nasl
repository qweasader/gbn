...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2386-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2386-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2386-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2386");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openttd' package(s) announced via the DSA-2386-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openttd", ver:"0.6.2-1+lenny4", rls:"DEB5"))) {
    report += res;
  }
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openttd", ver:"1.0.4-4", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openttd-data", ver:"1.0.4-4", rls:"DEB6"))) {
    report += res;
  }
