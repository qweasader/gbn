...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2485-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2485-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2485-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2485");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imp4' package(s) announced via the DSA-2485-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"imp4", ver:"4.3.7+debian0-2.2", rls:"DEB6"))) {
    report += res;
  }
