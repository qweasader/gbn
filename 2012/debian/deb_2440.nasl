...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2440-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2440-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2012/DSA-2440-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2440");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libtasn1-3' package(s) announced via the DSA-2440-1 advisory.");
...
if(release == "DEB6") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtasn1-3", ver:"2.7-1+squeeze+1", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtasn1-3-bin", ver:"2.7-1+squeeze+1", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtasn1-3-dbg", ver:"2.7-1+squeeze+1", rls:"DEB6"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtasn1-3-dev", ver:"2.7-1+squeeze+1", rls:"DEB6"))) {
    report += res;
  }
