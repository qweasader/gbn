...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xul-ext-ubufox", ver:"0.9.3-0ubuntu0.10.04.3", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xul-ext-webfav", ver:"1.17-0ubuntu3.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xul-ext-ubufox", ver:"0.9.3-0ubuntu0.10.10.3", rls:"UBUNTU10.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xul-ext-webfav", ver:"1.17-0ubuntu4.1", rls:"UBUNTU10.10"))) {
    report += res;
  }
