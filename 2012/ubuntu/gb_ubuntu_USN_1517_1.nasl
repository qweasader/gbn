...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmono-system-web1.0-cil", ver:"2.4.4~svn151842-1ubuntu4.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmono-system-web2.0-cil", ver:"2.4.4~svn151842-1ubuntu4.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU11.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmono-system-web1.0-cil", ver:"2.6.7-5ubuntu3.1", rls:"UBUNTU11.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmono-system-web2.0-cil", ver:"2.6.7-5ubuntu3.1", rls:"UBUNTU11.04"))) {
    report += res;
  }
...
if(release == "UBUNTU11.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmono-system-web2.0-cil", ver:"2.10.5-1ubuntu0.1", rls:"UBUNTU11.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmono-system-web4.0-cil", ver:"2.10.5-1ubuntu0.1", rls:"UBUNTU11.10"))) {
    report += res;
  }
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmono-system-web2.0-cil", ver:"2.10.8.1-1ubuntu2.2", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmono-system-web4.0-cil", ver:"2.10.8.1-1ubuntu2.2", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
