...
if(release == "UBUNTU11.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"liblightdm-gobject-1-0", ver:"1.0.6-0ubuntu1.1", rls:"UBUNTU11.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"liblightdm-qt-1-0", ver:"1.0.6-0ubuntu1.1", rls:"UBUNTU11.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lightdm", ver:"1.0.6-0ubuntu1.1", rls:"UBUNTU11.10"))) {
    report += res;
  }
