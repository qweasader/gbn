...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"puppet-common", ver:"0.25.4-2ubuntu6.6", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"puppet-common", ver:"2.6.1-0ubuntu2.6", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU11.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"puppet-common", ver:"2.6.4-2ubuntu2.8", rls:"UBUNTU11.04"))) {
    report += res;
  }
...
if(release == "UBUNTU11.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"puppet-common", ver:"2.7.1-1ubuntu3.5", rls:"UBUNTU11.10"))) {
    report += res;
  }
