...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xul-ext-ubufox", ver:"2.6-0ubuntu0.10.04.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU11.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xul-ext-ubufox", ver:"2.6-0ubuntu0.11.10.1", rls:"UBUNTU11.10"))) {
    report += res;
  }
...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xul-ext-ubufox", ver:"2.6-0ubuntu0.12.04.1", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU12.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xul-ext-ubufox", ver:"2.6-0ubuntu0.12.10.1", rls:"UBUNTU12.10"))) {
    report += res;
  }
