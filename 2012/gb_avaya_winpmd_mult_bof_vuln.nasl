...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/47947");
  ...
  script_tag(name:"summary", value:"Avaya WinPDM is prone to multiple buffer overflow vulnerabilities.");
