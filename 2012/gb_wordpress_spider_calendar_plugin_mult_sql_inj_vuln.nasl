...
if(description)
{
  ...
  script_name("WordPress Spider Calendar Plugin Multiple SQLi Vulnerabilities");
  ...
  script_tag(name:"summary", value:"WordPress Spider Calendar Plugin is prone to multiple SQL Injection vulnerabilities.");
