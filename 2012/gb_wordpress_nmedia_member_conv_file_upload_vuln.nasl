...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/53790");
  ...
  script_tag(name:"summary", value:"WordPress Nmedia Member Conversation Plugin is prone to file upload vulnerability.");
...
url = dir + "/wp-content/plugins/wordpress-member-private-conversation/doupload.php";
