...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/55764");
  ...
  script_tag(name:"summary", value:"TurboFTP server is prone to a buffer overflow vulnerability.");
