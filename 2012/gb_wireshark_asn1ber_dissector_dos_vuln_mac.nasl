...
if(version_in_range (version:version, test_version:"1.4.0", test_version2:"1.4.2")) {
  report = report_fixed_ver(installed_version:version, vulnerable_range:"1.4.0 - 1.4.2", install_path:location);
