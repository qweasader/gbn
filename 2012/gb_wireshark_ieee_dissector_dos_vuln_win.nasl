...
if(version_in_range(version:version, test_version:"1.6.0", test_version2:"1.6.5")) {
  report = report_fixed_ver(installed_version:version, vulnerable_range:"1.6.0 - 1.6.5", install_path:location);
