...
if(description)
{
  ...
  script_version("2021-10-11T10:02:32+0000");
  script_tag(name:"last_modification", value:"2021-10-11 10:02:32 +0000 (Mon, 11 Oct 2021)");
...
if( crontab ) {
  ...
  set_kb_item( name:"Policy/linux/root_crontab/content", value:crontab );
}
