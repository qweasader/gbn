...
res = http_get_cache(item:string("/system/login"), port:port);

if("Adobe Connect Central Login" >< res && res =~ "Copyright.*Adobe Systems")
{
  ...
  register_product(cpe:cpe, location:string("/system/login"), port:port, service:"www");
