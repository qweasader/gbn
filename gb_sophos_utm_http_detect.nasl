...
if(description)
{
  ...
  script_version("2021-11-29T02:59:24+0000");
  script_tag(name:"last_modification", value:"2021-11-29 02:59:24 +0000 (Mon, 29 Nov 2021)");
...
if ("Sophos UTM" >< res && ('copyright">Powered by UTM Web Protection' >< res || "login to WebAdmin" >< res)) {
  ...
  if (isnull(vers[1])) {
    url = "/help/en_US/Content/UTM1/UTMandAWS/Welcome_Ohelp.htm";
