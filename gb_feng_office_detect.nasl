...
foreach dir( make_list_unique( "/", "/feng_community", "/fengoffice", "/feng", "/office", http_cgi_dirs( port:port ) ) ) {
  ...
  if( res =~ "^HTTP/1\.[01] 200" && egrep( pattern:"Powered by .*Feng Office.* - version ", string:res ) &&
