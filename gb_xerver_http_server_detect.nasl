...
set_kb_item(name:"xerver/http/detected", value:TRUE);

cpe = build_cpe(value:version, exp:"^([0-9.]+)", base:"cpe:/a:xerver:xerver:");
if (!cpe)
  cpe = "cpe:/a:xerver:xerver";

register_product(cpe:cpe, location:"/", port:port, service:"www");

log_message(data:build_detection_report(app:"Xerver", version:version, install:"/", cpe:cpe,
                                        concluded: vers[0]),
            port:port);
