...
if(description)
{
  ...
  script_tag(name:"summary", value:"The /etc/ssh/sshd_config file contains configuration specifications for sshd.
...
if(get_kb_item("Policy/linux/sshd_config/stat/ERROR")){
  ...
  comment = "Unable to retrieve configuration from /etc/ssh/sshd_config";
}else{
