...
if(description)
{
  ...
  script_tag(name:"summary", value:"RekeyLimit specifies the maximum amount of data that may be transmitted
  before the session key is renegotiated, optionally followed a maximum amount of time that may pass
...
}else if(!value = get_kb_item("Policy/linux/sshd_config/rekeylimit")){
  value = "Error";
  compliant = "incomplete";
