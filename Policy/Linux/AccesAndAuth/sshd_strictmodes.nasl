...
if(description)
{
  ...
  script_tag(name:"summary", value:"StrictModes: Specifies whether sshd should check file modes and ownership
  of the user's files and home directory before accepting login. This is normally desirable because
