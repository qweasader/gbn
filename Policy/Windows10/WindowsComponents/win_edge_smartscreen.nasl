...
if(description)
{
  ...
  script_xref(name:"Policy", value:"CIS Microsoft Windows 10 Enterprise (Release 22H2) Benchmark v2.0.0: 18.10.76.3.1 (L1) Ensure 'Configure Windows Defender SmartScreen' is set to 'Enabled'");
