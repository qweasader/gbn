...
if(description)
{
  ...
  script_xref(name:"Policy", value:"CIS Microsoft Windows 11 Enterprise Benchmark v2.0.0: 19.7.7.4 (L2) Ensure 'Turn off all Windows spotlight features' is set to 'Enabled'");
