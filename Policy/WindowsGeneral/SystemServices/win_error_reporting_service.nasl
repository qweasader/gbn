...
if(description)
{
  ...
  script_xref(name:"Policy", value:"CIS Microsoft Windows 11 Enterprise Benchmark v2.0.0: 5.34 (L2) Ensure 'Windows Error Reporting Service (WerSvc)' is set to 'Disabled'");
