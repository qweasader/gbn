...
if(description)
{
  ...
  script_xref(name:"Policy", value:"CIS Microsoft Windows 10 Enterprise (Release 22H2) Benchmark v2.0.0: 5.22 (L2) Ensure 'Remote Desktop Services (TermService)' is set to 'Disabled'");
