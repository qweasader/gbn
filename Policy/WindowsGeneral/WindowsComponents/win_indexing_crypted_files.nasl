...
if(description)
{
  ...
  script_xref(name:"Policy", value:"CIS Microsoft Windows 10 Enterprise (Release 22H2) Benchmark v2.0.0: 18.10.59.5 (L1) Ensure 'Allow indexing of encrypted files' is set to 'Disabled'");
