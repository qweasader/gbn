...
if(description)
{
  ...
  script_dependencies("compliance_tests.nasl", "vrp_ssh_server_status.nasl");
  script_mandatory_keys("Compliance/Launch");
  script_exclude_keys("huawei/vrp/yunshan/detected");

  script_tag(name:"summary", value:"The SSH version 1.0 is considered as insecure and thus should not be used.");
