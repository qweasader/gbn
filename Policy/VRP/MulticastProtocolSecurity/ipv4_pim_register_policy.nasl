...
if(description)
{
  ...
  script_dependencies("compliance_tests.nasl", "vrp_current_configuration_interface.nasl", "vrp_current_configuration_section_include_multicast.nasl", "vrp_current_configuration_pim.nasl");
...
if(get_kb_item("Policy/vrp/installed/ERROR")){
  ...
  if(interfaces =~ "pim\s+sm"){
    # check if 'display current-configuration | section include multicast routing-enable' has errors
