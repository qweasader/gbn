...
if(description)
{
  ...
  script_dependencies("compliance_tests.nasl", "vrp_current_configuration_section_include_multicast_ipv6.nasl", "vrp_current_configuration_pim.nasl");
...
if(get_kb_item("Policy/vrp/installed/ERROR")){
  ...
  # check if 'display current-configuration | section include multicast ipv6 routing-enable' has errors
