...
if( ! get_kb_item( "login/SSH/success" ) || ! sock = ssh_login_or_reuse_connection() ) {
  ...
  } else if( value !~ "cipher-suite-list" ) {
    compliant = "yes";
  } else {
    weak_ciphers = make_list( "tls12_ck_dhe_dss_aes_128_cbc_sha", "tls12_ck_dhe_dss_aes_128_cbc_sha256",
      ...
      "tls12_ck_rsa_aes_128_cbc_sha", "tls12_ck_rsa_aes_128_cbc_sha256", "tls12_ck_rsa_aes_256_cbc_sha",
      "tls12_ck_rsa_aes_256_cbc_sha256", "tls1_ck_dhe_dss_with_aes_128_sha",
      "tls1_ck_dhe_dss_with_aes_256_sha", "tls1_ck_dhe_rsa_with_aes_128_sha",
      "tls1_ck_dhe_rsa_with_aes_256_sha", "tls1_ck_rsa_with_aes_128_sha", "tls1_ck_rsa_with_aes_256_sha" );
    cipher_line = egrep( string:value, pattern:"cipher-suite-list" );
    if( cipher_line ) {
      foreach cipher( weak_ciphers ) {
        if( cipher >< cipher_line )
          compliant = "no";
      }
    }
