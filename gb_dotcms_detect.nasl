...
if (description)
{
  ...
  script_version("2022-05-19T09:04:42+0000");
  script_tag(name:"last_modification", value:"2022-05-19 09:04:42 +0000 (Thu, 19 May 2022)");
...
foreach dir (make_list_unique("/", "/dotcms", "/dotCMS", "/dotAdmin", http_cgi_dirs(port: port))) {
  ...
  foreach url (make_list(dir + "/html/portal/login.jsp", dir + "/application/login/login.html")) {
    ...
    if (found) {
      ...
      set_kb_item(name: "dotCMS/installed", value: TRUE); # nb: This one should be dropped in the future.
