...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/35956");
...
.usk file, an attacker could exploit this vulnerability.");
  ...
  script_tag(name:"summary", value:"UltraPlayer Media Player is prone to a buffer overflow vulnerability.");
