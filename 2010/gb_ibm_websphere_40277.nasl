...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server Long Filename Information Disclosure Vulnerability (May 2010)");
  ...
  script_tag(name:"solution", value:"Update to version 6.0.2.43, 6.1.0.31, 7.0.0.11 or later.");
