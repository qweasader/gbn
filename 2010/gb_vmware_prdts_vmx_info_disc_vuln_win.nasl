...
if(description)
{
  ...
  script_name("VMware Products 'vmware-vmx' Information Disclosure Vulnerability (VMSA-2010-0007) - Windows");
  ...
  script_tag(name:"solution", value:"Apply the updates provided by the vendor.");
