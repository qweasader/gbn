...
if(description)
{
  ...
  script_name("VMware Products Tools RCE Vulnerabilities (VMSA-2010-0007) - Windows");
  script_xref(name:"URL", value:"http://secunia.com/advisories/39198");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/39392");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/39394");
  ...
  script_tag(name:"summary", value:"VMWare products are prone to remote code execution (RCE) vulnerabilities.");
