...
if (description)
{
  ...
  script_name("Xerver <= 4.32 Multiple Vulnerabilities");
  ...
  script_tag(name:"summary", value:"Xerver is prone to multiple vulnerabilities including source
  code disclosure, denial of service, security bypass, and directory traversal issues.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Successfully exploiting these issues may allow an attacker to
  disclose sensitive information, bypass certain security restrictions, perform denial of service
  attacks or execute arbitrary binaries.");

  script_tag(name:"affected", value:"Xerver versions 4.32 and prior.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/42110");
