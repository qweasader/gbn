...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server < 7.0.0.11 Information Disclosure Vulnerability");
  ...
  script_tag(name:"impact", value:"A local authenticated attacker can exploit this issue to gain
  access to sensitive information. This may aid in further attacks.");

  script_tag(name:"affected", value:"IBM WebSphere Application Server version 7.x through
  7.0.0.10.");

  script_tag(name:"solution", value:"Update to version 7.0.0.11 or later.");
