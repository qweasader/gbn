...
if (description)
{
  ...
  script_name("MantisBT < 1.2.3 Multiple HTML Injection Vulnerabilities");

  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/43224");
  ...
  script_tag(name:"summary", value:"MantisBT is prone to multiple HTML-injection vulnerabilities because the
  ...
  script_tag(name:"affected", value:"MantisBT prior to version 1.2.3.");
