...
if(version_in_range(version:version, test_version:"1.2.2", test_version2:"1.2.9")) {
  report = report_fixed_ver(installed_version:version, vulnerable_range:"1.2.2 - 1.2.9", install_path:location);
