...
if(description)
{
  ...
  script_name("Novell eDirectory < 8.8.5 ftf4 DoS Vulnerability");
  ...
  script_tag(name:"affected", value:"Novell eDirectory prior to version 8.8.5 ftf4.");

  script_tag(name:"solution", value:"Update to version 8.8.5 ftf4 or later.");
