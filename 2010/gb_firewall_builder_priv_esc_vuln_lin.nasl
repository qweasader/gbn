...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/36468");
  ...
  script_tag(name:"summary", value:"Firewall Builder is prone to a privilege escalation vulnerability.");
