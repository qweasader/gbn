...
if (description)
{
  ...
  script_name("Llighttpd < 1.4.26 'Slow Request Handling' Remote DoS Vulnerability");
  ...
  script_tag(name:"affected", value:"Lighttpd versions prior to 1.4.26.");

  script_tag(name:"solution", value:"Update to version 1.4.26 or later.");
...
if( version_is_less_equal( version: vers, test_version: "1.4.25" ) ) {
  report = report_fixed_ver( installed_version: vers, fixed_version: "1.4.26" );
