...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns23", ver:"1:9.3.2-2ubuntu1.11", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns36", ver:"1:9.4.2.dfsg.P2-2ubuntu0.5", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns44", ver:"1:9.5.0.dfsg.P2-1ubuntu3.5", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns46", ver:"1:9.5.1.dfsg.P2-1ubuntu0.4", rls:"UBUNTU9.04"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns53", ver:"1:9.6.1.dfsg.P1-3ubuntu0.3", rls:"UBUNTU9.10"))) {
    report += res;
  }
