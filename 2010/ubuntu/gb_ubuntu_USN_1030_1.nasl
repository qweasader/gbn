...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2010-12-02 19:24:00 +0000 (Thu, 02 Dec 2010)");
...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkrb5-3", ver:"1.8.1+dfsg-2ubuntu0.4", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkrb5-3", ver:"1.8.1+dfsg-5ubuntu0.2", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkrb53", ver:"1.4.3-5ubuntu0.12", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkrb53", ver:"1.6.dfsg.3~beta1-2ubuntu1.6", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkrb5-3", ver:"1.7dfsg~beta3-1ubuntu0.7", rls:"UBUNTU9.10"))) {
    report += res;
  }
