...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnss-db", ver:"2.2.3pre1-3ubuntu1.8.04.2", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnss-db", ver:"2.2.3pre1-3ubuntu1.8.10.2", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnss-db", ver:"2.2.3pre1-3ubuntu3.9.04.2", rls:"UBUNTU9.04"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnss-db", ver:"2.2.3pre1-3ubuntu3.9.10.2", rls:"UBUNTU9.10"))) {
    report += res;
  }
