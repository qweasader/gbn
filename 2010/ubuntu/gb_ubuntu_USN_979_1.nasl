...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"okular", ver:"4:4.4.2-0ubuntu1.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"okular", ver:"4:4.2.2-0ubuntu2.1", rls:"UBUNTU9.04"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"okular", ver:"4:4.3.2-0ubuntu1.1", rls:"UBUNTU9.10"))) {
    report += res;
  }
