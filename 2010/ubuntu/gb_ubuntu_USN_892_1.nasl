...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fuse-utils", ver:"2.4.2-0ubuntu3.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fuse-utils", ver:"2.7.2-1ubuntu2.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fuse-utils", ver:"2.7.3-4ubuntu2.1", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fuse-utils", ver:"2.7.4-1.1ubuntu4.0.9.04.1", rls:"UBUNTU9.04"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fuse-utils", ver:"2.7.4-1.1ubuntu4.3", rls:"UBUNTU9.10"))) {
    report += res;
  }
