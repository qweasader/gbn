...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"base-files", ver:"5.0.0ubuntu20.10.04.2", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"base-files", ver:"5.0.0ubuntu7.1", rls:"UBUNTU9.10"))) {
    report += res;
  }
