...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cmake", ver:"2.4.7-1ubuntu0.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cmake", ver:"2.6.0-4ubuntu2.1", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cmake", ver:"2.6.2-1ubuntu1.1", rls:"UBUNTU9.04"))) {
    report += res;
  }
