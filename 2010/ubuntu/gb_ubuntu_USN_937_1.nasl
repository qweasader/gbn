...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"texlive-binaries", ver:"2009-5ubuntu0.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"texlive-base-bin", ver:"2007.dfsg.1-2ubuntu0.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"texlive-base-bin", ver:"2007.dfsg.2-4ubuntu2.1", rls:"UBUNTU9.04"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"texlive-base-bin", ver:"2007.dfsg.2-7ubuntu1.1", rls:"UBUNTU9.10"))) {
    report += res;
  }
