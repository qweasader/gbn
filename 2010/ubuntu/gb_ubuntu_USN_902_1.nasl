...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pidgin", ver:"1:2.4.1-1ubuntu2.9", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pidgin", ver:"1:2.5.2-0ubuntu1.7", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pidgin", ver:"1:2.5.5-1ubuntu8.6", rls:"UBUNTU9.04"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pidgin", ver:"1:2.6.2-1ubuntu7.2", rls:"UBUNTU9.10"))) {
    report += res;
  }
