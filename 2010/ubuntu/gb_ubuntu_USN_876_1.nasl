...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-8.1", ver:"8.1.19-0ubuntu0.6.06", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-8.3", ver:"8.3.9-0ubuntu8.04", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-8.3", ver:"8.3.9-0ubuntu8.10", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-8.3", ver:"8.3.9-0ubuntu9.04", rls:"UBUNTU9.04"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"postgresql-8.4", ver:"8.4.2-0ubuntu9.10", rls:"UBUNTU9.10"))) {
    report += res;
  }
