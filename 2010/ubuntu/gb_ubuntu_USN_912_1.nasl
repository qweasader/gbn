...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libaudiofile0", ver:"0.2.6-6ubuntu1.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libaudiofile0", ver:"0.2.6-7ubuntu1.8.04.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libaudiofile0", ver:"0.2.6-7ubuntu1.8.10.1", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libaudiofile0", ver:"0.2.6-7ubuntu1.9.04.1", rls:"UBUNTU9.04"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libaudiofile0", ver:"0.2.6-7ubuntu2.1", rls:"UBUNTU9.10"))) {
    report += res;
  }
