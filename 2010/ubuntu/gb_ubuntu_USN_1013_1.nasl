...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6", ver:"2.3.11-1ubuntu2.4", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU10.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6", ver:"2.4.2-2ubuntu0.1", rls:"UBUNTU10.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6", ver:"2.1.10-1ubuntu2.10", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6", ver:"2.3.5-1ubuntu4.8.04.6", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6", ver:"2.3.9-5ubuntu0.4", rls:"UBUNTU9.10"))) {
    report += res;
  }
