...
if(release == "UBUNTU10.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openoffice.org-base-core", ver:"1:3.2.0-7ubuntu4.1", rls:"UBUNTU10.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openoffice.org-base-core", ver:"1:2.4.1-1ubuntu2.4", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openoffice.org-base-core", ver:"1:3.0.1-9ubuntu3.3", rls:"UBUNTU9.04"))) {
    report += res;
  }
...
if(release == "UBUNTU9.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openoffice.org-base-core", ver:"1:3.1.1-5ubuntu1.2", rls:"UBUNTU9.10"))) {
    report += res;
  }
