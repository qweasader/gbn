...
if(description)
{
  ...
  script_name("MediaWiki 1.8 - 1.15.4 'api.php' Information Disclosure Vulnerability");
  ...
  script_tag(name:"affected", value:"MediaWiki versions 1.8 through 1.15.4.");

  script_tag(name:"solution", value:"Update to version 1.15.5 or later.");
