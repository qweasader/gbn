...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/43869");
...
on a user's system.");
  ...
  script_tag(name:"summary", value:"FTP Voyager is prone to a directory traversal vulnerability.");
