...
#
# Auto generated from VID b6069837-aadc-11df-82df-0015f2db7bde
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.68001");
...
the client command queue.");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b6069837-aadc-11df-82df-0015f2db7bde.html");
