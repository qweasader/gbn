...
#
# Auto generated from VID 848539dc-0458-11df-8dd7-002170daae37
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66820");
  ...
  script_xref(name:"URL", value:"http://bugs.splitbrain.org/index.php?do=details&task_id=1847");
  script_xref(name:"URL", value:"http://bugs.splitbrain.org/index.php?do=details&task_id=1853");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/848539dc-0458-11df-8dd7-002170daae37.html");
