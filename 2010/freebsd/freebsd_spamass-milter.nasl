...
#
# Auto generated from VID 7132c842-58e2-11df-8d80-0015587e2cc1
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.67391");
  ...
  script_tag(name:"insight", value:"The following package is affected: spamass-milter
...
TO field of an email message.");
  ...
  script_xref(name:"URL", value:"http://archives.neohapsis.com/archives/fulldisclosure/2010-03/0139.html");
  script_xref(name:"URL", value:"http://xforce.iss.net/xforce/xfdb/56732");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/7132c842-58e2-11df-8d80-0015587e2cc1.html");
