...
#
# Auto generated from VID e02e6a4e-6b26-11df-96b2-0015587e2cc1
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.67653");
  ...
  script_xref(name:"URL", value:"http://php-security.org/2010/05/13/mops-2010-023-cacti-graph-viewer-sql-injection-vulnerability/index.html");
  ...
  script_xref(name:"URL", value:"http://www.vupen.com/english/advisories/2010/1204");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/e02e6a4e-6b26-11df-96b2-0015587e2cc1.html");
