...
#
# Auto generated from VID dd943fbb-d0fe-11df-95a8-00219b0fc4d8
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The following package is affected: apr
...
(memory consumption) via unspecified vectors.");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/dd943fbb-d0fe-11df-95a8-00219b0fc4d8.html");
