...
#
# Auto generated from VID 86b8b655-4d1a-11df-83fb-0015587e2cc1
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.67357");
...
with (1) renewal or (2) validation.");
  ...
  script_xref(name:"URL", value:"http://web.mit.edu/kerberos/advisories/MITKRB5-SA-2010-004.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/86b8b655-4d1a-11df-83fb-0015587e2cc1.html");
