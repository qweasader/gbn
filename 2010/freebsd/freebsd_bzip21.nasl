...
#
# Auto generated from VID 0ddb57a9-da20-4e99-b048-4366092f3d31
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.68499");
...
arbitrary code via a crafted compressed file.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/41452");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/43331");
  script_xref(name:"URL", value:"http://www.openwall.com/lists/oss-security/2010/09/21/4");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/0ddb57a9-da20-4e99-b048-4366092f3d31.html");
