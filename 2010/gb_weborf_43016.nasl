...
if (description)
{
  ...
  script_name("Weborf Directory Traversal Vulnerability (Sep 2010)");
  ...
  script_mandatory_keys("weborf/http/detected");
  ...
  script_tag(name:"affected", value:"Weborf version 0.12.2 and prior.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/43016");
...
url = "/..%2f..%2f..%2f..%2f..%2f..%2f..%2fetc%2fpasswd";
