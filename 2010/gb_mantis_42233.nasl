...
if (description)
{
  ...
  script_name("MantisBT <= 1.2.2 'manage_proj_cat_add.php' HTML Injection Vulnerability");

  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/42233");
  ...
  script_tag(name:"summary", value:"MantisBT is prone to an HTML-injection vulnerability because it fails to
  ...
  script_tag(name:"affected", value:"MantisBT 1.2.2 is vulnerable, other versions may also be affected.");
