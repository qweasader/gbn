...
if (description)
{
  ...
  script_name("Novell iManager <= 2.7.2 Buffer Overflow Vulnerability");
  ...
  script_tag(name:"impact", value:"Attackers may exploit this issue to execute arbitrary code in
  the context of the affected application. Failed exploit attempts will likely cause denial of
  service conditions.");

  script_tag(name:"affected", value:"Novell iManager version 2.7.2 and prior.");
