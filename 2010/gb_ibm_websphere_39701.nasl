...
if(description)
{
  ...
  script_name("IBM WebSphere Application Server < 6.1.0.31, 7.x < 7.0.0.11 Information Disclosure Vulnerability");
  ...
  6.1.0.30 and 7.x through 7.0.0.10.");

  script_tag(name:"solution", value:"Update to version 6.1.0.31, 7.0.0.11 or later.");
