...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2108-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2108-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-2108-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2108");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cvsnt' package(s) announced via the DSA-2108-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cvsnt", ver:"2.5.03.2382-3.3+lenny1", rls:"DEB5"))) {
    report += res;
  }
