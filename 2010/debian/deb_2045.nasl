...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2045-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2045-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-2045-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2045");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libtheora' package(s) announced via the DSA-2045-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtheora-bin", ver:"1.0~beta3-1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtheora-dev", ver:"1.0~beta3-1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtheora0", ver:"1.0~beta3-1+lenny1", rls:"DEB5"))) {
    report += res;
  }
