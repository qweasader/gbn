...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2022-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2022-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-2022-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2022");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DSA-2022-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mediawiki", ver:"1:1.12.0-2lenny4", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mediawiki-math", ver:"1:1.12.0-2lenny4", rls:"DEB5"))) {
    report += res;
  }
