...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2060-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2060-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-2060-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2060");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cacti' package(s) announced via the DSA-2060-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cacti", ver:"0.8.7b-2.1+lenny3", rls:"DEB5"))) {
    report += res;
  }
