...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2120-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2120-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-2120-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2120");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-8.3' package(s) announced via the DSA-2120-1 advisory.");
