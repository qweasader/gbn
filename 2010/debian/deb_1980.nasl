...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1980-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1980-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-1980-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1980");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ircd-hybrid, ircd-ratbox' package(s) announced via the DSA-1980-1 advisory.");
