...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1983-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1983-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-1983-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1983");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wireshark' package(s) announced via the DSA-1983-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tshark", ver:"1.0.2-3+lenny8", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"wireshark", ver:"1.0.2-3+lenny8", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"wireshark-common", ver:"1.0.2-3+lenny8", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"wireshark-dev", ver:"1.0.2-3+lenny8", rls:"DEB5"))) {
    report += res;
  }
