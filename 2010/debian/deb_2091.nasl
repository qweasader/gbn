...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2091-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2091-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-2091-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2091");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squirrelmail' package(s) announced via the DSA-2091-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squirrelmail", ver:"2:1.4.15-4+lenny3.1", rls:"DEB5"))) {
    report += res;
  }
