...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2095-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2095-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-2095-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2095");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lvm2' package(s) announced via the DSA-2095-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"clvm", ver:"2.02.39-8", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lvm2", ver:"2.02.39-8", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lvm2-udeb", ver:"2.02.39-8", rls:"DEB5"))) {
    report += res;
  }
