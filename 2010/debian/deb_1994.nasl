...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1994-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1994-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-1994-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1994");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ajaxterm' package(s) announced via the DSA-1994-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ajaxterm", ver:"0.9-2+etch1", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ajaxterm", ver:"0.10-2+lenny1", rls:"DEB5"))) {
    report += res;
  }
