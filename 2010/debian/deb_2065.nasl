...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-2065-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-2065-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-2065-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-2065");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kvirc' package(s) announced via the DSA-2065-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kvirc", ver:"2:3.4.0-5", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"kvirc-data", ver:"2:3.4.0-5", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"kvirc-dev", ver:"2:3.4.0-5", rls:"DEB5"))) {
    report += res;
  }
