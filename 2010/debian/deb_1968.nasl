...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1968-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1968-2");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-1968-2");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1968");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pdns-recursor' package(s) announced via the DSA-1968-2 advisory.");
