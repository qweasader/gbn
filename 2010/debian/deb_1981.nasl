...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-1981-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1981");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"maildrop", ver:"2.0.2-11+etch1", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"maildrop", ver:"2.0.4-3+lenny1", rls:"DEB5"))) {
    report += res;
  }
