...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1974-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1974-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2010/DSA-1974-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1974");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gzip' package(s) announced via the DSA-1974-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gzip", ver:"1.3.5-15+etch1", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gzip", ver:"1.3.12-6+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gzip-win32", ver:"1.3.12-6+lenny1", rls:"DEB5"))) {
    report += res;
  }
