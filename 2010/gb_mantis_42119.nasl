...
if (description)
{
  ...
  script_name("MantisBT <= 1.2.1 Attachment HTML Injection Vulnerability");

  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/42119");
  ...
  script_tag(name:"affected", value:"MantisBT 1.2.1 is vulnerable, other versions may also be affected.");
