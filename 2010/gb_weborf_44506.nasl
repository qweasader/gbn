...
if (description)
{
  ...
  script_name("Weborf < 0.12.4 DoS Vulnerability");
  ...
  script_tag(name:"affected", value:"Weborf prior to version 0.12.4.");

  script_tag(name:"solution", value:"Update to version 0.12.4 or later.");

  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/44506");
...
if (version_is_less(version: version, test_version: "0.12.4")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "0.12.4");
