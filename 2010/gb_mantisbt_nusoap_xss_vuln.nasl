...
if(description)
{
  ...
  script_name("NuSOAP 0.9.5 'nusoap.php' XSS Vulnerability");

  script_xref(name:"URL", value:"http://www.mantisbt.org/bugs/view.php?id=12312");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/42959");
  ...
  script_tag(name:"summary", value:"NuSOAP is prone to a cross-site scripting (XSS) vulnerability.");
...
req = http_get(item: dir + "/api/soap/mantisconnect.php", port: port);
res = http_keepalive_send_recv(port: port, data: req);

if ("<title>NuSOAP:" >< res) {
  url = dir + '/api/soap/mantisconnect.php' + '/1<ScRiPt>alert("VT-XSS-Test")</ScRiPt>';
