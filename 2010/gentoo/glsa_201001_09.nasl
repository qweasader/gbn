...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66742");
  ...
  script_tag(name:"insight", value:"An input sanitation flaw in the WEBrick HTTP server included in Ruby might
    allow remote attackers to inject arbitrary control characters into
terminal
    sessions.");
  script_tag(name:"solution", value:"All Ruby 1.8.7 users should upgrade to the latest version:
...
All Ruby 1.8.6 users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201001-09");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=300468");
