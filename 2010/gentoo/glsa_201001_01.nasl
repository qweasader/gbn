...
if(description)
{
  ...
  script_tag(name:"insight", value:"A Denial of Service condition in ntpd can cause excessive CPU or bandwidth
consumption.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201001-01");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=290881");
