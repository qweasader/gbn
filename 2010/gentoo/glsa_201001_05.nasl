...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66738");
  ...
  script_tag(name:"insight", value:"A remote attacker can bypass the tcp-wrappers client authorization in
    net-snmp.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20201001-05");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=250429");
