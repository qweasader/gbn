...
if(description)
{
  ...
  script_name("MediaWiki < 1.15.2 'CSS validation' Information Disclosure Vulnerability");
  ...
  because it fails to properly restrict the posting of remote images.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"An attacker can exploit this vulnerability to have users view
  remote images, which may aid in further attacks.");

  script_tag(name:"affected", value:"MediaWiki versions prior to 1.15.2.");
