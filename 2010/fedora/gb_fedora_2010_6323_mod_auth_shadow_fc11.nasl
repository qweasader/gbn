...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.861944");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mod_auth_shadow'
  ...
  script_tag(name:"affected", value:"mod_auth_shadow on Fedora 11");
