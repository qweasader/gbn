...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.862320");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mipv6-daemon'
  ...
  script_tag(name:"affected", value:"mipv6-daemon on Fedora 12");
