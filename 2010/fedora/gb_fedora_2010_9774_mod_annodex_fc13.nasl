...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.862130");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mod_annodex'
  ...
  script_tag(name:"affected", value:"mod_annodex on Fedora 13");
