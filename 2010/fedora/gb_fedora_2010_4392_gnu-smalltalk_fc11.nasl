...
{  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2010-March/037654.html");
  script_oid("1.3.6.1.4.1.25623.1.0.861787");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnu-smalltalk'
  ...
  script_tag(name:"affected", value:"gnu-smalltalk on Fedora 11");
