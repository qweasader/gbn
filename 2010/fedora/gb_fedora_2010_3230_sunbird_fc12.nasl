...
{  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2010-March/036098.html");
  script_oid("1.3.6.1.4.1.25623.1.0.861747");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'sunbird'
  ...
  script_tag(name:"affected", value:"sunbird on Fedora 12");
