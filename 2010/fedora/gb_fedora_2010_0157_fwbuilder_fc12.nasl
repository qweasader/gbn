...
{  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2010-February/035112.html");
  script_oid("1.3.6.1.4.1.25623.1.0.861706");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'fwbuilder'
  ...
  script_tag(name:"affected", value:"fwbuilder on Fedora 12");
