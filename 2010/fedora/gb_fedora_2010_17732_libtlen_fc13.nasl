...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.862567");
  ...
  script_tag(name:"affected", value:"libtlen on Fedora 13");
...
if(release == "FC13") {
  if(!isnull(res = isrpmvuln(pkg:"libtlen", rpm:"libtlen~0~0.10.20060309.fc13", rls:"FC13"))) {
    report += res;
  }
