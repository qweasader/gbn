...
{  script_xref(name:"URL", value:"http://lists.fedoraproject.org/pipermail/package-announce/2010-March/038150.html");
  script_oid("1.3.6.1.4.1.25623.1.0.861806");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'fcron'
  ...
  script_tag(name:"affected", value:"fcron on Fedora 12");
