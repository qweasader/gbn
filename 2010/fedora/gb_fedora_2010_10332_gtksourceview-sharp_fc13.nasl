...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'gtksourceview-sharp'
  ...
  script_tag(name:"affected", value:"gtksourceview-sharp on Fedora 13");
