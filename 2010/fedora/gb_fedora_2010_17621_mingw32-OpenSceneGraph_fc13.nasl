...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.862569");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mingw32-OpenSceneGraph'
  ...
  script_tag(name:"affected", value:"mingw32-OpenSceneGraph on Fedora 13");
