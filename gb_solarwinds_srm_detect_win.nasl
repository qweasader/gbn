...
if(description)
{
  ...
  script_name("SolarWinds Storage Resource Monitor (SRM) Detection (Windows SMB Login)");
  ...
  script_tag(name:"summary", value:"SMB login-based detection of SolarWinds Storage Resource Monitor
  (SRM).");
...
foreach key(key_list) {
  foreach item(registry_enum_keys(key:key)) {
    ...
    if(!appName || appName !~ "SolarWinds( Orion)? Storage Resource Monitor")
      continue;
    ...
    set_kb_item(name:"solarwinds/srm/smb-login/detected", value:TRUE);
