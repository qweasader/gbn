...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61118");
  ...
  script_xref(name:"URL", value:"http://ikiwiki.info/security/#index32h2");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/90db9983-2f53-11dd-a0d8-0016d325a0ed.html");
