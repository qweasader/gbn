...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53067");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/15423/");
  script_xref(name:"URL", value:"http://secunia.com/secunia_research/2003-1/advisory/");
  script_xref(name:"URL", value:"http://www.opera.com/freebsd/changelogs/801/#security");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/985bfcf0-e1d7-11d9-b875-0001020eed82.html");
