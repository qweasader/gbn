...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56654");
...
space, which causes less memory to be allocated than required.");
  ...
  script_xref(name:"URL", value:"http://www.gentoo.org/security/en/glsa/glsa-200604-10.xml");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17409");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a813a219-d2d4-11da-a672-000e0c2e438a.html");
