...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55779");
...
(segmentation fault) via certain 'odd' responses.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/17271/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/1c3142a3-4ab2-11da-932d-00055d790c25.html");
