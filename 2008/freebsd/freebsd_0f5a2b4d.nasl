...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52229");
...
parameter.");
  ...
  script_xref(name:"URL", value:"http://www.idefense.com/application/poi/display?id=185&type=vulnerabilities&flashstatus=false");
  script_xref(name:"URL", value:"https://marc.info/?l=full-disclosure&m=110600949323439");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/0f5a2b4d-694b-11d9-a9e7-0001020eed82.html");
