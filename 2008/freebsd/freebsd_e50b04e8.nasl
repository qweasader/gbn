...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52476");
...
arbitrary content into any file.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10193");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/e50b04e8-9c55-11d8-9366-0020ed76ef5a.html");
