...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57291");
  ...
  script_xref(name:"URL", value:"http://www.joomla.org/content/view/1841/78/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/0ab423e7-3822-11db-81e1-000e0c2e438a.html");
