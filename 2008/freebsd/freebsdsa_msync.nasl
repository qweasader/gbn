...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52653");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-04:11.msync.asc)");
  ...
  script_tag(name:"insight", value:"The msync(2) system call is used by applications to request that
...
problems between the virtual memory system and on-disk contents.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-04:11.msync.asc");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10416");
