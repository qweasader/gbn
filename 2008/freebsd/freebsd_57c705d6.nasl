...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60887");
...
uninitialized memory.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/29792");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/28770");
  script_xref(name:"URL", value:"http://libpng.sourceforge.net/Advisory-1.2.26.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/57c705d6-12ae-11dd-bab7-0016179b2dd5.html");
