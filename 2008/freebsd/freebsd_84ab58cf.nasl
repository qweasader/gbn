...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52357");
  ...
  script_xref(name:"URL", value:"http://www.hornik.sk/SA/SA-20040802.txt");
  script_xref(name:"URL", value:"http://secunia.com/advisories/12156");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/84ab58cf-e4ac-11d8-9b0a-000347a4fa7d.html");
