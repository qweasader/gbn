...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54184");
...
execute arbitrary code via a PDF document with a long /Filespec tag.");
  ...
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=112059685332569");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/70c59485-ee5a-11d9-8310-0001020eed82.html");
