...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52196");
...
header size.");
  ...
  script_xref(name:"URL", value:"http://www.squid-cache.org/bugs/show_bug.cgi?id=1216");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12412");
  script_xref(name:"URL", value:"http://www.squid-cache.org/Versions/v2/2.5/bugs/squid-2.5.STABLE7-oversize_reply_headers.patch");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/bfda39de-7467-11d9-9e1e-c296ac722cb3.html");
