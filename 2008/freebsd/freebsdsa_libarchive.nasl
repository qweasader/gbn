...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58443");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-07:05.libarchive.asc)");
...
Miscomputing the length of a buffer resulting in a buffer overflow
...
[CVE-2007-3641].");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-07:05.libarchive.asc");
