...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57471");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/21819/");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/19911");
  script_xref(name:"URL", value:"http://bugs.splitbrain.org/index.php?do=details&id=906");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/fcba5764-506a-11db-a5ae-00508d6a62df.html");
