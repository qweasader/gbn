...
#
# Auto generated from VID baece347-c489-11dd-a721-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.62851");
...
of service via a long SMTP request, which triggers an infinite loop.");
  ...
  script_xref(name:"URL", value:"http://lists.grok.org.uk/pipermail/full-disclosure/2008-November/065840.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/baece347-c489-11dd-a721-0030843d3802.html");
