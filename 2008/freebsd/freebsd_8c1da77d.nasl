...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52991");
...
image containing a long (1) Firstname or (2) Lastname field.");
  ...
  script_xref(name:"URL", value:"http://www.debian.org/security/2005/dsa-695");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/3006");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8c1da77d-d3e9-11d9-8ffb-00061bc2ad93.html");
