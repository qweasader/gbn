...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52347");
...
user names and passwords.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/12690/");
  script_xref(name:"URL", value:"http://www.cups.org/str.php?L920");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/30cea6be-1d0c-11d9-814e-0001020eed82.html");
