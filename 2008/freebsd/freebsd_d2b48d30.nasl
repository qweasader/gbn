...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58862");
  ...
  script_xref(name:"URL", value:"http://www.lighttpd.net/assets/2007/4/13/lighttpd_sa2007_01.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/d2b48d30-ea97-11db-a802-000fea2763ce.html");
