...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58859");
  ...
  script_xref(name:"URL", value:"http://www.mandriva.com/security/advisories?name=MDKSA-2007:083");
  script_xref(name:"URL", value:"http://secunia.com/advisories/24839");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/ef2ffb03-f2b0-11db-ad25-0010b5a0a860.html");
