...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58844");
  ...
  script_xref(name:"URL", value:"http://blogsecurity.net/news/news-310507/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/6a31cbe3-1695-11dc-a197-0011098b2f36.html");
