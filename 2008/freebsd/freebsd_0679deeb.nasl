...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57729");
  ...
  script_tag(name:"insight", value:"The following package is affected: sql-ledger
...
unspecified terminal parameter value containing ../ (dot dot slash).");
  ...
  script_xref(name:"URL", value:"http://www.us.debian.org/security/2006/dsa-1239");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/0679deeb-8eaf-11db-abc9-0003476f14d3.html");
