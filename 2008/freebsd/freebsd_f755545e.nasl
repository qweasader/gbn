...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52204");
  ...
  xpdf, kdegraphics, gpdf, teTeX-base, cups-base, koffice, pdftohtml
...
code via a PDF file with a large /Encrypt /Length keyLength value.");
  ...
  script_xref(name:"URL", value:"http://www.koffice.org/security/advisory-20050120-1.txt");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=110608898221554");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f755545e-6fcd-11d9-abec-00061bd2d56f.html");
