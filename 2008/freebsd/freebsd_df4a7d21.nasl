...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58812");
  ...
  script_xref(name:"URL", value:"http://www.opera.com/support/search/view/865/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/df4a7d21-4b17-11dc-9fc2-001372ae3ab9.html");
