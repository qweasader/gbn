...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52208");
...
(3) header names containing whitespace characters.");
  ...
  script_xref(name:"URL", value:"http://www.squid-cache.org/Versions/v2/2.5/bugs/#squid-2.5.STABLE7-header_parsing");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12412");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b4d94fa0-6e38-11d9-9e1e-c296ac722cb3.html");
