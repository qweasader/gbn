...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60883");
...
different vulnerability than CVE-2006-3636.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/27630");
  script_xref(name:"URL", value:"http://secunia.com/advisories/28794");
  script_xref(name:"URL", value:"http://sourceforge.net/project/shownotes.php?release_id=593924");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f47f2746-12c5-11dd-bab7-0016179b2dd5.html");
