...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52485");
...
a valid, trusted X.509 certificate.");
  ...
  script_xref(name:"URL", value:"http://www.kame.net/dev/cvsweb2.cgi/kame/kame/kame/racoon/crypto_openssl.c?rev=1.84&content-type=text/x-cvsweb-markup");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10072");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/d8769838-8814-11d8-90d1-0020ed76ef5a.html");
