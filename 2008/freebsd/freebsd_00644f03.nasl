...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52400");
  ...
  script_tag(name:"insight", value:"The following package is affected: imlib
...
file.");
  ...
  script_xref(name:"URL", value:"http://bugzilla.gnome.org/show_bug.cgi?id=151034");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11084");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/00644f03-fb58-11d8-9837-000c41e2cdad.html");
