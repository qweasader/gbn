...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52227");
...
should be regarded as distinct.");
  ...
  script_xref(name:"URL", value:"http://rus.members.beeb.net/xzgv.html");
  script_xref(name:"URL", value:"http://www.svgalib.org/rus/zgv/");
  script_xref(name:"URL", value:"http://www.idefense.com/application/poi/display?id=160&type=vulnerabilities&flashstatus=false");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=109886210702781");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=109898111915661");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/249a8c42-6973-11d9-ae49-000c41e2cdad.html");
