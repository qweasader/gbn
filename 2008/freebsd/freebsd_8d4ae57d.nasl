...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56658");
  ...
  script_tag(name:"insight", value:"The following package is affected: xine
...
file.");
  ...
  script_xref(name:"URL", value:"http://www.open-security.org/advisories/16");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17579");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8d4ae57d-d2ab-11da-a672-000e0c2e438a.html");
