...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52482");
...
'Security Association Next Payload' and (2) 'RESERVED' fields.");
  ...
  script_xref(name:"URL", value:"http://orange.kame.net/dev/query-pr.cgi?pr=555");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/40fcf20f-8891-11d8-90d1-0020ed76ef5a.html");
