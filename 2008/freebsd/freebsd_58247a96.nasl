...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54462");
...
script or HTML via the convcharset parameter.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12982");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=111264361622660");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/58247a96-01c8-11da-bc08-0001020eed82.html");
