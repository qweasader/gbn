...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56455");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-06:12.opie.asc)");
...
authentication for the root user.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:12.opie.asc");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17194");
