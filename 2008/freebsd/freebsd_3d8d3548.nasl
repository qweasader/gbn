...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57784");
  ...
  script_xref(name:"URL", value:"http://drupal.org/files/sa-2007-001/advisory.txt");
  script_xref(name:"URL", value:"http://drupal.org/files/sa-2007-002/advisory.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/3d8d3548-9d02-11db-a541-000ae42e9b93.html");
