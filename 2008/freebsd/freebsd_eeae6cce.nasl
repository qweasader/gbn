...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54201");
...
SQL commands by modifying the file's contents.");
  ...
  script_xref(name:"URL", value:"http://www.zataz.net/adviso/mysql-05172005.txt");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13660");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/eeae6cce-d05c-11d9-9aed-000e0c2e438a.html");
