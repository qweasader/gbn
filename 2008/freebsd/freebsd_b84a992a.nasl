...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60888");
...
triggering large outgoing queues without reading messages.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/29751");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/28722");
  script_xref(name:"URL", value:"http://www.igniterealtime.org/issues/browse/JM-1289");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b84a992a-12ab-11dd-bab7-0016179b2dd5.html");
