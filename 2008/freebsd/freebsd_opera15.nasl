...
#
# Auto generated from VID 225bc349-ce10-11dd-a721-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63044");
...
attackers to execute arbitrary code via a long file:// URI.");
  ...
  script_xref(name:"URL", value:"http://www.opera.com/support/kb/view/922/");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/32752/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/225bc349-ce10-11dd-a721-0030843d3802.html");
