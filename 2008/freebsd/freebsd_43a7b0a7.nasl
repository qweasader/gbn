...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54410");
...
those clients that are allowed to use recursion.");
  ...
  script_xref(name:"URL", value:"http://doc.powerdns.com/security-policy.html");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=112155941310297&w=2");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/43a7b0a7-f9bc-11d9-b473-00061bc2ad93.html");
