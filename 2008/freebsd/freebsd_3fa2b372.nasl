...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52142");
...
causes an out-of-bounds read.");
  ...
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/?id=13");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12999");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/3fa2b372-a9f5-11d9-a788-0001020eed82.html");
