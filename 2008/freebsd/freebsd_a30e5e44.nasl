...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52261");
...
ignores the parser warnings.");
  ...
  script_xref(name:"URL", value:"http://www.squid-cache.org/Versions/v2/2.5/bugs/#squid-2.5.STABLE7-empty_acls");
  script_xref(name:"URL", value:"http://www.squid-cache.org/bugs/show_bug.cgi?id=1166");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a30e5e44-5440-11d9-9e1e-c296ac722cb3.html");
