...
#
# Auto generated from ADV FreeBSD-SA-08:08.nmount.asc
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61514");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-08:08.nmount.asc)");
  ...
  script_tag(name:"insight", value:"The mount(2) and nmount(2) system calls are used by various utilities
...
sufficient bounds checking.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-08:08.nmount.asc");
