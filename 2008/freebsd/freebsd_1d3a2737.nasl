...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52178");
  ...
  script_xref(name:"URL", value:"https://www.vuxml.org/freebsd/1d3a2737-7eb7-11d9-acf7-000854d03344.html");
  script_tag(name:"insight", value:"The following package is affected: unace
