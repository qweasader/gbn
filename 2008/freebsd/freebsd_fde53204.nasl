...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52465");
...
to a symlink attack");
  ...
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=107997911025558");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9939");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/fde53204-7ea6-11d8-9645-0020ed76ef5a.html");
