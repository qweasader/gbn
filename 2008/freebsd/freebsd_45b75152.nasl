...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52136");
...
string via the lambda replace method.");
  ...
  script_xref(name:"URL", value:"http://www.mozilla.org/security/announce/mfsa2005-33.html");
  ...
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=288688");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/45b75152-ae5f-11d9-a788-0001020eed82.html");
