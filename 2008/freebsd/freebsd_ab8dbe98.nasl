...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57560");
...
instead of '--' and contains an inconsistent ID.");
  ...
  script_xref(name:"URL", value:"http://rubyforge.org/pipermail/mongrel-users/2006-October/001946.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/20777");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/ab8dbe98-6be4-11db-ae91-0012f06707f0.html");
