...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54209");
  ...
  script_tag(name:"insight", value:"The following package is affected: nwclient
...
password from the file.");
  ...
  script_xref(name:"URL", value:"http://portal1.legato.com/resources/bulletins/372.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/3564");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/3840");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/3842");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/d177d9f9-e317-11d9-8088-00123f0f7307.html");
