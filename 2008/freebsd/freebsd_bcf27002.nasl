...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52157");
  ...
  script_tag(name:"insight", value:"The following package is affected: grip
...
causing the cddb lookup to return more matches than expected.");
  ...
  script_xref(name:"URL", value:"http://sourceforge.net/tracker/index.php?func=detail&aid=834724&group_id=3714&atid=103714");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12770");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/bcf27002-94c3-11d9-a9e0-0001020eed82.html");
