...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52141");
...
irc_msg_nochan functions.");
  ...
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/?id=14");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13003");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/ec09baa3-a9f5-11d9-a788-0001020eed82.html");
