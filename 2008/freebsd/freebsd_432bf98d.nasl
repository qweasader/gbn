...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56270");
  ...
  script_tag(name:"insight", value:"The following package is affected: kdegraphics
...
associated bitmap.");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/432bf98d-9e25-11da-b410-000e0c2e438a.html");
