...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52259");
...
code via a crafted AIFF file.");
  ...
  script_xref(name:"URL", value:"http://xinehq.de/index.php/security/XSA-2004-7");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/64c8cc2a-59b1-11d9-8a99-000c6e8f12ef.html");
