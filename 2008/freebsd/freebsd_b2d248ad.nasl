...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52172");
...
stack-based buffer overflow in imapd.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12636");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b2d248ad-88f6-11d9-aa18-0001020eed82.html");
