...
#
# Auto generated from VID 24b64fb0-af1d-11dd-8a16-001b1116b350
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61877");
...
triggers a heap-based buffer overflow.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/498169/30/0/threaded");
  script_xref(name:"URL", value:"http://svn.clamav.net/svn/clamav-devel/trunk/ChangeLog");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/24b64fb0-af1d-11dd-8a16-001b1116b350.html");
