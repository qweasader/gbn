...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52494");
  ...
  script_tag(name:"insight", value:"The following package is affected: anubis
...
ssl_error function in ssl.c.");
  ...
  script_xref(name:"URL", value:"http://lists.netsys.com/pipermail/full-disclosure/2004-March/018290.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9772");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8471bb85-6fb0-11d8-873f-0020ed76ef5a.html");
