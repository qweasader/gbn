...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55968");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/15735");
  script_xref(name:"URL", value:"http://secunia.com/advisories/17895/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/59ada6e5-676a-11da-99f6-00123ffe8333.html");
