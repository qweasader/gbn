...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52419");
...
overwrite arbitrary files via a symlink attack on temporary files.");
  ...
  script_xref(name:"URL", value:"http://www.debian.org/security/2004/dsa-540");
  script_xref(name:"URL", value:"http://lists.mysql.com/internals/15185");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/0c4d5973-f2ab-11d8-9837-000c41e2cdad.html");
