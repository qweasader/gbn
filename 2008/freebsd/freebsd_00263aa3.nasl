...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52508");
...
the (1) email or (2) language parameters.");
  ...
  script_xref(name:"URL", value:"http://mail.python.org/pipermail/mailman-announce/2003-February/000056.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/6677");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/6678");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/00263aa3-67a8-11d8-80e3-0020ed76ef5a.html");
