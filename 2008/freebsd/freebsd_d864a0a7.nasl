...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61447");
...
handle.");
  ...
  script_xref(name:"URL", value:"http://article.gmane.org/gmane.comp.encryption.gpg.gnutls.devel/2947");
  script_xref(name:"URL", value:"http://secunia.com/advisories/31505/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/d864a0a7-6f27-11dd-acfe-00104b9e1a4a.html");
