...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52144");
...
previously freed memory.");
  ...
  script_xref(name:"URL", value:"http://www.squid-cache.org/Versions/v2/2.5/bugs/#squid-2.5.STABLE7-post");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13166");
  script_xref(name:"URL", value:"http://www.squid-cache.org/bugs/show_bug.cgi?id=1224");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8dbf7894-a9a8-11d9-a788-0001020eed82.html");
