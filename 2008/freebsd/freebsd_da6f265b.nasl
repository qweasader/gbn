...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52480");
  ...
  script_tag(name:"insight", value:"The following package is affected: kdepim
...
allows attackers to execute arbitrary code via a VCF file.");
  ...
  script_xref(name:"URL", value:"http://www.kde.org/info/security/advisory-20040114-1.txt");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9419");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/da6f265b-8f3d-11d8-8b29-0020ed76ef5a.html");
