...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52224");
...
LDAP server.");
  ...
  script_xref(name:"URL", value:"http://www.squid-cache.org/Versions/v2/2.5/bugs/#squid-2.5.STABLE7-ldap_spaces");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12431");
  script_xref(name:"URL", value:"http://www.squid-cache.org/bugs/show_bug.cgi?id=1187");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/7a921e9e-68b1-11d9-9e1e-c296ac722cb3.html");
