...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52394");
...
versions, allows remote attackers to execute arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://bugzilla.mozilla.org/show_bug.cgi?id=236618");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/15495");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a4fd8f53-05eb-11d9-b45d-000c41e2cdad.html");
