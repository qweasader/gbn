...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56933");
...
demonstrated using gxine 0.5.6.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/20369");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/18187");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/107e2ee5-f941-11da-b1fa-020039488e34.html");
