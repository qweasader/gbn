...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52996");
...
web script or HTML via certain integer variables.");
  ...
  script_xref(name:"URL", value:"http://www.squirrelmail.org/security/issue/2005-01-14");
  script_xref(name:"URL", value:"http://www.squirrelmail.org/security/issue/2005-01-19");
  script_xref(name:"URL", value:"http://www.squirrelmail.org/security/issue/2005-01-20");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=110702772714662");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/79630c0c-8dcc-45d0-9908-4087fe1d618c.html");
