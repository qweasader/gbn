...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52452");
...
authentication and obtain Gallery administrator privileges.");
  ...
  script_xref(name:"URL", value:"http://gallery.menalto.com/modules.php?op=modload&name=News&file=article&sid=123");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10451");
  script_xref(name:"URL", value:"http://secunia.com/advisories/11752");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/253ea131-bd12-11d8-b071-00e08110b673.html");
