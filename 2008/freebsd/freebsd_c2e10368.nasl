...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52448");
  ...
  script_tag(name:"insight", value:"The following package is affected: mod_security
...
arbitrary code via a specially crafted POST request.");
  ...
  script_xref(name:"URL", value:"http://www.s-quadra.com/advisories/Adv-20040315.txt");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9885");
  script_xref(name:"URL", value:"http://secunia.com/advisories/11138");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/c2e10368-77ab-11d8-b9e8-00e04ccb0a62.html");
