...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58798");
  ...
  script_xref(name:"URL", value:"http://www.bugzilla.org/security/3.0.1/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f8d3689e-6770-11dc-8be8-02e0185f8d72.html");
