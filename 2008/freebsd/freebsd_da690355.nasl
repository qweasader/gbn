...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52369");
...
properly handled when previewing a message.");
  ...
  script_xref(name:"URL", value:"http://bugzilla.mozilla.org/show_bug.cgi?id=257314");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11174");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/da690355-1159-11d9-bc4a-000c41e2cdad.html");
