...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60889");
...
(aka *printf functions).");
  ...
  script_xref(name:"URL", value:"http://securityreason.com/achievement_securityalert/52");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/28392");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f6377f08-12a7-11dd-bab7-0016179b2dd5.html");
