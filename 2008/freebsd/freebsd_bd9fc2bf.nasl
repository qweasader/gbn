...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52250");
...
software upgrades.");
  ...
  script_xref(name:"URL", value:"ftp://ftp.vim.org/pub/vim/patches/6.3/6.3.045");
  script_xref(name:"URL", value:"http://groups.yahoo.com/group/vimdev/message/38084");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/bd9fc2bf-5ffe-11d9-a11a-000a95bc6fae.html");
