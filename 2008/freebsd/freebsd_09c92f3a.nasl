...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56974");
...
that is used in an include_once call.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/435379");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/18175");
  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/436263");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/09c92f3a-fd49-11da-995c-605724cdf281.html");
