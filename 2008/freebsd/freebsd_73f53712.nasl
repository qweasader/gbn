...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58115");
  ...
  script_xref(name:"URL", value:"http://ktorrent.org/forum/viewtopic.php?t=1401");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/73f53712-d028-11db-8c07-0211d85f11fb.html");
