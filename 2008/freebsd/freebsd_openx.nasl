...
#
# Auto generated from VID 55616fda-a2d0-11dd-a9f9-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61797");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/32114/");
  script_xref(name:"URL", value:"http://blog.openx.org/10/openx-security-update/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/55616fda-a2d0-11dd-a9f9-0030843d3802.html");
