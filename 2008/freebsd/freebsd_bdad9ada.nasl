...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52169");
...
%00 (null) character after the file extension.");
  ...
  script_xref(name:"URL", value:"http://www.lighttpd.net/news/");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12567");
  script_xref(name:"URL", value:"http://xforce.iss.net/xforce/xfdb/19350");
  script_xref(name:"URL", value:"http://article.gmane.org/gmane.comp.web.lighttpd/1171");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/bdad9ada-8a52-11d9-9e53-000a95bc6fae.html");
