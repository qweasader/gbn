...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54366");
...
comment or posting.");
  ...
  script_xref(name:"URL", value:"http://drupal.org/files/sa-2005-002/advisory.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f241641e-f5ea-11d9-a6db-000d608ed240.html");
