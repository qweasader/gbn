...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60186");
  ...
  script_tag(name:"insight", value:"The following package is affected: geeklog
...
(0.3.11sr6).");
  ...
  script_xref(name:"URL", value:"http://www.geeklog.net/article.php/geeklog-1.4.0sr6");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/60e1792b-c380-11dc-821a-000bcdc1757a.html");
