...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60394");
  ...
  script_xref(name:"URL", value:"http://forums.cacti.net/about25749.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/dea7df85-d96c-11dc-9bfc-000e0c092e7a.html");
