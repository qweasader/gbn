...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52353");
...
buffer overflow when quoting is required in the output.");
  ...
  script_xref(name:"URL", value:"https://bugzilla.andrew.cmu.edu/cgi-bin/cvsweb.cgi/src/sasl/plugins/digestmd5.c#rev1.171");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11347");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/0c592c4a-1bcc-11d9-a3ec-00061bd2d56f.html");
