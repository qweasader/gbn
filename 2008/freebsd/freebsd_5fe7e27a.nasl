...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52237");
...
Squid's home router and invalid WCCP_I_SEE_YOU cache numbers.");
  ...
  script_xref(name:"URL", value:"http://www.squid-cache.org/Versions/v2/2.5/bugs/#squid-2.5.STABLE7-wccp_denial_of_service");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12275");
  script_xref(name:"URL", value:"http://www.squid-cache.org/bugs/show_bug.cgi?id=1190");
  script_xref(name:"URL", value:"http://www.squid-cache.org/Advisories/SQUID-2005_2.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5fe7e27a-64cb-11d9-9e1e-c296ac722cb3.html");
