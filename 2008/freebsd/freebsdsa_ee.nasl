...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56107");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-06:02.ee.asc)");
  ...
  script_tag(name:"insight", value:"The ee utility is a simple screen oriented text editor. This editor is
...
for this to be exploited.  The option simply needs to be selected.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:02.ee.asc");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16207");
