...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58857");
  ...
  script_xref(name:"URL", value:"http://lists.debian.org/debian-security-announce/debian-security-announce-2007/msg00040.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/0ac89b39-f829-11db-b55c-000e0c6d38a9.html");
