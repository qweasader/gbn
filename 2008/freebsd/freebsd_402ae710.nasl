...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61056");
...
(1) username or (2) password.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/30020");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/28986");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/402ae710-26a2-11dd-ae05-825f4c35000a.html");
