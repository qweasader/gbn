...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60188");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-08:01.pty.asc)");
  ...
  script_tag(name:"insight", value:"pt_chown is a setuid root support utility used by grantpt(3) to change
ownership of a tty.
...
user calling pt_chown [CVE-2008-0216].");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-08:01.pty.asc");
