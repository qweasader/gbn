...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57399");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/21171/");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/19117");
  script_xref(name:"URL", value:"http://aluigi.altervista.org/adv/freecivx-adv.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/2d9ad236-4d26-11db-b48d-00508d6a62df.html");
