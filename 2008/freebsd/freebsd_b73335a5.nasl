...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58824");
  ...
  script_xref(name:"URL", value:"http://www.isecpartners.com/advisories/2007-003-libvorbis.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b73335a5-3bbe-11dc-8e83-0016179b2dd5.html");
