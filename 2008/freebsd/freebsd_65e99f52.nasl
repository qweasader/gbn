...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52352");
...
negative length fields that causes a memory allocation error.");
  ...
  script_xref(name:"URL", value:"http://www.idefense.com/application/poi/display?id=152&type=vulnerabilities");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11385");
  script_xref(name:"URL", value:"http://www.squid-cache.org/Versions/v2/2.5/bugs/#squid-2.5.STABLE6-SNMP_core_dump");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/65e99f52-1c5f-11d9-bc4a-000c41e2cdad.html");
