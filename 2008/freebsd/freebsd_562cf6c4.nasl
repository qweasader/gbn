...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60088");
...
For details, please visit the referenced security advisories.");
  ...
  script_xref(name:"URL", value:"http://www.adobe.com/support/security/bulletins/apsb07-20.html");
  script_xref(name:"URL", value:"http://secunia.com/advisories/28161/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/562cf6c4-b9f1-11dc-a302-000102cc8983.html");
