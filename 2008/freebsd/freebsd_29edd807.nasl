...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52272");
...
double quote but no closing double quote.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11432");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/29edd807-438d-11d9-8bb9-00065be4b5b6.html");
