...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.59931");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-07:10.gtar.asc)");
  ...
  script_tag(name:"insight", value:"GNU tar (gtar) is a utility to create and extract tape archives,
...
gtar to overwrite arbitrary files on the system.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-07:10.gtar.asc");
