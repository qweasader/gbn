...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52459");
...
a symlink attack on the failed-mysql-bugreport temporary file.");
  ...
  script_xref(name:"URL", value:"http://bugs.mysql.com/bug.php?id=3284");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9976");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=108023246916294&w=2");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/2e129846-8fbb-11d8-8b29-0020ed76ef5a.html");
