...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56516");
...
style attributes, which are processed by Internet Explorer.");
  ...
  script_xref(name:"URL", value:"http://sourceforge.net/project/shownotes.php?release_id=379951");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16032");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/99015cf5-c4dd-11da-b2fb-000e0c2e438a.html");
