...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52392");
  ...
  script_tag(name:"insight", value:"The following package is affected: samba3
...
provided.");
  ...
  script_xref(name:"URL", value:"http://www.idefense.com/application/poi/display?id=139&type=vulnerabilities");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a711de5c-05fa-11d9-a9b2-00061bc2ad93.html");
