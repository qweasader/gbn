...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57782");
  ...
  script_xref(name:"URL", value:"http://fetchmail.berlios.de/fetchmail-SA-2006-02.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5238ac45-9d8c-11db-858b-0060084a00e5.html");
