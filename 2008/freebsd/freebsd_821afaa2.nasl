...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.59977");
  ...
  script_tag(name:"insight", value:"The following package is affected: liveMedia
...
to be used during memory allocation.");
  ...
  script_xref(name:"URL", value:"http://aluigi.altervista.org/adv/live555x-adv.txt");
  script_xref(name:"URL", value:"http://www.live555.com/liveMedia/public/changelog.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/821afaa2-9e9a-11dc-a7e3-0016360406fa.html");
