...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55896");
  ...
  script_tag(name:"insight", value:"The following packages are affected: horde horde-php5");

  script_tag(name:"solution", value:"Update your system with the appropriate patches or
  software upgrades.");

  script_xref(name:"URL", value:"http://lists.horde.org/archives/announce/2005/000232.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/873a6542-5b8d-11da-b96e-000fb586ba73.html");
