...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58840");
  ...
  script_xref(name:"URL", value:"http://spamassassin.apache.org/advisories/cve-2007-2873.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8092b820-1d6f-11dc-a0b2-001921ab2fa4.html");
