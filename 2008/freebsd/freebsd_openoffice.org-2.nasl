...
#
# Auto generated from VID 842bafdd-be2f-11dd-a578-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61953");
...
document, which trigger a heap-based buffer overflow.");
  ...
  script_xref(name:"URL", value:"http://www.openoffice.org/security/cves/CVE-2008-2237.html");
  script_xref(name:"URL", value:"http://www.openoffice.org/security/cves/CVE-2008-2238.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/842bafdd-be2f-11dd-a578-0030843d3802.html");
