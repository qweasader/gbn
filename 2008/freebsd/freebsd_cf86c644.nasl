...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58050");
  ...
  script_xref(name:"URL", value:"http://www.zerodayinitiative.com/advisories/ZDI-07-008.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/cf86c644-cb6c-11db-8e9d-000c6ec775d9.html");
