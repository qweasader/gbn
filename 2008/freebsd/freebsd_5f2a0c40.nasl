...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57103");
...
and 'restructured text' (reStructuredText).");
  ...
  script_xref(name:"URL", value:"http://www.zope.org/Products/Zope/Hotfix-2006-07-05/Hotfix-2006-07-05/view");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5f2a0c40-1322-11db-bd23-000475abc56f.html");
