...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56525");
...
state machine module.");
  ...
  script_xref(name:"URL", value:"http://www.freeradius.org/security.html#1.1.0");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17171");
  script_xref(name:"URL", value:"http://secunia.com/advisories/19300/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/37a5c10f-bf56-11da-b0e9-00123ffe8333.html");
