...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57258");
  ...
  script_xref(name:"URL", value:"http://www.squirrelmail.org/security/issue/2006-08-11");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/21b7c550-2a22-11db-a6e2-000e0c2e438a.html");
