...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56202");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-06:07.pf.asc)");
  ...
  script_tag(name:"insight", value:"pf is an Internet Protocol packet filter originally written for OpenBSD.
...
being inserted twice, violating a kernel invariant.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:07.pf.asc");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16375");
