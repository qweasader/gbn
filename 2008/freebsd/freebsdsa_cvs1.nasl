...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52652");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-04:10.cvs.asc)");
...
memory.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-04:10.cvs.asc");
