...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56102");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/18379/");
  script_xref(name:"URL", value:"http://lurker.clamav.net/message/20060109.213247.a16ae8db.en.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/612a34ec-81dc-11da-a043-0002a5c3d308.html");
