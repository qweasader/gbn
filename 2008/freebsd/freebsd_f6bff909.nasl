...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57404");
...
get_media_packet functions, and possibly other functions.");
  ...
  script_xref(name:"URL", value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=374577");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/18608");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f6bff909-4a26-11db-a4cc-000a48049292.html");
