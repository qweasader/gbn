...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52268");
...
triggers a heap-based buffer overflow.");
  ...
  script_xref(name:"URL", value:"http://www.idefense.com/application/poi/display?id=165&type=vulnerabilities");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11973");
  script_xref(name:"URL", value:"http://www.samba.org/samba/security/CVE-2004-1154.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/3b3676be-52e1-11d9-a9e7-0001020eed82.html");
