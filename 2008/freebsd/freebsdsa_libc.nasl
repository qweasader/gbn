...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60187");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-08:02.libc.asc)");
  ...
  script_tag(name:"insight", value:"The resolver is the part of libc that resolves hostnames (example.com) to
...
corruption with certain inputs.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-08:02.libc.asc");
