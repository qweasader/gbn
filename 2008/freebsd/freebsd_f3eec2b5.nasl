...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52164");
...
attackers to execute arbitrary SQL code via the catid parameter.");
  ...
  script_xref(name:"URL", value:"http://news.postnuke.com/Article2669.html");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=110962710805864");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=110962819232255");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f3eec2b5-8cd8-11d9-8066-000a95bc6fae.html");
