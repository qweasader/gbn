...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56647");
...
sites to execute arbitrary code via long HTTP headers.");
  ...
  script_xref(name:"URL", value:"http://www.clamav.net/security/0.88.2.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17754");
  script_xref(name:"URL", value:"http://secunia.com/advisories/19880/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b088bf48-da3b-11da-93e0-00123ffe8333.html");
