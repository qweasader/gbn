...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53076");
  ...
  script_tag(name:"insight", value:"The following packages are affected: gaim ja-gaim ko-gaim ru-gaim
...
a file name.");
  ...
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/index.php?id=18");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13931");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/2701611f-df5c-11d9-b875-0001020eed82.html");
