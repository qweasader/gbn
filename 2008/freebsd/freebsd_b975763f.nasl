...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57465");
  ...
  script_xref(name:"URL", value:"http://securitytracker.com/alerts/2006/Jul/1016522.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/18034");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b975763f-5210-11db-8f1a-000a48049292.html");
