...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52460");
  ...
  script_tag(name:"insight", value:"The following package is affected: subversion
...
svn-protocol command.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10386");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5d36ef32-a9cf-11d8-9c6d-0020ed76ef5a.html");
