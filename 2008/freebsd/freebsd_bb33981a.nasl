...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56271");
...
vulnerabilities in Perl applications.");
  ...
  script_xref(name:"URL", value:"http://dev.perl.org/perl5/news/2005/perl_patches_fix_sprintf_buffer.html");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/bb33981a-7ac6-11da-bf72-00123f589060.html");
