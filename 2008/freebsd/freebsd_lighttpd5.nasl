...
#
# Auto generated from VID fb911e31-8ceb-11dd-bb29-000c6e274733
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61701");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/31434");
  script_xref(name:"URL", value:"http://www.lighttpd.net/security/lighttpd_sa_2008_06.txt");
  script_xref(name:"URL", value:"http://www.lighttpd.net/security/lighttpd_sa_2008_07.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/fb911e31-8ceb-11dd-bb29-000c6e274733.html");
