...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.59649");
  ...
  script_xref(name:"URL", value:"http://ikiwiki.info/security/#index29h2");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/31d9fbb4-9d09-11dc-a29d-0016d325a0ed.html");
