...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53074");
...
.. (dot dot) in the original filename within a compressed file.");
  ...
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=111271860708210");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=111402732406477");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/63bd4bad-dffe-11d9-b875-0001020eed82.html");
