...
#
# Auto generated from ADV FreeBSD-SA-08:13.protosw.asc
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63077");
  script_version("2022-01-18T07:59:01+0000");
  script_cve_id("CVE-2008-5736");
  script_tag(name:"last_modification", value:"2022-01-18 07:59:01 +0000 (Tue, 18 Jan 2022)");
  script_tag(name:"creation_date", value:"2008-12-29 22:42:24 +0100 (Mon, 29 Dec 2008)");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_name("FreeBSD Security Advisory (FreeBSD-SA-08:13.protosw.asc)");
  ...
  script_tag(name:"insight", value:"The FreeBSD kernel provides support for a variety of different types of
...
properly initialized.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-08:13.protosw.asc");
