...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52734");
...
attackers to spoof DNS lookups.");
  ...
  script_xref(name:"URL", value:"http://www.squid-cache.org/Versions/v2/2.5/bugs/#squid-2.5.STABLE9-dns_reply");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13592");
  script_xref(name:"URL", value:"http://secunia.com/advisories/15294");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/7e97b288-c7ca-11d9-9e1e-c296ac722cb3.html");
