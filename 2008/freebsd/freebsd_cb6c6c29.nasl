...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52464");
...
bypass intended access restrictions.");
  ...
  script_xref(name:"URL", value:"http://bugs.proftpd.org/show_bug.cgi?id=2267");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10252");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/cb6c6c29-9c4f-11d8-9366-0020ed76ef5a.html");
