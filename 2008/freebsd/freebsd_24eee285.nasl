...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55046");
  ...
  script_xref(name:"URL", value:"http://rhn.redhat.com/errata/RHSA-2005-670.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/14529");
  script_xref(name:"URL", value:"http://www.kde.org/info/security/advisory-20050809-1.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/24eee285-09c7-11da-bc08-0001020eed82.html");
