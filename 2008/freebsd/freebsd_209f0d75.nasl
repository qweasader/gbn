...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58801");
  ...
  script_xref(name:"URL", value:"http://www.flyspray.org/fsa:1");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/209f0d75-4b5c-11dc-a6cd-000fb5066b20.html");
