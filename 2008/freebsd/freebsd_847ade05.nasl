...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52513");
...
arbitrary code via a long URL.");
  ...
  script_xref(name:"URL", value:"http://mail.gnome.org/archives/xml/2004-February/msg00070.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/847ade05-6717-11d8-b321-000a95bc6fae.html");
