...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54206");
  ...
  script_xref(name:"URL", value:"http://pear.php.net/package/XML_RPC/download/1.3.2");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b64481d9-eff4-11d9-8310-0001020eed82.html");
