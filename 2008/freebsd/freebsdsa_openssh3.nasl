...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57476");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-06:22.openssh.asc)");
...
cleanup routines to be executed multiple times.  [CVE-2006-5051]");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:22.openssh.asc");
