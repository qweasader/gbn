...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57461");
  ...
  script_xref(name:"URL", value:"http://www.ubuntu.com/usn/usn-357-1");
  script_xref(name:"URL", value:"http://secunia.com/advisories/22237/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5a39a22e-5478-11db-8f1a-000a48049292.html");
