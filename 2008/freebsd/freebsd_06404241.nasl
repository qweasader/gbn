...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52129");
...
attackers to execute arbitrary code via a crafted PCX image file.");
  ...
  script_xref(name:"URL", value:"http://bugs.kde.org/102328");
  script_xref(name:"URL", value:"http://www.kde.org/info/security/advisory-20050421-1.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/06404241-b306-11d9-a788-0001020eed82.html");
