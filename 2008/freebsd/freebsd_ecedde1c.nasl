...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61285");
  ...
  script_xref(name:"URL", value:"http://drupal.org/node/280571");
  script_xref(name:"URL", value:"http://secunia.com/advisories/31028/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/ecedde1c-5128-11dd-a4e1-0030843d3802.html");
