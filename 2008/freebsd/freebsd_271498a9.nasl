...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55418");
...
UPX packed executable.");
  ...
  script_xref(name:"URL", value:"http://www.gentoo.org/security/en/glsa/glsa-200509-13.xml");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/271498a9-2cd4-11da-a263-0001020eed82.html");
