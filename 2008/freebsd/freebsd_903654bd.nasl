...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58839");
  ...
  script_xref(name:"URL", value:"http://news.gmane.org/gmane.comp.security.virus.clamav.devel/cutoff=2853");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/903654bd-1927-11dc-b8a0-02e0185f8d72.html");
