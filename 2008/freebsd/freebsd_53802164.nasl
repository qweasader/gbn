...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61188");
  ...
  script_xref(name:"URL", value:"http://www.ruby-lang.org/en/news/2008/06/20/arbitrary-code-execution-vulnerabilities/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/53802164-3f7e-11dd-90ea-0019666436c2.html");
