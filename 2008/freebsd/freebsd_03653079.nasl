...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52177");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12736");
  script_xref(name:"URL", value:"http://www.phpbb.com/phpBB/viewtopic.php?f=14&t=265423");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/03653079-8594-11d9-afa0-003048705d5a.html");
