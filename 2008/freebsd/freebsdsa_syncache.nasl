...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52634");
  script_version("2023-07-26T05:05:09+0000");
  script_cve_id("CVE-2002-0518");
  script_tag(name:"last_modification", value:"2023-07-26 05:05:09 +0000 (Wed, 26 Jul 2023)");
  script_tag(name:"creation_date", value:"2008-09-04 20:41:11 +0200 (Thu, 04 Sep 2008)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_name("FreeBSD Security Advisory (FreeBSD-SA-02:20.syncache.asc)");
  ...
  script_tag(name:"insight", value:"The SYN cache (syncache) and SYN cookie mechanism (syncookie) are
...
FreeBSD 4.5-RELEASE, no other releases are affected.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-02:20.syncache.asc");
