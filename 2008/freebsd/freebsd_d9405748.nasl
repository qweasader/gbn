...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58847");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/25383/");
  script_xref(name:"URL", value:"http://tomcat.apache.org/connectors-doc/news/20070301.html#20070518.1");
  script_xref(name:"URL", value:"http://tomcat.apache.org/security-jk.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/d9405748-1342-11dc-a35c-001485ab073e.html");
