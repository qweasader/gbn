...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61451");
  ...
  script_xref(name:"URL", value:"http://www.ruby-lang.org/en/news/2008/08/08/multiple-vulnerabilities-in-ruby/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/c329712a-6b5b-11dd-9d79-001fc61c2a55.html");
