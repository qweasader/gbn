...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56105");
...
converts character sets.");
  ...
  script_xref(name:"URL", value:"http://bogofilter.sourceforge.net/security/bogofilter-SA-2005-01");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16171");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/92140bc9-7bde-11da-8ec4-0002b3b60e4c.html");
