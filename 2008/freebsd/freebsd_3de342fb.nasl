...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58816");
  ...
  script_xref(name:"URL", value:"https://www.vuxml.org/freebsd/3de342fb-40be-11dc-aeac-02e0185f8d72.html");
  script_tag(name:"insight", value:"The following package is affected: named");
