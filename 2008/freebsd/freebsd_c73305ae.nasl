...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52166");
...
remote attackers to execute arbitrary code via .WAV files.");
  ...
  script_xref(name:"URL", value:"http://service.real.com/help/faq/security/050224_player/EN/");
  script_xref(name:"URL", value:"http://marc.theaimsgroup.com/?l=vulnwatch&m=110977858619314");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/c73305ae-8cd7-11d9-9873-000a95bc6fae.html");
