...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52284");
...
programs via the (1) -rshcmd or (2) -sshcmd flags.");
  ...
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=110202047507273");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11791");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11792");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f11b219a-44b6-11d9-ae2f-021106004fd6.html");
