...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56577");
...
arbitrary web script or HTML via the action argument.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/19558/");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17403");
  script_xref(name:"URL", value:"http://mail.python.org/pipermail/mailman-announce/2006-April/000084.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8be2e304-cce6-11da-a3b1-00123ffe8333.html");
