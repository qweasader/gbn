...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57405");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/21982/");
  script_xref(name:"URL", value:"http://secunia.com/advisories/21709/");
  script_xref(name:"URL", value:"http://www.cdc.informatik.tu-darmstadt.de/securebrowser/");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/1fe734bf-4a06-11db-b48d-00508d6a62df.html");
