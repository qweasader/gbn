...
#
# Auto generated from ADV FreeBSD-SA-08:12.ftpd.asc
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63078");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-08:12.ftpd.asc)");
  ...
  script_tag(name:"insight", value:"ftpd(8) is a general-purpose implementation of File Transfer Protocol (FTP)
...
another very long command.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-08:12.ftpd.asc");
