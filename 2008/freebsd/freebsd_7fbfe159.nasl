...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52306");
...
allows remote attackers to execute arbitrary web script or HTML.");
  ...
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=110012133608004");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11653");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/7fbfe159-3438-11d9-a9e7-0001020eed82.html");
