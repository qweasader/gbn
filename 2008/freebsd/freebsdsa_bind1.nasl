...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53973");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-05:12.bind.asc)");
...
named(8) will exit.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-05:12.bind.asc");
