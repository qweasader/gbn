...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60834");
...
which causes all active SSL connections to be lost.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/29649");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/28489");
  script_xref(name:"URL", value:"http://trac.lighttpd.net/trac/ticket/285");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/1ac77649-0908-11dd-974d-000fea2763ce.html");
