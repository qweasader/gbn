...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52524");
...
From header that contains a large number of quotation marks (').");
  ...
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=103668430620531&w=2");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/6120");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5abfee2d-5d82-11d8-80e3-0020ed76ef5a.html");
