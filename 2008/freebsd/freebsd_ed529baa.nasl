...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57198");
  ...
  script_xref(name:"URL", value:"http://lists.gnupg.org/pipermail/gnupg-announce/2006q3/000229.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/ed529baa-21c6-11db-b625-02e081235dab.html");
