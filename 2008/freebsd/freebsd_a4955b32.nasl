...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54001");
...
parameter to index.php.");
  ...
  script_xref(name:"URL", value:"http://www.gentoo.org/security/en/glsa/glsa-200506-04.xml");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13809");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a4955b32-ed84-11d9-8310-0001020eed82.html");
