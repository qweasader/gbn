...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56769");
  ...
  frontpage, mod_frontpage13, mod_frontpage20, mod_frontpage21, mod_frontpage22
...
operation, (2) command, and (3) name parameters.");
  ...
  script_xref(name:"URL", value:"https://docs.microsoft.com/en-us/security-updates/securitybulletins/2006/ms06-017");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17452");
  script_xref(name:"URL", value:"http://www.rtr.com/fpsupport/fpse_release_may_2_2006.htm");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=114487846329000");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/c0171f59-ea8a-11da-be02-000c6ec775d9.html");
