...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55853");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/15396");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/15414");
  script_xref(name:"URL", value:"http://secunia.com/advisories/17441/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/9c1cea79-548a-11da-b53f-0004614cc33d.html");
