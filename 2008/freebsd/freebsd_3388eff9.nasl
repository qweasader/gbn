...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52527");
...
enable the account with a more easily guessable password.");
  ...
  script_xref(name:"URL", value:"http://www.samba.org/samba/whatsnew/samba-3.0.2.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9637");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/3388eff9-5d6e-11d8-80e3-0020ed76ef5a.html");
