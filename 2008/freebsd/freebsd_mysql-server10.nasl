...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56850");
...
code via crafted COM_TABLE_DUMP packets with invalid length values.");
  ...
  script_xref(name:"URL", value:"http://www.wisec.it/vulns.php?page=7");
  script_xref(name:"URL", value:"http://www.wisec.it/vulns.php?page=8");
  script_xref(name:"URL", value:"http://dev.mysql.com/doc/refman/4.1/en/news-4-0-27.html");
  script_xref(name:"URL", value:"http://dev.mysql.com/doc/refman/4.1/en/news-4-1-19.html");
  script_xref(name:"URL", value:"http://dev.mysql.com/doc/refman/5.1/en/news-5-1-10.html");
  script_xref(name:"URL", value:"http://secunia.com/advisories/19929/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a8d8713e-dc83-11da-a22b-000c6ec775d9.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/4913886c-e875-11da-b9f4-00123ffe8333.html");
