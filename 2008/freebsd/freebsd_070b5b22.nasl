...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61450");
  ...
  script_xref(name:"URL", value:"http://drupal.org/node/295053");
  script_xref(name:"URL", value:"http://secunia.com/advisories/31462/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/070b5b22-6d74-11dd-aa18-0030843d3802.html");
