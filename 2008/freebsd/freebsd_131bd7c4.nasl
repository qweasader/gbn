...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52239");
...
second field reuses RLE data from the end of the first field.");
  ...
  script_xref(name:"URL", value:"http://xinehq.de/index.php/security/XSA-2004-5");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11205");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/131bd7c4-64a3-11d9-829a-000a95bc6fae.html");
