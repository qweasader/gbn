...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54372");
  ...
  script_tag(name:"insight", value:"The following package is affected: kdebase");

  script_tag(name:"solution", value:"Update your system with the appropriate patches or
  software upgrades.");

  script_xref(name:"URL", value:"https://bugs.kde.org/show_bug.cgi?id=103331");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/14297");
  script_xref(name:"URL", value:"http://www.kde.org/info/security/advisory-20050718-1.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/2e116ba5-f7c3-11d9-928e-000b5d7e6dd5.html");
