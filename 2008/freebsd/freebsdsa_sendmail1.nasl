...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56453");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-06:13.sendmail.asc)");
...
of asynchronous signals.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:13.sendmail.asc");
