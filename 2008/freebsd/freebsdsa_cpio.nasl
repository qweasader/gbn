...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56108");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-06:03.cpio.asc)");
  ...
  script_tag(name:"insight", value:"The cpio utility copies files into or out of a cpio or tar archive.
...
A number of issues has been discovered in cpio:
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:03.cpio.asc");
