...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52475");
...
to write files outside of the module's path.");
  ...
  script_xref(name:"URL", value:"http://rsync.samba.org/#security_apr04");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10247");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/73ea0706-9c57-11d8-9366-0020ed76ef5a.html");
