...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52506");
...
and conduct unauthorized activities.");
  ...
  script_xref(name:"URL", value:"http://mail.python.org/pipermail/mailman-announce/2003-December/000066.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9336");
  script_xref(name:"URL", value:"http://xforce.iss.net/xforce/xfdb/14121");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/3cb88bb2-67a6-11d8-80e3-0020ed76ef5a.html");
