...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52469");
...
vulnerability than CVE-2004-0180.");
  ...
  script_xref(name:"URL", value:"http://ccvs.cvshome.org/servlets/NewsItemView?newsID=102");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/0792e7a7-8e37-11d8-90d1-0020ed76ef5a.html");
