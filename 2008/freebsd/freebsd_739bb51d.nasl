...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52492");
...
properly handled in isakmp_inf.c.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/349756");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9416");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9417");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/739bb51d-7e82-11d8-9645-0020ed76ef5a.html");
