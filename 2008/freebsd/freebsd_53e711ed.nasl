...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52170");
  ...
  script_xref(name:"URL", value:"http://www.phpbb.com/phpBB/viewtopic.php?t=267563");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12678");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/53e711ed-8972-11d9-9ff8-00306e01dda2.html");
