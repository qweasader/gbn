...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52325");
...
handled by the URL decoder.");
  ...
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/?id=3");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11056");
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/?id=4");
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/?id=5");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/4260eacb-26b8-11d9-9289-000c41e2cdad.html");
