...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54467");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/15870/");
  script_xref(name:"URL", value:"http://www.opera.com/freebsd/changelogs/802/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a2aa24fd-00d4-11da-bc08-0001020eed82.html");
