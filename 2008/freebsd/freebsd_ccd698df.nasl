...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52481");
...
field.");
  ...
  script_xref(name:"URL", value:"http://www.kame.net/dev/cvsweb2.cgi/kame/kame/kame/racoon/isakmp.c.diff?r1=1.180&r2=1.181");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10172");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/ccd698df-8e20-11d8-90d1-0020ed76ef5a.html");
