...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60399");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-08:03.sendfile.asc)");
  ...
  script_tag(name:"insight", value:"The sendfile(2) system call allows a server application (such as a
...
flags before sending data from a file.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-08:03.sendfile.asc");
