...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58841");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/24517/");
  script_xref(name:"URL", value:"http://security.gentoo.org/glsa/glsa-200703-28.xml");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/39988ee8-1918-11dc-b6bd-0016179b2dd5.html");
