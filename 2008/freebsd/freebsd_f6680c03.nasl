...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52349");
...
files.");
  ...
  script_xref(name:"URL", value:"http://scary.beasts.org/security/CESA-2004-006.txt");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11406");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f6680c03-0bd8-11d9-8a8a-000c41e2cdad.html");
