...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52537");
  ...
  script_xref(name:"URL", value:"http://security.e-matters.de/advisories/052002.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/af0296be-2455-11d8-82e5-0020ed76ef5a.html");
