...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52507");
...
users.");
  ...
  script_xref(name:"URL", value:"http://mail.python.org/pipermail/mailman-announce/2003-September/000061.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/429249d2-67a7-11d8-80e3-0020ed76ef5a.html");
