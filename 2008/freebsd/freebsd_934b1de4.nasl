...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54466");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/15756/");
  script_xref(name:"URL", value:"http://www.opera.com/freebsd/changelogs/802/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/934b1de4-00d7-11da-bc08-0001020eed82.html");
