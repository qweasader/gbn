...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55559");
  ...
  script_xref(name:"URL", value:"http://www.gentoo.org/security/en/glsa/glsa-200510-08.xml");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/3bc5691e-38dd-11da-92f5-020039488e34.html");
