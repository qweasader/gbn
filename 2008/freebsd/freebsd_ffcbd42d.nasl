...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60023");
...
username in a SAMLOGON logon request.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/27760/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/ffcbd42d-a8c5-11dc-bec2-02e0185f8d72.html");
