...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52246");
  ...
  script_tag(name:"insight", value:"The following package is affected: dillo
...
format string specifiers in a web page.");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/28ab7ddf-61ab-11d9-a9e7-0001020eed82.html");
