...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55419");
  ...
  script_xref(name:"URL", value:"http://www.mozilla.org/security/announce/mfsa2005-58.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8f5dd74b-2c61-11da-a263-0001020eed82.html");
