...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58808");
  ...
  script_xref(name:"URL", value:"http://www.fetchmail.info/fetchmail-SA-2007-02.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/45500f74-5947-11dc-87c1-000e2e5785ad.html");
