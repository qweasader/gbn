...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56264");
...
another user, which are not cleared even though other variables are.");
  ...
  script_xref(name:"URL", value:"http://www.courtesan.com/sudo/alerts/bash_env.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/15191");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/1b725079-9ef6-11da-b410-000e0c2e438a.html");
