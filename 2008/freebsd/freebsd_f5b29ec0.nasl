...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58785");
  ...
  script_xref(name:"URL", value:"http://studio.imagemagick.org/pipermail/magick-announce/2007-September/000037.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f5b29ec0-71f9-11dc-8c6a-00304881ac9a.html");
