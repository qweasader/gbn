...
#
# Auto generated from VID 12efc567-9879-11dd-a5e7-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61804");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/32200/");
  script_xref(name:"URL", value:"http://secunia.com/advisories/32201/");
  script_xref(name:"URL", value:"http://secunia.com/advisories/32198/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/12efc567-9879-11dd-a5e7-0030843d3802.html");
