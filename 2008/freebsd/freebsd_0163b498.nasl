...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52131");
  ...
  script_tag(name:"insight", value:"The following package is affected: axel
...
before 1.0b may allow remote attackers to execute arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.debian.org/security/2005/dsa-706");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13059");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/0163b498-af54-11d9-acd0-000854d03344.html");
