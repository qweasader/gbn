...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58867");
  ...
  script_xref(name:"URL", value:"http://www.zope.org/Products/Zope/Hotfix-2007-03-20/announcement/view");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/23084");
  script_xref(name:"URL", value:"http://plone.org/products/plone/releases/2.5.3");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/34414a1e-e377-11db-b8ab-000c76189c4c.html");
