...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58834");
  ...
  script_xref(name:"URL", value:"http://www.isecpartners.com/advisories/2007-001-vlc.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/7128fb45-2633-11dc-94da-0016179b2dd5.html");
