...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52543");
...
script or HTML via the X-Forwarded-For parameter.");
  ...
  script_xref(name:"URL", value:"http://coppermine.sourceforge.net/board/index.php?topic=17134.0");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13218");
  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/396080");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/756db070-b9d4-11d9-ae81-000ae42e9b93.html");
