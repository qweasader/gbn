...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56774");
...
parameter.");
  ...
  script_xref(name:"URL", value:"http://www.phpmyadmin.net/home_page/security.php?issue=PMASA-2006-3");
  script_xref(name:"URL", value:"http://secunia.com/advisories/19659");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/2ecd02e2-e864-11da-b9f4-00123ffe8333.html");
