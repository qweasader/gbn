...
#
# Auto generated from VID d1ce8a4f-c235-11dd-8cbc-00163e000016
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.62859");
...
crafted hyperlink in an HTML part of an e-mail message.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/Advisories/32143/");
  script_xref(name:"URL", value:"http://sourceforge.net/project/shownotes.php?release_id=644750&group_id=311");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/d1ce8a4f-c235-11dd-8cbc-00163e000016.html");
