...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52424");
...
messages that are not properly handled in a strncpy call.");
  ...
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/?id=0");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10865");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5b8f9a02-ec93-11d8-b913-000c41e2cdad.html");
