...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53098");
...
security advisories.");
  ...
  script_xref(name:"URL", value:"http://www.ethereal.com/appnotes/enpa-sa-00019.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13391");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13504");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13567");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/76adaab0-e4e3-11d9-b875-0001020eed82.html");
