...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60226");
  ...
  script_xref(name:"URL", value:"http://lists.freedesktop.org/archives/xorg/2008-January/032099.html");
  script_xref(name:"URL", value:"http://secunia.com/advisories/28532/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/fe2b6597-c9a4-11dc-8da8-0008a18a9961.html");
