...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58814");
  ...
  script_xref(name:"URL", value:"http://www.joomla.org/content/view/3677/1/");
  script_xref(name:"URL", value:"http://secunia.com/advisories/26239/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/4872d9a7-4128-11dc-bdb0-0016179b2dd5.html");
