...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57785");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-07:01.jail.asc)");
...
structure.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-07:01.jail.asc");
