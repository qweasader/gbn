...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52526");
...
possibly escape the chroot jail.");
  ...
  script_xref(name:"URL", value:"http://rsync.samba.org/#security");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9153");
  script_xref(name:"URL", value:"http://lists.samba.org/archive/rsync-announce/2003/000011.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5729b8ed-5d75-11d8-80e3-0020ed76ef5a.html");
