...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56519");
...
via crafted encoded links.");
  ...
  script_xref(name:"URL", value:"http://mail.wikipedia.org/pipermail/mediawiki-announce/2006-March/000040.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17269");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/74b7403c-c4d5-11da-b2fb-000e0c2e438a.html");
