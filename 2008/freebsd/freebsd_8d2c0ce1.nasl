...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60835");
  ...
  script_xref(name:"URL", value:"http://ikiwiki.info/security/#index31h2");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8d2c0ce1-08b6-11dd-94b4-0016d325a0ed.html");
