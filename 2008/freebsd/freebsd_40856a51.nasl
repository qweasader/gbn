...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53066");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/15411/");
  script_xref(name:"URL", value:"http://www.opera.com/freebsd/changelogs/801/#security");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/40856a51-e1d9-11d9-b875-0001020eed82.html");
