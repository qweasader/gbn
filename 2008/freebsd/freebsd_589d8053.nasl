...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60833");
...
by the PROTOS GENOME test suite for Archive Formats.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/29000");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/589d8053-0b03-11dd-b4ef-00e07dc4ec84.html");
