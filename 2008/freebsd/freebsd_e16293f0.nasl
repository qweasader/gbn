...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52326");
...
variable in Groupware server messages.");
  ...
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/?id=2");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11056");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/e16293f0-26b7-11d9-9289-000c41e2cdad.html");
