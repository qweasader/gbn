...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52331");
...
to cause a denial of service (segmentation fault).");
  ...
  script_xref(name:"URL", value:"http://nagoya.apache.org/bugzilla/show_bug.cgi?id=29964");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11094");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11154");
  script_xref(name:"URL", value:"http://nagoya.apache.org/bugzilla/show_bug.cgi?id=30134");
  script_xref(name:"URL", value:"https://marc.info/?l=apache-httpd-announce&m=109527608022322");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/7b81fc47-239f-11d9-814e-0001020eed82.html");
