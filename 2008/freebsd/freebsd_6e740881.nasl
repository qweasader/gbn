...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52378");
...
via Javascript that sets the value of an <input type='file'> tag.");
  ...
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=241924");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/15495");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/6e740881-0cae-11d9-8a8a-000c41e2cdad.html");
