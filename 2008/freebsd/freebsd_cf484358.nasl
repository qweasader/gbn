...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60089");
  ...
  script_xref(name:"URL", value:"http://www.dovecot.org/list/dovecot-news/2007-December/000057.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/cf484358-b5d6-11dc-8de0-001c2514716c.html");
