...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52175");
...
'Firescrolling.'");
  ...
  script_xref(name:"URL", value:"http://www.mikx.de/fireflashing/");
  script_xref(name:"URL", value:"http://www.mikx.de/firescrolling/");
  script_xref(name:"URL", value:"http://www.mozilla.org/security/announce/mfsa2005-27.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/cbfde1cd-87eb-11d9-aa18-0001020eed82.html");
