...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52140");
...
user, which leads to an out-of-bounds read.");
  ...
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/?id=15");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13004");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/ecf68408-a9f5-11d9-a788-0001020eed82.html");
