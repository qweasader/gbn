...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61286");
...
code via a crafted PDF document.");
  ...
  script_xref(name:"URL", value:"http://milw0rm.com/exploits/6032");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/bc20510f-4dd4-11dd-93e7-0211d880e350.html");
