...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58864");
  ...
  script_xref(name:"URL", value:"http://fetchmail.berlios.de/fetchmail-SA-2007-01.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f1c4d133-e6d3-11db-99ea-0060084a00e5.html");
