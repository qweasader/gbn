...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61059");
  ...
  script_tag(name:"insight", value:"The following package is affected: vorbis-tools
...
dereference a function pointer.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/29882/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/633716fa-1f8f-11dd-b143-0211d880e350.html");
