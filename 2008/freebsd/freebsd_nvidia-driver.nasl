...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57506");
  ...
  script_xref(name:"URL", value:"http://www.rapid7.com/advisories/R7-0025.jsp");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a6d9da4a-5d5e-11db-8faf-000c6ec775d9.html");
