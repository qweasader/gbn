...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58270");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-07:04.file.asc)");
  ...
  script_tag(name:"insight", value:"The file(1) utility attempts to classify file system objects based on
...
in a buffer overflow when processing certain files.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-07:04.file.asc");
