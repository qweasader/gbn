...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57708");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/23347/");
  script_xref(name:"URL", value:"http://www.quantenblog.net/security/virus-scanner-bypass");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/eb5124a4-8a20-11db-b033-00123ffe8333.html");
