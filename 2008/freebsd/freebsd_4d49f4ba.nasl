...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52390");
...
during expansion of environment variables.");
  ...
  script_xref(name:"URL", value:"http://lists.netsys.com/pipermail/full-disclosure/2004-September/026463.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/4d49f4ba-071f-11d9-b45d-000c41e2cdad.html");
