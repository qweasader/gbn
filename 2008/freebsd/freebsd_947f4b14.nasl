...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55221");
  ...
  script_tag(name:"insight", value:"The following package is affected: bind
...
that tracks nameservers and addresses.");
  ...
  script_xref(name:"URL", value:"http://www.uniras.gov.uk/niscc/docs/al-20050125-00059.html?lang=en");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12364");
  script_xref(name:"URL", value:"http://www.isc.org/sw/bind/bind-security.php");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/947f4b14-1c89-11da-bc01-000e0c2e438a.html");
