...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61220");
...
properly handled when using vsnprintf to format log messages.");
  ...
  script_xref(name:"URL", value:"http://fetchmail.berlios.de/fetchmail-SA-2008-01.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/1e8e63c0-478a-11dd-a88d-000ea69a5213.html");
