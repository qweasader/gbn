...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57779");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/23528/");
  script_xref(name:"URL", value:"http://forums.cacti.net/about18846-0-asc-0.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/41da2ba4-a24e-11db-bd24-000f3dcc6a5d.html");
