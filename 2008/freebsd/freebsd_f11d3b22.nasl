...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56200");
...
bounces the message to the originator or local postmaster.");
  ...
  script_xref(name:"URL", value:"http://fetchmail.berlios.de/fetchmail-SA-2006-01.txt");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16365");
  script_xref(name:"URL", value:"http://bugs.debian.org/348747");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f11d3b22-88c6-11da-a7b2-0060084a00e5.html");
