...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52294");
...
an attacker to execute arbitrary code on the system.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11729");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/31952117-3d17-11d9-8818-008088034841.html");
