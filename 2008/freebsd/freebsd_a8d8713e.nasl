...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56714");
...
code via crafted COM_TABLE_DUMP packets with invalid length values.");
  ...
  script_xref(name:"URL", value:"http://dev.mysql.com/doc/refman/5.0/en/news-5-0-21.html");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=114659633220473");
