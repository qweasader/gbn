...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54183");
...
in the cli_msexpand function.");
  ...
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=112006402411598");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/14090");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/6d18fe19-ee67-11d9-8310-0001020eed82.html");
