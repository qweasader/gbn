...
#
# Auto generated from VID 87106b67-be13-11dd-a578-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61957");
...
functions.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/30190");
  script_xref(name:"URL", value:"http://www.cups.org/str.php?L2974");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/87106b67-be13-11dd-a578-0030843d3802.html");
