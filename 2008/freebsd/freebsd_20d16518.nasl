...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52330");
...
before the @ (at sign) in a URL.");
  ...
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=109834486312407");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11468");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/20d16518-2477-11d9-814e-0001020eed82.html");
