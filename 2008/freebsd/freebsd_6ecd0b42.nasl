...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60285");
...
attackers to execute arbitrary code via a crafted MPEG stream.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/19853/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/6ecd0b42-ce77-11dc-89b1-000e35248ad7.html");
