...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52161");
...
reference a URL on a remote web server that contains the code.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12644");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12645");
  script_xref(name:"URL", value:"https://marc.info/?l=bugtraq&m=110929725801154");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/882ef43b-901f-11d9-a22c-0001020eed82.html");
