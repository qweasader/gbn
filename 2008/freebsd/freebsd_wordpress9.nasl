...
#
# Auto generated from VID 622bc638-be27-11dd-a578-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61954");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/32882/");
  script_xref(name:"URL", value:"http://wordpress.org/development/2008/11/wordpress-265/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/622bc638-be27-11dd-a578-0030843d3802.html");
