...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57080");
...
allows script execution in the pub directory.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/20992/");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/18854");
  script_xref(name:"URL", value:"http://twiki.org/cgi-bin/view/Codev/SecurityAlertSecureFileUploads");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a876df84-0fef-11db-ac96-000c6ec775d9.html");
