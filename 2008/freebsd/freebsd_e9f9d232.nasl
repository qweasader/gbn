...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52376");
...
security lock icon that makes a web page appear to be encrypted.");
  ...
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=240053");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/15495");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/e9f9d232-0cb2-11d9-8a8a-000c41e2cdad.html");
