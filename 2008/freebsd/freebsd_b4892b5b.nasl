...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54425");
...
commands via the (1) filter or (2) cats_app parameter.");
  ...
  script_xref(name:"URL", value:"http://sourceforge.net/project/shownotes.php?release_id=320768");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b4892b5b-fb1c-11d9-96ba-00909925db3e.html");
