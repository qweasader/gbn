...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52643");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-04:01.mksnap_ffs.asc)");
  ...
  script_tag(name:"insight", value:"Mounted filesystems can have a variety of flags set on them.  Some
...
default value.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-04:01.mksnap_ffs.asc");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9533");
