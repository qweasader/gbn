...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56250");
  ...
  script_tag(name:"insight", value:"The following package is affected: kpopup
...
modifying the PATH variable to reference a malicious killall program.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/342736");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/8915");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/8918");
  script_xref(name:"URL", value:"http://www.henschelsoft.de/kpopup_en.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/1613db79-8e52-11da-8426-000fea0a9611.html");
