...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56268");
  ...
  script_tag(name:"insight", value:"The following package is affected: postgresql
...
that call other functions that accept internal arguments.");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/486aff57-9ecd-11da-b410-000e0c2e438a.html");
