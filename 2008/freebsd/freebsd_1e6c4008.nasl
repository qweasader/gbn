...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52328");
...
writes to the wrong buffer.");
  ...
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/?id=9");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/1e6c4008-245f-11d9-b584-0050fc56d258.html");
