...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52303");
...
consumption) via a certain HTTP request.");
  ...
  script_xref(name:"URL", value:"http://www.debian.org/security/2004/dsa-586");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11618");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/d656296b-33ff-11d9-a9e7-0001020eed82.html");
