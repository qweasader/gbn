...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58807");
  ...
  script_tag(name:"insight", value:"The following package is affected: lsh
...
vectors.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/14609");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/72cdf2ab-5b87-11dc-812d-0011098b2f36.html");
