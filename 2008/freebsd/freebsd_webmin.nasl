...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52391");
...
the /tmp/.usermin directory.");
  ...
  script_xref(name:"URL", value:"http://www.webmin.com/changes-1.160.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11153");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/ae7b7f65-05c7-11d9-b45d-000c41e2cdad.html");
