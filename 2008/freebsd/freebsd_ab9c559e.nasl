...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52368");
...
bitmap files that trigger heap-based buffer overflows.");
  ...
  script_xref(name:"URL", value:"http://bugzilla.mozilla.org/show_bug.cgi?id=255067");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11171");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/ab9c559e-115a-11d9-bc4a-000c41e2cdad.html");
