...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52733");
...
connect to other systems.");
  ...
  script_xref(name:"URL", value:"http://www.squid-cache.org/Versions/v2/2.5/bugs/#squid-2.5.STABLE9-cachemgr_conf");
  script_xref(name:"URL", value:"http://www.squid-cache.org/bugs/show_bug.cgi?id=1094");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a395397c-c7c8-11d9-9e1e-c296ac722cb3.html");
