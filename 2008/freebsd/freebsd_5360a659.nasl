...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52366");
...
trusted certificates.");
  ...
  script_xref(name:"URL", value:"http://bugzilla.mozilla.org/show_bug.cgi?id=234058");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5360a659-131c-11d9-bc4a-000c41e2cdad.html");
