...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56109");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-06:04.ipfw.asc)");
  ...
  script_tag(name:"insight", value:"ipfw(8) is a system facility which provides IP packet filtering,
...
pointer fails to get initialized.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:04.ipfw.asc");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16209");
