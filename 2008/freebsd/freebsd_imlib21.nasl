...
#
# Auto generated from VID 910486d5-ba4d-11dd-8f23-0019666436c2
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61913");
...
solely from third party information.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/Advisories/32796/");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/32371");
  script_xref(name:"URL", value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=505714#15");
  script_xref(name:"URL", value:"http://bugzilla.enlightenment.org/show_bug.cgi?id=547");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/910486d5-ba4d-11dd-8f23-0019666436c2.html");
