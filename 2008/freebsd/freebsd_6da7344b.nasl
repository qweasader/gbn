...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57104");
...
page title is output, possibly involving the $names variable.");
  ...
  script_xref(name:"URL", value:"http://drupal.org/node/66767");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/6da7344b-128a-11db-b25f-00e00c69a70d.html");
