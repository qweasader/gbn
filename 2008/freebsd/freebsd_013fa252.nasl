...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52389");
...
authoring access.");
  ...
  script_xref(name:"URL", value:"http://nagoya.apache.org/bugzilla/show_bug.cgi?id=31183");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/013fa252-0724-11d9-b45d-000c41e2cdad.html");
