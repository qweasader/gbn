...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52645");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-04:03.jail.asc)");
...
would fail only after changing the calling process's root directory.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-04:03.jail.asc");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9762");
