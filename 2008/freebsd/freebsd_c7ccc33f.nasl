...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52192");
...
'../' and './' sequences.");
  ...
  script_xref(name:"URL", value:"https://marc.info/?l=full-disclosure&m=110797575304304");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/c7ccc33f-7d31-11d9-a9e7-0001020eed82.html");
