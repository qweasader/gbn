...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60892");
...
of an undefined UploadDir variable.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/29944/");
  script_xref(name:"URL", value:"http://www.phpmyadmin.net/home_page/security.php?issue=PMASA-2008-3");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/fe971a0f-1246-11dd-bab7-0016179b2dd5.html");
...
if(!isnull(bver) && revcomp(a:bver, b:"2.11.5.2")<0) {
