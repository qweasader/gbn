...
#
# Auto generated from VID 724e6f93-8f2a-11dd-821f-001cc0377035
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61700");
...
causes the stream_read function to read or write arbitrary memory.");
  ...
  script_xref(name:"URL", value:"http://www.ocert.org/advisories/ocert-2008-013.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/724e6f93-8f2a-11dd-821f-001cc0377035.html");
