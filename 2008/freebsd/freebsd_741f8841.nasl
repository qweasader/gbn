...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52150");
...
using the sidebar panel to inject Javascript into a privileged page.");
  ...
  script_xref(name:"URL", value:"http://www.mozilla.org/security/announce/mfsa2005-31.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/741f8841-9c6b-11d9-9dbe-000a95bc6fae.html");
