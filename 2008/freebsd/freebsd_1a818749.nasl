...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60396");
  ...
  script_tag(name:"insight", value:"The following package is affected: zenphoto
...
albumnr parameter.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/27084");
  script_xref(name:"URL", value:"http://secunia.com/advisories/28281");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/1a818749-d646-11dc-8959-000bcdc1757a.html");
