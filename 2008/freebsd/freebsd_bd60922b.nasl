...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52402");
...
a denial of service (infinite loop) via a certain BER encoding.");
  ...
  script_xref(name:"URL", value:"http://web.mit.edu/kerberos/advisories/MITKRB5-SA-2004-003-asn1.txt");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11079");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/bd60922b-fb8d-11d8-a13e-000a95bc6fae.html");
