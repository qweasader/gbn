...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53077");
...
of a large size, possibly due to an integer signedness error.");
  ...
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/index.php?id=19");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/13932");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b6612eee-df5f-11d9-b875-0001020eed82.html");
