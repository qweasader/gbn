...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52148");
...
service (clamd daemon crash) via a Zip file with malformed headers.");
  ...
  script_xref(name:"URL", value:"http://sourceforge.net/project/shownotes.php?release_id=300116");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12408");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/70b62f5e-9e2e-11d9-a256-0001020eed82.html");
