...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57674");
  ...
  script_xref(name:"URL", value:"http://www.ruby-lang.org/en/news/2006/12/04/another-dos-vulnerability-in-cgi-library/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a8674c14-83d7-11db-88d5-0012f06707f0.html");
