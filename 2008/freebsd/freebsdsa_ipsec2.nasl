...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60398");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-08:04.ipsec.asc)");
  ...
  script_tag(name:"insight", value:"The IPsec suite of protocols provide network level security for IPv4
...
IPsec packets, which can result in a NULL pointer being dereferenced.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-08:04.ipsec.asc");
