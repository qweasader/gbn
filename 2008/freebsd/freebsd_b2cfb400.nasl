...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52341");
...
attackers to inject arbitrary web script via the UserAgent parameter.");
  ...
  script_xref(name:"URL", value:"http://www.securitytracker.com/alerts/2004/Aug/1011047.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11021");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b2cfb400-1df0-11d9-a859-0050fc56d258.html");
