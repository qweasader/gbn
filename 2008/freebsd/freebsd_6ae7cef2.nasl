...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.59976");
...
response splitting attacks via unspecified vectors.");
  ...
  script_xref(name:"URL", value:"http://svn.codehaus.org/jetty/jetty/trunk/VERSION.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/6ae7cef2-a6ae-11dc-95e6-000c29c5647f.html");
