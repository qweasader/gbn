...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56657");
...
2.0.1.");
  ...
  script_xref(name:"URL", value:"http://echo.or.id/adv/adv24-theday-2005.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/e0b342a1-d2ae-11da-a672-000e0c2e438a.html");
