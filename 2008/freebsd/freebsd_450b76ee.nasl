...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57472");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/22192/");
  script_xref(name:"URL", value:"http://secunia.com/advisories/22199/");
  script_xref(name:"URL", value:"http://bugs.splitbrain.org/?do=details&id=924");
  script_xref(name:"URL", value:"http://bugs.splitbrain.org/?do=details&id=926");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/450b76ee-5068-11db-a5ae-00508d6a62df.html");
