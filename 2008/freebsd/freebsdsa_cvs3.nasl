...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52664");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-05:05.cvs.asc)");
...
possible use of uninitialized variables, and memory leaks.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-05:05.cvs.asc");
