...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54381");
  ...
  script_xref(name:"URL", value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=212762");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/3497d7be-2fef-45f4-8162-9063751b573a.html");
