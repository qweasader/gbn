...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52509");
...
Web_Links module.");
  ...
  script_xref(name:"URL", value:"http://security.nnov.ru/search/document.asp?docid=5748");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9630");
  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/348375");
  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/353201");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/75770425-67a2-11d8-80e3-0020ed76ef5a.html");
