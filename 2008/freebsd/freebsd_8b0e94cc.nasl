...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52546");
...
(infinite loop) via malformed SNAC packets from (1) AIM or (2) ICQ.");
  ...
  script_xref(name:"URL", value:"http://gaim.sourceforge.net/security/index.php?id=10");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12589");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8b0e94cc-b5cd-11d9-a788-0001020eed82.html");
