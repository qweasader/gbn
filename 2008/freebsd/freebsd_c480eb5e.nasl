...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52491");
  ...
  script_tag(name:"insight", value:"The following package is affected: ezbounce
...
attackers to execute arbitrary code via the 'sessions' command.");
  ...
  script_xref(name:"URL", value:"http://ezbounce.dc-team.com/");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/8071");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/c480eb5e-7f00-11d8-868e-000347dd607f.html");
