...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56263");
...
circuit to be built through the malicious server.");
  ...
  script_xref(name:"URL", value:"http://archives.seul.org/or/announce/Jan-2006/msg00001.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/d38e1810-9ef7-11da-b410-000e0c2e438a.html");
