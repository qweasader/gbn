...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52365");
...
interactive events to manipulate the XPInstall Security dialog box.");
  ...
  script_xref(name:"URL", value:"http://bugzilla.mozilla.org/show_bug.cgi?id=162020");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/15495");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a7e0d783-131b-11d9-bc4a-000c41e2cdad.html");
