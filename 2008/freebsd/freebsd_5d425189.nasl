...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52194");
...
extension.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12411");
  script_xref(name:"URL", value:"http://archives.postgresql.org/pgsql-bugs/2005-01/msg00269.php");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5d425189-7a03-11d9-a9e7-0001020eed82.html");
