...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57068");
  ...
  script_xref(name:"URL", value:"http://dev.mutt.org/cgi-bin/gitweb.cgi?p=mutt/.git;a=commit;h=dc0272b749f0e2b102973b7ac43dbd3908507540");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/18642");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/d2a43243-087b-11db-bc36-0008743bf21a.html");
