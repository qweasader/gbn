...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57197");
  ...
  script_xref(name:"URL", value:"http://drupal.org/files/sa-2006-011/advisory.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/c905298c-2274-11db-896e-000ae42e9b93.html");
