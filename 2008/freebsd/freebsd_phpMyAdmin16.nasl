...
#
# Auto generated from VID 74bf1594-8493-11dd-bb64-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61659");
  ...
  script_xref(name:"URL", value:"http://secunia.com/Advisories/31884/");
  script_xref(name:"URL", value:"http://www.phpmyadmin.net/home_page/security.php?issue=PMASA-2008-7");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/74bf1594-8493-11dd-bb64-0030843d3802.html");
