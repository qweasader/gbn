...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56851");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-06:15.ypserv.asc)");
  ...
  script_tag(name:"insight", value:"The ypserv(8) utility is a server which distributes NIS databases to client
...
to be inadvertently disabled.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:15.ypserv.asc");
