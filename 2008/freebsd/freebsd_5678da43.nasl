...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58861");
  ...
  script_xref(name:"URL", value:"http://www.lighttpd.net/assets/2007/4/13/lighttpd_sa2007_02.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/5678da43-ea99-11db-a802-000fea2763ce.html");
