...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52152");
...
not properly handled when the user replies to the message.");
  ...
  script_xref(name:"URL", value:"http://sylpheed.good-day.net/index.cgi.en#changes");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/f8536143-9bc4-11d9-b8b3-000a95bc6fae.html");
