...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52346");
...
via TIFF images that lead to incorrect malloc calls.");
  ...
  script_xref(name:"URL", value:"http://www.idefense.com/application/poi/display?id=173&type=vulnerabilities");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11406");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/3897a2f8-1d57-11d9-bc4a-000c41e2cdad.html");
