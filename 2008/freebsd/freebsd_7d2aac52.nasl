...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52151");
...
extension 2 block and buffer size.");
  ...
  script_xref(name:"URL", value:"http://www.mozilla.org/security/announce/mfsa2005-30.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12881");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/15495");
  script_xref(name:"URL", value:"http://xforce.iss.net/xforce/alerts/id/191");
  script_xref(name:"URL", value:"https://bugzilla.mozilla.org/show_bug.cgi?id=285595");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/7d2aac52-9c6b-11d9-99a7-000a95bc6fae.html");
