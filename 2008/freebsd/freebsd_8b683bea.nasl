...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56653");
  ...
  script_tag(name:"insight", value:"The following package is affected: asterisk
...
buffer overflow when it is used as an unsigned length.");
  ...
  script_xref(name:"URL", value:"http://www.cipher.org.uk/index.php?p=advisories/Asterisk_Codec_Integer_Overflow_07-04-2006.advisory");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17561");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8b683bea-d49c-11da-a672-000e0c2e438a.html");
