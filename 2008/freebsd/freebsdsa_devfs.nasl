...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54382");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-05:17.devfs.asc)");
...
namespace in the global file system namespace.  This includes access
to system devices such as storage devices, kernel and system memory
devices, BPF devices, and serial port devices.  Devfs is generally
...
jail with their normal default access permissions.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-05:17.devfs.asc");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/14334");
