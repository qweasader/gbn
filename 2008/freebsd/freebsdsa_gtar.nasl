...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57680");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-06:26.gtar.asc)");
...
absolute due to lack of proper sanity checks.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-06:26.gtar.asc");
