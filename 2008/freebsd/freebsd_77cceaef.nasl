...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56773");
...
using UNC share pathnames.");
  ...
  script_xref(name:"URL", value:"http://retrogod.altervista.org/cpg_143_adv.html");
  script_xref(name:"URL", value:"http://secunia.com/advisories/18941/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/77cceaef-e9a4-11da-b9f4-00123ffe8333.html");
