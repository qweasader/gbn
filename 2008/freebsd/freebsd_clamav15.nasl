...
#
# Auto generated from VID da5c4072-8082-11dd-9c8c-001c2514716c
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61615");
...
a malformed CHM file, related to an 'invalid memory access.'");
  ...
  script_xref(name:"URL", value:"https://wwws.clamav.net/bugzilla/show_bug.cgi?id=1089");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/da5c4072-8082-11dd-9c8c-001c2514716c.html");
