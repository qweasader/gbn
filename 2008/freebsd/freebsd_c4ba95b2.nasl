...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61191");
...
users, which allows remote attackers to gain privileges.");
  ...
  script_xref(name:"URL", value:"http://hg.moinmo.in/moin/1.6/rev/f405012e67af");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/c4ba95b2-39ce-11dd-98c9-00163e000016.html");
