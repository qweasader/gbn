...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60395");
  ...
  script_xref(name:"URL", value:"http://ikiwiki.info/security/#index30h2");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/739329c8-d8f0-11dc-ac2f-0016d325a0ed.html");
