...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52373");
...
follow renames.");
  ...
  script_xref(name:"URL", value:"http://subversion.tigris.org/security/CVE-2004-0749-advisory.txt");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11243");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/184f5d0b-0fe8-11d9-8a8a-000c41e2cdad.html");
