...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.52505");
...
via malformed e-mail commands.");
  ...
  script_xref(name:"URL", value:"http://umn.dl.sourceforge.net/sourceforge/mailman/mailman-2.0.13-2.0.14-diff.txt");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9620");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/b0e76877-67a8-11d8-80e3-0020ed76ef5a.html");
