...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56656");
...
arbitrary files via a symlink attack on a temporary PID file.");
  ...
  script_xref(name:"URL", value:"http://www.debian.org/security/2005/dsa-658");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12360");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/8cfb6f42-d2b0-11da-a672-000e0c2e438a.html");
