...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.62857");
...
within the multi_sort function in core/utility_api.php.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/32314/");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/af2745c0-c3e0-11dd-a721-0030843d3802.html");
