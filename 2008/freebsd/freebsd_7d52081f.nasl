...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55356");
...
preferences of other users.");
  ...
  script_xref(name:"URL", value:"http://www.squirrelmail.org/security/issue/2005-07-13");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/14254");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/7d52081f-2795-11da-bc01-000e0c2e438a.html");
