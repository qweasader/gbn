...
if(description)
{
  ...
  script_tag(name:"affected", value:"Firefox version 3.0.1 through 3.0.3.");
  ...
  script_tag(name:"summary", value:"Mozilla Firefox browser is prone to a cross-site scripting (XSS)
  vulnerability.");
