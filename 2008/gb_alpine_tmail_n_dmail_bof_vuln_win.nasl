...
if(description)
{
  ...
  script_tag(name:"affected", value:"University of Washington Alpine 2.00 and prior on Windows.");
  ...
  script_tag(name:"summary", value:"Alpine is prone to buffer overflow vulnerabilities.");
