...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54989");
  ...
  script_tag(name:"insight", value:"pam_ldap and nss_ldap fail to restart TLS when following a referral,
...
All nss_ldap users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200507-13");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/14125");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/14126");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=96767");
