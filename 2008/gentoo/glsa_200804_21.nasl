...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60821");
...
arbitrary code execution on a user's system via a malicious Flash file.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200804-21");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=204344");
