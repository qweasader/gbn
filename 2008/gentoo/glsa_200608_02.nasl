...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57852");
  ...
  script_tag(name:"insight", value:"The Mozilla Foundation has reported numerous security vulnerabilities
related to Mozilla SeaMonkey.");
  script_tag(name:"solution", value:"All Thunderbird users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=www-client/seamonkey-1.0.3'");

  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200608-02");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=141842");
