...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61391");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in Python may allow for the execution of arbitrary
code.");
  script_tag(name:"solution", value:"All Python 2.4 users should upgrade to the latest version:
...
future.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200807-16");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=230640");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=232137");
