...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61441");
  ...
  script_tag(name:"insight", value:"stunnel does not properly prevent the authentication of a revoked
certificate which would be published by OCSP.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200808-08");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=222805");
