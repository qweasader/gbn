...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61184");
  ...
  script_tag(name:"insight", value:"Font parsing vulnerabilities in FreeType might lead to user-assisted
execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200806-10");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=225851");
