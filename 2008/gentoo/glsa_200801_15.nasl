...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60278");
  ...
  script_tag(name:"insight", value:"PostgreSQL contains multiple vulnerabilities that could result in privilege
escalation or a Denial of Service.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200801-15");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=204760");
