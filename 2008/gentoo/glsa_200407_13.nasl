...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54620");
  ...
  script_tag(name:"insight", value:"Multiple security vulnerabilities, potentially allowing remote code
...
version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200407-13");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=56985");
