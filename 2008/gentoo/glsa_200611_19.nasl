...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57932");
  ...
  script_tag(name:"insight", value:"ImageMagick improperly handles PALM and DCM images, potentially resulting
in the execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200611-19");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=152672");
