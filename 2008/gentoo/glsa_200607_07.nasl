...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57844");
  ...
  script_tag(name:"insight", value:"A buffer overflow has been found in the libmms library shipped with
xine-lib, potentially resulting in the execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200607-07");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=139319");
