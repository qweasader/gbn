...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54831");
...
to finalize the update.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-45");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=78522");
  script_xref(name:"URL", value:"http://gallery.menalto.com/modules.php?op=modload&name=News&file=article&sid=149");
  script_xref(name:"URL", value:"http://secunia.com/advisories/13887/");
