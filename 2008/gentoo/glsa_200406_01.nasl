...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54586");
...
which may allow an attacker to run arbitrary code or crash the program.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200406-01");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=51022");
