...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56327");
  ...
  script_tag(name:"insight", value:"A flaw in the parsing of Distinguished Encoding Rules (DER) has been
...
All GNU TLS users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200602-08");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16568");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=122307");
