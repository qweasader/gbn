...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60872");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities have been identified in BEA JRockit.");
  script_tag(name:"solution", value:"All JRockit 1.4 users should upgrade to the latest version:
...
All JRockit 1.5 users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200804-28");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=218226");
