...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60939");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in the Horde Application Framework may lead to the
...
All horde-webmail users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200805-01");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=212635");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=213493");
