...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54743");
  ...
  script_tag(name:"insight", value:"Davfs2 and the lvmcreate_initrd script (included in the lvm-user package)
...
to overwrite arbitrary files with the rights of the user running them.");
  script_tag(name:"solution", value:"All Davfs2 users should upgrade to the latest version:
...
All lvm-user users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200411-22");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11290");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=68406");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=69149");
