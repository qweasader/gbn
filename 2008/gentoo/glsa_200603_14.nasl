...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56542");
  ...
  script_tag(name:"insight", value:"An error in the rshd daemon of Heimdal could allow authenticated users to
elevate privileges.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200603-14");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16524");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=121839");
