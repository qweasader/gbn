...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54609");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities have been found in the Linux kernel used by
...
system:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200407-02");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=47881");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=49637");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=53804");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=54976");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=55698");
