...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58188");
  ...
  script_tag(name:"insight", value:"Asterisk is vulnerable to two Denial of Service issues in the SIP channel.");
...
consider upgrading to Asterisk 1.2.x.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200704-01");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=171467");
