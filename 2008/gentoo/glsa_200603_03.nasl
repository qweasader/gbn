...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56364");
  ...
  script_tag(name:"insight", value:"MPlayer is vulnerable to integer overflows in FFmpeg and ASF decoding that
could potentially result in the execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200603-03");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=115760");
