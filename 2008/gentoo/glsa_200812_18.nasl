...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.62967");
  ...
  script_tag(name:"insight", value:"Multiple memory management errors in JasPer might lead to execution of
arbitrary code via jpeg2k files.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200812-18");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=222819");
