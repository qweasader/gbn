...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54923");
  ...
  script_tag(name:"insight", value:"RealPlayer and Helix Player are vulnerable to a buffer overflow that could
...
All Helix Player users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200504-21");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=89862");
  script_xref(name:"URL", value:"http://service.real.com/help/faq/security/050419_player/EN/");
