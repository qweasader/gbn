...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57004");
  ...
  script_tag(name:"insight", value:"Several vulnerabilities in Mozilla Thunderbird allow cross site scripting,
...
such a version is available.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200606-21");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=135256");
