...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54690");
  ...
  script_tag(name:"insight", value:"libXpm, the X Pixmap library that is a part of the X Window System,
...
switch to X.org rather than upgrading XFree86.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200409-34");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=64152");
  script_xref(name:"URL", value:"http://freedesktop.org/pipermail/xorg/2004-September/003196.html");
