...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60623");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities have been found in MIT Kerberos 5, which could
...
privileges.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200803-31");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=199205");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=212363");
