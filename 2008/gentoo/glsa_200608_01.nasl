...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57851");
  ...
  script_tag(name:"insight", value:"A flaw in mod_rewrite could result in a Denial of Service or the execution
of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200608-01");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=141986");
  script_xref(name:"URL", value:"http://www.apache.org/dist/httpd/Announcement2.0.html");
