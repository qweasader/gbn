...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57859");
  ...
  script_tag(name:"insight", value:"An authenticated user can crash MySQL through invalid parameters to the
date_format function.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200608-09");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=142429");
