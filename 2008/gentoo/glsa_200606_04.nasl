...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56927");
  ...
  script_tag(name:"insight", value:"Tor is vulnerable to a possible buffer overflow, a Denial of Service,
information disclosure and information leak.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200606-04");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=134329");
  script_xref(name:"URL", value:"http://tor.eff.org/cvs/tor/ChangeLog");
