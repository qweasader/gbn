...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54685");
  ...
  script_tag(name:"insight", value:"Multiple Denial of Service vulnerabilities were found and fixed in
FreeRADIUS.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200409-29");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=60587");
