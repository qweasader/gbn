...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60282");
  ...
  script_tag(name:"insight", value:"A Denial of Service vulnerability has been reported in libxml2.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200801-20");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=202628");
