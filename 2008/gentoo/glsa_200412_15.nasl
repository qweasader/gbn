...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54774");
...
utilization.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200412-15");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=74443");
