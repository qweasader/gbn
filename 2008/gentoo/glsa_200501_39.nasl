...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54825");
  ...
  script_tag(name:"insight", value:"SquirrelMail fails to properly sanitize user input, which could lead to
...
to finalize the update.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-39");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=78116");
  script_xref(name:"URL", value:"http://sourceforge.net/mailarchive/message.php?msg_id=10628451");
