...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60507");
  ...
  script_tag(name:"insight", value:"A persistent Cross-Site Scripting vulnerability has been discovered in
Mantis.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200803-04");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=203791");
