...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57960");
  ...
  script_tag(name:"insight", value:"The Ruby cgi.rb CGI library is vulnerable to a Denial of Service attack.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200612-21");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=157048");
