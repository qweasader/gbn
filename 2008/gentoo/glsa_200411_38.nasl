...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54759");
  ...
  script_tag(name:"insight", value:"The Java plug-in security in Sun and Blackdown Java environments can be
...
Note: You should unmerge all vulnerable versions to be fully protected.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200411-38");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11726");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=72172");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=72221");
  script_xref(name:"URL", value:"http://www.idefense.com/application/poi/display?id=158&type=vulnerabilities");
  script_xref(name:"URL", value:"http://www.blackdown.org/java-linux/java2-status/security/Blackdown-SA-2004-01.txt");
