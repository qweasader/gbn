...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54589");
  ...
  script_tag(name:"insight", value:"Mailman contains a bug allowing 3rd parties to retrieve member passwords.");
  script_tag(name:"solution", value:"All users of Mailman should upgrade to the latest stable version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200406-04");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10412");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=51671");
