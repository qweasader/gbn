...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54633");
  ...
  script_tag(name:"insight", value:"libpng contains numerous vulnerabilities potentially allowing an attacker
to perform a Denial of Service attack or even execute arbitrary code.");
  script_tag(name:"solution", value:"All libpng users should upgrade to the latest stable version:
...
older versions of libpng :
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200408-03");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=59424");
