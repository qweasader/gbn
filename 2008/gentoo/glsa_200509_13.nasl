...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55393");
  ...
  script_tag(name:"insight", value:"Clam AntiVirus is subject to vulnerabilities ranging from Denial of Service
to execution of arbitrary code when handling compressed executables.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200509-13");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=106279");
  script_xref(name:"URL", value:"http://sourceforge.net/project/shownotes.php?release_id=356974");
