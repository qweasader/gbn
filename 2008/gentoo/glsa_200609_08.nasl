...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57886");
  ...
  script_tag(name:"insight", value:"xine-lib is vulnerable to multiple buffer overflows that could be exploited
to execute arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200609-08");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=133520");
