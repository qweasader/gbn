...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54985");
...
remote execution of arbitrary code.");
  script_tag(name:"solution", value:"Since Adobe will most likely not update the 5.0 series of Adobe Acrobat
...
of the 7.0 series:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200507-09");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=98101");
  script_xref(name:"URL", value:"http://www.idefense.com/application/poi/display?id=279&type=vulnerabilities&flashstatus=true");
