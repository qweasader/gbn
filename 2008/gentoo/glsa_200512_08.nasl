...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56022");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities have been discovered in Xpdf, GPdf, CUPS and
...
All CUPS users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200512-08");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=114428");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=115286");
