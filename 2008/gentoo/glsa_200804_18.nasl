...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60818");
  ...
  script_tag(name:"insight", value:"Poppler does not handle fonts inside PDF files safely, allowing for
execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200804-18");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=216850");
