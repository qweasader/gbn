...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60280");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in Kazehakase could result in the execution of
arbitrary code.");
  script_tag(name:"solution", value:"All Kazehakase users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=www-client/kazehakase-0.5.0'");

  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200801-18");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=198983");
