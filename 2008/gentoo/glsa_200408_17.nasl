...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54647");
  ...
  script_tag(name:"insight", value:"rsync fails to properly sanitize paths. This vulnerability could allow the
...
path on rsync server configurations that allow uploading.");
  script_tag(name:"solution", value:"All users should update to the latest version of the rsync package.
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200408-17");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=60309");
