...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58656");
  ...
  script_tag(name:"insight", value:"KPDF includes code from xpdf that is vulnerable to a stack-based buffer
overflow.");
...
All KPDF users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200710-08");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=187139");
