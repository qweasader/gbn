...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58545");
  ...
  script_tag(name:"insight", value:"A Denial of Service vulnerability and a table structure information leakage
vulnerability were found in MySQL.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200708-10");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=185333");
