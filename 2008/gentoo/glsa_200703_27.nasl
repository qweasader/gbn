...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58186");
  ...
  script_tag(name:"insight", value:"Squid is affected by a Denial of Service vulnerability.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200703-27");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=171681");
