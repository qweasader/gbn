...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58125");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities have been reported in SeaMonkey, some of which may
allow user-assisted arbitrary remote code execution.");
  script_tag(name:"solution", value:"Users upgrading to the following release of SeaMonkey should note that the
...
All SeaMonkey binary users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200703-08");
