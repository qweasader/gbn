...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54896");
  ...
  script_tag(name:"insight", value:"Mozilla Firefox 1.0.2 fixes new security vulnerabilities, including the
...
'>=www-client/mozilla-firefox-bin-1.0.2'");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200503-31");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=86148");
