...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58153");
  ...
  script_tag(name:"insight", value:"PostgreSQL contains two vulnerabilities that could result in a Denial of
Service or unauthorized access to certain information.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200703-15");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=165482");
