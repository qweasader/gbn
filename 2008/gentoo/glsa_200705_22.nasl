...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58300");
  ...
  script_tag(name:"insight", value:"A vulnerability has been discovered in FreeType allowing for the execution
of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200705-22");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=179161");
