...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54781");
  ...
  script_tag(name:"insight", value:"mpg123 is vulnerable to a buffer overflow that allows an attacker to
execute arbitrary code through the use of a malicious playlist.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200412-22");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=74692");
