...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58539");
  ...
  script_tag(name:"insight", value:"A vulnerability has been discovered in ClamAV, allowing for a Denial of
Service.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200708-04");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=185013");
