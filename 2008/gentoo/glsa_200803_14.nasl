...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60517");
  ...
  script_tag(name:"insight", value:"A stack-based buffer overflow has been discovered in Ghostscript, allowing
arbitrary code execution.");
  script_tag(name:"solution", value:"All Ghostscript ESP users should upgrade to the latest version:
...
All Ghostscript GNU users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200803-14");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=208999");
