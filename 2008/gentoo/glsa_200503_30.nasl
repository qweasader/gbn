...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54895");
  ...
  script_tag(name:"insight", value:"The Mozilla Suite is vulnerable to multiple issues ranging from the remote
...
All Mozilla Suite binary users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200503-30");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=84074");
