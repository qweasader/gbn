...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56120");
  ...
  script_tag(name:"insight", value:"xine-lib and FFmpeg are vulnerable to a buffer overflow that may be
...
'>=media-video/ffmpeg-0.4.9_p20051216'");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200601-06");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/15743");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=115849");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=116181");
