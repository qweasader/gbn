...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58654");
  ...
  script_tag(name:"insight", value:"A buffer underflow vulnerability and an information disclosure
vulnerability have been discovered in OpenSSL.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200710-06");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=188799");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=194039");
