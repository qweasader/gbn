...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58741");
  ...
  script_tag(name:"insight", value:"A flaw has been discovered in OpenSSH which could allow a local attacker to
bypass security restrictions.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200711-02");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=191321");
