...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55573");
  ...
  script_tag(name:"insight", value:"RealPlayer and Helix Player are vulnerable to a format string vulnerability
...
All Helix Player users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200510-07");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=107309");
