...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54881");
...
run arbitrary code or crash the program.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200503-16");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=84547");
