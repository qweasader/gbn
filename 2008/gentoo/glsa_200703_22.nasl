...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58160");
  ...
  script_tag(name:"insight", value:"The Mozilla Network Security Services libraries are vulnerable to two
...
code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200703-22");
