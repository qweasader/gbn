...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56685");
  ...
  script_tag(name:"insight", value:"Several vulnerabilities in Mozilla Suite allow attacks ranging from script
execution with elevated privileges to information leaks.");
  script_tag(name:"solution", value:"All Mozilla Suite users should upgrade to the latest version:
...
All Mozilla Suite binary users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200604-18");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=130887");
