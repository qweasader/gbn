...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58546");
  ...
  script_tag(name:"insight", value:"Several vulnerabilities were reported in Lighttpd, most of them allowing a
Denial of Service and potentially the remote execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200708-11");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=185442");
