...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60449");
  ...
  script_tag(name:"insight", value:"xine-lib is vulnerable to multiple buffer overflows when processing FLAC
and ASF streams.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200802-12");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=209106");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=208100");
