...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60815");
  ...
  script_tag(name:"insight", value:"A vulnerability in libpng may allow for execution of arbitrary code in
certain applications that handle untrusted images.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200804-15");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=217047");
