...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58428");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities have been discovered in emul-linux-x86-java,
possibly resulting in the execution of arbitrary code or a Denial of
Service.");
  script_tag(name:"solution", value:"All Emul-linux-x86-java users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=app-emulation/emul-linux-x86-java-1.5.0.11'");

  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200706-08");
