...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56330");
  ...
  script_tag(name:"insight", value:"A flaw in OpenSSH and Dropbear allows local users to elevate their
privileges via scp.");
...
All Dropbear users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200602-11");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16369");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=119232");
