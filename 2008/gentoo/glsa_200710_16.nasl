...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58677");
  ...
  script_tag(name:"insight", value:"A vulnerability has been discovered in the Composite extension of the X.Org
X server, allowing for a local privilege escalation.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200710-16");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=191964");
