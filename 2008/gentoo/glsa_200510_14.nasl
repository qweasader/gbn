...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55649");
...
All CMake users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200510-14");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=105719");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=105721");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=106678");
