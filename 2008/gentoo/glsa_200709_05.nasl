...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58602");
  ...
  script_tag(name:"insight", value:"RealPlayer is vulnerable to a buffer overflow allowing for execution of
arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200709-05");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=183421");
