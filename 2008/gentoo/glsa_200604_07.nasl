...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56621");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities have been discovered in the ADOdb layer included
...
'>=net-analyzer/cacti-0.8.6h_p20060108-r2'");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200604-07");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=129284");
