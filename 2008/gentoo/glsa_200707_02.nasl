...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58455");
...
All OpenOffice.org binary users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200707-02");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=181773");
