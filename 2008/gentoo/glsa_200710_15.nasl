...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58676");
  ...
  script_tag(name:"insight", value:"KDM allows logins without password under certain circumstances allowing a
local user to gain elevated privileges.");
  script_tag(name:"solution", value:"All KDM users should upgrade to the latest version:
...
All kdebase users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200710-15");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=192373");
