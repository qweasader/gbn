...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54817");
  ...
  script_tag(name:"insight", value:"teTeX, pTeX and CSTeX make use of vulnerable Xpdf code which may allow the
...
Finally, all pTeX users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200501-31");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=75801");
