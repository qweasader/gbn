...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61380");
  ...
  script_tag(name:"insight", value:"An integer overflow vulnerability has been reported in OpenOffice.org.");
...
All OpenOffice.org binary users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200807-05");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=225723");
