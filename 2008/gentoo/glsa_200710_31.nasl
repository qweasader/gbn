...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58710");
  ...
  script_tag(name:"insight", value:"Opera contains multiple vulnerabilities, which may allow the execution of
arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200710-31");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=196164");
