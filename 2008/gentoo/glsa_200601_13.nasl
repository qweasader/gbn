...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56225");
  ...
  script_tag(name:"insight", value:"Gallery is possibly vulnerable to a cross-site scripting attack that could
...
to finalize the update.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200601-13");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=119590");
  script_xref(name:"URL", value:"http://gallery.menalto.com/page/gallery_1_5_2_release");
