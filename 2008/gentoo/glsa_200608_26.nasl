...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57876");
  ...
  script_tag(name:"insight", value:"Wireshark is vulnerable to several security issues that may lead to a
Denial of Service and/or the execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200608-26");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=144946");
  script_xref(name:"URL", value:"http://www.wireshark.org/security/wnpa-sec-2006-02.html");
