...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54935");
...
the execution of arbitrary code or abnormal termination.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200505-03");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=90539");
