...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57909");
  ...
  script_tag(name:"insight", value:"OpenSSL contains multiple vulnerabilities including the possible remote
execution of arbitrary code.");
  script_tag(name:"solution", value:"All OpenSSL 0.9.8 users should upgrade to the latest version:
...
All OpenSSL 0.9.7 users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200610-11");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=145510");
