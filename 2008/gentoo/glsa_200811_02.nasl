...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61857");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in Gallery may lead to execution of arbitrary
code, disclosure of local files or theft of user's credentials.");
  script_tag(name:"solution", value:"All Gallery 2 users should upgrade to the latest version:
...
All Gallery 1 users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200811-02");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=234137");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=238113");
