...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61382");
  ...
  script_tag(name:"insight", value:"NX uses code from the X.org X11 server which is prone to multiple
vulnerabilities.");
  script_tag(name:"solution", value:"All NX Node users should upgrade to the latest version:
...
All NX users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200807-07");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=230147");
  script_xref(name:"URL", value:"http://www.gentoo.org/security/en/glsa/glsa-200806-07.xml");
