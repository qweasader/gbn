...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58746");
  ...
  script_tag(name:"insight", value:"Multiple integer overflow vulnerabilities have been discovered in Python,
possibly resulting in the execution of arbitrary code or a Denial of
Service.");
  script_tag(name:"solution", value:"All Python 2.3.x users should upgrade to the latest version:
...
All Python 2.4.x users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200711-07");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=192876");
