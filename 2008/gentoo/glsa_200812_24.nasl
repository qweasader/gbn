...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63069");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in VLC may lead to the remote execution of
arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200812-24");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=245774");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=249391");
