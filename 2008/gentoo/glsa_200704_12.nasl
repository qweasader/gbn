...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58218");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities have been discovered in OpenOffice.org, allowing
...
All OpenOffice.org binary users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200704-12");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=170828");
  script_xref(name:"URL", value:"http://www.gentoo.org/security/en/glsa/glsa-200704-07.xml");
