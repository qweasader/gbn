...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54893");
  ...
  script_tag(name:"insight", value:"Java Web Start JNLP files can be abused to evade sandbox restriction and
...
All Sun JRE users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200503-28");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=85804");
  script_xref(name:"URL", value:"http://jouko.iki.fi/adv/ws.html");
  script_xref(name:"URL", value:"http://sunsolve.sun.com/search/document.do?assetkey=1-26-57740-1");
