...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.62964");
  ...
  script_tag(name:"insight", value:"POV-Ray includes a version of libpng that might allow for the execution of
arbitrary code when reading a specially crafted PNG file");
  script_tag(name:"solution", value:"All POV-Ray users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=media-gfx/povray-3.6.1-r4'");

  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200812-15");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=153538");
