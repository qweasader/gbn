...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55640");
  ...
  script_tag(name:"insight", value:"When using a specific option, OpenSSL can be forced to fallback to the less
secure SSL 2.0 protocol.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200510-11");
  ...
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=108852");
