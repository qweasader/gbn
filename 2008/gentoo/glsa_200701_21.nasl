...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57981");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in MIT Kerberos 5 could potentially result in the
execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200701-21");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=158810");
