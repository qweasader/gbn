...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60515");
  ...
  script_tag(name:"insight", value:"A format string error has been discovered in Evolution, possibly resulting
in the execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200803-12");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=212272");
