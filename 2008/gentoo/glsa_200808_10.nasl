...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61443");
  ...
  script_tag(name:"insight", value:"Adobe Reader is vulnerable to execution of arbitrary code via a crafted
PDF.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200808-10");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=233383");
