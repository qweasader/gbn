...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56727");
  ...
  script_tag(name:"insight", value:"The Quake 3 engine has a vulnerability that could be exploited to execute
arbitrary code.");
  script_tag(name:"solution", value:"All Quake 3 users should upgrade to the latest version:
...
All Enemy Territory users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200605-12");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17857");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=132377");
