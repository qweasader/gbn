...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56414");
  ...
  script_tag(name:"insight", value:"A malicious tar archive could trigger a Buffer overflow in GNU tar,
potentially resulting in the execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200603-06");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/16764");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=123038");
