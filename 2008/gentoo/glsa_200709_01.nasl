...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58599");
  ...
  script_tag(name:"insight", value:"Two vulnerabilities have been found in MIT Kerberos 5, which could allow a
...
privileges.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200709-01");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=191301");
