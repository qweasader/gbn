...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54526");
  ...
  script_tag(name:"insight", value:"A buffer overflow has been discovered in libxml2 versions prior to 2.6.6
which may be exploited by an attacker allowing the execution of arbitrary
code.");
  script_tag(name:"solution", value:"All users are recommended to upgrade their libxml2 installation:

    # emerge sync
    # emerge -pv '>=dev-libs/libxml2-2.6.6'
    # emerge '>=dev-libs/libxml2-2.6.6'");

  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200403-01");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9718");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=42735");
