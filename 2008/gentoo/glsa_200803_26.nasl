...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60589");
  ...
  script_tag(name:"insight", value:"An insecure temporary file creation vulnerability has been discovered in
Adobe Acrobat Reader.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200803-26");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=212367");
