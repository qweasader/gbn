...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60874");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in start_kdeinit could possibly allow a local
attacker to execute arbitrary code with root privileges.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200804-30");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=218933");
