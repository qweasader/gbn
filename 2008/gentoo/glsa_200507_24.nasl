...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55000");
  ...
  script_tag(name:"insight", value:"Several vulnerabilities in the Mozilla Suite allow attacks ranging from the
...
All Mozilla Suite binary users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200507-24");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/14242");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=98846");
