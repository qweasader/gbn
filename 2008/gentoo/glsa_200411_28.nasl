...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54749");
  ...
  script_tag(name:"insight", value:"libXpm contains several vulnerabilities that could lead to a Denial of
...
All XFree86 users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200411-28");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11694");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=68544");
