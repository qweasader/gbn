...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56152");
  ...
  script_tag(name:"insight", value:"Sun's and Blackdown's JDK or JRE may allow untrusted applets to elevate
their privileges.");
...
a SPARC package is released.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200601-10");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=118114");
  script_xref(name:"URL", value:"http://sunsolve.sun.com/searchproxy/document.do?assetkey=1-26-102003-1");
  script_xref(name:"URL", value:"http://www.blackdown.org/java-linux/java2-status/security/Blackdown-SA-2005-03.txt");
