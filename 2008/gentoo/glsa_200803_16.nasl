...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.60519");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities have been discovered in MPlayer, possibly allowing
for the remote execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200803-16");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=208566");
