...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54783");
  ...
  script_tag(name:"insight", value:"New integer overflows were discovered in Xpdf, potentially resulting in the
...
All GPdf users should also upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200412-24");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=75191");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=75201");
  script_xref(name:"URL", value:"http://www.idefense.com/application/poi/display?id=172&type=vulnerabilities&flashstatus=true");
