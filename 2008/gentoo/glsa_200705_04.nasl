...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58254");
  ...
  script_tag(name:"insight", value:"The mod_perl Apache module is vulnerable to a Denial of Service when
processing regular expressions.");
  script_tag(name:"solution", value:"All mod_perl 1.x users should upgrade to the latest version:
...
All mod_perl 2.x users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200705-04");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=172676");
