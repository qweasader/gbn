...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54681");
  ...
  script_tag(name:"insight", value:"A vulnerability in CUPS allows remote attackers to cause a denial of
service when sending a carefully-crafted UDP packet to the IPP port.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200409-25");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11183");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=64168");
  script_xref(name:"URL", value:"http://www.cups.org/str.php?L863");
