...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54684");
  ...
  script_tag(name:"insight", value:"The GdkPixbuf library, which is also included in GTK+ 2, contains several
...
All GdkPixbuf users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200409-28");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=64230");
  script_xref(name:"URL", value:"http://bugzilla.gnome.org/show_bug.cgi?id=150601");
