...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54536");
  ...
  script_tag(name:"insight", value:"Squid versions 2.0 through to 2.5.STABLE4 could allow a remote attacker to
...
bypass the ACL.");
  script_tag(name:"solution", value:"Squid can be updated as follows:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200403-11");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9778");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=45273");
