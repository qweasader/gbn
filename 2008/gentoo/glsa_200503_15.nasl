...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54880");
...
X.org, that can potentially lead to remote code execution.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200503-15");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/12714");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=83598");
  script_xref(name:"URL", value:"https://bugs.freedesktop.org/show_bug.cgi?id=1920");
