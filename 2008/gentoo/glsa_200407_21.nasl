...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54628");
  ...
  script_tag(name:"insight", value:"Two buffer overflows vulnerabilities were found in Samba, potentially
allowing the remote execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200407-21");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=57962");
