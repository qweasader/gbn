...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61251");
  ...
  script_tag(name:"insight", value:"Poppler is affected by a memory management issue, which could lead to the
execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200807-04");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=229931");
