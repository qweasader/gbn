...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.58622");
  ...
  script_tag(name:"insight", value:"Vulnerabilities have been discovered in ClamAV allowing remote execution of
arbitrary code and Denial of Service attacks.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200709-14");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=189912");
