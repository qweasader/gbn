...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55975");
  ...
  script_tag(name:"insight", value:"Webmin and Usermin are vulnerable to a format string vulnerability which
...
All Usermin users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200512-02");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=113888");
  script_xref(name:"URL", value:"http://www.dyadsecurity.com/webmin-0001.html");
