...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54503");
  ...
  script_tag(name:"insight", value:"FreeRADIUS is vulnerable to a heap exploit and a NULL pointer dereference
vulnerability.");
...
as stable.
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200311-04");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=33989");
  script_xref(name:"URL", value:"http://www.securitytracker.com/alerts/2003/Nov/1008263.html");
