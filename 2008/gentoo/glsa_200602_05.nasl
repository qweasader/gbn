...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56324");
  ...
  script_tag(name:"insight", value:"KPdf includes vulnerable Xpdf code to handle PDF files, making it
...
All Kpdf users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200602-05");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=121375");
