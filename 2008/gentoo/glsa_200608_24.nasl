...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57874");
  ...
  script_tag(name:"insight", value:"AlsaPlayer is vulnerable to multiple buffer overflows which could lead to
the execution of arbitrary code.");
  script_tag(name:"solution", value:"AlsaPlayer has been masked in Portage pending the resolution of these
