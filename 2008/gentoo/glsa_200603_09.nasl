...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56417");
...
to finalize the update.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200603-09");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=123781");
