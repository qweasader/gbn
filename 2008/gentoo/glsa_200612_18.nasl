...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.57957");
  ...
  script_tag(name:"insight", value:"ClamAV is vulnerable to Denial of Service.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200612-18");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=157698");
