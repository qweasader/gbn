...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61050");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities have been reported in OpenOffice.org, possibly
...
All OpenOffice.org binary users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200805-16");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=218080");
  script_xref(name:"URL", value:"http://www.gentoo.org/security/en/glsa/glsa-200803-20.xml");
