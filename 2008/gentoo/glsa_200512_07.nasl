...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56021");
  ...
  script_tag(name:"insight", value:"OpenLDAP and Gauche suffer from RUNPATH issues that may allow users in the
...
All Gauche users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200512-07");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=105380");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=112577");
