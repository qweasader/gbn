...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.54773");
  ...
  script_tag(name:"insight", value:"Several vulnerabilities were found and fixed in PHP, ranging from an
...
All php-cgi users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200412-14");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=74547");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/384663/2004-12-15/2004-12-21/0");
