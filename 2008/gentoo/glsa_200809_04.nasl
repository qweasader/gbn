...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.61599");
  ...
  script_tag(name:"insight", value:"A vulnerability in MySQL might allow users to bypass privileges and gain
access to other databases.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200809-04");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=220399");
