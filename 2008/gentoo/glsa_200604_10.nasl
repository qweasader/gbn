...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.56627");
  ...
  script_tag(name:"insight", value:"xzgv and zgv attempt to decode JPEG images within the CMYK/YCCK colour
...
All zgv users should also upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200604-10");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/17409");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=127008");
