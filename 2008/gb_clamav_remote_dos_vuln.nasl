...
if(description)
{
  ...
  script_name("ClamAV < 0.94.1 get_unicode_name() Off-By-One Heap based BOF Vulnerability");
  ...
  script_tag(name:"affected", value:"ClamAV before version 0.94.1.");
...
if( version_is_less( version:vers, test_version:"0.94.1" ) ) {
  report = report_fixed_ver( installed_version:vers, fixed_version:"0.94.1", install_path:path );
