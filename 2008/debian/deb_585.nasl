...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-585-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-585-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-585-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-585");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'shadow' package(s) announced via the DSA-585-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"login", ver:"20000902-12woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"passwd", ver:"20000902-12woody1", rls:"DEB3.0"))) {
    report += res;
  }
