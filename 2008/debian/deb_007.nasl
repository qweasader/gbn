...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53563");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20007-1");
  script_tag(name:"insight", value:"A busy week for the Zope team: on Monday another security alert was
