...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1090-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1090-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1090-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1090");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'spamassassin' package(s) announced via the DSA-1090-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"spamassassin", ver:"3.0.3-2sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"spamc", ver:"3.0.3-2sarge1", rls:"DEB3.1"))) {
    report += res;
  }
