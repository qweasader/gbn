...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-706-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-706-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-706-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-706");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'axel' package(s) announced via the DSA-706-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"axel", ver:"1.0a-1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"axel-kapt", ver:"1.0a-1woody1", rls:"DEB3.0"))) {
    report += res;
  }
