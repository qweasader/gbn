...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-880-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-880-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-880-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-880");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'phpmyadmin' package(s) announced via the DSA-880-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"phpmyadmin", ver:"4:2.6.2-3sarge1", rls:"DEB3.1"))) {
    report += res;
  }
