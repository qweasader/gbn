...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53428");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20173-1");
  script_tag(name:"insight", value:"The developers of Bugzilla, a web-based bug tracking system,
...
contain a bugzilla package.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your bugzilla package.");
