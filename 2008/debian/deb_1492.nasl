...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1492-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1492-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1492-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1492");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wml' package(s) announced via the DSA-1492-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"wml", ver:"2.0.11-1etch1", rls:"DEB4"))) {
    report += res;
  }
