...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-228");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmcrypt-dev", ver:"2.5.0-1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmcrypt4", ver:"2.5.0-1woody1", rls:"DEB3.0"))) {
    report += res;
  }
