...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-618-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-618-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-618-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-618");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imlib' package(s) announced via the DSA-618-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gdk-imlib-dev", ver:"1.9.14-2woody2", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gdk-imlib1", ver:"1.9.14-2woody2", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"imlib-base", ver:"1.9.14-2woody2", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"imlib-dev", ver:"1.9.14-2woody2", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"imlib-progs", ver:"1.9.14-2woody2", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"imlib1", ver:"1.9.14-2woody2", rls:"DEB3.0"))) {
    report += res;
  }
