...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1318-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1318-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/DSA-1318-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1318");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ekg' package(s) announced via the DSA-1318-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ekg", ver:"1:1.5+20050411-7", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgadu-dev", ver:"1:1.5+20050411-7", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgadu3", ver:"1:1.5+20050411-7", rls:"DEB3.1"))) {
    report += res;
  }
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ekg", ver:"1:1.7~rc2-1etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ekg", ver:"1:1.7~rc2-1etch1+b1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgadu-dev", ver:"1:1.7~rc2-1etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgadu-dev", ver:"1:1.7~rc2-1etch1+b1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgadu3", ver:"1:1.7~rc2-1etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgadu3", ver:"1:1.7~rc2-1etch1+b1", rls:"DEB4"))) {
    report += res;
  }
