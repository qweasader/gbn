...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-679-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-679-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-679-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-679");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'toolchain-source' package(s) announced via the DSA-679-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"toolchain-source", ver:"3.0.4-1woody1", rls:"DEB3.0"))) {
    report += res;
  }
