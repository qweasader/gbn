...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53860");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20262-1");
  script_tag(name:"insight", value:"Sebastian Krahmer of the SuSE security audit team found two problems
