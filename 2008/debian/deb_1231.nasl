...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1231-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1231-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1231-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1231");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg' package(s) announced via the DSA-1231-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnupg", ver:"1.4.1-1.sarge6", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gpgv-udeb", ver:"1.4.1-1.sarge6", rls:"DEB3.1"))) {
    report += res;
  }
