...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1551-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1551-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1551-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1551");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python2.4' package(s) announced via the DSA-1551-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"idle-python2.4", ver:"2.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.4", ver:"2.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.4-dbg", ver:"2.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.4-dev", ver:"2.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.4-examples", ver:"2.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.4-minimal", ver:"2.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }
