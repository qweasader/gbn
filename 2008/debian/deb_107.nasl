...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53763");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20107-1");
  script_tag(name:"insight", value:"Basically, this is the same Security Advisory as DSA 072-1, but for
...
arbitrary code.");
  script_tag(name:"summary", value:"The remote host is missing an update to jgroff
