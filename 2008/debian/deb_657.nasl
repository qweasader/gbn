...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53745");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20657-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/11205");
  script_tag(name:"insight", value:"A heap overflow has been discovered in the DVD subpicture decoder of
...
version 1-rc6a-1.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your libxine packages.");
