...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53458");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20619-1");
...
version 3.00-11.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your xpdf package immediately.");
