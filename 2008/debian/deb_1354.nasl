...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1354-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1354-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/DSA-1354-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1354");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gpdf' package(s) announced via the DSA-1354-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gpdf", ver:"2.8.2-1.2sarge6", rls:"DEB3.1"))) {
    report += res;
  }
