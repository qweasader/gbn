...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20063-1");
  script_tag(name:"insight", value:"zen-parse reported on bugtraq that there is a possible buffer overflow
