...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1241-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1241-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1241-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1241");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squirrelmail' package(s) announced via the DSA-1241-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squirrelmail", ver:"2:1.4.4-10", rls:"DEB3.1"))) {
    report += res;
  }
