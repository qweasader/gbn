...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1620-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1620-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1620-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1620");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python2.5' package(s) announced via the DSA-1620-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"idle-python2.5", ver:"2.5-5+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.5", ver:"2.5-5+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.5-dbg", ver:"2.5-5+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.5-dev", ver:"2.5-5+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.5-examples", ver:"2.5-5+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.5-minimal", ver:"2.5-5+etch1", rls:"DEB4"))) {
    report += res;
  }
