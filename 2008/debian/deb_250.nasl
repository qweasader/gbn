...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53325");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20250-1");
  script_tag(name:"insight", value:"Hironori Sakamoto, one of the w3m developers, found two security
...
version 0.3.p24.17-3 and later.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your w3mmee-ssl packages.");
  script_tag(name:"summary", value:"The remote host is missing an update to w3mmee-ssl
