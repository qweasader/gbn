...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1085-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1085-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1085-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1085");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lynx-cur' package(s) announced via the DSA-1085-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lynx-cur", ver:"2.8.5-2.5woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lynx-cur-wrapper", ver:"2.8.5-2.5woody1", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lynx-cur", ver:"2.8.6-9sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"lynx-cur-wrapper", ver:"2.8.6-9sarge1", rls:"DEB3.1"))) {
    report += res;
  }
