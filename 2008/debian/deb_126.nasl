...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53844");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20126-1");
  script_tag(name:"insight", value:"A cross-site scripting (CSS) problem was discovered in Horde and IMP (a web
