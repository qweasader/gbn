...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-458-3)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-458-3");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-458-3");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-458");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python2.2' package(s) announced via the DSA-458-3 advisory.");
