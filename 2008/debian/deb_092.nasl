...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53832");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20092-1");
  script_tag(name:"insight", value:"Nicolas Boullis found a nasty security problem in the wmtv (a
