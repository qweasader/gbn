...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1327-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1327-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/DSA-1327-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1327");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gsambad' package(s) announced via the DSA-1327-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gsambad", ver:"0.1.4-2etch1", rls:"DEB4"))) {
    report += res;
  }
