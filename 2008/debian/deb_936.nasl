...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-936-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-936-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-936-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-936");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libextractor' package(s) announced via the DSA-936-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"extract", ver:"0.4.2-2sarge2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libextractor1", ver:"0.4.2-2sarge2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libextractor1-dev", ver:"0.4.2-2sarge2", rls:"DEB3.1"))) {
    report += res;
  }
