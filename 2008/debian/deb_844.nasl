...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-844-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-844-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-844-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-844");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mod-auth-shadow' package(s) announced via the DSA-844-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache-mod-auth-shadow", ver:"1.3-3.1woody.2", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache-mod-auth-shadow", ver:"1.4-1sarge1", rls:"DEB3.1"))) {
    report += res;
  }
