...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53329");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20253-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/6884");
  script_tag(name:"insight", value:"A vulnerability has been discovered in OpenSSL, a Secure Socket Layer
