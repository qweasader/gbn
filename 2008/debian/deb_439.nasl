...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53140");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20439-1");
...
For the unstable distribution (sid) these problems will be fixed soon.");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update to kernel-image-2.4.16-lart, kernel-image-2.4.16-netwinder, kernel-image-2.4.16-riscpc, kernel-patch-2.4.16-arm
