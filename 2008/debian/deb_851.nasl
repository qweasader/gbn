...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-851-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-851-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-851-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-851");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openvpn' package(s) announced via the DSA-851-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openvpn", ver:"2.0-1sarge1", rls:"DEB3.1"))) {
    report += res;
  }
