...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-951-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-951-2");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-951-2");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-951");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'trac' package(s) announced via the DSA-951-2 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"trac", ver:"0.8.1-3sarge4", rls:"DEB3.1"))) {
    report += res;
  }
