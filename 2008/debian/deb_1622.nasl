...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1622-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1622-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1622-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1622");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'newsx' package(s) announced via the DSA-1622-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"newsx", ver:"1.6-2etch1", rls:"DEB4"))) {
    report += res;
  }
