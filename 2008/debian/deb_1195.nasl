...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1195-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1195-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1195-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl096' package(s) announced via the DSA-1195-1 advisory.");
