...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-457");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"wu-ftpd", ver:"2.6.2-3woody4", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"wu-ftpd-academ", ver:"2.6.2-3woody4", rls:"DEB3.0"))) {
    report += res;
  }
