...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53390");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20109-1");
  script_tag(name:"insight", value:"Due to unescaped HTML code Faq-O-Matic returned unverified scripting
...
distribution.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your faqomatic package if you have it");
  script_tag(name:"summary", value:"The remote host is missing an update to faqomatic
