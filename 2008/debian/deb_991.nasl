...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-991-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-991-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-991-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-991");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zoo' package(s) announced via the DSA-991-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"zoo", ver:"2.10-9woody0", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"zoo", ver:"2.10-11sarge0", rls:"DEB3.1"))) {
    report += res;
  }
