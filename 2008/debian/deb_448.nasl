...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-448");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"asnparser", ver:"1.2.5-5woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libpt-1.2.0", ver:"1.2.5-5woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libpt-dbg", ver:"1.2.5-5woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libpt-dev", ver:"1.2.5-5woody1", rls:"DEB3.0"))) {
    report += res;
  }
