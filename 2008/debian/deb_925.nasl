...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-925-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-925-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-925-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-925");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'phpbb2' package(s) announced via the DSA-925-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"phpbb2", ver:"2.0.13-6sarge2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"phpbb2-conf-mysql", ver:"2.0.13-6sarge2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"phpbb2-languages", ver:"2.0.13-6sarge2", rls:"DEB3.1"))) {
    report += res;
  }
