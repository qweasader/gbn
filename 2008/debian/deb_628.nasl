...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-628-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-628-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-628-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-628");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imlib2' package(s) announced via the DSA-628-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libimlib2", ver:"1.0.5-2woody2", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libimlib2-dev", ver:"1.0.5-2woody2", rls:"DEB3.0"))) {
    report += res;
  }
