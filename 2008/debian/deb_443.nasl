...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53680");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20443-1");
  script_tag(name:"insight", value:"A number of vulnerabilities have been discovered in XFree86:
