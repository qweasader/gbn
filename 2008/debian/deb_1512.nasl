...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1512-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1512-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1512-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1512");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'evolution' package(s) announced via the DSA-1512-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"evolution", ver:"2.0.4-2sarge3", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"evolution-dev", ver:"2.0.4-2sarge3", rls:"DEB3.1"))) {
    report += res;
  }
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"evolution", ver:"2.6.3-6etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"evolution-common", ver:"2.6.3-6etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"evolution-dbg", ver:"2.6.3-6etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"evolution-dev", ver:"2.6.3-6etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"evolution-plugins", ver:"2.6.3-6etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"evolution-plugins-experimental", ver:"2.6.3-6etch2", rls:"DEB4"))) {
    report += res;
  }
