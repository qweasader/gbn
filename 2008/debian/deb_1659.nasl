...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1659-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1659-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1659-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1659");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libspf2' package(s) announced via the DSA-1659-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libspf2-2", ver:"1.2.5-4+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libspf2-dev", ver:"1.2.5-4+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"spfquery", ver:"1.2.5-4+etch1", rls:"DEB4"))) {
    report += res;
  }
