...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53785");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20022-1");
  script_tag(name:"insight", value:"Former versions of the exmh program used /tmp for storing temporary
...
We recommend you upgrade your exmh packages immediately.");
  script_tag(name:"summary", value:"The remote host is missing an update to exmh
