...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1242-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1242-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1242-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1242");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'elog' package(s) announced via the DSA-1242-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"elog", ver:"2.5.7+r1558-4+sarge3", rls:"DEB3.1"))) {
    report += res;
  }
