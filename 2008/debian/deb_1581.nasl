...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1581-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1581-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1581-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1581");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnutls13' package(s) announced via the DSA-1581-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnutls-bin", ver:"1.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gnutls-doc", ver:"1.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgnutls-dev", ver:"1.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgnutls13", ver:"1.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgnutls13-dbg", ver:"1.4.4-3+etch1", rls:"DEB4"))) {
    report += res;
  }
