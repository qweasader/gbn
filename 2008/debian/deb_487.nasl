...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53181");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20487-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10136");
  script_tag(name:"insight", value:"Multiple format string vulnerabilities were discovered in neon, an
...
version 0.24.5-1.");
  ...
  script_tag(name:"solution", value:"We recommend that you update your neon package.");
