...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1352-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1352-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/DSA-1352-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1352");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pdfkit.framework' package(s) announced via the DSA-1352-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pdfkit.framework", ver:"0.8-2sarge4", rls:"DEB3.1"))) {
    report += res;
  }
