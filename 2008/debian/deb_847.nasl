...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-847-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-847-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-847-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-847");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dia' package(s) announced via the DSA-847-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dia", ver:"0.94.0-7sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dia-common", ver:"0.94.0-7sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dia-gnome", ver:"0.94.0-7sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dia-libs", ver:"0.94.0-7sarge1", rls:"DEB3.1"))) {
    report += res;
  }
