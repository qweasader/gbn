...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-387");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gopher", ver:"3.0.3woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gopherd", ver:"3.0.3woody1", rls:"DEB3.0"))) {
    report += res;
  }
