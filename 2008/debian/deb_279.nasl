...
contain a metrics package anymore.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your metrics package.");
  script_tag(name:"summary", value:"The remote host is missing an update to metrics
