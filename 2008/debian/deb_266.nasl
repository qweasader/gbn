...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53337");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20266-1");
  script_tag(name:"insight", value:"Several vulnerabilities have been discovered in krb5, an
...
For the unstable distribution (sid) this problem will be fixed soon.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your krb5 package.");
