...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53864");
  ...
  script_tag(name:"severity_date", value:"2024-02-02 02:56:22 +0000 (Fri, 02 Feb 2024)");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20047-1");
  script_tag(name:"insight", value:"The kernels used in Debian GNU/Linux 2.2 have been found to have
multiple security problems. This is a list of problems based
on the 2.2.19 release notes:
...
for your system.");
  script_tag(name:"summary", value:"The remote host is missing an update to various kernel packages
