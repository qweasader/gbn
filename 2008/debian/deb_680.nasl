...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-680-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-680-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-680-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-680");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'htdig' package(s) announced via the DSA-680-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"htdig", ver:"3.1.6-3woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"htdig-doc", ver:"3.1.6-3woody1", rls:"DEB3.0"))) {
    report += res;
  }
