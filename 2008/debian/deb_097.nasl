...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53385");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20097-1");
  script_tag(name:"insight", value:"Patrice Fournier discovered a bug in all versions of Exim older than
...
unstable distribution.  We recommend that you upgrade your exim");
  script_tag(name:"summary", value:"The remote host is missing an update to exim
