...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-759-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-759-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-759-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-759");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'phppgadmin' package(s) announced via the DSA-759-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"phppgadmin", ver:"3.5.2-5", rls:"DEB3.1"))) {
    report += res;
  }
