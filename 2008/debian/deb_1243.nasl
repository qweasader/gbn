...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1243-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1243-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1243-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1243");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'evince' package(s) announced via the DSA-1243-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"evince", ver:"0.1.5-2sarge1", rls:"DEB3.1"))) {
    report += res;
  }
