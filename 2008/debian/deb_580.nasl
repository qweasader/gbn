...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-580-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-580-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-580-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-580");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'iptables' package(s) announced via the DSA-580-1 advisory.");
