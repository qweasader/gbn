...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1077-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1077-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1077-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1077");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lynx-ssl' package(s) announced via the DSA-1077-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lynx-ssl", ver:"1:2.8.4.1b-3.3", rls:"DEB3.0"))) {
    report += res;
  }
