...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1095-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1095-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1095-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1095");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'freetype' package(s) announced via the DSA-1095-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"freetype2-demos", ver:"2.0.9-1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6", ver:"2.0.9-1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6-dev", ver:"2.0.9-1woody1", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"freetype2-demos", ver:"2.1.7-2.5", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6", ver:"2.1.7-2.5", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6-dev", ver:"2.1.7-2.5", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6-udeb", ver:"2.1.7-2.5", rls:"DEB3.1"))) {
    report += res;
  }
