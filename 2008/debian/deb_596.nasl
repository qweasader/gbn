...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-596-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-596-2");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-596-2");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-596");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sudo' package(s) announced via the DSA-596-2 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sudo", ver:"1.6.6-1.3", rls:"DEB3.0"))) {
    report += res;
  }
