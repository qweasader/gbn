...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53305");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20226-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/6475");
  script_tag(name:"insight", value:"iDEFENSE discovered an integer overflow in the pdftops filter from the
...
fixed in version 2.01-2.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your xpdf-i package.");
  script_tag(name:"summary", value:"The remote host is missing an update to xpdf-i
