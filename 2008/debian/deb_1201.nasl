...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1201-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1201-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1201-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1201");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ethereal' package(s) announced via the DSA-1201-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ethereal", ver:"0.10.10-2sarge9", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ethereal-common", ver:"0.10.10-2sarge9", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ethereal-dev", ver:"0.10.10-2sarge9", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tethereal", ver:"0.10.10-2sarge9", rls:"DEB3.1"))) {
    report += res;
  }
