...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-639-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-639-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-639-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-639");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mc' package(s) announced via the DSA-639-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gmc", ver:"4.5.55-1.2woody5", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mc", ver:"4.5.55-1.2woody5", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mc-common", ver:"4.5.55-1.2woody5", rls:"DEB3.0"))) {
    report += res;
  }
