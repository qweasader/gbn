...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-715-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-715-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-715-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-715");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cvs' package(s) announced via the DSA-715-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cvs", ver:"1.11.1p1debian-10", rls:"DEB3.0"))) {
    report += res;
  }
