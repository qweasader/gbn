...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-272");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dietlibc-dev", ver:"0.12-2.5", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dietlibc-doc", ver:"0.12-2.5", rls:"DEB3.0"))) {
    report += res;
  }
