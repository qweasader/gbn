...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53808");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20053-1");
  script_tag(name:"insight", value:"The nedit (Nirvana editor) package as shipped in the non-free section
...
This has been fixed in version 5.02-7.1.");
  script_tag(name:"summary", value:"The remote host is missing an update to nedit
