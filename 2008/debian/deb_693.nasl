...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-693-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-693-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-693-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-693");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'luxman' package(s) announced via the DSA-693-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"luxman", ver:"0.41-17.2", rls:"DEB3.0"))) {
    report += res;
  }
