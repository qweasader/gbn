...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1275-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1275-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/DSA-1275-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1275");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zope2.7' package(s) announced via the DSA-1275-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"zope2.7", ver:"2.7.5-2sarge4", rls:"DEB3.1"))) {
    report += res;
  }
