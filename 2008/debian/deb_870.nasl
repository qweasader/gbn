...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-870-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-870-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-870-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-870");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sudo' package(s) announced via the DSA-870-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sudo", ver:"1.6.6-1.4", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sudo", ver:"1.6.8p7-1.2", rls:"DEB3.1"))) {
    report += res;
  }
