...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1165");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"capi4hylafax", ver:"1:01.02.03-10sarge2", rls:"DEB3.1"))) {
    report += res;
  }
