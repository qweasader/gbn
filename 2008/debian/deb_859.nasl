...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-859-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-859-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-859-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-859");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xli' package(s) announced via the DSA-859-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xli", ver:"1.17.0-11woody2", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xli", ver:"1.17.0-18sarge1", rls:"DEB3.1"))) {
    report += res;
  }
