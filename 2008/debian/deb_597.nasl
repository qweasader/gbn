...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53288");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20597-1");
  script_tag(name:"insight", value:"Stefan Esser discovered several security related problems in the Cyrus
...
version 2.1.17-1.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your cyrus-imapd package immediately.");
