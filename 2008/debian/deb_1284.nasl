...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1284-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1284-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/DSA-1284-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1284");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qemu' package(s) announced via the DSA-1284-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"qemu", ver:"0.6.1+20050407-1sarge1", rls:"DEB3.1"))) {
    report += res;
  }
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"qemu", ver:"0.8.2-4etch1", rls:"DEB4"))) {
    report += res;
  }
