...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53757");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20270-1");
...
version 2.4.19-0.020911.6 of kernel-patch-2.4.19-mips (mips+mipsel).");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update to kernel-patch-2.4.17-mips, kernel-patch-2.4.19-mips
