...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53397");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20121-1");
  script_tag(name:"insight", value:"Several security related problems have been found in the xtell
...
2.7 for the testing and unstable distribution of Debian.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your xtell packages immediately.");
  script_tag(name:"summary", value:"The remote host is missing an update to xtell
