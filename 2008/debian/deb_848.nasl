...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-848-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-848-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-848-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-848");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'masqmail' package(s) announced via the DSA-848-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"masqmail", ver:"0.1.16-2.2", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"masqmail", ver:"0.2.20-1sarge1", rls:"DEB3.1"))) {
    report += res;
  }
