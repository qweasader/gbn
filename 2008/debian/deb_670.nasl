...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-670-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-670-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-670-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-670");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'emacs20' package(s) announced via the DSA-670-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"emacs20", ver:"20.7-13.3", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"emacs20-el", ver:"20.7-13.3", rls:"DEB3.0"))) {
    report += res;
  }
