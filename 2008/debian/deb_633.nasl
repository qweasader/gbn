...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-633-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-633-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-633-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-633");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bmv' package(s) announced via the DSA-633-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bmv", ver:"1.2-14.2", rls:"DEB3.0"))) {
    report += res;
  }
