...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53436");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20186-1");
  script_tag(name:"insight", value:"Enrico Zini discovered a buffer overflow in log2mail, a daemon for
...
affected since it doesn't contain a log2mail package");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your log2mail package.");
  script_tag(name:"summary", value:"The remote host is missing an update to log2mail
