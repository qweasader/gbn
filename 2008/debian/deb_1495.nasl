...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1495-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1495");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nagios-plugins", ver:"1.4-6sarge1", rls:"DEB3.1"))) {
    report += res;
  }
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nagios-plugins", ver:"1.4.5-1etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"nagios-plugins-basic", ver:"1.4.5-1etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"nagios-plugins-standard", ver:"1.4.5-1etch1", rls:"DEB4"))) {
    report += res;
  }
