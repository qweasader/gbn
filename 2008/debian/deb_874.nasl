...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-874-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-874-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-874-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-874");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lynx' package(s) announced via the DSA-874-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lynx", ver:"2.8.4.1b-3.3", rls:"DEB3.0"))) {
    report += res;
  }
