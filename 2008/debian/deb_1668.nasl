...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1668-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1668-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1668-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1668");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'hf' package(s) announced via the DSA-1668-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"hf", ver:"0.7.3-4etch1", rls:"DEB4"))) {
    report += res;
  }
