...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-590-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-590-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-590-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-590");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnats' package(s) announced via the DSA-590-1 advisory.");
