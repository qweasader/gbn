...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1010-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1010-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1010-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1010");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ilohamail' package(s) announced via the DSA-1010-1 advisory.");
