...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53760");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20100-1");
  script_tag(name:"insight", value:"GOBBLES found a buffer overflow in gzip that occurs when compressing
...
stable/unstable/testing with at least version 1.2.4-33.");
  script_tag(name:"summary", value:"The remote host is missing an update to gzip
