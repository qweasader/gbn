...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1553-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1553");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ikiwiki", ver:"1.33.5", rls:"DEB4"))) {
    report += res;
  }
