...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53306");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20225-1");
  script_tag(name:"insight", value:"A security vulnerability has been confirmed to exist in Apache Tomcat
...
current version 4.1.16-1.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your tomcat packages.");
  script_tag(name:"summary", value:"The remote host is missing an update to tomcat4
