...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1001-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1001-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1001-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1001");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'crossfire' package(s) announced via the DSA-1001-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"crossfire-doc", ver:"1.1.0-1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"crossfire-edit", ver:"1.1.0-1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"crossfire-server", ver:"1.1.0-1woody1", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"crossfire-doc", ver:"1.6.0.dfsg.1-4sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"crossfire-edit", ver:"1.6.0.dfsg.1-4sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"crossfire-server", ver:"1.6.0.dfsg.1-4sarge1", rls:"DEB3.1"))) {
    report += res;
  }
