...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53768");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20002-1");
  script_tag(name:"insight", value:"Colin Phipps found an interesting symlink attack problem in fsh (a
...
This has been fixed in version 1.0.post.1-3potato.");
  script_tag(name:"summary", value:"The remote host is missing an update to fsh
