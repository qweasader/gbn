...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1672-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1672-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1672-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1672");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imlib2' package(s) announced via the DSA-1672-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libimlib2", ver:"1.3.0.0debian1-4+etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libimlib2-dev", ver:"1.3.0.0debian1-4+etch2", rls:"DEB4"))) {
    report += res;
  }
