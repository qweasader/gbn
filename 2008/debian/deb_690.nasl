...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-690-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-690-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-690-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-690");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bsmtpd' package(s) announced via the DSA-690-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bsmtpd", ver:"2.3pl8b-12woody1", rls:"DEB3.0"))) {
    report += res;
  }
