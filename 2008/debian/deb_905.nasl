...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-905-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-905-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-905-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-905");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mantis' package(s) announced via the DSA-905-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mantis", ver:"0.19.2-4.1", rls:"DEB3.1"))) {
    report += res;
  }
