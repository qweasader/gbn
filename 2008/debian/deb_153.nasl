...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53581");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20153-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5504");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5509");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5510");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5514");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5515");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5563");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5565");
  script_tag(name:"insight", value:"Joao Gouveia discovered an uninitialized variable which was insecurely
...
affected, since it doesn't contain the mantis package.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your mantis packages immediately.");
