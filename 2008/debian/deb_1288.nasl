...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2007/DSA-1288-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1288");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bcrelay", ver:"1.3.0-2etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"pptpd", ver:"1.3.0-2etch1", rls:"DEB4"))) {
    report += res;
  }
