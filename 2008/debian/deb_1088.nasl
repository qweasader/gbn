...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1088-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1088-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1088-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1088");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'centericq' package(s) announced via the DSA-1088-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"centericq", ver:"4.5.1-1.1woody2", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"centericq", ver:"4.20.0-1sarge4", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"centericq-common", ver:"4.20.0-1sarge4", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"centericq-fribidi", ver:"4.20.0-1sarge4", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"centericq-utf8", ver:"4.20.0-1sarge4", rls:"DEB3.1"))) {
    report += res;
  }
