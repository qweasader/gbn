...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-488");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"logcheck", ver:"1.1.1-13.1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"logcheck-database", ver:"1.1.1-13.1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"logtail", ver:"1.1.1-13.1woody1", rls:"DEB3.0"))) {
    report += res;
  }
