...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-974-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-974-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-974-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-974");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gpdf' package(s) announced via the DSA-974-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gpdf", ver:"2.8.2-1.2sarge3", rls:"DEB3.1"))) {
    report += res;
  }
