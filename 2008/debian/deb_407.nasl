...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53105");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20407-1");
  script_tag(name:"insight", value:"Several vulnerabilities were discovered upstream in ethereal, a
...
version 0.10.0-1.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your ethereal and tethereal packages.");
