...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-954-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-954-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-954-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-954");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wine' package(s) announced via the DSA-954-1 advisory.");
