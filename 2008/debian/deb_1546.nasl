...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1546-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1546-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1546-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1546");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnumeric' package(s) announced via the DSA-1546-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnumeric", ver:"1.6.3-5.1+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gnumeric-common", ver:"1.6.3-5.1+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gnumeric-doc", ver:"1.6.3-5.1+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gnumeric-plugins-extra", ver:"1.6.3-5.1+etch1", rls:"DEB4"))) {
    report += res;
  }
