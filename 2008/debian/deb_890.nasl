...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-890-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-890-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-890-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-890");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libungif4' package(s) announced via the DSA-890-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libungif-bin", ver:"4.1.0b1-2woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libungif4-dev", ver:"4.1.0b1-2woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libungif4g", ver:"4.1.0b1-2woody1", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libungif-bin", ver:"4.1.3-2sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libungif4-dev", ver:"4.1.3-2sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libungif4g", ver:"4.1.3-2sarge1", rls:"DEB3.1"))) {
    report += res;
  }
