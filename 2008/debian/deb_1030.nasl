...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1030-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1030-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1030-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1030");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'moodle' package(s) announced via the DSA-1030-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"moodle", ver:"1.4.4.dfsg.1-3sarge1", rls:"DEB3.1"))) {
    report += res;
  }
