...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-614-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-614-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-614-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-614");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xzgv' package(s) announced via the DSA-614-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xzgv", ver:"0.7-6woody2", rls:"DEB3.0"))) {
    report += res;
  }
