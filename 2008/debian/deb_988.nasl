...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-988-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-988-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-988-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-988");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squirrelmail' package(s) announced via the DSA-988-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squirrelmail", ver:"1:1.2.6-5", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squirrelmail", ver:"2:1.4.4-8", rls:"DEB3.1"))) {
    report += res;
  }
