...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53812");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20059-1");
  script_tag(name:"insight", value:"Luki R. reported a bug in man-db: it did handle nested calls of
