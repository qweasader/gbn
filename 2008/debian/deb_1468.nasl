...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1468-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1468-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1468-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1468");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tomcat5.5' package(s) announced via the DSA-1468-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat5.5-java", ver:"5.5.20-2etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat5.5", ver:"5.5.20-2etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat5.5-admin", ver:"5.5.20-2etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat5.5-webapps", ver:"5.5.20-2etch2", rls:"DEB4"))) {
    report += res;
  }
