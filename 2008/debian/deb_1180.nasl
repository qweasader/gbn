...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1180-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1180-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1180-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1180");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bomberclone' package(s) announced via the DSA-1180-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bomberclone", ver:"0.11.5-1sarge2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"bomberclone-data", ver:"0.11.5-1sarge2", rls:"DEB3.1"))) {
    report += res;
  }
