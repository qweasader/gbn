...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53810");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20056-1");
  script_tag(name:"insight", value:"Ethan Benson found a bug in man-db packages as distributed in
