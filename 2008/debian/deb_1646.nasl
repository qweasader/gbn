...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1646-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1646-2");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1646-2");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1646");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squid' package(s) announced via the DSA-1646-2 advisory.");
