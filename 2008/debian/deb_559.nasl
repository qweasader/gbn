...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-559-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-559-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-559-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-559");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'net-acct' package(s) announced via the DSA-559-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"net-acct", ver:"0.71-5woody1", rls:"DEB3.0"))) {
    report += res;
  }
