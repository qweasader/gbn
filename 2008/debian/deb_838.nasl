...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-838-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-838-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-838-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-838");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mozilla-firefox' package(s) announced via the DSA-838-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mozilla-firefox", ver:"1.0.4-2sarge5", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mozilla-firefox-dom-inspector", ver:"1.0.4-2sarge5", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mozilla-firefox-gnome-support", ver:"1.0.4-2sarge5", rls:"DEB3.1"))) {
    report += res;
  }
