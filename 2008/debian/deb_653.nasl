...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-653-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-653-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-653-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-653");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ethereal' package(s) announced via the DSA-653-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ethereal", ver:"0.9.4-1woody11", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ethereal-common", ver:"0.9.4-1woody11", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ethereal-dev", ver:"0.9.4-1woody11", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tethereal", ver:"0.9.4-1woody11", rls:"DEB3.0"))) {
    report += res;
  }
