...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53259");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20569-1");
...
version 0.17.24+0.1-4.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your netkit-telnet-ssl package.");
