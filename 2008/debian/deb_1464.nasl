...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1464-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1464-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1464-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1464");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'syslog-ng' package(s) announced via the DSA-1464-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"syslog-ng", ver:"2.0.0-1etch1", rls:"DEB4"))) {
    report += res;
  }
