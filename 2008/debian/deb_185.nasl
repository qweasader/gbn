...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53435");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20185-1");
  script_tag(name:"insight", value:"A stack buffer overflow in the kadm_ser_wrap_in function in the
