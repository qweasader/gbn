...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1522-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1522-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1522-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1522");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unzip' package(s) announced via the DSA-1522-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unzip", ver:"5.52-1sarge5", rls:"DEB3.1"))) {
    report += res;
  }
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unzip", ver:"5.52-9etch1", rls:"DEB4"))) {
    report += res;
  }
