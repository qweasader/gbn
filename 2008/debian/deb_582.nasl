...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-582-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-582-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-582-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-582");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxml, libxml2' package(s) announced via the DSA-582-1 advisory.");
