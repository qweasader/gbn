...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1060-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1060-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1060-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1060");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kernel-patch-vserver' package(s) announced via the DSA-1060-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kernel-patch-vserver", ver:"1.9.5.6", rls:"DEB3.1"))) {
    report += res;
  }
