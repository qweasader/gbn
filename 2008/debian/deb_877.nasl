...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-877-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-877-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-877-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-877");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnump3d' package(s) announced via the DSA-877-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnump3d", ver:"2.9.3-1sarge2", rls:"DEB3.1"))) {
    report += res;
  }
