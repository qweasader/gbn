...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1086-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1086-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1086-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1086");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xmcd' package(s) announced via the DSA-1086-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cddb", ver:"2.6-14woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xmcd", ver:"2.6-14woody1", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cddb", ver:"2.6-17sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xmcd", ver:"2.6-17sarge1", rls:"DEB3.1"))) {
    report += res;
  }
