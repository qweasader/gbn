...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53656");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20368-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/8370");
  script_tag(name:"insight", value:"Steve Kemp discovered a buffer overflow in xpcd-svga which can be
...
We recommend that you update your xpcd package.");
  script_tag(name:"summary", value:"The remote host is missing an update to xpcd
