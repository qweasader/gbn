...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53410");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20150-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5453");
  script_tag(name:"insight", value:"A problem has been discovered in Interchange, an e-commerce and
...
the Interchange system.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your interchange packages.");
  script_tag(name:"summary", value:"The remote host is missing an update to interchange
