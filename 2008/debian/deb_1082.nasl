...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1082-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1082-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1082-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1082");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kernel-source-2.4.17' package(s) announced via the DSA-1082-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kernel-doc-2.4.17", ver:"2.4.17-1woody4", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"kernel-source-2.4.17", ver:"2.4.17-1woody4", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mkcramfs", ver:"2.4.17-1woody4", rls:"DEB3.0"))) {
    report += res;
  }
