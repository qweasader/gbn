...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53729");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20162-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5573");
  script_tag(name:"insight", value:"Ethereal developers discovered a buffer overflow in the ISIS protocol
