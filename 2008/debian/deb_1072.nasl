...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1072-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1072-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1072-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1072");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nagios' package(s) announced via the DSA-1072-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nagios-common", ver:"2:1.3-cvs.20050402-2.sarge.2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"nagios-mysql", ver:"2:1.3-cvs.20050402-2.sarge.2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"nagios-pgsql", ver:"2:1.3-cvs.20050402-2.sarge.2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"nagios-text", ver:"2:1.3-cvs.20050402-2.sarge.2", rls:"DEB3.1"))) {
    report += res;
  }
