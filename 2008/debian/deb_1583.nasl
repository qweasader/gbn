...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1583-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1583-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1583-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1583");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnome-peercast' package(s) announced via the DSA-1583-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnome-peercast", ver:"0.5.4-1.1etch0", rls:"DEB4"))) {
    report += res;
  }
