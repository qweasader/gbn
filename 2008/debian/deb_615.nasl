...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-615-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-615-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-615-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-615");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'debmake' package(s) announced via the DSA-615-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"debmake", ver:"3.6.10.woody.1", rls:"DEB3.0"))) {
    report += res;
  }
