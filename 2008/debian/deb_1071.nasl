...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1071-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1071-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1071-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1071");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mysql' package(s) announced via the DSA-1071-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmysqlclient10", ver:"3.23.49-8.15", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmysqlclient10-dev", ver:"3.23.49-8.15", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mysql-client", ver:"3.23.49-8.15", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mysql-common", ver:"3.23.49-8.15", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mysql-server", ver:"3.23.49-8.15", rls:"DEB3.0"))) {
    report += res;
  }
