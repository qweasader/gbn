...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-948-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-948-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-948-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-948");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'kdelibs' package(s) announced via the DSA-948-1 advisory.");
