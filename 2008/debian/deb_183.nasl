...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53693");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20183-1");
...
affected since no krb5 packages are included.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your krb5 packages immediately.");
