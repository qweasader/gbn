...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-698-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-698-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-698-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-698");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mc' package(s) announced via the DSA-698-1 advisory.");
