...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1031-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1031-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1031-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1031");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cacti' package(s) announced via the DSA-1031-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cacti", ver:"0.8.6c-7sarge3", rls:"DEB3.1"))) {
    report += res;
  }
