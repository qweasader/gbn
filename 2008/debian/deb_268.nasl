...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53724");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20268-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/7120");
  script_tag(name:"insight", value:"Core Security Technologies discovered a buffer overflow in the IMAP
...
version 1.5.4-1.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your mutt package.");
