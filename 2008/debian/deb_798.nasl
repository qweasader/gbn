...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-798-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-798-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-798-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-798");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'phpgroupware' package(s) announced via the DSA-798-1 advisory.");
