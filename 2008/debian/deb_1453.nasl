...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1453-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1453-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1453-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1453");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tomcat5' package(s) announced via the DSA-1453-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat5-java", ver:"5.0.30-12etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat5", ver:"5.0.30-12etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat5-admin", ver:"5.0.30-12etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat5-webapps", ver:"5.0.30-12etch1", rls:"DEB4"))) {
    report += res;
  }
