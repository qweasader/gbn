...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53574");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20084-1");
  script_tag(name:"insight", value:"Stephane Gaudreault told us that version 2.0.6a of gftp displays the
...
for the stable Debian GNU/Linux 2.2.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your gftp package.");
  script_tag(name:"summary", value:"The remote host is missing an update to gftp
