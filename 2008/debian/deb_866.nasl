...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.55716");
...
version 1.7.12-1.
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20866-1");
  script_tag(name:"summary", value:"The remote host is missing an update to mozilla
