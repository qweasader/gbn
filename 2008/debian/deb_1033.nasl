...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1033-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1033-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1033-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1033");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'horde3' package(s) announced via the DSA-1033-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"horde3", ver:"3.0.4-4sarge3", rls:"DEB3.1"))) {
    report += res;
  }
