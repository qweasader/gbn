...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-634-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-634-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-634-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-634");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'hylafax' package(s) announced via the DSA-634-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"hylafax-client", ver:"1:4.1.1-3.1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"hylafax-doc", ver:"1:4.1.1-3.1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"hylafax-server", ver:"1:4.1.1-3.1", rls:"DEB3.0"))) {
    report += res;
  }
