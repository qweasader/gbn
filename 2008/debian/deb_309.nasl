...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53753");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20309-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/7708");
  script_tag(name:"insight", value:"'bazarr' discovered that eterm is vulnerable to a buffer overflow of
...
We recommend that you update your eterm package.");
  script_tag(name:"summary", value:"The remote host is missing an update to eterm
