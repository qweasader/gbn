...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53762");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20102-2");
  script_tag(name:"insight", value:"Basically, this is the same Security Advisory as DSA 102-1, except
...
3.1.8-11 for the unstable and testing release. We
recommend that you upgrade your at packages immediately since an
exploit has already been published.");
  script_tag(name:"summary", value:"The remote host is missing an update to at
