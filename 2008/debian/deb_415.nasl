...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53113");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20415-1");
  script_tag(name:"insight", value:"Two vulnerabilities were discovered in zebra, an IP routing daemon:
...
We recommend that you update your zebra package.");
  script_tag(name:"summary", value:"The remote host is missing an update to zebra
