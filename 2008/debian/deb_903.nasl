...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-903-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-903-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-903-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-903");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unzip' package(s) announced via the DSA-903-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unzip", ver:"5.50-1woody5", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"unzip", ver:"5.52-1sarge3", rls:"DEB3.1"))) {
    report += res;
  }
