...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-881-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-881-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-881-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-881");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl096' package(s) announced via the DSA-881-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl0.9.6", ver:"0.9.6m-1sarge1", rls:"DEB3.1"))) {
    report += res;
  }
