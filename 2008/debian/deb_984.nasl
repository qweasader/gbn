...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-984-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-984-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-984-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-984");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xpdf' package(s) announced via the DSA-984-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xpdf", ver:"3.00-13.6", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xpdf-common", ver:"3.00-13.6", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xpdf-reader", ver:"3.00-13.6", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xpdf-utils", ver:"3.00-13.6", rls:"DEB3.1"))) {
    report += res;
  }
