...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-686-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-686-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-686-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-686");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gftp' package(s) announced via the DSA-686-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gftp", ver:"2.0.11-1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gftp-common", ver:"2.0.11-1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gftp-gtk", ver:"2.0.11-1woody1", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gftp-text", ver:"2.0.11-1woody1", rls:"DEB3.0"))) {
    report += res;
  }
