...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-721-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-721-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-721-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-721");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squid' package(s) announced via the DSA-721-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"squid", ver:"2.4.6-2woody8", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"squid-cgi", ver:"2.4.6-2woody8", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"squidclient", ver:"2.4.6-2woody8", rls:"DEB3.0"))) {
    report += res;
  }
