...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53133");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20433-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/9138");
  script_tag(name:"insight", value:"RedHat and SuSE kernel and security teams revealed an integer overflow
...
with newly uploaded packages.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your kernel image packages for the mips");
