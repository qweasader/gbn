...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53583");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20155-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/5410");
  script_tag(name:"insight", value:"Due to a security engineering oversight, the SSL library from KDE,
...
2.2.2-14 or higher.");
  ...
  script_tag(name:"solution", value:"We recommend that you upgrade your kdelibs and libarts packages and");
