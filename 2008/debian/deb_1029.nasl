...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1029-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1029-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1029-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1029");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libphp-adodb' package(s) announced via the DSA-1029-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libphp-adodb", ver:"1.51-1.2", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libphp-adodb", ver:"4.52-1sarge1", rls:"DEB3.1"))) {
    report += res;
  }
