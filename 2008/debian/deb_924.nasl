...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-924-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-924-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-924-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-924");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nbd' package(s) announced via the DSA-924-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nbd-client", ver:"1:1.2cvs20020320-3.woody.3", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"nbd-server", ver:"1:1.2cvs20020320-3.woody.3", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nbd-client", ver:"1:2.7.3-3sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"nbd-server", ver:"1:2.7.3-3sarge1", rls:"DEB3.1"))) {
    report += res;
  }
