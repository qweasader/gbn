...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-594-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-594-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-594-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-594");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'apache' package(s) announced via the DSA-594-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"apache", ver:"1.3.26-0woody6", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"apache-common", ver:"1.3.26-0woody6", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"apache-dev", ver:"1.3.26-0woody6", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"apache-doc", ver:"1.3.26-0woody6", rls:"DEB3.0"))) {
    report += res;
  }
