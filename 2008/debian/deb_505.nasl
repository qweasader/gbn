...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53196");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20505-1");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/10384");
  script_tag(name:"insight", value:"Stefan Esser discovered a heap overflow in the CVS server, which
