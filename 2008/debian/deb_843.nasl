...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-843-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-843-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-843-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-843");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'arc' package(s) announced via the DSA-843-1 advisory.");
