...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1020-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1020-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1020-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1020");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'flex' package(s) announced via the DSA-1020-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"flex", ver:"2.5.31-31sarge1", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"flex-doc", ver:"2.5.31-31sarge1", rls:"DEB3.1"))) {
    report += res;
  }
