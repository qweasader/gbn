...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-575-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-575-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-575-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-575");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'catdoc' package(s) announced via the DSA-575-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"catdoc", ver:"0.91.5-1.woody3", rls:"DEB3.0"))) {
    report += res;
  }
