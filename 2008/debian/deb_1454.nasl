...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1454-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1454-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1454-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1454");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'freetype' package(s) announced via the DSA-1454-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"freetype2-demos", ver:"2.2.1-5+etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6", ver:"2.2.1-5+etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6-dev", ver:"2.2.1-5+etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6-udeb", ver:"2.2.1-5+etch2", rls:"DEB4"))) {
    report += res;
  }
