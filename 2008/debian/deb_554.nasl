...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-554-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-554-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-554-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-554");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sendmail' package(s) announced via the DSA-554-1 advisory.");
