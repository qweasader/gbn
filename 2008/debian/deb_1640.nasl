...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1640-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1640-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1640-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1640");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DSA-1640-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-django", ver:"0.95.1-1etch2", rls:"DEB4"))) {
    report += res;
  }
