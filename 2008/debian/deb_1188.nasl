...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1188-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1188-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1188-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1188");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mailman' package(s) announced via the DSA-1188-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mailman", ver:"2.1.5-8sarge5", rls:"DEB3.1"))) {
    report += res;
  }
