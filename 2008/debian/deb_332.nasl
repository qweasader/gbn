...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53621");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20332-1");
...
advisories.");
  ...
  script_tag(name:"solution", value:"For the stable distribution (woody), these problems have been fixed in
...
and follow the instructions given during the kernel upgrade process.");
  script_tag(name:"summary", value:"The remote host is missing an update to kernel-source-2.4.17, kernel-patch-2.4.17-mips
