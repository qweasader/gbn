...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-409");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind", ver:"1:8.3.3-2.0woody2", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"bind-dev", ver:"1:8.3.3-2.0woody2", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"bind-doc", ver:"1:8.3.3-2.0woody2", rls:"DEB3.0"))) {
    report += res;
  }
