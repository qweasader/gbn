...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-676-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-676-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-676-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-676");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xpcd' package(s) announced via the DSA-676-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xpcd", ver:"2.08-8woody3", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xpcd-gimp", ver:"2.08-8woody3", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"xpcd-svga", ver:"2.08-8woody3", rls:"DEB3.0"))) {
    report += res;
  }
