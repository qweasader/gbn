...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-604-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-604-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-604-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-604");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'hpsockd' package(s) announced via the DSA-604-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"hpsockd", ver:"0.6.woody1", rls:"DEB3.0"))) {
    report += res;
  }
