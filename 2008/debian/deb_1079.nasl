...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1079-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1079-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2006/DSA-1079-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1079");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mysql-dfsg' package(s) announced via the DSA-1079-1 advisory.");
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmysqlclient12", ver:"4.0.24-10sarge2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libmysqlclient12-dev", ver:"4.0.24-10sarge2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mysql-client", ver:"4.0.24-10sarge2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mysql-common", ver:"4.0.24-10sarge2", rls:"DEB3.1"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mysql-server", ver:"4.0.24-10sarge2", rls:"DEB3.1"))) {
    report += res;
  }
