...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-421");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache-mod-auth-shadow", ver:"1.3-3.1woody.1", rls:"DEB3.0"))) {
    report += res;
  }
