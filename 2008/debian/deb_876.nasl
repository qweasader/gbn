...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-876-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-876-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-876-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-876");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lynx' package(s) announced via the DSA-876-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lynx", ver:"2.8.4.1b-3.2", rls:"DEB3.0"))) {
    report += res;
  }
...
if(release == "DEB3.1") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lynx", ver:"2.8.5-2sarge1", rls:"DEB3.1"))) {
    report += res;
  }
