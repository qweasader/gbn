...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.53793");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=DSA%20031-1");
  script_tag(name:"insight", value:"Todd Miller announced a new version of sudo which corrects a buffer
