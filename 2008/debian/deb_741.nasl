...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-741-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-741-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-741-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-741");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bzip2' package(s) announced via the DSA-741-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bzip2", ver:"1.0.2-1.woody5", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libbz2-1.0", ver:"1.0.2-1.woody5", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libbz2-dev", ver:"1.0.2-1.woody5", rls:"DEB3.0"))) {
    report += res;
  }
