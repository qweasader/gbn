...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1663-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1663-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2008/DSA-1663-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1663");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'net-snmp' package(s) announced via the DSA-1663-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsnmp-base", ver:"5.2.3-7etch4", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libsnmp-perl", ver:"5.2.3-7etch4", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libsnmp9", ver:"5.2.3-7etch4", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libsnmp9-dev", ver:"5.2.3-7etch4", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"snmp", ver:"5.2.3-7etch4", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"snmpd", ver:"5.2.3-7etch4", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tkmib", ver:"5.2.3-7etch4", rls:"DEB4"))) {
    report += res;
  }
