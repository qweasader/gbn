...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-641-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-641-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2005/DSA-641-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-641");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'playmidi' package(s) announced via the DSA-641-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"playmidi", ver:"2.4-4woody1", rls:"DEB3.0"))) {
    report += res;
  }
