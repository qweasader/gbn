...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-546-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-546-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-546-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-546");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gdk-pixbuf' package(s) announced via the DSA-546-1 advisory.");
