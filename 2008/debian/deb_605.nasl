...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-605-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-605-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-605-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-605");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'viewcvs' package(s) announced via the DSA-605-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"viewcvs", ver:"0.9.2-4woody1", rls:"DEB3.0"))) {
    report += res;
  }
