...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-617-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-617-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2004/DSA-617-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-617");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tiff' package(s) announced via the DSA-617-1 advisory.");
...
if(release == "DEB3.0") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtiff-tools", ver:"3.5.5-6.woody3", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtiff3g", ver:"3.5.5-6.woody3", rls:"DEB3.0"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtiff3g-dev", ver:"3.5.5-6.woody3", rls:"DEB3.0"))) {
    report += res;
  }
