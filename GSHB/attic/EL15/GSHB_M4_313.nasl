...
if(description)
{
  ...
  script_name("IT-Grundschutz M4.313: Bereitstellung von sicheren Domaenen-Controllern");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M4.313: Bereitstellung von sicheren Domaenen-Controllern.
