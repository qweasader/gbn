...
if(description)
{
  ...
  script_name("IT-Grundschutz M4.305: Einsatz von Speicherbeschraenkungen (Quotas)");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M4.305: Einsatz von Speicherbeschraenkungen (Quotas).
