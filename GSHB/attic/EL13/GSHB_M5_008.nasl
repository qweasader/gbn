...
if(description)
{
  ...
  script_name("IT-Grundschutz M5.008: Regelmaessiger Sicherheitscheck des Netzes");
  ...
  script_tag(name:"summary", value:"IT-Grundschutz M5.008: Regelmaessiger Sicherheitscheck des Netzes.
