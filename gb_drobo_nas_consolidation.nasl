...
if(description)
{
  ...
  script_name("Drobo NAS Detection Consolidation");

  script_tag(name:"summary", value:"Consolidation of Drobo NAS detections.");
...
os_register_and_report(os: "Drobo NAS Firmware", cpe: os_cpe, desc: "Drobo NAS Detection Consolidation",
                       runs_key: "unixoide");
