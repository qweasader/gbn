...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"2021-11-24 11:16:33 +0000 (Wed, 24 Nov 2021)");
...
if (egrep(pattern: "<title>Welcome to NetWorker Management Console", string: res, icase: TRUE)) {
  ...
  cpe1 = build_cpe(value: version, exp: "^([0-9.]+)", base: "cpe:/a:dell:emc_networker:");
  cpe2 = build_cpe(value: version, exp: "^([0-9.]+)", base: "cpe:/a:emc:networker:");
  if (!cpe1) {
  ...
  log_message(data: build_detection_report(app: "Dell EMC NetWorker", version: version, install: "/",
                                           cpe: cpe1, concluded: vers[0], concludedUrl: concUrl),
              port: port);
}
