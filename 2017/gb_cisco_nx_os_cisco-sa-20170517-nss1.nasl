...
if (description)
{
  ...
  script_name("Cisco Nexus 5000 Series Switches Telnet CLI Command Injection Vulnerability (cisco-sa-20170517-nss1)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the Telnet CLI command of Cisco NX-OS System
  Software running on Cisco Nexus 5000 Series Switches could allow an authenticated, local attacker
  to perform a command injection attack.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to insufficient input validation of
  command arguments. An attacker could exploit this vulnerability by injecting crafted command
  arguments into the Telnet CLI command.");
...
if (!model || model !~ "^C?(3|35|5|6|7|9)[0-9]+")
  exit(0);
