...
if (description)
{
  ...
  script_name("HP/HPE/Micro Focus Universal CMDB RCE Vulnerability (HPESBGN03758)");
  ...
  script_tag(name:"affected", value:"HP/HPE/Micro Focus Universal CMDB versions 10.10, 10.11, 10.20,
  10.21, 10.22, 10.30 and 10.31.");

  script_tag(name:"solution", value:"See the advisory for a solution.");

  script_xref(name:"URL", value:"https://support.hpe.com/hpesc/public/docDisplay?docId=emr_na-hpesbgn03758en_us");
...
affected = make_list("10.10", "10.11", "10.20", "10.21", "10.22", "10.30", "10.31");
