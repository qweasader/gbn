...
if (description)
{
  ...
  script_name("Cisco Unified Communications Manager Cross-Site Scripting Vulnerability (cisco-sa-20170315-ucm1)");
  ...
  Communications Manager (CallManager) could allow an authenticated, remote attacker to perform a
  cross-site scripting (XSS) attack.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to insufficient validation of
  user-supplied input by the Cisco Unified CM User Options portal of the affected software.");

  script_tag(name:"impact", value:"An attacker could exploit this vulnerability by persuading an
  authenticated user of the portal to follow a malicious link. A successful exploit could allow the
  attacker to execute arbitrary code in the context of the portal.");
