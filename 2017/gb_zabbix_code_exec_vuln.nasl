...
if (description)
{
  ...
  script_name("Zabbix Arbitrary Code Execution Vulnerability (CVE-2016-4338)");
  ...
  script_tag(name:"insight", value:"The mysql user parameter configuration script
  (userparameter_mysql.conf), when used with a shell other than bash, allows context-dependent
  attackers to execute arbitrary code or SQL commands via the mysql.size parameter.");

  script_tag(name:"affected", value:"Zabbix version prior to 2.0.18, 2.2.x and 3.0.x.");

  script_tag(name:"solution", value:"Update to 2.0.18, 2.2.13, 3.0.3 or later.");
