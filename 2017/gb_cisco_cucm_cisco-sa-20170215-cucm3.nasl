...
if (description)
{
  ...
  script_name("Cisco Unified Communications Manager Information Disclosure Vulnerability (cisco-sa-20170215-cucm3)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the web framework Cisco Unified
  Communications Manager could allow an unauthenticated, remote attacker to view sensitive data.");

  script_tag(name:"insight", value:"The vulnerability is due to insufficient protection of
  sensitive files. An attacker could exploit this vulnerability by browsing to a specific URL.");

  script_tag(name:"impact", value:"An exploit could allow the attacker to view configuration
  information.");
