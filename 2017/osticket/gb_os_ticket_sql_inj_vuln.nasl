...
if (description)
{
  ...
  script_name("osTicket < 1.10.1 SQLi Vulnerability - Active Check");
  ...
  script_tag(name:"summary", value:"osTicket is prone to an unauthenticated SQL injection (SQLi)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Sends a crafted HTTP GET request and checks the response.");

  script_tag(name:"insight", value:"By constructing an array via use of square brackets at the end
  of a parameter name it is possible to inject SQL commands.");
