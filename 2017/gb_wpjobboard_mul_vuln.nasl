...
if(description)
{
  ...
  script_tag(name:"summary", value:"WpJobBoard is prone to multiple cross-site web vulnerabilities.");
...
if(version_is_equal(version:ver, test_version:"4.4.4") ||
   version_is_equal(version:ver, test_version:"4.5.1")) {
