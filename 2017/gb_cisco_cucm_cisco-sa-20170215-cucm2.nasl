...
if (description)
{
  ...
  script_name("Cisco Unified Communications Manager Cross-Site Scripting Vulnerability (cisco-sa-20170215-cucm2)");
  ...
  Unified Communications Manager Switches could allow an unauthenticated, remote attacker to
  conduct a cross-site scripting (XSS) attack against a user of the web-based management interface
