...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:1.9.1-1ubuntu0.7", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.7.4-0ubuntu1.3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU17.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"git", ver:"1:2.11.0-2ubuntu0.3", rls:"UBUNTU17.04"))) {
    report += res;
  }
