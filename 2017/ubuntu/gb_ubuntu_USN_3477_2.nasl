...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"57.0+build4-0ubuntu0.14.04.5", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"57.0+build4-0ubuntu0.16.04.6", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU17.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"57.0+build4-0ubuntu0.17.04.6", rls:"UBUNTU17.04"))) {
    report += res;
  }
...
if(release == "UBUNTU17.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"57.0+build4-0ubuntu0.17.10.6", rls:"UBUNTU17.10"))) {
    report += res;
  }
