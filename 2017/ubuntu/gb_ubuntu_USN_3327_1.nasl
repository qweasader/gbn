...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-raspi2' package(s) announced via the USN-3327-1 advisory.");
...
if(release == "UBUNTU16.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.8.0-1040-raspi2", ver:"4.8.0-1040.44", rls:"UBUNTU16.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi2", ver:"4.8.0.1040.44", rls:"UBUNTU16.10"))) {
    report += res;
  }
