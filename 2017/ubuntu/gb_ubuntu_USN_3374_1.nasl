...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rabbitmq-server", ver:"3.2.4-1ubuntu0.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rabbitmq-server", ver:"3.5.7-1ubuntu0.16.04.2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
