...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libiberty-dev", ver:"20131116-1ubuntu0.2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libiberty-dev", ver:"20160215-1ubuntu0.2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU17.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libiberty-dev", ver:"20161220-1ubuntu0.2", rls:"UBUNTU17.04"))) {
    report += res;
  }
