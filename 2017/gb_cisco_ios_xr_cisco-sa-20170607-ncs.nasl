...
if (description)
{
  ...
  script_name("Cisco Network Convergence System 5500 Series Routers Local Denial of Service Vulnerability (cisco-sa-20170607-ncs)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the forwarding component of Cisco IOS XR
  ...
  script_tag(name:"insight", value:"The vulnerability occurs because adjacency information for a
