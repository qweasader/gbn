...
if(description)
{
  ...
  script_tag(name:"summary", value:"QNAP QTS is prone to multiple arbitrary command execution
  vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"solution", value:"Update to QNAP QTS 4.2.4 Build 20170313 or later.");
...
if( version_is_less( version:version, test_version:"4.2.4_20170313" ) )
{
  report = report_fixed_ver( installed_version:version, fixed_version:"4.2.4_20170313" );
