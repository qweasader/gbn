...
if (description)
{
  ...
  script_name("Cisco Unified Communications Manager SQL Injection Vulnerability (cisco-sa-20170802-ucm)");
  ...
  allow an authenticated, remote attacker to conduct a blind SQL injection attack.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to a failure to validate user-supplied
  input used in SQL queries that bypass protection filters. An attacker could exploit this
  vulnerability by sending crafted URLs that include SQL statements.");

  script_tag(name:"impact", value:"An exploit could allow the attacker to modify or delete entries
  in some database tables, affecting the integrity of the data.");
