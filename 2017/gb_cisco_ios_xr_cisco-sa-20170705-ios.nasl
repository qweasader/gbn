...
if (description)
{
  ...
  script_name("Cisco IOS XR Software Incorrect Permissions Privilege Escalation Vulnerability (cisco-sa-20170705-ios)");
  ...
  an authenticated, local attacker to execute arbitrary code at the root privilege level on an
  affected system.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to incorrect permissions that are
  given to a set of users. An attacker could exploit this vulnerability by logging in to an
  affected device and elevating their privileges via crafted input.");

  script_tag(name:"impact", value:"A successful exploit could allow the attacker to gain root-level
  privileges and take full control of the affected device.");
