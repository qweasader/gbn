...
if(description)
{
  ...
  script_name("Tenable Nessus < 6.9.3 XSS Vulnerabilities");
  ...
  script_tag(name:"summary", value:"Tenable Nessus is prone to two stored cross-site scripting (XSS)
  vulnerabilities.");
  ...
  script_tag(name:"solution", value:"Update to version 6.9.3 or later.");
...
if( version_in_range( version:vers, test_version:"6.8.0", test_version2:"6.9.2" ) ) {
  report = report_fixed_ver( installed_version:vers, fixed_version:"6.9.3", install_path:location );
