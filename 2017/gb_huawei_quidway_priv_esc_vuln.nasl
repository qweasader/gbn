...
if (description)
{
  ...
  script_tag(name:"summary", value:"Huawei Quidway switches are prone to a privilege escalation
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Huawei Quidway switches allows remote attackers to gain
  privileges via a crafted packet.");

  script_tag(name:"impact", value:"Attackers may exploit this vulnerability to obtain higher access
  permissions.");

  script_tag(name:"affected", value:"Quidway S2350, S2750, S5300, S5700, S6300, S6700, S7700, S9300,
  S9300E and S9700 with versions prior to V200R005C00SPC300.");

  script_tag(name:"solution", value:"Update to version V200R005C00SPC300 or later.");
