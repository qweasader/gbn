...
if(description)
{
  ...
  script_name("Cybozu Garoon 3.0.0 - 4.2.5 Multiple XSS Vulnerabilities");

  script_tag(name:"summary", value:"Cybozu Garoon is prone to multiple cross-site scripting (XSS)
  vulnerabilities.");
  ...
  arbitrary script in the logged-in user's web browser.");

  script_tag(name:"affected", value:"Cybozu Garoon versions 3.0.0 through 4.2.5.");
...
if(version_in_range(version:version, test_version:"3.0.0", test_version2:"4.2.5")) {
