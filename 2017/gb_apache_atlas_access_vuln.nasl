...
if(description)
{
  ...
  script_tag(name:"summary", value:"Apache Atlas is prone to an access vulnerability. Atlas users can access the webapp directory contents by pointing to URIs like /js, /img.");
