...
if (description)
{
  ...
  script_name("Cisco Unified Communications Manager Cross-Site Request Forgery Vulnerability (cisco-sa-20170315-ucm2)");
  ...
  Communications Manager (CallManager) could allow an unauthenticated, remote attacker to conduct a
  cross-site request forgery (CSRF) attack against a user of the web interface of the affected
  software.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to insufficient CSRF protections
  implemented by the affected software. An attacker could exploit this vulnerability by persuading
  a user of the web interface to follow a malicious link.");

  script_tag(name:"impact", value:"A successful exploit could allow the attacker to submit
  arbitrary requests to the affected software via the user's web browser and with the user's
  privileges.");
