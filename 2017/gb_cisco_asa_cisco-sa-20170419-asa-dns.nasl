...
if (description)
{
  ...
  script_name("Cisco ASA Software DNS Denial of Service Vulnerability (cisco-sa-20170419-asa-dns)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the DNS code of Cisco ASA Software could
  ...
  script_tag(name:"insight", value:"The vulnerability is due to a flaw in handling crafted DNS
  ...
  script_tag(name:"impact", value:"A successful exploit could cause the device to reload, resulting
