...
if(description)
{
  ...
  script_name("MantisBT < 2.1.1 'view_type' XSS Vulnerability - Windows");
  ...
  script_tag(name:"impact", value:"Successfully exploitation will allow remote attacker to execute
  ...
  script_tag(name:"affected", value:"MantisBT versions before 2.1.1.");
