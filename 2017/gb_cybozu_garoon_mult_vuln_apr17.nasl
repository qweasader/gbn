...
if(description)
{
  ...
  script_name("Cybozu Garoon 3.0.0 - 4.2.3 Multiple Vulnerabilities");
  ...
  script_tag(name:"affected", value:"Cybozu Garoon versions 3.0.0 through 4.2.3.");
...
if(version_in_range(version:version, test_version:"3.0.0", test_version2:"4.2.3")) {
