...
if(description)
{
  ...
  script_name("MantisBT 1.2.13 - 1.2.19 'adm_config_report.php' XSS Vulnerability - Windows");
  ...
  script_tag(name:"affected", value:"MantisBT version 1.2.13 through 1.2.19.");

  script_tag(name:"solution", value:"Update to version 1.2.20 or later.");
...
if (version_in_range(version: version, test_version: "1.2.13", test_version2: "1.2.19")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.2.20", install_path: location);
