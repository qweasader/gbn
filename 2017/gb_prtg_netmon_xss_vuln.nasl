...
if (description)
{
  ...
  script_name("PRTG Network Monitor < 17.2.32.2279 XSS Vulnerability");
  ...
  script_tag(name:"affected", value:"PRTG Network Monitor versions prior to 17.2.32.2279.");

  script_tag(name:"solution", value:"Update to version 17.2.32.2279 or later.");
