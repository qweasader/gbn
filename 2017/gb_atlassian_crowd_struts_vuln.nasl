...
if (description)
{
  ...
  script_name("Atlassian Crowd Struts2 RCE Vulnerability (CWD-4879)");
  ...
  script_tag(name:"summary", value:"Atlassian Crowd is prone to a remote code execution (RCE)
  vulnerability in Struts2.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Crowd uses a version of Struts 2 that is vulnerable to
  CVE-2017-5638. Attackers can use this vulnerability to execute Java code of their choice on the
  system.");

  script_tag(name:"affected", value:"Atlassiona Crowd version 2.8.3 through 2.9.6, 2.10.1 through
  2.10.2 and 2.11.0.");
...
if (version_in_range(version: version, test_version: "2.10.1", test_version2: "2.10.2")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.10.3", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}
