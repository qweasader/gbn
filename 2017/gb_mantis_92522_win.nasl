...
if(description)
{
  ...
  script_name("MantisBT < 1.2.19, 1.3.0 'view_type' XSS Vulnerability - Windows");
  ...
  script_tag(name:"solution", value:"Update to version 1.2.19, 1.3.1 or 2.0.0-beta2.");
...
if (version =~ "^2\.0") {
  if (version_is_less(version: version, test_version: "2.0.0-beta.2")) {
    vuln = TRUE;
    fix = "2.0.0-beta.2";
  }
}
