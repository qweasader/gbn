...
if(description)
{
  ...
  script_name("phpMyAdmin Multiple Vulnerabilities (PMASA-2014-15, PMASA-2014-16) - Windows");
  ...
  script_tag(name:"solution", value:"Update to version 4.1.14.7, 4.2.12 or later.");

  script_tag(name:"qod_type", value:"remote_banner");
  script_tag(name:"solution_type", value:"VendorFix");

  script_xref(name:"URL", value:"https://www.phpmyadmin.net/security/PMASA-2014-15/");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/71244");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/71245");
