...
if (description)
{
  ...
  script_name("Cisco ASA Software IPsec Denial of Service Vulnerability (cisco-sa-20170419-asa-ipsec)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the IPsec code of Cisco ASA Software could
  allow an authenticated, remote attacker to cause a reload of the affected system.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to improper parsing of malformed IPsec
