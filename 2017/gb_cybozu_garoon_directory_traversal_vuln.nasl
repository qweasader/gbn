...
if(description)
{
  ...
  script_name("Cybozu Garoon 4.2.4 - 4.2.5 Directory Traversal Vulnerability");

  script_tag(name:"summary", value:"Cybozu Garoon is prone to a directory traversal vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw is due to an input validation error in SOAP API
  'WorkflowHandleApplications'.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to read
  arbitrary files.");

  script_tag(name:"affected", value:"Cybozu Garoon versions 4.2.4 through 4.2.5.");
...
if(version_in_range(version:version, test_version:"4.2.4", test_version2:"4.2.5")) {
