...
if(description)
{
  ...
  script_name("Cybozu Garoon 3.7.0 - 4.2.5 'Rich text' Function XSS Vulnerability");

  script_tag(name:"summary", value:"Cybozu Garoon is prone to a cross-site scripting (XSS)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Stored cross-site scripting in the 'Rich text' function of the
  application 'Space'");

  script_tag(name:"impact", value:"An arbitrary script may be executed on the logged-in user's web
  browser.");

  script_tag(name:"affected", value:"Cybozu Garoon versions 3.7.0 through 4.2.5.");
...
if(version_in_range(version:version, test_version:"3.7.0", test_version2:"4.2.5")) {
