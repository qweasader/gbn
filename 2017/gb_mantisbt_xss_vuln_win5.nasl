...
if(description)
{
  ...
  script_name("MantisBT < 1.3.9, 2.x < 2.1.3, 2.2.x < 2.2.3 Multiple XSS Vulnerabilities - Windows");
  ...
  script_tag(name:"solution", value:"Update to version 1.3.9, 2.1.3, or 2.2.3.");
