...
if(description)
{
  ...
  script_tag(name:"summary", value:"ImageMagick is prone to multiple security bypass vulnerabilities.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/95208");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/95207");
