...
if(description)
{
  ...
  script_name("Kaspersky Total Security < 17.0.0.611 Multiple Vulnerabilities");

  script_tag(name:"summary", value:"Kaspersky Total Security is prone to multiple denial of service
  ...
  script_tag(name:"affected", value:"Kaspersky Total Security version 16.0.0.614 and prior.");
