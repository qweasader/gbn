...
if (description)
{
  ...
  script_name("IceWarp Mail Server <= 10.4.4 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"Cross-site scripting (XSS) vulnerability in the admin panel in
  IceWarp Mail Server allows remote authenticated domain administrators to inject arbitrary web
  script or HTML via a crafted user name.");

  script_tag(name:"affected", value:"IceWarp Mail Server version 10.4.4 is vulnerable. Other versions
