...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3790-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3790-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3790-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3790");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'spice' package(s) announced via the DSA-3790-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libspice-server-dev", ver:"0.12.5-1+deb8u4", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libspice-server1", ver:"0.12.5-1+deb8u4", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libspice-server1-dbg", ver:"0.12.5-1+deb8u4", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"spice-client", ver:"0.12.5-1+deb8u4", rls:"DEB8"))) {
    report += res;
  }
