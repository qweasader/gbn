...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-16 23:36:36 +0000 (Sun, 16 Jul 2017)");

  script_name("Debian: Security Advisory (DSA-3910-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3910-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3910-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3910");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'knot' package(s) announced via the DSA-3910-1 advisory.");
