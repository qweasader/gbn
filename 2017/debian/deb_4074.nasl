...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-12-21 15:33:37 +0000 (Thu, 21 Dec 2017)");

  script_name("Debian: Security Advisory (DSA-4074-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4074-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-4074-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4074");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/imagemagick");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imagemagick' package(s) announced via the DSA-4074-1 advisory.");
