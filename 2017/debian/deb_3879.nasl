...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-04-19 19:44:05 +0000 (Wed, 19 Apr 2017)");

  script_name("Debian: Security Advisory (DSA-3879-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3879-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3879-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3879");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libosip2' package(s) announced via the DSA-3879-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libosip2-11", ver:"4.1.0-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libosip2-dev", ver:"4.1.0-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
