...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-25 17:46:31 +0000 (Fri, 25 Aug 2017)");

  script_name("Debian: Security Advisory (DSA-3924-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3924-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3924-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'varnish' package(s) announced via the DSA-3924-1 advisory.");
