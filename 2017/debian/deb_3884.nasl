...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-06-28 14:11:26 +0000 (Wed, 28 Jun 2017)");

  script_name("Debian: Security Advisory (DSA-3884-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3884-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3884-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3884");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnutls28' package(s) announced via the DSA-3884-1 advisory.");
