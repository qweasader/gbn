...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3900-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3900-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3900-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3900");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openvpn' package(s) announced via the DSA-3900-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openvpn", ver:"2.3.4-5+deb8u2", rls:"DEB8"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openvpn", ver:"2.4.0-6+deb9u1", rls:"DEB9"))) {
    report += res;
  }
