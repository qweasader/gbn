...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-02-13 22:31:50 +0000 (Mon, 13 Feb 2017)");

  script_name("Debian: Security Advisory (DSA-3821-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3821-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3821-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3821");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gst-plugins-ugly1.0' package(s) announced via the DSA-3821-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gstreamer1.0-plugins-ugly", ver:"1.4.4-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gstreamer1.0-plugins-ugly-dbg", ver:"1.4.4-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gstreamer1.0-plugins-ugly-doc", ver:"1.4.4-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
