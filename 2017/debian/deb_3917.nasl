...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-13 12:53:13 +0000 (Thu, 13 Jul 2017)");

  script_name("Debian: Security Advisory (DSA-3917-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3917-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3917-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3917");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'catdoc' package(s) announced via the DSA-3917-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"catdoc", ver:"0.94.4-1.1+deb8u1", rls:"DEB8"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"catdoc", ver:"1:0.94.3~git20160113.dbc9ec6+dfsg-1+deb9u1", rls:"DEB9"))) {
    report += res;
  }
