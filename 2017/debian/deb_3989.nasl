...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3989-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3989-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3989-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3989");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dnsmasq' package(s) announced via the DSA-3989-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq", ver:"2.72-3+deb8u2", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-base", ver:"2.72-3+deb8u2", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-utils", ver:"2.72-3+deb8u2", rls:"DEB8"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq", ver:"2.76-5+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-base", ver:"2.76-5+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-utils", ver:"2.76-5+deb9u1", rls:"DEB9"))) {
    report += res;
  }
