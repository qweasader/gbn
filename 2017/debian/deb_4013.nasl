...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-09-06 18:58:34 +0000 (Wed, 06 Sep 2017)");

  script_name("Debian: Security Advisory (DSA-4013-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4013-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-4013-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4013");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjpeg2' package(s) announced via the DSA-4013-1 advisory.");
