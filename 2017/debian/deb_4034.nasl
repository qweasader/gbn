...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-12-05 01:00:01 +0000 (Tue, 05 Dec 2017)");

  script_name("Debian: Security Advisory (DSA-4034-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4034-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-4034-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'varnish' package(s) announced via the DSA-4034-1 advisory.");
