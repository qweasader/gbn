...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3894-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3894-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3894-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3894");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'graphite2' package(s) announced via the DSA-3894-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgraphite2-3", ver:"1.3.10-1~deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgraphite2-3-dbg", ver:"1.3.10-1~deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgraphite2-dev", ver:"1.3.10-1~deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgraphite2-doc", ver:"1.3.10-1~deb8u1", rls:"DEB8"))) {
    report += res;
  }
