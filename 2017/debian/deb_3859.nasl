...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-07-11 17:11:02 +0000 (Mon, 11 Jul 2022)");

  script_name("Debian: Security Advisory (DSA-3859-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3859-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3859-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3859");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'dropbear' package(s) announced via the DSA-3859-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dropbear", ver:"2014.65-1+deb8u2", rls:"DEB8"))) {
    report += res;
  }
