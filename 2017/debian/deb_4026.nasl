...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-11-13 16:28:07 +0000 (Mon, 13 Nov 2017)");

  script_name("Debian: Security Advisory (DSA-4026-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4026-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-4026-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4026");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bchunk' package(s) announced via the DSA-4026-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bchunk", ver:"1.2.0-12+deb8u1", rls:"DEB8"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bchunk", ver:"1.2.0-12+deb9u1", rls:"DEB9"))) {
    report += res;
  }
