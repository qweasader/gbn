...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3775-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3775-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3775-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3775");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tcpdump' package(s) announced via the DSA-3775-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tcpdump", ver:"4.9.0-1~deb8u1", rls:"DEB8"))) {
    report += res;
  }
