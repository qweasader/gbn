...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-09-24 21:23:08 +0000 (Mon, 24 Sep 2018)");

  script_name("Debian: Security Advisory (DSA-4063-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4063-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-4063-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4063");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/pdns-recursor");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pdns-recursor' package(s) announced via the DSA-4063-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"pdns-recursor", ver:"4.0.4-1+deb9u3+b1", rls:"DEB9"))) {
    report += res;
  }
