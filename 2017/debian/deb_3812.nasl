...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-03-28 15:47:55 +0000 (Tue, 28 Mar 2017)");

  script_name("Debian: Security Advisory (DSA-3812-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3812-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3812-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3812");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ioquake3' package(s) announced via the DSA-3812-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ioquake3", ver:"1.36+u20140802+gca9eebb-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ioquake3-dbg", ver:"1.36+u20140802+gca9eebb-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ioquake3-server", ver:"1.36+u20140802+gca9eebb-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
