...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-12-12 14:21:54 +0000 (Tue, 12 Dec 2017)");

  script_name("Debian: Security Advisory (DSA-4049-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4049-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-4049-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4049");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ffmpeg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-4049-1 advisory.");
