...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-04-28 18:17:15 +0000 (Fri, 28 Apr 2017)");

  script_name("Debian: Security Advisory (DSA-3836-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3836-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3836-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3836");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'weechat' package(s) announced via the DSA-3836-1 advisory.");
