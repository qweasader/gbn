...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3845-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3845-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3845-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3845");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libtirpc, rpcbind' package(s) announced via the DSA-3845-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtirpc-dev", ver:"0.2.5-1+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtirpc1", ver:"0.2.5-1+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"rpcbind", ver:"0.2.1-6+deb8u2", rls:"DEB8"))) {
    report += res;
  }
