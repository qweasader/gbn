...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3818-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3818-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3818-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3818");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gst-plugins-bad1.0' package(s) announced via the DSA-3818-1 advisory.");
