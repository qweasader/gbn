...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2016-12-29 21:34:14 +0000 (Thu, 29 Dec 2016)");

  script_name("Debian: Security Advisory (DSA-3761-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3761-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3761-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3761");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'rabbitmq-server' package(s) announced via the DSA-3761-1 advisory.");
