...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4003-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4003-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-4003-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4003");
  script_xref(name:"URL", value:"https://security.libvirt.org/2017/0002.html");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libvirt' package(s) announced via the DSA-4003-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnss-libvirt", ver:"3.0.0-4+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libvirt-clients", ver:"3.0.0-4+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libvirt-daemon", ver:"3.0.0-4+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libvirt-daemon-system", ver:"3.0.0-4+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libvirt-dev", ver:"3.0.0-4+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libvirt-doc", ver:"3.0.0-4+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libvirt-sanlock", ver:"3.0.0-4+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libvirt0", ver:"3.0.0-4+deb9u1", rls:"DEB9"))) {
    report += res;
  }
