...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-02-23 14:52:54 +0000 (Thu, 23 Feb 2017)");

  script_name("Debian: Security Advisory (DSA-3807-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3807-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3807-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3807");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icoutils' package(s) announced via the DSA-3807-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"icoutils", ver:"0.31.0-2+deb8u3", rls:"DEB8"))) {
    report += res;
  }
