...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3778-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3778-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3778-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3778");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby-archive-tar-minitar' package(s) announced via the DSA-3778-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-archive-tar-minitar", ver:"0.5.2-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
