...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-09-29 15:56:51 +0000 (Fri, 29 Sep 2017)");

  script_name("Debian: Security Advisory (DSA-3977-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3977-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3977-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3977");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'newsbeuter' package(s) announced via the DSA-3977-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"newsbeuter", ver:"2.8-2+deb8u2", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"newsbeuter-dbg", ver:"2.8-2+deb8u2", rls:"DEB8"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"newsbeuter", ver:"2.9-5+deb9u2", rls:"DEB9"))) {
    report += res;
  }
