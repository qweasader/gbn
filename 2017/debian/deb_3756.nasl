...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-26 09:20:27 +0000 (Sat, 26 Aug 2017)");

  script_name("Debian: Security Advisory (DSA-3756-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3756-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3756-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3756");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icoutils' package(s) announced via the DSA-3756-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"icoutils", ver:"0.31.0-2+deb8u1", rls:"DEB8"))) {
    report += res;
  }
