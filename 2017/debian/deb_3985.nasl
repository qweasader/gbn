...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-11-15 16:03:25 +0000 (Wed, 15 Nov 2017)");

  script_name("Debian: Security Advisory (DSA-3985-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3985-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3985-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3985");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium-browser' package(s) announced via the DSA-3985-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"chromedriver", ver:"61.0.3163.100-1~deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium", ver:"61.0.3163.100-1~deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium-driver", ver:"61.0.3163.100-1~deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium-l10n", ver:"61.0.3163.100-1~deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium-shell", ver:"61.0.3163.100-1~deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"chromium-widevine", ver:"61.0.3163.100-1~deb9u1", rls:"DEB9"))) {
    report += res;
  }
