...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-3846-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3846-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3846-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3846");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libytnef' package(s) announced via the DSA-3846-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libytnef0", ver:"1.5-6+deb8u1", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libytnef0-dev", ver:"1.5-6+deb8u1", rls:"DEB8"))) {
    report += res;
  }
