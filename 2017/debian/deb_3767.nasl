...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-01-31 13:18:54 +0000 (Tue, 31 Jan 2017)");

  script_name("Debian: Security Advisory (DSA-3767-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3767-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3767-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mysql-5.5' package(s) announced via the DSA-3767-1 advisory.");
