...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-06-08 13:47:48 +0000 (Thu, 08 Jun 2017)");

  script_name("Debian: Security Advisory (DSA-3943-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-3943-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-3943-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-3943");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gajim' package(s) announced via the DSA-3943-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gajim", ver:"0.16-1+deb8u2", rls:"DEB8"))) {
    report += res;
  }
