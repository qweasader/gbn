...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4029-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4029-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2017/DSA-4029-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4029");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postgresql-common' package(s) announced via the DSA-4029-1 advisory.");
