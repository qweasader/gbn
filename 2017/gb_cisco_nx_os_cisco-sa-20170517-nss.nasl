...
if (description)
{
  ...
  script_name("Cisco Nexus 5000 Series Switches CLI Command Injection Vulnerability (cisco-sa-20170517-nss)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the CLI of Cisco NX-OS System Software
  running on Cisco Nexus 5000 Series Switches could allow an authenticated, local attacker to
  ...
  arguments into a vulnerable CLI command.");
