...
if (description)
{
  ...
  script_name("WordPress Calls To Action Plugin < 2.5.1 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Calls To Action' is prone to a cross-site scripting (XSS) vulnerability.");

  script_tag(name:"impact", value:"The flaw resulting in attackers being able to inject arbitrary web script or HTML via the (1) open-tab parameter in a wp_cta_global_settings action to wp-admin/edit.php or (2) wp-cta-variation-id parameter to ab-testing-call-to-action-example/.");
...
CPE = "cpe:/a:inboundnow:call_to_action";
