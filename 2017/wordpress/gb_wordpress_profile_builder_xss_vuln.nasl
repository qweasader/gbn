...
if (description)
{
  ...
  script_name("WordPress Profile Builder Plugin < 2.0.3 Multiple XSS Vulnerabilities");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Profile Builder' is prone to multiple
  cross-site scripting (XSS) vulnerabilities.");

  script_tag(name:"impact", value:"The flaws in assets/misc/fallback-page.php allow remote attackers
  to inject arbitrary web script or HTML via the (1) site_name, (2) message
  or (3) site_url parameter.");
...
CPE = "cpe:/a:cozmoslabs:profile_builder";
