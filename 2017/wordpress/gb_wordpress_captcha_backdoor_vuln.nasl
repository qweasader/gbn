...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Captcha' is prone to a backdoor
  vulnerability.");
  ...
  Another recommendation is that you uninstall the Captcha plugin immediately since the developer
  cannot be trusted.");
