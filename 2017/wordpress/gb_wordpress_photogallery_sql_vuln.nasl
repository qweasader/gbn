...
if (description)
{
  ...
  script_tag(name:"insight", value:"The flaw is related to bwg_edit_tag() in photo-gallery.php and edit_tag()
  in admin/controllers/BWGControllerTags_bwg.php. It is exploitable by administrators via the tag_id
  parameter.");
