...
if (description)
{
  ...
  script_name("WordPress No External Links Plugin < 3.5.19 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'WP No External Links' is prone to a
  cross-site scripting (XSS) vulnerability.");

  script_tag(name:"insight", value:"The XSS vulnerability exists in the No External Links plugin via
  the date1 or date2 parameter to wp-admin/options-general.php.");
...
CPE = "cpe:/a:wp_no_external_links_project:wp_no_external_links";
