...
if (description)
{
  ...
  script_name("WordPress Relevanssi Plugin < 3.5.8 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Relevanssi' is prone to a stored cross-site
  scripting (XSS) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"The flaw results in attackers being able to execute JavaScript on
  the affected site.");
...
CPE = "cpe:/a:relevanssi:relevanssi";
