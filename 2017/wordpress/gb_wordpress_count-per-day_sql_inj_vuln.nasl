...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Cpimt Per Day' is prone to an SQL injection (SQLi) vulnerability.");

  script_tag(name:"insight", value:"An SQL injection vulnerability in counter-options.php in the Count Per Day plugin for WordPress
