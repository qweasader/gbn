...
if (description)
{
  ...
  script_name("WordPress Role Scoper Plugin < 1.3.67 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Role Scoper' is prone to a cross-site
  scripting (XSS) vulnerability.");

  script_tag(name:"insight", value:"The flaw results in attackers being able to inject arbitrary web
  script or HTML via the object_name parameter in a rs-object_role_edit page to wp-admin/admin.php.");
...
CPE = "cpe:/a:role_scoper_project:role_scoper";
