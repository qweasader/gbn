...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'YouTube' is prone to a cross-site request
  forgery (CSRF) vulnerability.");

  script_tag(name:"insight", value:"CSRF in YouTube (WordPress plugin) could allow unauthenticated
