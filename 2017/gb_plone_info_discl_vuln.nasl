...
if (description)
{
  ...
  script_name("Plone CMS < 5.0.5 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"Plone allows remote attackers to obtain information about the ID
  of sensitive content via unspecified vectors.");

  script_tag(name:"impact", value:"An unauthenticated attacker may gain information about private
  site content.");
