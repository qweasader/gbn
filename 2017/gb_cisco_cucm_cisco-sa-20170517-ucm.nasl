...
if (description)
{
  ...
  script_name("Cisco Unified Communications Manager Cross-Site Scripting Vulnerability (cisco-sa-20170517-ucm)");
  ...
  Unified Communications Manager could allow an unauthenticated, remote attacker to conduct a
