...
if(description)
{
  ...
  script_name("Open-Xchange (OX) App Suite Content Spoofing Vulnerability");

  script_tag(name:"summary", value:"Open-Xchange (OX) App Suite is prone to content spoofing vulnerability.");
  ...
  script_tag(name:"solution", value:"Update to version 7.8.1-rev11, or 7.8.0-rev23, or later.");

  script_tag(name:"solution_type", value:"VendorFix");

  script_xref(name:"URL", value:"http://www.securityfocus.com/archive/1/archive/1/538732/100/0/threaded");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/91361");
...
if(version =~ "^7\.8\.0" && version_is_less(version: version, test_version: "7.8.0.23"))
  fix = "7.8.0-rev23";
