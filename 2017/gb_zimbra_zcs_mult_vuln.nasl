...
if (description)
{
  ...
  script_name("Zimbra < 8.7.6 Multiple Vulnerabilities");
  ...
  - CVE-2017-6813: Improper handling of privileges

  - CVE-2017-6821: Improper limitation of file paths

  - CVE-2016-9924: XML external entity (XXE)");

  script_tag(name:"affected", value:"Zimbra prior to version 8.7.6.");

  script_tag(name:"solution", value:"Update to version 8.7.6 or later.");

  script_xref(name:"URL", value:"https://wiki.zimbra.com/wiki/Security_Center");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/97121");
