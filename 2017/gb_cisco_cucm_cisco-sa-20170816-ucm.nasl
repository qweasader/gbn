...
if (description)
{
  ...
  script_name("Cisco Unified Communications Manager Horizontal Privilege Escalation Vulnerability (cisco-sa-20170816-ucm)");
  ...
  script_tag(name:"summary", value:"A vulnerability in configuration modification permissions
  ...
  script_tag(name:"insight", value:"The vulnerability is due to lack of proper Role Based Access
