...
if(description)
{
  ...
  script_name("Apache Ambari 2.4.0 - 2.4.2, 2.5.0 XML Injection Vulnerability");
  ...
  script_tag(name:"summary", value:"Apache Ambari is prone to an XML injection vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"An authorized user of the Ambari Hive View may be able to gain
  unauthorized read access to files on the host where the Amari server executes. Access to files
  are limit to the set of files for which the user that executes the Ambari server has read
  access.");

  script_tag(name:"affected", value:"Apache Ambari version 2.4.x prior to 2.4.3 and version 2.5.0.");
