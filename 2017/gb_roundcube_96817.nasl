...
if(description)
{
  ...
  script_name("Roundcube Webmail < 1.1.8, 1.2.x < 1.2.4 XSS Vulnerability");
  ...
  script_tag(name:"affected", value:"Roundcube Webmail versions prior to 1.1.8 and 1.2.x to
  1.2.4.");

  script_tag(name:"solution", value:"Update to version 1.1.8, 1.2.4 or later.");
...
if (version_is_less_equal(version: version, test_version: "1.1.7")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.1.8", install_path: location);
