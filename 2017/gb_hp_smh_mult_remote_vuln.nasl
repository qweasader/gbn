...
if (description)
{
  ...
  script_cve_id("CVE-2016-8743", "CVE-2017-12544", "CVE-2017-12545", "CVE-2017-12546", "CVE-2017-12547",
                "CVE-2017-12548", "CVE-2017-12549", "CVE-2017-12550", "CVE-2017-12551", "CVE-2017-12552",
                "CVE-2017-12553");
  script_tag(name:"qod_type", value:"remote_banner");
  script_tag(name:"solution_type", value:"VendorFix");
  script_name("HP/HPE System Management Homepage (SMH) Multiple Remote Vulnerabilities (HPESBMU03753)");
  ...
  security misconfiguration and improper authentication mechanism.");

  script_tag(name:"impact", value:"Successfully exploiting these issues allow attackers to obtain
  sensitive information, bypass authentication, execute arbitrary commands, cause denial of service
  and local unqualified configuration change.");

  script_tag(name:"affected", value:"HP/HPE SMH prior to version 7.6.1.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/101029");
