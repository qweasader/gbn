...
if(description)
{
  ...
  script_name("Apache Subversion DoS Vulnerability (Nov 2017)");
  ...
  script_tag(name:"insight", value:"The flaw is due to a failure to handle exceptional conditions.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to cause a
  denial of service condition.");

  script_tag(name:"affected", value:"Apache Subversion version 1.8.x before 1.8.2.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/101620");
...
if (version_in_range_exclusive(version: version, test_version_lo: "1.8.0", test_version_up: "1.8.2")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "1.8.2");
