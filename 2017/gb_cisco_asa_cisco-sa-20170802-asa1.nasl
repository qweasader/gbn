...
if (description)
{
  ...
  script_name("Cisco ASA WebVPN Cross-Site Scripting Vulnerability (cisco-sa-20170802-asa1)");
  ...
  Adaptive Security Appliance (ASA) could allow an unauthenticated, remote attacker to conduct a
