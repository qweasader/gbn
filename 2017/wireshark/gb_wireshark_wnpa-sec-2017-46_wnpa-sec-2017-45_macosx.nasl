...
if(description)
{
  ...
  script_name("Wireshark Security Updates (wnpa-sec-2017-46_wnpa-sec-2017-45) - Mac OS X");
...
if(version =~ "^2\.4") {
  if(version_in_range(version:version, test_version:"2.4.0", test_version2:"2.4.1")) {
    report = report_fixed_ver(installed_version:version, fixed_version:"2.4.2", install_path:path);
