...
if (description)
{
  ...
  script_name("TIBCO JasperReports XSS Vulnerability (Nov 2017)");
  ...
  script_tag(name:"summary", value:"TIBCO JasperReports contain a vulnerability which may allow a
  subset of authorized users to perform persistent cross-site scripting (XSS) attacks.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"The impact of this vulnerability includes the possibility that a
  malicious user can gain access to a more privileged account.");
