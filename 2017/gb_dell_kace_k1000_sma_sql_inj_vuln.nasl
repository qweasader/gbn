...
if (description)
{
  ...
  script_name("Quest / Dell KACE Systems Management Appliance (SMA) 6.4.120822 - 7.2.101 SQLi Vulnerability");
  ...
  script_tag(name:"summary", value:"An SQL injection (SQLi) exists in Quest / Dell KACE Systems
  Management Appliance (SMA).");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Quest / Dell KACE SMA versions 6.4.120822 through 7.2.101.");
