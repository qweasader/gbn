...
if (description)
{
  ...
  script_name("phpMyAdmin Multiple XSS Vulnerabilities (PMASA-2014-2) - Windows");
  ...
  inject arbitrary web script or HTML via a crafted (1) database name or (2) table name that is
  improperly handled after presence in (a) the favorite list or (b) recent tables.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/68201");
