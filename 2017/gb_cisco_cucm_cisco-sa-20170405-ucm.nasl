...
if (description)
{
  ...
  script_name("Cisco Unified Communications Manager SQL Injection Vulnerability (cisco-sa-20170405-ucm)");
  ...
  script_tag(name:"summary", value:"A vulnerability in the Cisco Unified Communications Manager web
  interface could allow an authenticated, remote attacker to impact the confidentiality of the
  system by executing arbitrary SQL queries. The attacker must be authenticated as an
  administrative user to execute SQL database queries.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is due to a lack of input validation on HTTP
  requests that contain user-supplied input. An attacker could exploit this vulnerability by
  sending crafted HTTP requests that contain malicious SQL statements to the affected system.");
