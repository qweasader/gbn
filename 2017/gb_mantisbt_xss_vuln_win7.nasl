...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-15 17:17:00 +0000 (Tue, 15 Aug 2017)");
  ...
  script_name("MantisBT < 1.3.12, 2.x < 2.5.2 Multiple XSS Vulnerabilities - Windows");
