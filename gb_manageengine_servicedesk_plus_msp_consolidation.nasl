...
if(description)
{
  ...
  script_dependencies("gb_manageengine_servicedesk_plus_msp_http_detect.nasl");
  ...
  script_tag(name:"summary", value:"Consolidation of ManageEngine ServiceDesk Plus - MSP
  detections.");
