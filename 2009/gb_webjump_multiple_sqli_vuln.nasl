...
if(description)
{
  ...
  script_name("WEBJump! Multiple SQLi Vulnerabilities (Mar 2009) - Active Check");
  ...
  script_tag(name:"summary", value:"WEBJump! is prone to multiple SQL injection (SQLi)
...
foreach dir (make_list_unique("/", http_cgi_dirs(port: port))) {
  ...
  res = http_get_cache(port: port, item: dir + "/portfolio_genre.php");
  if (!res || res !~ "^HTTP/1\.[01] 200")
    continue;

  url = dir + "/portfolio_genre.php?id=-67%20union%20select%201,2,0x53514c2d496e6a656374696f6e2d54657374--";
