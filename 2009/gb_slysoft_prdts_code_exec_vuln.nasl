...
if(description)
{
  ...
  script_name("SlySoft Products Code Execution Vulnerability (CVE-2009-0824)");
  script_xref(name:"URL", value:"http://secunia.com/advisories/34269");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/34103");
  ...
  script_tag(name:"summary", value:"SlySoft Products is prone to a Code Execution Vulnerability.");
  exit(0);
}
