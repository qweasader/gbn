...
if(description)
{
  ...
  script_name("A4Desk Event Calendar SQLi Vulnerability (Mar 2009) - Active Check");
  ...
  script_tag(name:"summary", value:"A4Desk Event Calendar is prone to an SQL injection (SQLi)
