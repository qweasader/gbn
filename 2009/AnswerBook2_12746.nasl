...
if (description)
{
  ...
  script_name("Sun Solaris AnswerBook2 Multiple XSS Vulnerabilities");
  ...
  scripting vulnerabilities. These issues arise due to insufficient sanitization of user-supplied
  data facilitating execution of arbitrary HTML and script code in a user's browser.");

  script_tag(name:"insight", value:"The following specific issues were identified:

  - It is reported that the Search function of the application is affected by a cross-site scripting
  vulnerability.
