...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64804");
...
Hat Update Agent with the following command: up2date.");
  ...
  script_xref(name:"URL", value:"http://rhn.redhat.com/errata/RHSA-2009-1289.html");
  script_xref(name:"URL", value:"http://www.redhat.com/security/updates/classification/#moderate");
  script_xref(name:"URL", value:"http://www.redhat.com/docs/en-US/Red_Hat_Enterprise_Linux/5.4/html/Technical_Notes/mysql.html");
