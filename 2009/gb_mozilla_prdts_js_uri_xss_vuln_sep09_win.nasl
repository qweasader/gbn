...
if(description)
{
  ...
  script_version("2022-03-02T09:14:10+0000");
  script_tag(name:"last_modification", value:"2022-03-02 09:14:10 +0000 (Wed, 02 Mar 2022)");
  script_tag(name:"creation_date", value:"2009-09-07 19:45:38 +0200 (Mon, 07 Sep 2009)");
  script_tag(name:"cvss_base", value:"4.3");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:M/Au:N/C:N/I:P/A:N");
  script_cve_id("CVE-2009-3010", "CVE-2009-3014");
  script_name("Mozilla Products 'javascript:' URI XSS Vulnerability (Sep 2009) - Windows");
  ...
  script_tag(name:"summary", value:"Mozilla Products are prone to a cross-site scripting (XSS)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Application fails to sanitise the 'javascript:' and 'data:'
  URIs in Refresh headers or Location headers in HTTP responses, which can be exploited via vectors
  related to injecting a Refresh header or Location HTTP response header.");

  script_tag(name:"impact", value:"Successful exploitation will allow attackers to conduct XSS
  attacks against the victim's system.");

  script_tag(name:"affected", value:"Mozilla Firefox version 3.0.13 and prior, 3.5 and 3.6/3.7 a1 pre

  Mozilla Browser 1.7.13 and prior
