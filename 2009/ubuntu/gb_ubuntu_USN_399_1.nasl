...
if(release == "UBUNTU5.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"w3m", ver:"0.5.1-3ubuntu1.1", rls:"UBUNTU5.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"w3m", ver:"0.5.1-4ubuntu2.6.06", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"w3m", ver:"0.5.1-4ubuntu2.6.10", rls:"UBUNTU6.10"))) {
    report += res;
  }
