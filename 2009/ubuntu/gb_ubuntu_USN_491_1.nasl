...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns21", ver:"1:9.3.2-2ubuntu1.3", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns21", ver:"1:9.3.2-2ubuntu3.2", rls:"UBUNTU6.10"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns22", ver:"1:9.3.4-2ubuntu2.1", rls:"UBUNTU7.04"))) {
    report += res;
  }
