...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkadm55", ver:"1.4.3-5ubuntu0.4", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkadm55", ver:"1.4.3-9ubuntu1.3", rls:"UBUNTU6.10"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkadm55", ver:"1.4.4-5ubuntu3.1", rls:"UBUNTU7.04"))) {
    report += res;
  }
