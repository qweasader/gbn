...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-base", ver:"2.41-2ubuntu2.2", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-base", ver:"2.45-1ubuntu1.1", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-base", ver:"2.47-3ubuntu0.1", rls:"UBUNTU9.04"))) {
    report += res;
  }
