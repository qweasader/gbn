...
if(release == "UBUNTU5.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dbus", ver:"0.36.2-0ubuntu7.1", rls:"UBUNTU5.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dbus", ver:"0.60-6ubuntu8.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dbus", ver:"0.93-0ubuntu3.1", rls:"UBUNTU6.10"))) {
    report += res;
  }
