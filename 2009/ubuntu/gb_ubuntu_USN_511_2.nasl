...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkadm55", ver:"1.4.3-5ubuntu0.6", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"librpcsecgss1", ver:"0.7-0ubuntu1.2", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkadm55", ver:"1.4.3-9ubuntu1.5", rls:"UBUNTU6.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"librpcsecgss2", ver:"0.13-2ubuntu0.2", rls:"UBUNTU6.10"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libkadm55", ver:"1.4.4-5ubuntu3.3", rls:"UBUNTU7.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"librpcsecgss3", ver:"0.14-2ubuntu1.2", rls:"UBUNTU7.04"))) {
    report += res;
  }
