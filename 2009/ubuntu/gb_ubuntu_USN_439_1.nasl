...
if(release == "UBUNTU5.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmagic1", ver:"4.12-1ubuntu1.1", rls:"UBUNTU5.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmagic1", ver:"4.16-0ubuntu3.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libmagic1", ver:"4.17-2ubuntu1.1", rls:"UBUNTU6.10"))) {
    report += res;
  }
