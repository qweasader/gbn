...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ktorrent", ver:"1.2-0ubuntu5.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ktorrent", ver:"2.0.3+dfsg1-0ubuntu1.1", rls:"UBUNTU6.10"))) {
    report += res;
  }
