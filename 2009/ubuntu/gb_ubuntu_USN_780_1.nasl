...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cupsys", ver:"1.2.2-0ubuntu0.6.06.14", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cupsys", ver:"1.3.7-1ubuntu3.5", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"1.3.9-2ubuntu9.2", rls:"UBUNTU8.10"))) {
    report += res;
  }
...
if(release == "UBUNTU9.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"1.3.9-17ubuntu3.1", rls:"UBUNTU9.04"))) {
    report += res;
  }
