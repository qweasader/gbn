...
if(release == "UBUNTU5.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fetchmail", ver:"6.2.5-13ubuntu3.3", rls:"UBUNTU5.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fetchmail", ver:"6.3.2-2ubuntu2.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fetchmail", ver:"6.3.4-1ubuntu4.1", rls:"UBUNTU6.10"))) {
    report += res;
  }
