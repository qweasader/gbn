...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"emacs21", ver:"21.4a-3ubuntu2.2", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"emacs21-bin-common", ver:"21.4a-3ubuntu2.2", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"emacs21", ver:"21.4a+1-2ubuntu1.2", rls:"UBUNTU7.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"emacs21-bin-common", ver:"21.4a+1-2ubuntu1.2", rls:"UBUNTU7.04"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"emacs22", ver:"22.1-0ubuntu5.2", rls:"UBUNTU7.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"emacs22-bin-common", ver:"22.1-0ubuntu5.2", rls:"UBUNTU7.10"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"emacs22", ver:"22.1-0ubuntu10.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"emacs22-bin-common", ver:"22.1-0ubuntu10.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
