...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsnmp-perl", ver:"5.2.1.2-4ubuntu2.3", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libsnmp9", ver:"5.2.1.2-4ubuntu2.3", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsnmp-perl", ver:"5.3.1-6ubuntu2.2", rls:"UBUNTU7.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libsnmp10", ver:"5.3.1-6ubuntu2.2", rls:"UBUNTU7.10"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsnmp-perl", ver:"5.4.1~dfsg-4ubuntu4.2", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libsnmp15", ver:"5.4.1~dfsg-4ubuntu4.2", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsnmp15", ver:"5.4.1~dfsg-7.1ubuntu6.1", rls:"UBUNTU8.10"))) {
    report += res;
  }
