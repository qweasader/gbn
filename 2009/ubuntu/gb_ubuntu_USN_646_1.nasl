...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rdesktop", ver:"1.4.1-1.1ubuntu0.6.06.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rdesktop", ver:"1.5.0-1ubuntu1.1", rls:"UBUNTU7.04"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rdesktop", ver:"1.5.0-2ubuntu0.1", rls:"UBUNTU7.10"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rdesktop", ver:"1.5.0-3+cvs20071006ubuntu0.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
