...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"2.0.0.11+0nobinonly-0ubuntu0.6.10", rls:"UBUNTU6.10"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"2.0.0.11+1nobinonly-0ubuntu0.7.4", rls:"UBUNTU7.04"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"2.0.0.11+2nobinonly-0ubuntu0.7.10", rls:"UBUNTU7.10"))) {
    report += res;
  }
