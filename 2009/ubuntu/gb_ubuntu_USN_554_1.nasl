...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tetex-bin", ver:"3.0-13ubuntu6.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tetex-bin", ver:"3.0-17ubuntu2.1", rls:"UBUNTU6.10"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tetex-bin", ver:"3.0-27ubuntu1.2", rls:"UBUNTU7.04"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"texlive-extra-utils", ver:"2007-12ubuntu3.1", rls:"UBUNTU7.10"))) {
    report += res;
  }
