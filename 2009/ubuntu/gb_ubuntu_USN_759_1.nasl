...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpoppler1", ver:"0.5.1-0ubuntu7.5", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libpoppler1-glib", ver:"0.5.1-0ubuntu7.5", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpoppler-glib2", ver:"0.6.4-1ubuntu3.2", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libpoppler2", ver:"0.6.4-1ubuntu3.2", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpoppler-glib3", ver:"0.8.7-1ubuntu0.2", rls:"UBUNTU8.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libpoppler3", ver:"0.8.7-1ubuntu0.2", rls:"UBUNTU8.10"))) {
    report += res;
  }
