...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cpio", ver:"2.6-10ubuntu0.3", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cpio", ver:"2.6-17ubuntu0.7.04.1", rls:"UBUNTU7.04"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cpio", ver:"2.8-1ubuntu2.2", rls:"UBUNTU7.10"))) {
    report += res;
  }
