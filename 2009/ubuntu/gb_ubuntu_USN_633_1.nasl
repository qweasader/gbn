...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxslt1.1", ver:"1.1.15-1ubuntu1.2", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxslt1.1", ver:"1.1.20-0ubuntu2.2", rls:"UBUNTU7.04"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxslt1.1", ver:"1.1.21-2ubuntu2.2", rls:"UBUNTU7.10"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxslt1.1", ver:"1.1.22-1ubuntu1.2", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
