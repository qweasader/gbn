...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"elinks", ver:"0.10.6-1ubuntu3.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"elinks", ver:"0.11.1-1ubuntu2.1", rls:"UBUNTU6.10"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"elinks", ver:"0.11.1-1.2ubuntu2.1", rls:"UBUNTU7.04"))) {
    report += res;
  }
