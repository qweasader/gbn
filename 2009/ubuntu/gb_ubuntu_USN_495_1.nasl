...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libqt3-mt", ver:"3:3.3.6-1ubuntu6.3", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libqt3-mt", ver:"3:3.3.6-3ubuntu3.2", rls:"UBUNTU6.10"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libqt3-mt", ver:"3:3.3.8really3.3.7-0ubuntu5.1", rls:"UBUNTU7.04"))) {
    report += res;
  }
