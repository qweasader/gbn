...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gstreamer0.10-plugins-good", ver:"0.10.6-0ubuntu4.2", rls:"UBUNTU7.10"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gstreamer0.10-plugins-good", ver:"0.10.7-3ubuntu0.2", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gstreamer0.10-plugins-good", ver:"0.10.10.4-1ubuntu1.1", rls:"UBUNTU8.10"))) {
    report += res;
  }
