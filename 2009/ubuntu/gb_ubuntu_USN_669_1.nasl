...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnome-screensaver", ver:"2.14.3-0ubuntu1.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnome-screensaver", ver:"2.20.0-0ubuntu4.3", rls:"UBUNTU7.10"))) {
    report += res;
  }
