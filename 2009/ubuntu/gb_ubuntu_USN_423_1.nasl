...
if(release == "UBUNTU5.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"moin", ver:"1.2.4-1ubuntu2.2", rls:"UBUNTU5.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-moinmoin", ver:"1.3.4-6ubuntu1.5.10", rls:"UBUNTU5.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-moinmoin", ver:"1.5.2-1ubuntu2.2", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-moinmoin", ver:"1.5.3-1ubuntu1.2", rls:"UBUNTU6.10"))) {
    report += res;
  }
