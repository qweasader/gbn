...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"passwd", ver:"1:4.0.13-7ubuntu3.3", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"passwd", ver:"1:4.0.18.1-9ubuntu0.1", rls:"UBUNTU7.10"))) {
    report += res;
  }
...
if(release == "UBUNTU8.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"passwd", ver:"1:4.0.18.2-1ubuntu2.1", rls:"UBUNTU8.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU8.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"passwd", ver:"1:4.1.1-1ubuntu1.1", rls:"UBUNTU8.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-vm-builder", ver:"0.9-0ubuntu3.1", rls:"UBUNTU8.10"))) {
    report += res;
  }
