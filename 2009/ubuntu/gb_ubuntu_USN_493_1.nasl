...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"1.5.dfsg+1.5.0.13~prepatch070731-0ubuntu1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"2.0.0.6+0dfsg-0ubuntu0.6.10", rls:"UBUNTU6.10"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"2.0.0.6+1-0ubuntu1", rls:"UBUNTU7.04"))) {
    report += res;
  }
