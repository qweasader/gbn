...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libflac7", ver:"1.1.2-3ubuntu1.1", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libflac7", ver:"1.1.2-5ubuntu1.1", rls:"UBUNTU6.10"))) {
    report += res;
  }
...
if(release == "UBUNTU7.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libflac7", ver:"1.1.2-5ubuntu2.1", rls:"UBUNTU7.04"))) {
    report += res;
  }
...
if(release == "UBUNTU7.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libflac8", ver:"1.1.4-3ubuntu1.1", rls:"UBUNTU7.10"))) {
    report += res;
  }
