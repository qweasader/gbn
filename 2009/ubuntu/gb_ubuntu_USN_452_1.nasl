...
if(release == "UBUNTU5.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kdelibs4c2", ver:"4:3.4.3-0ubuntu2.4", rls:"UBUNTU5.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libqt3-mt", ver:"3:3.3.4-8ubuntu5.2", rls:"UBUNTU5.10"))) {
    report += res;
  }
...
if(release == "UBUNTU6.06 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kdelibs4c2a", ver:"4:3.5.2-0ubuntu18.4", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libqt3-mt", ver:"3:3.3.6-1ubuntu6.2", rls:"UBUNTU6.06 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU6.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kdelibs4c2a", ver:"4:3.5.5-0ubuntu3.4", rls:"UBUNTU6.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libqt3-mt", ver:"3:3.3.6-3ubuntu3.1", rls:"UBUNTU6.10"))) {
    report += res;
  }
