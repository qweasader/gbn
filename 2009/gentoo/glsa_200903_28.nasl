...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities were found in libpng, which might result in the
execution of arbitrary code");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200903-28");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=244808");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=255231");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=259578");
