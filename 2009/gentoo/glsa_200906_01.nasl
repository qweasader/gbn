...
if(description)
{
  ...
  script_tag(name:"insight", value:"A vulnerability has been discovered in libpng that allows for information
    disclosure.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200906-01");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=272970");
