...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in GnuTLS might result in a Denial of Service,
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200905-04");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=267774");
