...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64925");
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in Dnsmasq might result in the remote execution of
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200909-19");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=282653");
