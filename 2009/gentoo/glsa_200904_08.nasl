...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63802");
  ...
  script_tag(name:"insight", value:"An error in OpenSSL might allow for a Denial of Service when printing
certificate details.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200904-08");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=263751");
