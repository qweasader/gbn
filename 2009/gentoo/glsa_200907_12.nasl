...
if(description)
{
  ...
  script_tag(name:"insight", value:"A buffer overflow in dhclient as included in the ISC DHCP implementation
...
privileges.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200907-12");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=277729");
