...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple errors in the IPSec Tools racoon daemon might allow remote
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200905-03");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=267135");
