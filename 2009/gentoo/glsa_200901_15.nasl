...
if(description)
{
  ...
  script_tag(name:"insight", value:"A vulnerability in Net-SNMP could lead to a Denial of Service.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200901-15");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=245306");
