...
if(description)
{
  ...
  script_tag(name:"insight", value:"A vulnerability in gedit might allow local attackers to execute arbitrary
code.");
  script_tag(name:"solution", value:"All gedit 2.22.x users should upgrade to the latest version:
...
All gedit 2.24.x users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200903-41");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=257004");
