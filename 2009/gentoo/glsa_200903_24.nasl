...
if(description)
{
  ...
  script_tag(name:"insight", value:"An insecure temporary file usage in Shadow may allow local users to gain
root privileges.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200903-24");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=251320");
