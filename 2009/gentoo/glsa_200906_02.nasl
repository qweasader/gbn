...
if(description)
{
  ...
  script_tag(name:"insight", value:"A flaw in the Ruby standard library might allow remote attackers to cause a
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200906-02");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=273213");
