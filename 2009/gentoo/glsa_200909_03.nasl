...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64872");
  ...
  script_tag(name:"insight", value:"Multiple integer overflows in the Apache Portable Runtime and its Utility
    Library might allow for the remote execution of arbitrary code.");
  script_tag(name:"solution", value:"All Apache Portable Runtime users should upgrade to the latest version:
...
All APR Utility Library users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200909-03");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=280514");
