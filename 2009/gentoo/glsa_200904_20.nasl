...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple errors in CUPS might allow for the remote execution of arbitrary
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200904-20");
