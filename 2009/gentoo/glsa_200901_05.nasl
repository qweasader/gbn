...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple buffer overflows have been discovered in Streamripper, allowing
for user-assisted execution of arbitrary code.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200901-05");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=249039");
