...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in gitweb allow for remote execution of arbitrary
commands.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200903-15");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=251343");
