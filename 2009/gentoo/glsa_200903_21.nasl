...
if(description)
{
  ...
  script_tag(name:"insight", value:"A vulnerability in cURL may allow for arbitrary file access.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200903-21");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=260361");
