...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64044");
  ...
  script_tag(name:"insight", value:"Multiple integer overflows in FreeType might allow for the remote execution
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200905-05");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=263032");
