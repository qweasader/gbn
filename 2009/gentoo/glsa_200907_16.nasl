...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple integer overflows in Python have an unspecified impact.");
  script_tag(name:"solution", value:"All Python 2.5 users should upgrade to the latest version:
...
All Python 2.4 users should upgrade to the latest version:
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200907-16");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=246991");
