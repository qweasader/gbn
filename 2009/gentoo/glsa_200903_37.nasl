...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63692");
  ...
  script_tag(name:"insight", value:"Multiple integer overflows in the Ghostscript ICC library might allow for
user-assisted execution of arbitrary code.");
  script_tag(name:"solution", value:"All GPL Ghostscript users should upgrade to the latest version:
...
For installation instructions, see above.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200903-37");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=261087");
