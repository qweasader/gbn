...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63154");
  ...
  script_tag(name:"insight", value:"Two errors in pdnsd allow for Denial of Service and cache poisoning.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200901-03");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=231285");
