...
if(description)
{
  ...
  script_tag(name:"insight", value:"Multiple vulnerabilities in MPlayer may lead to the execution of arbitrary
code or a Denial of Service.");
 ...
 # emerge --ask --oneshot --verbose '>=media-video/mplayer-1.0_rc2_p28058-r1 '");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200901-07");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=231836");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=239130");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=251017");
