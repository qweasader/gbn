...
if(description)
{
  ...
  script_tag(name:"insight", value:"An insecure temporary file usage has been reported in Scilab, allowing for
symlink attacks.");
  script_tag(name:"solution", value:"All Scilab users should upgrade to the latest version:

    # emerge --sync
    # emerge --ask --oneshot --verbose '>=sci-mathematics/scilab-4.1.2-r1'");

  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=GLSA%20200901-14");
  script_xref(name:"URL", value:"http://bugs.gentoo.org/show_bug.cgi?id=245922");
