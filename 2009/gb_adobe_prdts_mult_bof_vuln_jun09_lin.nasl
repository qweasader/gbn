...
if(description)
{
  ...
  script_name("Adobe Reader Multiple BOF Vulnerabilities (APSB09-07) - Linux");

  script_tag(name:"summary", value:"Adobe Reader is prone to multiple buffer overflow vulnerabilities.");
