...
if(description)
{
  ...
  script_name("Wireshark 'DCERPC/NT' Dissector DoS Vulnerability (Nov 2009) - Linux");
  ...
  script_tag(name:"impact", value:"Successful exploitation could result in a DoS condition.");
...
if(version_in_range(version:version, test_version:"1.2.0", test_version2:"1.2.2") ||
  ...
  report = report_fixed_ver(installed_version:version, fixed_version:"1.0.10/1.2.3", install_path:location);
