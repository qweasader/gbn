...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63348");
...
please visit the referenced security advisories.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=CESA-2009:0019-01");
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=RHSA-2009:0019");
  script_xref(name:"URL", value:"https://rhn.redhat.com/errata/rh21as-errata.html");
  script_tag(name:"summary", value:"The remote host is missing updates to hanterm-xf announced in
