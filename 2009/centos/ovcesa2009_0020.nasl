...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63178");
  ...
  script_mandatory_keys("ssh/login/centos", "ssh/login/rpms", re:"ssh/login/release=CentOS(5|4|3)");
...
please visit the referenced security advisories.");
  ...
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=CESA-2009:0020");
  script_xref(name:"URL", value:"http://www.securityspace.com/smysecure/catid.html?in=RHSA-2009:0020");
  script_xref(name:"URL", value:"https://rhn.redhat.com/errata/RHSA-2009-0020.html");
