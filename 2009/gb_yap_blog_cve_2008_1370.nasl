...
if(description)
{
  ...
  script_name("Yap Blog < 1.1.1 'index.php' RFI Vulnerability");
  ...
  script_tag(name:"summary", value:"Yap Blog is prone to a remote file inclusion (RFI) vulnerability
  ...
  script_tag(name:"affected", value:"Versions prior to 1.1.1 are vulnerable.");
