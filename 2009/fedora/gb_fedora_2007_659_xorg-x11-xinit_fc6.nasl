...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.861042");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-x11-xinit'
  ...
  script_tag(name:"affected", value:"xorg-x11-xinit on Fedora Core 6");
