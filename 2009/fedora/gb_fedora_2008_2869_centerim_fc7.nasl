...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.860043");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'centerim'
  ...
  script_tag(name:"affected", value:"centerim on Fedora 7");
