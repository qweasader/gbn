...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.860732");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'pam_krb5'
  ...
  script_tag(name:"affected", value:"pam_krb5 on Fedora 8");
