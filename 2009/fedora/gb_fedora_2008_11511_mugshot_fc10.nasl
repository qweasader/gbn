...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.860777");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'mugshot'
  ...
  script_tag(name:"affected", value:"mugshot on Fedora 10");
