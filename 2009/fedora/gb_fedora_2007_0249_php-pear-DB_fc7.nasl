...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.861270");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-pear-DB'
  ...
  script_tag(name:"affected", value:"php-pear-DB on Fedora 7");
