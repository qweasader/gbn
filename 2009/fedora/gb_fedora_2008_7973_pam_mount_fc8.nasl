...
if(description)
{
  ...
  script_oid("1.3.6.1.4.1.25623.1.0.860191");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'pam_mount'
  ...
  script_tag(name:"affected", value:"pam_mount on Fedora 8");
