...
#
# Auto generated from VID 68bda678-caab-11de-a97e-be89dfd1042e
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66152");
  ...
  script_tag(name:"insight", value:"The following package is affected: p5-HTML-Parser
...
which triggers generation of an invalid UTF-8 character.");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/68bda678-caab-11de-a97e-be89dfd1042e.html");
