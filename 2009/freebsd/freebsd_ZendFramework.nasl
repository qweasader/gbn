...
#
# Auto generated from VID cf495fd4-fdcd-11dd-9a86-0050568452ac
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63430");
  ...
  script_xref(name:"URL", value:"http://framework.zend.com/issues/browse/ZF-5748");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/cf495fd4-fdcd-11dd-9a86-0050568452ac.html");
