...
#
# Auto generated from VID 83d7d149-b965-11de-a515-0022156e8794
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The following package is affected: ctorrent
...
Torrent file containing a long path.");
  ...
  script_xref(name:"URL", value:"http://sourceforge.net/tracker/?func=detail&aid=2782875&group_id=202532&atid=981959");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/34584");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/83d7d149-b965-11de-a515-0022156e8794.html");
