...
#
# Auto generated from VID a2d4a330-4d54-11de-8811-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64120");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/35201/");
  script_xref(name:"URL", value:"http://www.wireshark.org/security/wnpa-sec-2009-03.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/a2d4a330-4d54-11de-8811-0030843d3802.html");
