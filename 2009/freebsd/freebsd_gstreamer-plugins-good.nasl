...
#
# Auto generated from VID 37a365ed-1269-11de-a964-0030843d3802
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The following package is affected: gstreamer-plugins-good
...
malformed QuickTime media .mov file.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/33650/");
  script_xref(name:"URL", value:"http://trapkit.de/advisories/TKADV2009-003.txt");
  script_xref(name:"URL", value:"http://gstreamer.freedesktop.org/releases/gst-plugins-good/0.10.12.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/37a365ed-1269-11de-a964-0030843d3802.html");
