...
#
# Auto generated from VID 24aa9970-9ccd-11de-af10-000c29a67389
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"insight", value:"The following package is affected: silc-toolkit
...
silc_client_nickname_format functions.");
  ...
  script_xref(name:"URL", value:"http://silcnet.org/docs/changelog/SILC%20Toolkit%201.1.10");
  script_xref(name:"URL", value:"http://www.openwall.com/lists/oss-security/2009/09/03/5");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/24aa9970-9ccd-11de-af10-000c29a67389.html");
