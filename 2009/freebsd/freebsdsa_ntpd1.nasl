...
#
# Auto generated from ADV FreeBSD-SA-09:11.ntpd.asc
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64207");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-09:11.ntpd.asc)");
  ...
  script_tag(name:"insight", value:"The ntpd(8) daemon is an implementation of the Network Time Protocol (NTP)
...
configured to use the 'autokey' security model.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-09:11.ntpd.asc");
