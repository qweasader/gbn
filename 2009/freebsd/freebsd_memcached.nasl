...
#
# Auto generated from VID 86ada694-8b30-11de-b9d0-000c6e274733
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64787");
  ...
  script_tag(name:"insight", value:"The following package is affected: memcached
...
daemon's TCP port.");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/86ada694-8b30-11de-b9d0-000c6e274733.html");
