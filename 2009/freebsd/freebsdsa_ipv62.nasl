...
#
# Auto generated from ADV FreeBSD-SA-09:10.ipv6.asc
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64205");
  script_version("2022-01-18T07:59:01+0000");
  script_cve_id("CVE-2009-2208");
  script_tag(name:"last_modification", value:"2022-01-18 07:59:01 +0000 (Tue, 18 Jan 2022)");
  script_tag(name:"creation_date", value:"2009-06-15 19:20:43 +0200 (Mon, 15 Jun 2009)");
  script_tag(name:"cvss_base", value:"3.6");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:N/I:P/A:P");
  script_name("FreeBSD Security Advisory (FreeBSD-SA-09:10.ipv6.asc)");
...
The SIOCSIFINFO_IN6 ioctl is missing a necessary permissions check.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-09:10.ipv6.asc");
