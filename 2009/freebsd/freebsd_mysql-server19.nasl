...
#
# Auto generated from VID bb4e9a44-dff2-11dd-a765-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63171");
...
allows remote authenticated users to rename arbitrary tables.");
  ...
  script_xref(name:"URL", value:"http://bugs.mysql.com/bug.php?id=27515");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/24016");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/bb4e9a44-dff2-11dd-a765-0030843d3802.html");
