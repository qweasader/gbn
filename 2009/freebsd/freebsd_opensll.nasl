...
#
# Auto generated from VID 82b55df8-4d5a-11de-8811-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64118");
  ...
  script_tag(name:"insight", value:"The following package is affected: opensll
...
memory leak.'");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/82b55df8-4d5a-11de-8811-0030843d3802.html");
