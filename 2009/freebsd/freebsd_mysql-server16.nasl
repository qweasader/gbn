...
#
# Auto generated from VID 66a770b4-e008-11dd-a765-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63168");
...
statement.");
  ...
  script_xref(name:"URL", value:"http://dev.mysql.com/doc/refman/5.0/en/releasenotes-es-5-0-66.html");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/66a770b4-e008-11dd-a765-0030843d3802.html");
