...
#
# Auto generated from ADV FreeBSD-SA-09:13.pipe.asc
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.65013");
  script_version("2022-01-18T07:59:01+0000");
  script_cve_id("CVE-2009-3527");
  ...
  script_tag(name:"insight", value:"Pipes are a form of inter-process communication (IPC) provided by the
...
corruption, and other unpredictable results.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-09:13.pipe.asc");
