...
#
# Auto generated from ADV FreeBSD-SA-09:02.openssl.asc
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63176");
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-09:02.openssl.asc)");
...
is only a problem for DSA and ECDSA keys.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-09:02.openssl.asc");
