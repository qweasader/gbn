...
#
# Auto generated from VID 6355efdb-4d4d-11de-8811-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64121");
...
file with an invalid header value.");
  ...
  script_xref(name:"URL", value:"http://www.trapkit.de/advisories/TKADV2009-006.txt");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/6355efdb-4d4d-11de-8811-0030843d3802.html");
