...
#
# Auto generated from VID 27d78386-d35f-11dd-b800-001b77d09812
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63106");
...
issue exists because of an incomplete fix for CVE-2008-3714.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/31519");
  script_xref(name:"URL", value:"http://bugs.debian.org/cgi-bin/bugreport.cgi?bug=495432");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/27d78386-d35f-11dd-b800-001b77d09812.html");
