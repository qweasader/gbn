...
#
# Auto generated from ADV FreeBSD-SA-09:14.devfs.asc
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.65014");
  ...
  script_tag(name:"insight", value:"The device file system (devfs) provides access to system devices, such as
...
where the kernel might dereference a NULL pointer.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-09:14.devfs.asc");
