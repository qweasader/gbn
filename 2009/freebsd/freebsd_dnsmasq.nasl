...
#
# Auto generated from VID 80aa98e0-97b4-11de-b946-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64829");
  ...
  script_tag(name:"insight", value:"The following package is affected: dnsmasq
...
(aka RRQ) request with a malformed blksize option.");
  ...
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/80aa98e0-97b4-11de-b946-0030843d3802.html");
