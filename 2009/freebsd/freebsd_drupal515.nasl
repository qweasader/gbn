...
#
# Auto generated from VID 751823d4-f189-11de-9344-00248c9b4be7
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66607");
  ...
  script_xref(name:"URL", value:"http://drupal.org/node/661586");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/751823d4-f189-11de-9344-00248c9b4be7.html");
