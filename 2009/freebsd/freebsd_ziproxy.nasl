...
#
# Auto generated from VID 872ae5be-29c0-11de-bdeb-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63864");
...
HTTP requests with a modified Host header.");
  ...
  script_xref(name:"URL", value:"http://www.kb.cert.org/vuls/id/MAPG-7N9GN8");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/33858");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/872ae5be-29c0-11de-bdeb-0030843d3802.html");
