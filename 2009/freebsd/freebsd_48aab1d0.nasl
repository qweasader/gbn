...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64003");
...
arbitrary code via the MaxRecordSize header field in a WMF file.");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/20921/");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/18751");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/48aab1d0-4252-11de-b67a-0030843d3802.html");
