...
#
# Auto generated from VID 1a0e4cc6-29bf-11de-bdeb-0030843d3802
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63865");
  ...
  script_xref(name:"URL", value:"http://www.phpmyadmin.net/home_page/security/PMASA-2009-4.php");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/1a0e4cc6-29bf-11de-bdeb-0030843d3802.html");
