...
#
# Auto generated from ADV FreeBSD-SA-09:03.ntpd.asc
#
# Authors:
...
if(description)
{
  ...
  script_name("FreeBSD Security Advisory (FreeBSD-SA-09:03.ntpd.asc)");
  ...
  script_tag(name:"insight", value:"The ntpd daemon is an implementation of the Network Time Protocol
...
EVP_VerifyFinal().");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-09:03.ntpd.asc");
