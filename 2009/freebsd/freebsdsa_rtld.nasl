...
#
# Auto generated from ADV FreeBSD-SA-09:16.rtld.asc
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66354");
  ...
  script_tag(name:"insight", value:"The run-time link-editor, rtld, links dynamic executable with their
...
result in attempts to unset environment variables failing.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=FreeBSD-SA-09:16.rtld.asc");
