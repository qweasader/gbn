...
#
# Auto generated from VID 58a3c266-db01-11dd-ae30-001cc0377035
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63105");
  ...
  script_tag(name:"insight", value:"The following package is affected: php5-gd
...
bgd_color or clrBack argument) for an indexed image.");
  ...
  script_xref(name:"URL", value:"http://www.securiteam.com/unixfocus/6G00Y0ANFU.html");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/33002");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/58a3c266-db01-11dd-ae30-001cc0377035.html");
