...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63352");
  ...
  script_xref(name:"URL", value:"http://secunia.com/advisories/33880/");
  script_xref(name:"URL", value:"http://archives.seul.org/or/announce/Feb-2009/msg00000.html");
  script_xref(name:"URL", value:"http://www.vuxml.org/freebsd/78f5606b-f9d1-11dd-b79c-0030843d3802.html");
