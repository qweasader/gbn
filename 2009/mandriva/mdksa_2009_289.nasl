...
#
# Auto-generated from advisory MDVSA-2009:289 (kernel)
#
# Authors:
...
if(description)
{
  ...
  script_tag(name:"insight", value:"For details on the issues addressed in this update, please visit
...
To update your kernel, please follow the directions linked in the references.");
  ...
  script_tag(name:"affected", value:"Mandrake 2009.0, Enterprise Server 5.0");
  script_tag(name:"solution", value:"To upgrade automatically use MandrakeUpdate or urpmi. The verification
of md5 checksums and GPG signatures is performed automatically for you.");

  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:289");
