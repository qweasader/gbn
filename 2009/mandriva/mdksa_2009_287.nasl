...
#
# Auto-generated from advisory MDVSA-2009:287 (xpdf)
#
# Authors:
...
if(description)
{
  ...
  script_mandatory_keys("ssh/login/mandriva_mandrake_linux", "ssh/login/rpms", re:"ssh/login/release=MNDK_(2009\.0|3\.0|4\.0)");
  script_tag(name:"insight", value:"Multiple vulnerabilities has been found and corrected in xpdf:
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:287");
