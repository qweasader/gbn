...
#
# Auto-generated from advisory MDVSA-2009:207 (perl-Compress-Raw-Bzip2)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64679");
  ...
  script_tag(name:"insight", value:"A vulnerability has been found and corrected in perl-Compress-Raw-Bzip:
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:207");
