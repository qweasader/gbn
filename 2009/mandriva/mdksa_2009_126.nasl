...
#
# Auto-generated from advisory MDVSA-2009:126 (eggdrop)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64141");
  ...
  script_mandatory_keys("ssh/login/mandriva_mandrake_linux", "ssh/login/rpms", re:"ssh/login/release=MNDK_(2008\.1|2009\.0|2009\.1|3\.0)");
  script_tag(name:"insight", value:"mod/server.mod/servmsg.c in Eggheads Eggdrop and Windrop 1.6.19 and
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:126");
