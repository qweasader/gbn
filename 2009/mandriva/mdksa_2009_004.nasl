...
#
# Auto-generated from advisory MDVSA-2009:004 (pam_mount)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63137");
  ...
  script_tag(name:"insight", value:"passwdehd script in pam_mount would allow local users to overwrite
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:004");
  script_tag(name:"summary", value:"The remote host is missing an update to pam_mount
