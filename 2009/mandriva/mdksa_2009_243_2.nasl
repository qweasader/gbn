...
#
# Auto-generated from advisory MDVSA-2009:243-2 (freetype2)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66421");
  ...
  script_tag(name:"insight", value:"Multiple integer overflows in FreeType 2.3.9 and earlier allow remote
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:243-2");
  script_tag(name:"summary", value:"The remote host is missing an update to freetype2
