...
#
# Auto-generated from advisory MDVSA-2009:208-1 (libgadu)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66377");
  ...
  script_tag(name:"insight", value:"A vulnerability has been found and corrected in libgadu:
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:208-1");
  script_tag(name:"summary", value:"The remote host is missing an update to libgadu
