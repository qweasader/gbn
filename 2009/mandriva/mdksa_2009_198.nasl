...
#
# Auto-generated from advisory MDVSA-2009:198 (firefox)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64604");
  ...
  script_tag(name:"insight", value:"Security issues were identified and fixed in firefox 3.0.x:
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:198");
  script_xref(name:"URL", value:"http://www.mozilla.org/security/known-vulnerabilities/firefox30.html#firefox3.0.13");
