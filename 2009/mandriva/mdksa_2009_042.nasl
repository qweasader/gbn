...
#
# Auto-generated from advisory MDVSA-2009:042 (samba)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63421");
  ...
  script_tag(name:"insight", value:"Samba 3.2.0 through 3.2.6, when registry shares are enabled, allows
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:042");
