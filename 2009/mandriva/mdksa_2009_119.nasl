...
#
# Auto-generated from advisory MDVSA-2009:119 (kernel)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.64131");
...
To update your kernel, please follow the directions linked in the references.");
  ...
  script_tag(name:"affected", value:"Mandrake 2009.1");
  script_tag(name:"solution", value:"To upgrade automatically use MandrakeUpdate or urpmi. The verification
of md5 checksums and GPG signatures is performed automatically for you.");

  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:119");
