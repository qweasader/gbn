...
#
# Auto-generated from advisory MDVSA-2009:297 (ffmpeg)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66246");
  ...
  script_mandatory_keys("ssh/login/mandriva_mandrake_linux", "ssh/login/rpms", re:"ssh/login/release=MNDK_(2009\.0|3\.0|4\.0|mes5)");
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:297");
