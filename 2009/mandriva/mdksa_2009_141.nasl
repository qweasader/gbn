...
#
# Auto-generated from advisory MDVSA-2009:141 (mozilla-thunderbird)
#
# Authors:
...
if(description)
{
  ...
  script_mandatory_keys("ssh/login/mandriva_mandrake_linux", "ssh/login/rpms", re:"ssh/login/release=MNDK_(2009\.0|2009\.1|3\.0)");
  script_tag(name:"insight", value:"A number of security vulnerabilities have been discovered for
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:141");
  script_xref(name:"URL", value:"http://www.mozilla.org/security/known-vulnerabilities/thunderbird20.html#thunderbird2.0.0.21");
  script_tag(name:"summary", value:"The remote host is missing an update to mozilla-thunderbird
