...
#
# Auto-generated from advisory MDVSA-2009:070 (openoffice.org)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.63521");
  ...
  script_tag(name:"insight", value:"senddoc uses temporary files (/tmp/log.obr.4043) in an insecure way
...
Further this update is a rebuild against (latest) xulrunner 1.9.0.6.

Affected: 2008.1");
  script_tag(name:"solution", value:"To upgrade automatically use MandrakeUpdate or urpmi. The verification
of md5 checksums and GPG signatures is performed automatically for you.");

  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:070");
