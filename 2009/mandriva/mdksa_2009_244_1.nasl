...
#
# Auto-generated from advisory MDVSA-2009:244-1 (xfig)
#
# Authors:
...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.66551");
  ...
  script_tag(name:"insight", value:"A vulnerability was discovered and corrected in xfig:
...
of md5 checksums and GPG signatures is performed automatically for you.");
  ...
  script_xref(name:"URL", value:"https://secure1.securityspace.com/smysecure/catid.html?in=MDVSA-2009:244-1");
  script_tag(name:"summary", value:"The remote host is missing an update to xfig
