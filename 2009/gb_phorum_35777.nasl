...
if (description)
{
  ...
  script_name("Phorum < 5.2.12a Multiple BBCode HTML Injection Vulnerabilities");
  ...
  script_tag(name:"summary", value:"Phorum is prone to multiple HTML-injection vulnerabilities
  ...
  script_tag(name:"affected", value:"Phorum prior to version 5.2.12a.");

  script_tag(name:"solution", value:"Update to version 5.2.12a or later.");
...
if (version_is_less(version: version, test_version: "5.2.12a")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "5.2.12a", install_path: location);
