...
if(description)
{
  ...
  script_tag(name:"summary", value:"Sun Java JRE is prone to Multiple Vulnerabilities.");
...
if(version_in_range(version:vers, test_version:"1.3", test_version2:"1.3.1.24") ||
   version_in_range(version:vers, test_version:"1.4", test_version2:"1.4.2.19") ||
   version_in_range(version:vers, test_version:"1.5", test_version2:"1.5.0.17") ||
   version_in_range(version:vers, test_version:"1.6", test_version2:"1.6.0.12")) {
