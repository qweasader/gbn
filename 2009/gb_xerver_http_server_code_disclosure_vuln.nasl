...
if(description)
{
  ...
  script_name("Xerver HTTP Server <= 4.32 Information Disclosure Vulnerability");
  ...
  script_tag(name:"summary", value:"Xerver HTTP Server is prone to a source code disclosure
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"An error exists when processing HTTP requests containing
  '::$DATA' after the HTML file name which can be exploited to disclose the source code.");
