...
if(description)
{
  ...
  script_name("dotProject < 2.1.2 Privilege Escalation Vulnerability");
  ...
  script_tag(name:"summary", value:"dotProject is prone to a privilege escalation vulnerability.");
  ...
  request to certain administrative pages to gain administrative privileges on the affected
  system.");

  script_tag(name:"affected", value:"dotProject prior to version 2.1.2.");

  script_tag(name:"solution", value:"Update to version 2.1.2.");

  script_xref(name:"URL", value:"http://en.securitylab.ru/nvd/378282.php");
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/29679");
