...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1748-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1748-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1748-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1748");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libsoup' package(s) announced via the DSA-1748-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsoup2.2-8", ver:"2.2.98-2+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libsoup2.2-dev", ver:"2.2.98-2+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libsoup2.2-doc", ver:"2.2.98-2+etch1", rls:"DEB4"))) {
    report += res;
  }
