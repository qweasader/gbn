...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1780-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1780-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1780-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1780");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libdbd-pg-perl' package(s) announced via the DSA-1780-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdbd-pg-perl", ver:"1.49-2+etch1", rls:"DEB4"))) {
    report += res;
  }
