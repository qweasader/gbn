...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1810-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1810-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1810-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1810");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libapache-mod-jk' package(s) announced via the DSA-1810-1 advisory.");
