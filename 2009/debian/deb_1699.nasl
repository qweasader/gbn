...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1699-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1699-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1699-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1699");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zaptel' package(s) announced via the DSA-1699-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtonezone-dev", ver:"1:1.2.11.dfsg-1+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtonezone1", ver:"1:1.2.11.dfsg-1+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"zaptel", ver:"1:1.2.11.dfsg-1+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"zaptel-source", ver:"1:1.2.11.dfsg-1+etch1", rls:"DEB4"))) {
    report += res;
  }
