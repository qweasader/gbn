...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1938-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1938-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1938-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1938");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php-mail' package(s) announced via the DSA-1938-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"php-mail", ver:"1.1.6-2+etch1", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"php-mail", ver:"1.1.14-1+lenny1", rls:"DEB5"))) {
    report += res;
  }
