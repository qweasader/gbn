...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1739-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1739-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1739-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1739");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mldonkey' package(s) announced via the DSA-1739-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mldonkey-gui", ver:"2.9.5-2+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"mldonkey-server", ver:"2.9.5-2+lenny1", rls:"DEB5"))) {
    report += res;
  }
