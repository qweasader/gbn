...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1919-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1919-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1919-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1919");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'smarty' package(s) announced via the DSA-1919-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"smarty", ver:"2.6.14-1etch2", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"smarty", ver:"2.6.20-1.2", rls:"DEB5"))) {
    report += res;
  }
