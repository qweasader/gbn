...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1911-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1911-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1911-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1911");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pygresql' package(s) announced via the DSA-1911-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-pygresql", ver:"1:3.8.1-1etch2", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-pygresql", ver:"1:3.8.1-3+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-pygresql-dbg", ver:"1:3.8.1-3+lenny1", rls:"DEB5"))) {
    report += res;
  }
