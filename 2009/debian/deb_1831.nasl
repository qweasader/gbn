...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1831-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1831-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1831-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1831");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'djbdns' package(s) announced via the DSA-1831-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dbndns", ver:"1:1.05-4+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"djbdns", ver:"1:1.05-4+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"dnscache-run", ver:"1:1.05-4+lenny1", rls:"DEB5"))) {
    report += res;
  }
