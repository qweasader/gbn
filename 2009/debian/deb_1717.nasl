...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1717-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1717-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1717-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1717");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'devil' package(s) announced via the DSA-1717-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdevil-dev", ver:"1.6.7-5+etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libdevil1c2", ver:"1.6.7-5+etch1", rls:"DEB4"))) {
    report += res;
  }
