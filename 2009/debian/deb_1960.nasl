...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1960-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1960-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1960-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1960");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'acpid' package(s) announced via the DSA-1960-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"acpid", ver:"1.0.4-5etch2", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"acpid", ver:"1.0.8-1lenny2", rls:"DEB5"))) {
    report += res;
  }
