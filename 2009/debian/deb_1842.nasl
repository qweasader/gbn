...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1842-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1842-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1842-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1842");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openexr' package(s) announced via the DSA-1842-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libopenexr-dev", ver:"1.2.2-4.3+etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libopenexr2c2a", ver:"1.2.2-4.3+etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openexr", ver:"1.2.2-4.3+etch2", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libopenexr-dev", ver:"1.6.1-3+lenny3", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libopenexr6", ver:"1.6.1-3+lenny3", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openexr", ver:"1.6.1-3+lenny3", rls:"DEB5"))) {
    report += res;
  }
