...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1947-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1947-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1947-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'opensaml2, shibboleth-sp, shibboleth-sp2' package(s) announced via the DSA-1947-1 advisory.");
