...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1829-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1829");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sork-passwd-h3", ver:"3.0-2+etch1", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"sork-passwd-h3", ver:"3.0-2+lenny1", rls:"DEB5"))) {
    report += res;
  }
