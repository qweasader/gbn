...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2009-08-28 12:18:00 +0000 (Fri, 28 Aug 2009)");

  script_name("Debian: Security Advisory (DSA-1872-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1872-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1872-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1872");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'fai-kernels, linux-2.6, user-mode-linux' package(s) announced via the DSA-1872-1 advisory.");
