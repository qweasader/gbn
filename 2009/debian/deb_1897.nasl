...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1897-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1897-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1897-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1897");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'horde3' package(s) announced via the DSA-1897-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"horde3", ver:"3.1.3-4etch6", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"horde3", ver:"3.2.2+debian0-2+lenny1", rls:"DEB5"))) {
    report += res;
  }
