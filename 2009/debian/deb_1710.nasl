...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1710-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1710-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1710-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1710");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ganglia-monitor-core' package(s) announced via the DSA-1710-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ganglia-monitor", ver:"2.5.7-3.1etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"gmetad", ver:"2.5.7-3.1etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libganglia1", ver:"2.5.7-3.1etch1", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libganglia1-dev", ver:"2.5.7-3.1etch1", rls:"DEB4"))) {
    report += res;
  }
