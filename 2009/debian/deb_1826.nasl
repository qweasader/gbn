...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1826-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1826-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1826-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1826");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'eggdrop' package(s) announced via the DSA-1826-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"eggdrop", ver:"1.6.18-1etch2", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"eggdrop-data", ver:"1.6.18-1etch2", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"eggdrop", ver:"1.6.19-1.1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"eggdrop-data", ver:"1.6.19-1.1+lenny1", rls:"DEB5"))) {
    report += res;
  }
