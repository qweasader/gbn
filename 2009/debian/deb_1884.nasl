...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1884-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1884-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1884-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1884");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nginx' package(s) announced via the DSA-1884-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nginx", ver:"0.4.13-2+etch2", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"nginx", ver:"0.6.32-3+lenny2", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"nginx", ver:"0.6.32-3+lenny2+b1", rls:"DEB5"))) {
    report += res;
  }
