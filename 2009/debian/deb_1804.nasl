...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1804-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1804-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1804-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1804");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ipsec-tools' package(s) announced via the DSA-1804-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ipsec-tools", ver:"1:0.6.6-3.1etch3", rls:"DEB4"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"racoon", ver:"1:0.6.6-3.1etch3", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ipsec-tools", ver:"1:0.7.1-1.3+lenny2", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"racoon", ver:"1:0.7.1-1.3+lenny2", rls:"DEB5"))) {
    report += res;
  }
