...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1795-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1795-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1795-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1795");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ldns' package(s) announced via the DSA-1795-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ldnsutils", ver:"1.4.0-1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libldns-dev", ver:"1.4.0-1+lenny1", rls:"DEB5"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libldns1", ver:"1.4.0-1+lenny1", rls:"DEB5"))) {
    report += res;
  }
