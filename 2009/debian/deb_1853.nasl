...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1853-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1853-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1853-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1853");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'memcached' package(s) announced via the DSA-1853-1 advisory.");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"memcached", ver:"1.1.12-1+etch1", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"memcached", ver:"1.2.2-1+lenny1", rls:"DEB5"))) {
    report += res;
  }
