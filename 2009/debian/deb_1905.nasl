...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-1905-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-1905-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1905-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1905");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DSA-1905-1 advisory.");
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-django", ver:"1.0.2-1+lenny2", rls:"DEB5"))) {
    report += res;
  }
