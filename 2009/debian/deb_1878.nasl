...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2009/DSA-1878-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-1878");
...
if(release == "DEB4") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"devscripts", ver:"2.9.26etch4", rls:"DEB4"))) {
    report += res;
  }
...
if(release == "DEB5") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"devscripts", ver:"2.10.35lenny6", rls:"DEB5"))) {
    report += res;
  }
