...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/35035");
  ...
  script_tag(name:"summary", value:"DM FileManager is prone to a security bypass vulnerability.");
