...
if (description)
{
  ...
  script_tag(name:"summary", value:"Consolidation of Siemens SIMATIC CP device detections.");
...
os_register_and_report(os: os_name, version: detected_version, cpe: os_cpe,
