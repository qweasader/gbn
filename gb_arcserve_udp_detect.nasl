...
function check_win()
{
  ...
  log_message( data: build_detection_report( app:"Arcserve Unified Data Protection (UDP)",
                                             version:vers + " (" + build + ")",
                                             install:"/",
                                             cpe:cpe,
                                             concluded: concluded ),
...
if (res =~ "^HTTP/1\.[01] 302" && "/samlsso?SAMLRequest=" >< res) {
  ...
  log_message(data: build_detection_report(app: "Arcserve Unified Data Protection (UDP)", version: version, install: "/", cpe: cpe,
