...
if(description)
{
  ...
  Note: The created System Characteristics are shown in a separate VT 'Show System Characteristics' (OID: 1.3.6.1.4.1.25623.1.0.103999).");
...
create_sc = script_get_preference("Create OVAL System Characteristics for NIST Windows OVAL Definitions", id:1);
if (create_sc == "no") {
  exit (0);
}
