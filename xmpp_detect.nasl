...
if(description)
{
  ...
  script_version("2022-02-15T14:06:47+0000");
  script_tag(name:"last_modification", value:"2022-02-15 14:06:47 +0000 (Tue, 15 Feb 2022)");
  script_tag(name:"creation_date", value:"2010-02-08 23:29:56 +0100 (Mon, 08 Feb 2010)");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_name("XMPP (Jabber) Server / Client Detection (Remote)");
  ...
  script_tag(name:"summary", value:"Detection of services supporting the Extensible Messaging and
  Presence Protocol (XMPP) (formerly named Jabber).");
