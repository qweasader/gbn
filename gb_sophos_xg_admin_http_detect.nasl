...
if(description)
{
  ...
  script_version("2022-04-05T06:56:06+0000");
  script_tag(name:"cvss_base", value:"0.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:N");
  script_tag(name:"last_modification", value:"2022-04-05 06:56:06 +0000 (Tue, 05 Apr 2022)");
...
if( ! found = eregmatch( string:res, pattern:"<title>Sophos</title>", icase:FALSE ) )
  exit( 0 );
...
if( ! res1 || ! found = eregmatch( string:res1, pattern:"Sophos [^ ]*Firewall", icase:TRUE ) )
  exit( 0 );
...
set_kb_item( name:"sophos/xg_firewall/http-admin/" + port + "/concluded", value:concl );
set_kb_item( name:"sophos/xg_firewall/http-admin/" + port + "/concludedUrl", value:conclUrl );
