...
if (description)
{
  ...
  script_tag(name:"summary", value:"Consolidation of Inim SmartLAN device detections.");
...
os_register_and_report(os: "SmartLAN Firmware", version: detected_version, cpe: os_cpe, desc: "Inim SmartLAN Detection Consolidation",
                       runs_key: "unixoide");
