...
if(description)
{
  ...
  script_name("LIVE555 Streaming Media Server Detection Consolidation");

  script_tag(name:"summary", value:"Consolidation of LIVE555 Streaming Media Server detections.");
