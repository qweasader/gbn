...
if (description)
{
  ...
  script_version("2022-01-28T13:03:32+0000");
  script_tag(name:"last_modification", value:"2022-01-28 13:03:32 +0000 (Fri, 28 Jan 2022)");
...
if (http_ports = get_kb_list("epson/printer/http/port")) {
  foreach port (http_ports) {
    ...
    generalConcluded = get_kb_item("epson/printer/http/" + port + "/generalConcluded");
    if (generalConcluded) {
