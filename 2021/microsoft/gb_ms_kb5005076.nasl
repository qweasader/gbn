...
if(description)
{
  ...
  script_cve_id("CVE-2021-26424", "CVE-2021-26425", "CVE-2021-26426", "CVE-2021-26432",
                ...
                "CVE-2021-36937", "CVE-2021-36942", "CVE-2021-36947", "CVE-2021-34481");
...
if(version_is_less(version:fileVer, test_version:"6.3.9600.20094"))
{
  report = report_fixed_ver(file_checked:dllPath + "\spoolsv.exe",
                            file_version:fileVer, vulnerable_range:"6.3.9600.20094");
