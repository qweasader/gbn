...
if (description)
{
  ...
  script_tag(name:"summary", value:"Asterisk is prone to a denial of service vulnerability in the
  PJSIP channel driver.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Given a scenario where an outgoing call is placed from Asterisk
