...
if(description)
{
  ...
  script_version("2021-10-18T15:02:31+0000");
  script_cve_id("CVE-2021-34409");
  script_tag(name:"cvss_base", value:"7.2");
  script_tag(name:"cvss_base_vector", value:"AV:L/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2021-10-18 15:02:31 +0000 (Mon, 18 Oct 2021)");
  script_tag(name:"severity_vector", value:"CVSS:3.1/AV:L/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H");
  script_tag(name:"severity_origin", value:"NVD");
  script_tag(name:"severity_date", value:"2021-10-06 17:02:00 +0000 (Wed, 06 Oct 2021)");
  script_tag(name:"creation_date", value:"2021-09-29 13:47:33 +0200 (Wed, 29 Sep 2021)");
  script_name("Zoom Client < 5.2.0 Privilege Escalation Vulnerability (ZSB-21005) - Mac OS X");
