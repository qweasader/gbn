...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-10-06 19:35:00 +0000 (Wed, 06 Oct 2021)");
  script_tag(name:"creation_date", value:"2021-09-29 13:47:33 +0200 (Wed, 29 Sep 2021)");
  script_name("Zoom Client < 5.3.2 Privilege Escalation Vulnerability (ZSB-21004) - Windows");
