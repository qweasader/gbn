...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2021-1056");
...
In the Linux kernel through 5.8.7, local attackers able to inject conntrack netlink ... [Please see the references for more information on the vulnerabilities]");
