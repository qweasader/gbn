...
if(description)
{
  ...
  script_cve_id("CVE-2019-1559", "CVE-2020-1971");
  ...
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2021-1505");
