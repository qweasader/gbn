...
if (description)
{
  ...
  script_version("2022-01-28T10:34:39+0000");
  script_tag(name:"last_modification", value:"2022-01-28 10:34:39 +0000 (Fri, 28 Jan 2022)");
  ...
  script_tag(name:"insight", value:"A local file inclusion vulnerability allows remote authenticated
  attackers to execute arbitrary code via the import of personal data.");

  script_tag(name:"affected", value:"ILIAS versions prior to 5.3.19 and 5.4.x prior to 5.4.10.");
