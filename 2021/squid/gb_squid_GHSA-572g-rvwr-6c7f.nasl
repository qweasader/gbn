...
if(description)
{
  ...
  script_name("Squid < 4.15, 5.0.x < 5.0.6 DoS Vulnerability (GHSA-572g-rvwr-6c7f, SQUID-2021:5)");
  ...
  publication in October 2023 and filed as 'Crash in Content-Range Response Header Logic'.");
  ...
  script_xref(name:"URL", value:"https://megamansec.github.io/Squid-Security-Audit/range-fatal.html");
