...
if(description)
{
  ...
  script_name("e107 < 2.3.1 Multiple Vulnerabilities");
  ...
  - CVE-2021-27885: cross-site request forgery (CSRF) in usersettings.php due to the lack of a
  certain e_TOKEN protection mechanism.

  - No CVE: cross-site scripting (XSS)");

  script_tag(name:"affected", value:"e107 through version 2.3.0.");

  script_tag(name:"solution", value:"Update to version 2.3.1 or later.");

  script_xref(name:"URL", value:"https://github.com/e107inc/e107/releases/tag/v2.3.1");
  script_xref(name:"URL", value:"http://packetstormsecurity.com/files/161651/e107-CMS-2.3.0-Cross-Site-Request-Forgery.html");
