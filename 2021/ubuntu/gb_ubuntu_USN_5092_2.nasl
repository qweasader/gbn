...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-azure-5.11, linux-hwe-5.11, linux-oracle-5.11' package(s) announced via the USN-5092-2 advisory.");
...
could ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-azure-5.11, linux-hwe-5.11, linux-oracle-5.11' package(s) on Ubuntu 20.04, Ubuntu 21.04.");
...
if(release == "UBUNTU21.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.11.0-1017-azure", ver:"5.11.0-1017.18", rls:"UBUNTU21.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.11.0.1017.18", rls:"UBUNTU21.04"))) {
    report += res;
  }
