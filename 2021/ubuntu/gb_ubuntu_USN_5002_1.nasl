...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-03-10 15:21:14 +0000 (Thu, 10 Mar 2022)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gke-5.3, linux-hwe, linux-raspi2-5.3' package(s) announced via the USN-5002-1 advisory.");
...
code.");
  ...
  script_tag(name:"affected", value:"'linux-gke-5.3, linux-hwe, linux-raspi2-5.3' package(s) on Ubuntu 18.04.");
