...
if(release == "UBUNTU21.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-django", ver:"2:2.2.20-1ubuntu0.3", rls:"UBUNTU21.04"))) {
    report += res;
  }
...
if(release == "UBUNTU21.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-django", ver:"2:2.2.24-1ubuntu1.1", rls:"UBUNTU21.10"))) {
    report += res;
  }
