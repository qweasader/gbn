...
if(release == "UBUNTU21.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgnome-autoar-0-0", ver:"0.3.1-1ubuntu0.1", rls:"UBUNTU21.04"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libgnome-autoar-gtk-0-0", ver:"0.3.1-1ubuntu0.1", rls:"UBUNTU21.04"))) {
    report += res;
  }
