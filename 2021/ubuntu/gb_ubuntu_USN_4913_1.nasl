...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libjs-underscore", ver:"1.4.4-2ubuntu1+esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"node-underscore", ver:"1.4.4-2ubuntu1+esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
