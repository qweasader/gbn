...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-06-16 12:38:27 +0000 (Wed, 16 Jun 2021)");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rabbitmq-server", ver:"3.5.7-1ubuntu0.16.04.4+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU21.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"rabbitmq-server", ver:"3.8.9-2ubuntu0.1", rls:"UBUNTU21.04"))) {
    report += res;
  }
