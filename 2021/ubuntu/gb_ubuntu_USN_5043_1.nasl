...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-08-17 15:13:55 +0000 (Tue, 17 Aug 2021)");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libexiv2-14", ver:"0.25-2.1ubuntu16.04.7+esm4", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU21.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libexiv2-27", ver:"0.27.3-3ubuntu1.5", rls:"UBUNTU21.04"))) {
    report += res;
  }
