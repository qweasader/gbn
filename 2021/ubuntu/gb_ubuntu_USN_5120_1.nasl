...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-5.8' package(s) announced via the USN-5120-1 advisory.");
...
privileges. (CVE-2021-40490)");
  ...
  script_tag(name:"affected", value:"'linux-azure-5.8' package(s) on Ubuntu 20.04.");
