...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Photo Gallery' is prone to an SQL injection
  (SQLi) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Unvalidated input leads to SQL injection via the
  frontend/models/model.php bwg_search_x parameter.");
