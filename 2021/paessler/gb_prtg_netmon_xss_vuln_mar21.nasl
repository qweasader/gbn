...
if(description)
{
  ...
  script_version("2022-03-15T15:24:21+0000");
  script_tag(name:"last_modification", value:"2022-03-15 15:24:21 +0000 (Tue, 15 Mar 2022)");
  ...
  script_name("PRTG Network Monitor 7.x - 22.1.75.1569 XSS Vulnerability");
  ...
  script_tag(name:"affected", value:"PRTG Network Monitor versions 7.x through 22.1.75.1569.");
...
if( version_in_range( version: version, test_version: "7.0.0", test_version2: "22.1.75.1569" ) ) {
