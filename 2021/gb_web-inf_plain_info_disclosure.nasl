...
if(description)
{
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/65678");
  ...
  However, some application or web servers / products are prone to a vulnerability that still
  exposes this information if the client requests the URL directly.");
