...
if (description)
{
  ...
  script_name("Terramaster TOS <= 4.1.24 RCE Vulnerability - Active Check");
  ...
  script_tag(name:"summary", value:"Terramaster TOS is prone to a remote code execution (RCE)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Sends a crafted HTTP GET request and checks the response.");

  script_tag(name:"insight", value:"TerraMaster TOS has Invalid Parameter Checking that leads to
  code injection as root. This is a dynamic class method invocation vulnerability in
  include/exportUser.php, in which an attacker can trigger a call to the exec method with (for
  example) OS commands in the opt parameter.");
