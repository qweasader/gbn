...
if(description)
{
  ...
  script_tag(name:"insight", value:"Gitea does not prevent a git protocol path that specifies a TCP
  port number and also contains newlines (with URL encoding) in ParseRemoteAddr in
  modules/auth/repo_form.go.");

  script_tag(name:"affected", value:"Gitea version 0.9.99 through 1.12.5.");
