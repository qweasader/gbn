...
if(description)
{
  ...
  script_tag(name:"summary", value:"LimeSurvey is prone to multiple cross-site scripting (XSS)
  vulnerabilities.");
  ...
  - CVE-2020-25797: XSS in the Add Participants Function

  - CVE-2020-25798: XSS via parameter ParticipantAttributeNamesDropdown of the Attributes on the
  central participant database page

  - CVE-2020-25799: XSS in the Quota component of the Survey page.");
