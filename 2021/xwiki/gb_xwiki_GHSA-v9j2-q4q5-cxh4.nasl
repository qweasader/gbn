...
if(description)
{
  ...
  script_version("2022-02-17T09:47:01+0000");
  script_tag(name:"last_modification", value:"2022-02-17 09:47:01 +0000 (Thu, 17 Feb 2022)");
...
# nb: To not match versions like 13.10 which would cause a false positive otherwise
if (version =~ "^13\.[01]($|\.)") {
