...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"2022-03-09 08:30:28 +0000 (Wed, 09 Mar 2022)");
...
- CVE-2016-6836: VMWARE VMXNET3 NIC device allowed privileged user inside
 the guest to leak information. It occurred while processing transmit(tx)
