...
Added support for overriding max threads per process limit (bsc#1133719)");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on SUSE Enterprise Storage 5, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud Crowbar 8.");
