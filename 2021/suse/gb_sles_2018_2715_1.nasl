...
Fixed erroneous debug message when paired with OpenSSL (bsc#1089533)");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on SUSE CaaS Platform 3.0, SUSE CaaS Platform ALL, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Software Development Kit 12-SP3.");
