...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl' package(s) announced via the SUSE-SU-2013:0773-1 advisory.");
...
>");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on SUSE Linux Enterprise Desktop 10-SP4, SUSE Linux Enterprise Server 10-SP4.");
