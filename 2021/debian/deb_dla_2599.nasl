...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2599-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2599-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'shibboleth-sp2' package(s) announced via the DLA-2599-1 advisory.");
