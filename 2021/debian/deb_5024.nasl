...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-12-30 16:22:23 +0000 (Thu, 30 Dec 2021)");

  script_name("Debian: Security Advisory (DSA-5024-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-5024-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5024");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/apache-log4j2");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'apache-log4j2' package(s) announced via the DSA-5024-1 advisory.");
