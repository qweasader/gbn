...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-02-25 17:17:07 +0000 (Thu, 25 Feb 2021)");

  script_name("Debian: Security Advisory (DLA-2567-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2567-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/unrar-free");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unrar-free' package(s) announced via the DLA-2567-1 advisory.");
