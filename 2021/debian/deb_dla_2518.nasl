...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2518-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2518-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2518-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/cairo");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cairo' package(s) announced via the DLA-2518-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libcairo2-udeb", ver:"1.14.8-1+deb9u1", rls:"DEB9"))) {
    report += res;
  }
