...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-02-17 20:42:13 +0000 (Thu, 17 Feb 2022)");

  script_name("Debian: Security Advisory (DLA-2637-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2637-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'drupal7' package(s) announced via the DLA-2637-1 advisory.");
