...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5018-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-5018-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5018");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/python-babel");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-babel' package(s) announced via the DSA-5018-1 advisory.");
