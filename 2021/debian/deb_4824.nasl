...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-09-28 15:55:04 +0000 (Mon, 28 Sep 2020)");

  script_name("Debian: Security Advisory (DSA-4824-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4824-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4824-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4824");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-4824-1 advisory.");
