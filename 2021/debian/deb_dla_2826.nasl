...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-08-28 01:13:21 +0000 (Sat, 28 Aug 2021)");

  script_name("Debian: Security Advisory (DLA-2826-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2826-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mbedtls");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mbedtls' package(s) announced via the DLA-2826-1 advisory.");
