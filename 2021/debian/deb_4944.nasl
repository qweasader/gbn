...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4944-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4944-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4944");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/krb5");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'krb5' package(s) announced via the DSA-4944-1 advisory.");
