...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-10-20 17:22:51 +0000 (Wed, 20 Oct 2021)");

  script_name("Debian: Security Advisory (DSA-5009-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-5009-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5009");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tomcat9");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tomcat9' package(s) announced via the DSA-5009-1 advisory.");
