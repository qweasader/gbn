...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2618-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2618-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/smarty3");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'smarty3' package(s) announced via the DLA-2618-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Several vulnerabilities were discovered in smarty3, a template engine for PHP.
