...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-31 19:38:47 +0000 (Mon, 31 Dec 2018)");

  script_name("Debian: Security Advisory (DLA-2806-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2806-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/glusterfs");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'glusterfs' package(s) announced via the DLA-2806-1 advisory.");
