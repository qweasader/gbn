...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2674-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2674-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/isc-dhcp");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'isc-dhcp' package(s) announced via the DLA-2674-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"isc-dhcp-client-udeb", ver:"4.3.5-3+deb9u2", rls:"DEB9"))) {
    report += res;
  }
