...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4967-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4967-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squashfs-tools' package(s) announced via the DSA-4967-1 advisory.");
