...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-07-12 14:53:51 +0000 (Mon, 12 Jul 2021)");

  script_name("Debian: Security Advisory (DSA-4931-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4931-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4931");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/xen");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xen' package(s) announced via the DSA-4931-1 advisory.");
