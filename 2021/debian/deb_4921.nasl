...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4921-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4921-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4921");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nginx");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nginx' package(s) announced via the DSA-4921-1 advisory.");
