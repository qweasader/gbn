...
if(description)
{
  ...
  script_cve_id("CVE-2020-18768", "CVE-2020-19131", "CVE-2020-19144");
  ...
  script_tag(name:"severity_date", value:"2021-09-10 19:45:22 +0000 (Fri, 10 Sep 2021)");

  script_name("Debian: Security Advisory (DLA-2777-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2777-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tiff");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tiff' package(s) announced via the DLA-2777-1 advisory.");
