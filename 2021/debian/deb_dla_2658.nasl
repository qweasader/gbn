...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-04-08 22:09:25 +0000 (Thu, 08 Apr 2021)");

  script_name("Debian: Security Advisory (DLA-2658-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2658-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/redmine");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'redmine' package(s) announced via the DLA-2658-1 advisory.");
