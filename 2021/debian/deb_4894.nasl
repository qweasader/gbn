...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4894-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4894");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/php-pear");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php-pear' package(s) announced via the DSA-4894-1 advisory.");
