...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4970-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4970-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'postorius' package(s) announced via the DSA-4970-1 advisory.");
