...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2741-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/commons-io");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'commons-io' package(s) announced via the DLA-2741-1 advisory.");
