...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-06-08 20:26:56 +0000 (Tue, 08 Jun 2021)");

  script_name("Debian: Security Advisory (DSA-4917-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4917-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4917");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-4917-1 advisory.");
