...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-05-01 17:44:38 +0000 (Wed, 01 May 2019)");

  script_name("Debian: Security Advisory (DLA-2661-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2661-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/jetty9");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jetty9' package(s) announced via the DLA-2661-1 advisory.");
