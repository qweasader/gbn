...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4893-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4893-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4893");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/xorg-server");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xorg-server' package(s) announced via the DSA-4893-1 advisory.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xserver-xorg-core-udeb", ver:"2:1.20.4-1+deb10u3", rls:"DEB10"))) {
    report += res;
  }
