...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-09-29 18:39:08 +0000 (Tue, 29 Sep 2020)");

  script_name("Debian: Security Advisory (DSA-4950-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4950-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4950");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ansible");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ansible' package(s) announced via the DSA-4950-1 advisory.");
