...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-5003-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-5003-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5003");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/samba");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'samba' package(s) announced via the DSA-5003-1 advisory.");
