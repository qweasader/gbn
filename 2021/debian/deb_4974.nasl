...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-08-24 15:09:10 +0000 (Tue, 24 Aug 2021)");

  script_name("Debian: Security Advisory (DSA-4974-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4974-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4974");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nextcloud-desktop");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nextcloud-desktop' package(s) announced via the DSA-4974-1 advisory.");
