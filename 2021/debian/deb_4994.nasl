...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4994-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4994-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4994");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/bind9");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bind9' package(s) announced via the DSA-4994-1 advisory.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns-export1104-udeb", ver:"1:9.11.5.P4+dfsg-5.1+deb10u6", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libirs-export161-udeb", ver:"1:9.11.5.P4+dfsg-5.1+deb10u6", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libisc-export1100-udeb", ver:"1:9.11.5.P4+dfsg-5.1+deb10u6", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libisccc-export161-udeb", ver:"1:9.11.5.P4+dfsg-5.1+deb10u6", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libisccfg-export163-udeb", ver:"1:9.11.5.P4+dfsg-5.1+deb10u6", rls:"DEB10"))) {
    report += res;
  }
