...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-14 19:48:10 +0000 (Tue, 14 Jan 2020)");

  script_name("Debian: Security Advisory (DLA-2566-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2566-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libbsd");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libbsd' package(s) announced via the DLA-2566-1 advisory.");
