...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2572-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2572-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wpa");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wpa' package(s) announced via the DLA-2572-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"wpasupplicant-udeb", ver:"2:2.4-1+deb9u8", rls:"DEB9"))) {
    report += res;
  }
