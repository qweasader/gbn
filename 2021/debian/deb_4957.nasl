...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-07-06 14:48:52 +0000 (Tue, 06 Jul 2021)");

  script_name("Debian: Security Advisory (DSA-4957-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4957-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'trafficserver' package(s) announced via the DSA-4957-1 advisory.");
