...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-26 18:19:38 +0000 (Fri, 26 Apr 2019)");

  script_name("Debian: Security Advisory (DLA-2855-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2855-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/monit");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'monit' package(s) announced via the DLA-2855-1 advisory.");
