...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-01-12 03:50:20 +0000 (Tue, 12 Jan 2021)");

  script_name("Debian: Security Advisory (DSA-4832-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4832-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4832-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4832");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-4832-1 advisory.");
