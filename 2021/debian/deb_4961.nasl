...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-09-02 02:18:02 +0000 (Thu, 02 Sep 2021)");

  script_name("Debian: Security Advisory (DSA-4961-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4961-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4961");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tor");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tor' package(s) announced via the DSA-4961-1 advisory.");
