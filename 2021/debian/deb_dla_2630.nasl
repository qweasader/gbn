...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-04-23 14:47:15 +0000 (Fri, 23 Apr 2021)");

  script_name("Debian: Security Advisory (DLA-2630-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2630-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wordpress");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DLA-2630-1 advisory.");
