...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-02-16 16:19:15 +0000 (Tue, 16 Feb 2021)");

  script_name("Debian: Security Advisory (DLA-2554-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2554-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/firejail");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firejail' package(s) announced via the DLA-2554-1 advisory.");
