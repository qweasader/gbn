...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-02-16 15:56:34 +0000 (Tue, 16 Feb 2021)");

  script_name("Debian: Security Advisory (DSA-4847-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4847-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4847");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/connman");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'connman' package(s) announced via the DSA-4847-1 advisory.");
