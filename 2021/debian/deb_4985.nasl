...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-09-27 18:36:59 +0000 (Mon, 27 Sep 2021)");

  script_name("Debian: Security Advisory (DSA-4985-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4985-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4985");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wordpress");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DSA-4985-1 advisory.");
