...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2836-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2836-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nss");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nss' package(s) announced via the DLA-2836-1 advisory.");
...
For Debian 9 stretch, this problem has been fixed in version 2:3.26.2-1.1+deb9u3.
