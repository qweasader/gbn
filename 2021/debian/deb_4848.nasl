...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4848-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4848-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4848");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/golang-1.11");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'golang-1.11' package(s) announced via the DSA-4848-1 advisory.");
