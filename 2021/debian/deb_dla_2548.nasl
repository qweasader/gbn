...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-03-27 03:20:07 +0000 (Sat, 27 Mar 2021)");

  script_name("Debian: Security Advisory (DLA-2548-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2548-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/privoxy");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'privoxy' package(s) announced via the DLA-2548-1 advisory.");
