...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-05-27 12:24:23 +0000 (Thu, 27 May 2021)");

  script_name("Debian: Security Advisory (DLA-2671-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2671-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/rxvt-unicode");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'rxvt-unicode' package(s) announced via the DLA-2671-1 advisory.");
