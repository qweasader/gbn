...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-09-15 00:19:27 +0000 (Wed, 15 Sep 2021)");

  script_name("Debian: Security Advisory (DSA-4968-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4968-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4968");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/haproxy");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'haproxy' package(s) announced via the DSA-4968-1 advisory.");
