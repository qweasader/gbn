...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2715-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2715-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'systemd' package(s) announced via the DLA-2715-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libudev1-udeb", ver:"232-25+deb9u13", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"udev-udeb", ver:"232-25+deb9u13", rls:"DEB9"))) {
    report += res;
  }
