...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4942-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4942-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4942");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'systemd' package(s) announced via the DSA-4942-1 advisory.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libudev1-udeb", ver:"241-7~deb10u8", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"udev-udeb", ver:"241-7~deb10u8", rls:"DEB10"))) {
    report += res;
  }
