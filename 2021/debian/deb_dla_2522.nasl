...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-01-19 23:08:18 +0000 (Tue, 19 Jan 2021)");

  script_name("Debian: Security Advisory (DLA-2522-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2522-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2522-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/coturn");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'coturn' package(s) announced via the DLA-2522-1 advisory.");
