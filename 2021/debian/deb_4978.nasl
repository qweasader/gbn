...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4978-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4978-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4978");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/linux");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'linux' package(s) announced via the DSA-4978-1 advisory.");
...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"usbip", ver:"2.0+5.10.46-5", rls:"DEB11"))) {
    report += res;
  }
