...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-11-23 00:08:35 +0000 (Tue, 23 Nov 2021)");

  script_name("Debian: Security Advisory (DSA-5013-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-5013-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-5013");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/roundcube");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'roundcube' package(s) announced via the DSA-5013-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that roundcube, a skinnable AJAX based webmail solution for IMAP servers, did not properly sanitize requests and mail messages. This would allow an attacker to perform Cross-Side Scripting (XSS) or SQL injection attacks.
