...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-03-25 14:17:14 +0000 (Thu, 25 Mar 2021)");

  script_name("Debian: Security Advisory (DLA-2614-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2614-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/busybox");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'busybox' package(s) announced via the DLA-2614-1 advisory.");
