...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-12-02 21:01:46 +0000 (Wed, 02 Dec 2020)");

  script_name("Debian: Security Advisory (DSA-4823-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4823-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4823-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4823");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/influxdb");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'influxdb' package(s) announced via the DSA-4823-1 advisory.");
