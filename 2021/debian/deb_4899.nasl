...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-05-04 09:00:28 +0000 (Tue, 04 May 2021)");

  script_name("Debian: Security Advisory (DSA-4899-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4899-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4899");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openjdk-11");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjdk-11' package(s) announced via the DSA-4899-1 advisory.");
