...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-07-26 17:00:12 +0000 (Mon, 26 Jul 2021)");

  script_name("Debian: Security Advisory (DLA-2733-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2733-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tomcat8");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tomcat8' package(s) announced via the DLA-2733-1 advisory.");
