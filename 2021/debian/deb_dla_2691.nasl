...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2691-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2691-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libgcrypt20");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libgcrypt20' package(s) announced via the DLA-2691-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgcrypt11-dev", ver:"1.5.4-3+really1.7.6-2+deb9u4", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgcrypt20-udeb", ver:"1.7.6-2+deb9u4", rls:"DEB9"))) {
    report += res;
  }
