...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4904-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4904-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4904");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gst-plugins-ugly1.0");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gst-plugins-ugly1.0' package(s) announced via the DSA-4904-1 advisory.");
