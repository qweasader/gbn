...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-03-28 16:30:40 +0000 (Thu, 28 Mar 2019)");

  script_name("Debian: Security Advisory (DLA-2793-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2793-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mosquitto");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mosquitto' package(s) announced via the DLA-2793-1 advisory.");
