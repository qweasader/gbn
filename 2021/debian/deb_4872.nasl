...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-03-26 14:13:08 +0000 (Fri, 26 Mar 2021)");

  script_name("Debian: Security Advisory (DSA-4872-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4872-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4872");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'shibboleth-sp' package(s) announced via the DSA-4872-1 advisory.");
