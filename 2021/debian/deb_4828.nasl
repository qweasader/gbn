...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-12-18 16:16:05 +0000 (Fri, 18 Dec 2020)");

  script_name("Debian: Security Advisory (DSA-4828-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4828-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4828-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4828");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libxstream-java");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxstream-java' package(s) announced via the DSA-4828-1 advisory.");
