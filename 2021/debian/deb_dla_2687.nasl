...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-05-21 17:47:19 +0000 (Fri, 21 May 2021)");

  script_name("Debian: Security Advisory (DLA-2687-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2021/DLA-2687-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/prosody");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'prosody' package(s) announced via the DLA-2687-1 advisory.");
...
For Debian 9 stretch, these problems have been fixed in version 0.9.12-2+deb9u3.
