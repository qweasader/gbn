...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4954-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4954-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'c-ares' package(s) announced via the DSA-4954-1 advisory.");
