...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-03-25 02:48:42 +0000 (Thu, 25 Mar 2021)");

  script_name("Debian: Security Advisory (DSA-4873-1)");
  ...
  script_xref(name:"URL", value:"https://www.debian.org/security/2021/DSA-4873-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4873");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/squid");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squid' package(s) announced via the DSA-4873-1 advisory.");
