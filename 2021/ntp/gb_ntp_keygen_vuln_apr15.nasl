...
if(description)
{
  ...
  script_name("NTPd < 4.2.8p2, 4.3.x < 4.3.12 Keygen Vulnerability");
  ...
  script_tag(name:"summary", value:"NTPd is prone to a vulnerability in ntp-keygen.");
  ...
  script_tag(name:"affected", value:"NTPd version prior to 4.2.8p2 and 4.3.x prior to 4.3.12.");
