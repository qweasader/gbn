...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2021-08-09 21:00:00 +0000 (Mon, 09 Aug 2021)");
  ...
  script_name("GetSimple CMS <= 3.4.0.9 Multiple XSS Vulnerabilities"); # 3.3.16 is the official version,
                                                                        # GitHub has 3.4.0.9 without Fix.
...
if( version_is_less_equal( version:version, test_version:"3.4.0.9" ) ) {
