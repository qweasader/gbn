...
if (description)
{
  ...
  script_name("Plone CMS < 5.2.3 Multiple Vulnerabilities");
  ...
  - CVE-2020-28734: XXE via a feature that is explicitly only available to the Manager role

  - CVE-2020-28735: SSRF via the tracebacks feature

  - CVE-2020-28736: XXE via a feature that is protected by an unapplied permission of
  plone.schemaeditor.ManageSchemata");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"Plone CMS prior to version 5.2.3.");
