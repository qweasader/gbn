...
if (description)
{
  ...
  script_name("LANCOM Device Detection Consolidation");

  script_tag(name:"summary", value:"Consolidation of LANCOM device detections.");
...
os_register_and_report(os: os_name, cpe: os_cpe, desc: "LANCOM Device Detection Consolidation", runs_key: "unixoide");
