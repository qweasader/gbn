...
if (description)
{
  ...
  script_name("Telekom Digitalisierungsbox Detection Consolidation");

  script_tag(name:"summary", value:"Consolidation of Telekom Digitalisierungsbox detections.");
...
name = "Telekom Digitalisierungsbox ";
...
os_register_and_report(os: os_name, cpe: os_cpe, desc: "Telekom Digitalisierungsbox Detection Consolidation",
                       runs_key: "unixoide");
