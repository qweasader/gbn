...
if( get_kb_item( "win/lsc/disable_win_cmd_exec" ) ) {
  set_kb_item( name:"openssl/smb-login/" + port + "/installs", value:"0#---#" + location + "#---#" + version + "#---#" + reg_concluded + "#---#Win CMD execution disabled in the scan config, location and version extraction not possible." );
  exit( 0 );
}
