...
if(description)
{
  ...
  script_name("Hirschmann Device Detection Consolidation");
  ...
  script_tag(name:"summary", value:"Consolidation of Hirschmann device detections.");
...
os_register_and_report( os:"Belden Hirschmann Firmware", cpe:os_cpe, desc:"Hirschmann Device Detection Consolidation", runs_key:"unixoide" );
