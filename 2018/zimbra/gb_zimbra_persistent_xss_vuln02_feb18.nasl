...
if(description)
{
  ...
  script_name("Zimbra < 8.8.3 Persistent XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The flaw is due to an input validation error in an unknown
  function.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to inject
  arbitrary html and script code into the web site.");

  script_tag(name:"affected", value:"Zimbra prior to version 8.8.3.");

  script_tag(name:"solution", value:"Update to version 8.8.3 or later.");
...
if (version_is_less(version: version, test_version: "8.8.3")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "8.8.3");
