...
if(description)
{
  ...
  script_name("TeamViewer Authentication Bypass Vulnerability (Sep 2018) - Linux");
  ...
  digits to 6 characters. Update to TeamViewer version 10.0.140685, 11.0.137769, 12.1.83885,
  13.2.75536 or later.");
