...
if(description)
{
  ...
  script_name("'Microsoft.Data.OData' Denial of Service Vulnerability (Sep 2018) - Windows");

  script_tag(name:"summary", value:"'OData Library' is prone to a denial of service vulnerability.");
