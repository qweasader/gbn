...
if(description)
{
  ...
  script_name("Axis Devices Default Credentials (HTTP)");

  script_category(ACT_ATTACK);

  script_copyright("Copyright (C) 2018 Greenbone Networks GmbH");
  script_family("Default Accounts");
  script_dependencies("gb_axis_devices_consolidation.nasl", "gb_default_credentials_options.nasl");
  script_mandatory_keys("axis/device/http/detected");
  script_exclude_keys("default_credentials/disable_default_account_checks");
  script_require_ports("Services/www", 80);

  script_tag(name:"summary", value:"The remote Axis device is using known default credentials for
  the HTTP login.");
  ...
  script_tag(name:"affected", value:"All Axis devices with default credentials.");
