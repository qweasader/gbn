...
if(description)
{
  ...
  script_name("IceWarp Mail Server <= 12.0.3 XSS Vulnerability");
  ...
  script_tag(name:"insight", value:"The flaw exists due to insufficient sanitization of input in the
  'webdav/ticket/' URI.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to inject and
  execute arbitrary web script or HTML.");

  script_tag(name:"affected", value:"IceWarp Mail Server version 12.0.3 and prior.");
...
if (version_is_less_equal(version: version, test_version: "12.0.3")) {
