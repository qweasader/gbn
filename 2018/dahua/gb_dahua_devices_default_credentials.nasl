...
if(description)
{
  ...
  script_name("Dahua Devices Default Credentials (HTTP)");
  script_dependencies("gb_dahua_devices_http_detect.nasl", "gb_default_credentials_options.nasl");
  ...
  script_tag(name:"summary", value:"The remote installation of Dahua's ip camera software (or a
  derivative of such) is using known default credentials.");

  script_tag(name:"impact", value:"This issue may be exploited by a remote attacker to gain access
  to sensitive information or modify system configuration.");

  script_tag(name:"insight", value:"The installation of Dahua's ip camera software (or a derivative
  of such) is lacking a proper password configuration, which makes critical information and actions
  accessible for people with knowledge of the default credentials.");

  script_tag(name:"vuldetect", value:"Checks if a successful login to Dahua's ip camera software is
  possible.");
