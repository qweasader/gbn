...
if(description)
{
  ...
  script_tag(name:"summary", value:"Joomla is prone to a local file inclusion vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to an error in PHP 5.3, where 'class_exists'
  function validates invalid names as valid.");
  ...
  script_tag(name:"solution", value:"Update to version 3.8.9 or later.");
...
if(version_in_range(version:vers, test_version:"2.5.0", test_version2:"3.8.8")) {
