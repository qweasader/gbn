...
if(version_in_range(version:version, test_version:"0.1", test_version2:"1.19")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"1.19.1", install_path:path);
