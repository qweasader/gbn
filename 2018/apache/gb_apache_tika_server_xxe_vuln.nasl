...
if(description)
{
  ...
  script_tag(name:"summary", value:"Apache Tika Server is prone to an XML external entity (XXE)
  vulnerability.");
...
if(version_in_range(version:version, test_version:"0.10", test_version2:"1.12")) {
  report = report_fixed_ver(installed_version:version, fixed_version:"1.13", install_path:path);
