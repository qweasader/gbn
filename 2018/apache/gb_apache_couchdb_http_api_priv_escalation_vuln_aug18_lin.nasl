...
if(description)
{
  ...
  script_name("Apache CouchDB < 2.2.0 Privilege Escalation Vulnerability - Linux");
...
{
  report = report_fixed_ver(installed_version:version, fixed_version:"2.2.0", install_path:path);
