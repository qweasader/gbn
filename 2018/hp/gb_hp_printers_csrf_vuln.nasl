...
if(description)
{
  ...
  script_name("HP Printers CSRF Vulnerability (Oct 2018)");
  ...
  certain HP printers and MFPs in 2405129_000052 and other firmware versions. This vulnerability
  is known as cross-site request forgery (CSRF), and could potentially be exploited remotely to
