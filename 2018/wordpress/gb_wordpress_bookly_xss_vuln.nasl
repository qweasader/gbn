...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2022-11-14 15:03:00 +0000 (Mon, 14 Nov 2022)");
  ...
  script_name("WordPress Bookly Plugin < 14.5 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Bookly' is prone to a cross-site scripting (XSS) vulnerability.");
