...
if(description)
{
  ...
  script_name("WordPress Disable Comments Plugin < 1.0.4 CSRF Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Disable Comments' is prone to a cross-site
...
CPE = "cpe:/a:disable_comments:disable_comments_project";
