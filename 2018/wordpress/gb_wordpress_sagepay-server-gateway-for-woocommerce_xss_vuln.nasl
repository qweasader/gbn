...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'SagePay Server Gateway for WooCommerce' is
  prone to a cross-site scripting (XSS) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"WordPress SagePay Server Gateway for WooCommerce plugin before
  version 1.0.9.");
...
CPE = "cpe:/a:patsatech:sagepay_server_gateway_for_woocommerce";
