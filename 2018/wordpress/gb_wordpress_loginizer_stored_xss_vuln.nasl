...
if( description )
{
  ...
  script_name("WordPress Loginizer Plugin 1.3.8 - 1.3.9 Stored XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Loginizer' is prone to a stored cross-site
