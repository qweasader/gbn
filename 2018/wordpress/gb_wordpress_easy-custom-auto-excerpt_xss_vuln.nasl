...
if (description)
{
  ...
  script_name("WordPress Easy Custom Auto Excerpt Plugin <= 2.4.6 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Easy Custom Auto Excerpt' is prone to a cross-site scripting (XSS) vulnerability.");
...
CPE = "cpe:/a:tonjoostudio:easy_custom_auto_excerpt";
