...
if (description)
{
  ...
  script_name("WordPress Tabs Plugin <= 1.8.0 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Tabs' is prone to a cross-site scripting
  (XSS) vulnerability.");
...
CPE = "cpe:/a:wpshopmart:tabs_responsive";
