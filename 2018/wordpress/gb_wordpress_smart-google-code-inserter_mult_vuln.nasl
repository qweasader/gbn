...
if (description)
{
  ...
  script_name("WordPress Smart Google Code Inserter Plugin < 3.5 Multiple Vulnerabilities");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'The Smart Google Code Inserter' is prone to
  authentication bypass and SQL injection (SQLi) vulnerabilities.");
...
CPE = "cpe:/a:oturia:smart_google_code_inserter";
