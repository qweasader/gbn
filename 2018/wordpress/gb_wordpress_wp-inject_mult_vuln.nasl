...
if (description)
{
  ...
  script_name("WordPress ImageInject Plugin < 1.16 Multiple Vulnerabilities");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'ImageInject' is prone to
