...
if( description )
{
  ...
  script_version("2021-10-08T13:45:20+0000");
  script_tag(name:"last_modification", value:"2021-10-08 13:45:20 +0000 (Fri, 08 Oct 2021)");
  ...
  script_tag(name:"summary", value:"Moodle CMS is prone to a reflected cross-site scripting (XSS)
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The breadcrumb navigation provided by Boost theme when
  displaying search results of a blog were insufficiently filtered, which could result in a
  reflected XSS if a user followed a malicious link containing JavaScript in the search parameter.");

  script_tag(name:"affected", value:"Moodle CMS 3.5 to 3.5.1, 3.4 to 3.4.4, 3.3.7 and earlier
