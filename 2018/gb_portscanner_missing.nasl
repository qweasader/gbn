...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-22.04/en/performance.html#optimizing-the-scan-performance");
  script_xref(name:"URL", value:"https://docs.greenbone.net/GSM-Manual/gos-22.04/en/scanning.html?highlight=scanner_plugins_timeout#description-of-scanner-preferences");
