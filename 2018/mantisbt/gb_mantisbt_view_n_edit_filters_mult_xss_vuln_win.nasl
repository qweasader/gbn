...
if(description)
{
  ...
  script_name("MantisBT 2.1.0 - 2.15.0 'View Filters' And 'Edit Filter' Pages XSS Vulnerabilities - Windows");

  script_tag(name:"summary", value:"MantisBT is prone to multiple cross-site scripting (XSS)
  vulnerabilities.");
  ...
  script_tag(name:"affected", value:"MantisBT version 2.1.0 through 2.15.0.");

  script_tag(name:"solution", value:"Update to version 2.15.1 or later.");
...
if(version_in_range(version: version, test_version: "2.1.0", test_version2: "2.15.0")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "2.15.1", install_path: location);
