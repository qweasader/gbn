...
if(description)
{
  ...
  script_name("TeamSpeak 3 Server < 3.5.1 Permission Checks Bypass Vulnerability");
  ...
  script_tag(name:"summary", value:"TeamSpeak 3 server allows to bypass permission checks.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Exploiting this vulnerability may allow an attacker to gain talk
  power and channel commander temporarily, to set their own avatar and client descriptions, and made
  it possible to prevent a client ban.");

  script_tag(name:"affected", value:"TeamSpeak 3 server versions prior to 3.5.1.");
