...
if(description)
{
  ...
  script_name("Adobe Photoshop CC Remote Code Execution Vulnerability (May 2018) - Mac OS X");

  script_tag(name:"summary", value:"Adobe Photoshop CC is prone to a remote code execution (RCE) vulnerability.");
