...
if (description)
{
  ...
  script_tag(name:"insight", value:"It is possible to upload SVG files as media objects (e.g. in wiki
  pages) which could be used to inject and execute JavaScript (persistent XSS).");

  script_tag(name:"affected", value:"ILIAS prior to version 5.2.2.");
