...
if (description)
{
  ...
  script_tag(name:"summary", value:"ILIAS eLearning is prone to a cross-site scripting (XSS)
  vulnerability.");

  script_tag(name:"insight", value:"Cross-site scripting exists via the cmd parameter to the
  displayHeader function in setup/classes/class.ilSetupGUI.php in the Setup component.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"ILIAS prior to version 5.2.3.");
