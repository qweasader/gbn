...
if(description)
{
  ...
  script_name("Wireshark Security Updates (wnpa-sec-2018-32, wnpa-sec-2018-27, wnpa-sec-2018-26) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Wireshark version 2.6.0 on Mac OS X.");
