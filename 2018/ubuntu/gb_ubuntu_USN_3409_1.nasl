...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fontforge", ver:"20120731.b-5ubuntu0.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"fontforge-common", ver:"20120731.b-5ubuntu0.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
