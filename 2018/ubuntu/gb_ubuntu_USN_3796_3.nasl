...
if(release == "UBUNTU18.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-paramiko", ver:"2.4.1-0ubuntu3.1", rls:"UBUNTU18.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3-paramiko", ver:"2.4.1-0ubuntu3.1", rls:"UBUNTU18.10"))) {
    report += res;
  }
