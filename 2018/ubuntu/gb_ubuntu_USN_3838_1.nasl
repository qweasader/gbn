...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libraw9", ver:"0.15.4-1ubuntu0.3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libraw15", ver:"0.17.1-1ubuntu0.4", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libraw16", ver:"0.18.8-1ubuntu0.2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
