...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"irssi", ver:"0.8.15-5ubuntu3.4", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"irssi", ver:"0.8.19-1ubuntu1.6", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU17.04") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"irssi", ver:"0.8.20-2ubuntu2.3", rls:"UBUNTU17.04"))) {
    report += res;
  }
...
if(release == "UBUNTU17.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"irssi", ver:"1.0.4-1ubuntu2.2", rls:"UBUNTU17.10"))) {
    report += res;
  }
