...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-3678-3 advisory.");
...
(CVE-2018-10021)");
  ...
  script_tag(name:"affected", value:"'linux-azure' package(s) on Ubuntu 18.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1013-azure", ver:"4.15.0-1013.13", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"4.15.0.1013.13", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
