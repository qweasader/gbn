...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpolkit-backend-1-0", ver:"0.105-4ubuntu3.14.04.2", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpolkit-backend-1-0", ver:"0.105-14.1ubuntu0.1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU17.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpolkit-backend-1-0", ver:"0.105-18ubuntu0.1", rls:"UBUNTU17.10"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpolkit-backend-1-0", ver:"0.105-20ubuntu0.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
