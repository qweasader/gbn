...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-perl2", ver:"2.0.8+httpd24-r1449661-6ubuntu2.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-perl2", ver:"2.0.9-4ubuntu1.2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-perl2", ver:"2.0.10-2ubuntu3.18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-perl2", ver:"2.0.10-2ubuntu3.18.10.1", rls:"UBUNTU18.10"))) {
    report += res;
  }
