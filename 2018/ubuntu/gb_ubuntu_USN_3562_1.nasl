...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-01-26 19:59:56 +0000 (Fri, 26 Jan 2018)");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libminiupnpc8", ver:"1.6-3ubuntu2.14.04.4", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libminiupnpc10", ver:"1.9.20140610-2ubuntu2.16.04.2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU17.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libminiupnpc10", ver:"1.9.20140610-4ubuntu1.1", rls:"UBUNTU17.10"))) {
    report += res;
  }
