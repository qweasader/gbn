...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux' package(s) announced via the USN-3581-1 advisory.");
...
if(release == "UBUNTU17.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.13.0-36-generic", ver:"4.13.0-36.40", rls:"UBUNTU17.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.13.0-36-generic-lpae", ver:"4.13.0-36.40", rls:"UBUNTU17.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.13.0-36-lowlatency", ver:"4.13.0-36.40", rls:"UBUNTU17.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic", ver:"4.13.0.36.38", rls:"UBUNTU17.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-lpae", ver:"4.13.0.36.38", rls:"UBUNTU17.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency", ver:"4.13.0.36.38", rls:"UBUNTU17.10"))) {
    report += res;
  }
