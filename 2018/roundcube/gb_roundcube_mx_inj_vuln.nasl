...
if (description)
{
  ...
  script_name("Roundcube Webmail 1.2.0 - 1.3.5 MX Injection Vulnerability");
  ...
  script_tag(name:"summary", value:"Roundcube Webmail is prone to an injection vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"With the archive plugin enabled and configured, it's possible to
  exploit the unsanitized, user-controlled '_uid' parameter to perform an MX (IMAP) injection attack
  by placing an IMAP command after a %0d%0a sequence.

  NOTE: this is less easily exploitable in 1.3.4 and later because of a Same Origin Policy
  protection mechanism.");

  script_tag(name:"affected", value:"Roundcube Webmail versions 1.2.0 through 1.3.5.");
