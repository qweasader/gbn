...
if (version_is_less_equal(version: version, test_version: "4.2.6_20171026")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.2.6_20171208");
  security_message(port: 0, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "4.3.0", test_version2: "4.3.3_20170727")) {
