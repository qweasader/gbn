...
if (version_in_range(version: version, test_version: "4.3.3", test_version2: "4.3.3_20180126")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.3.3_20180402");
  security_message(port: 0, data: report);
  exit(0);
}

if (version_in_range(version: version, test_version: "4.3.4", test_version2: "4.3.4_20180215")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "4.3.4_20180315");
  security_message(port: 0, data: report);
  exit(0);
}
