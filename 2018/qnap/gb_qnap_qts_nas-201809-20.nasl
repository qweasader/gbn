...
if( version_is_less( version: version, test_version: "4.2.6_20180829" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "4.2.6_20180829" );
  security_message( data: report, port: 0 );
  exit( 0 );
}

if( version_in_range( version: version, test_version: "4.3.0", test_version2: "4.3.3_20180725" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "4.3.3_20180810" );
  security_message( data: report, port: 0 );
  exit( 0 );
}

if( version_in_range( version: version, test_version: "4.3.4", test_version2: "4.3.4_20180719" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "4.3.4_20180810" );
  security_message( data: report, port: 0 );
  exit( 0 );
}
