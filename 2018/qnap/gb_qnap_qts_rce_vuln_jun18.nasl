...
if(description)
{
  ...
  script_name("QNAP QTS < 4.2.6 build 20171208, 4.3.3.x < 4.3.3 build 20180402, 4.3.4 < 4.3.4 build 20180501 RCE Vulnerability");
...
if ( version =~ "^4\.3" ) {
  if ( version_is_less( version: version, test_version: "4.3.3" ) ) {
    report = report_fixed_ver( installed_version: version, installed_build: build, fixed_version: "4.3.3", fixed_build: "20180504" );
    security_message( port: 0, data: report );
    exit( 0 );
  }
...
if ( version =~ "^4\.3\.4" ) {
  if ( version_is_less( version: version, test_version: "4.3.4" ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "4.3.4", fixed_build: "20180501" );
    security_message( port: 0, data: report );
    exit( 0 );
  }

  if ( version_is_equal( version: version, test_version: "4.3.4" ) &&
     ( ! build || version_is_less( version: build, test_version: "20180501" ) ) ) {
    report = report_fixed_ver( installed_version: version, fixed_version: "4.3.4", fixed_build: "20180501" );
    security_message( port: 0, data: report );
    exit( 0 );
  }
