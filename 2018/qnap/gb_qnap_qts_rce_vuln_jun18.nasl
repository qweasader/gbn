...
if( version_in_range( version: version, test_version: "4.3.0", test_version2: "4.3.3_20180402" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "4.3.3_20180504" );
  security_message( data: report, port: 0 );
  exit( 0 );
}

if( version_in_range( version: version, test_version: "4.3.4", test_version2: "4.3.4_20180413" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "4.3.4_20180501" );
  security_message( data: report, port: 0 );
  exit( 0 );
}
