...
if(description)
{
  ...
  script_tag(name:"insight", value:"The flaw exists as the application does not properly filter HTML
  code from user-supplied input before displaying the input.");

  script_tag(name:"impact", value:"Successful exploitation will allow remote attackers to conduct XSS
  attacks.");

  script_tag(name:"affected", value:"QNAP QTS prior to version 4.3.3 build 20180126 and 4.3.4.x prior
  to 4.3.4 build 20180315.");

  script_tag(name:"solution", value:"Update to version 4.3.3 build 20180402, 4.3.4 build 20180413 or
...
if (version =~ "^4\.3\.4") {
   if (!build || version_is_less(version: build, test_version: "20180413")) {
