...
if( description )
{
  ...
  script_tag(name:"affected", value:"QNAP QTS through 4.2.6 build 20171208, 4.3.x through 4.3.3
  build 20171213 and 4.3.4 through build 20171223.");
  script_tag(name:"solution", value:"Update to 4.2.6 build 20180504, 4.3.3 build 20180126,
  4.3.4 20171230 or later.");
