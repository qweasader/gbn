...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-01-11 00:35:56 +0000 (Wed, 11 Jan 2017)");

  script_name("Debian: Security Advisory (DLA-1480-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1480-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1480-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ruby2.1' package(s) announced via the DLA-1480-1 advisory.");
