...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4158-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4158-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4158-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4158");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl1.0' package(s) announced via the DSA-4158-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libcrypto1.0.2-udeb", ver:"1.0.2l-2+deb9u3", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl1.0.2-udeb", ver:"1.0.2l-2+deb9u3", rls:"DEB9"))) {
    report += res;
  }
