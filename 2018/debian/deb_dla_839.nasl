...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-839-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-839-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-839-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tnef' package(s) announced via the DLA-839-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"CVE-2017-6307
...
For Debian 7 Wheezy, these problems have been fixed in version 1.4.9-1+deb7u1.
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tnef", ver:"1.4.9-1+deb7u1", rls:"DEB7"))) {
    report += res;
  }
