...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1100-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1100-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1100-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gdk-pixbuf' package(s) announced via the DLA-1100-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgdk-pixbuf2.0-0-udeb", ver:"2.26.1-1+deb7u6", rls:"DEB7"))) {
    report += res;
  }
