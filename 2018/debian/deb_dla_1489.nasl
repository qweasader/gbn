...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1489-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1489-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1489-1");
  script_xref(name:"URL", value:"https://lists.debian.org/debian-lts-announce/2018/08/msg00037.html");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'spice-gtk' package(s) announced via the DLA-1489-1 advisory.");
