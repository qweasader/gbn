...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-07 18:54:11 +0000 (Mon, 07 Aug 2017)");

  script_name("Debian: Security Advisory (DLA-1105-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1105-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1105-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'clamav' package(s) announced via the DLA-1105-1 advisory.");
