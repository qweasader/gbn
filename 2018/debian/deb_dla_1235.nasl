...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-01-19 18:41:58 +0000 (Fri, 19 Jan 2018)");

  script_name("Debian: Security Advisory (DLA-1235-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1235-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1235-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'opencv' package(s) announced via the DLA-1235-1 advisory.");
