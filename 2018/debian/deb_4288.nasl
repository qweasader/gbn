...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-10-25 19:42:29 +0000 (Thu, 25 Oct 2018)");

  script_name("Debian: Security Advisory (DSA-4288-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4288-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4288-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4288");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ghostscript");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ghostscript' package(s) announced via the DSA-4288-1 advisory.");
