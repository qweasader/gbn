...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-02-01 19:38:55 +0000 (Thu, 01 Feb 2018)");

  script_name("Debian: Security Advisory (DSA-4191-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4191-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4191-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4191");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/redmine");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'redmine' package(s) announced via the DSA-4191-1 advisory.");
