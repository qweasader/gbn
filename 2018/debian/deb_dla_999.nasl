...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-05 17:31:45 +0000 (Wed, 05 Jul 2017)");

  script_name("Debian: Security Advisory (DLA-999-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-999-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-999-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openvpn' package(s) announced via the DLA-999-1 advisory.");
