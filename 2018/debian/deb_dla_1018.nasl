...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1018-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1018-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1018-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sqlite3' package(s) announced via the DLA-1018-1 advisory.");
