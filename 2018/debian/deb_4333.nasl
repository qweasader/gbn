...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-23 18:28:32 +0000 (Wed, 23 Jan 2019)");

  script_name("Debian: Security Advisory (DSA-4333-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4333-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4333-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4333");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/icecast2");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icecast2' package(s) announced via the DSA-4333-1 advisory.");
