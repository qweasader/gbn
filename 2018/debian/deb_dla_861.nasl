...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-861-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-861-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-861-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'r-base' package(s) announced via the DLA-861-1 advisory.");
