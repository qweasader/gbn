...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-10-09 18:46:59 +0000 (Tue, 09 Oct 2018)");

  script_name("Debian: Security Advisory (DSA-4264-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4264-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4264-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4264");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/python-django");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DSA-4264-1 advisory.");
