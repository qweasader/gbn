...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-27 17:44:50 +0000 (Thu, 27 Jul 2017)");

  script_name("Debian: Security Advisory (DLA-1024-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1024-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1024-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nginx' package(s) announced via the DLA-1024-1 advisory.");
