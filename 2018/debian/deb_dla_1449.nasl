...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1449-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1449-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1449-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl' package(s) announced via the DLA-1449-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libcrypto1.0.0-udeb", ver:"1.0.1t-1+deb8u9", rls:"DEB8"))) {
    report += res;
  }
