...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-08-14 13:15:12 +0000 (Tue, 14 Aug 2018)");

  script_name("Debian: Security Advisory (DSA-4229-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4229-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4229-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4229");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/strongswan");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'strongswan' package(s) announced via the DSA-4229-1 advisory.");
