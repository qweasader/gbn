...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-04-10 18:51:01 +0000 (Tue, 10 Apr 2018)");

  script_name("Debian: Security Advisory (DLA-1307-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1307-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1307-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'clamav' package(s) announced via the DLA-1307-1 advisory.");
