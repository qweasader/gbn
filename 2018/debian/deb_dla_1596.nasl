...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-11 20:13:59 +0000 (Tue, 11 Dec 2018)");

  script_name("Debian: Security Advisory (DLA-1596-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1596-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1596-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squid3' package(s) announced via the DLA-1596-1 advisory.");
