...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-04-11 14:07:25 +0000 (Tue, 11 Apr 2017)");

  script_name("Debian: Security Advisory (DLA-884-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-884-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-884-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'collectd' package(s) announced via the DLA-884-1 advisory.");
