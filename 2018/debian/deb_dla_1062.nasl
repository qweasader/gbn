...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-11-01 19:11:35 +0000 (Wed, 01 Nov 2017)");

  script_name("Debian: Security Advisory (DLA-1062-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1062-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1062-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'curl' package(s) announced via the DLA-1062-1 advisory.");
