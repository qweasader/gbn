...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1120-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1120-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1120-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'git' package(s) announced via the DLA-1120-1 advisory.");
