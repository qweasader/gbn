...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-04-10 21:37:59 +0000 (Mon, 10 Apr 2017)");

  script_name("Debian: Security Advisory (DLA-901-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-901-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-901-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'radare2' package(s) announced via the DLA-901-1 advisory.");
