...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-06-15 19:38:40 +0000 (Fri, 15 Jun 2018)");

  script_name("Debian: Security Advisory (DLA-1381-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1381-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1381-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imagemagick' package(s) announced via the DLA-1381-1 advisory.");
