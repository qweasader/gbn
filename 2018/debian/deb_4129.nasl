...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-03-02 14:38:03 +0000 (Fri, 02 Mar 2018)");

  script_name("Debian: Security Advisory (DSA-4129-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4129-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4129-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4129");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/freexl");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'freexl' package(s) announced via the DSA-4129-1 advisory.");
