...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-21 18:03:35 +0000 (Fri, 21 Dec 2018)");

  script_name("Debian: Security Advisory (DSA-4359-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4359-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4359-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4359");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wireshark");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wireshark' package(s) announced via the DSA-4359-1 advisory.");
