...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-11-08 14:21:33 +0000 (Thu, 08 Nov 2018)");

  script_name("Debian: Security Advisory (DSA-4282-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4282-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4282-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'trafficserver' package(s) announced via the DSA-4282-1 advisory.");
