...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-04-13 18:48:51 +0000 (Fri, 13 Apr 2018)");

  script_name("Debian: Security Advisory (DSA-4168-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4168-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4168-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4168");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/squirrelmail");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'squirrelmail' package(s) announced via the DSA-4168-1 advisory.");
