...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-10-10 19:01:16 +0000 (Wed, 10 Oct 2018)");

  script_name("Debian: Security Advisory (DSA-4281-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4281-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4281-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4281");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tomcat8");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tomcat8' package(s) announced via the DSA-4281-1 advisory.");
