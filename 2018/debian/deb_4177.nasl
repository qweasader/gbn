...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-05-21 17:00:13 +0000 (Mon, 21 May 2018)");

  script_name("Debian: Security Advisory (DSA-4177-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4177-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4177-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4177");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libsdl2-image");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libsdl2-image' package(s) announced via the DSA-4177-1 advisory.");
