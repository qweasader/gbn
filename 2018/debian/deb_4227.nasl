...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-09-18 14:59:49 +0000 (Tue, 18 Sep 2018)");

  script_name("Debian: Security Advisory (DSA-4227-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4227-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4227-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4227");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/plexus-archiver");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'plexus-archiver' package(s) announced via the DSA-4227-1 advisory.");
