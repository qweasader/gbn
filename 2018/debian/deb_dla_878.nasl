...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-02-24 16:00:00 +0000 (Fri, 24 Feb 2017)");

  script_name("Debian: Security Advisory (DLA-878-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-878-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-878-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libytnef' package(s) announced via the DLA-878-1 advisory.");
