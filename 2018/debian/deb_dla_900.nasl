...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-900-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-900-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-900-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'freetype' package(s) announced via the DLA-900-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6-udeb", ver:"2.4.9-1.1+deb7u5", rls:"DEB7"))) {
    report += res;
  }
