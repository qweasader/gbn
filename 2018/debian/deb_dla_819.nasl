...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-819-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-819-2");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-819-2");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mysql-5.5' package(s) announced via the DLA-819-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It has been found that the C client library for MySQL (libmysqlclient.so) has use-after-free vulnerability which can cause crash of applications using that MySQL client.

For Debian 7 Wheezy, these problems have been fixed in version 5.5.47-0+deb7u2.
