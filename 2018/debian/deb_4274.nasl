...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-11-01 14:17:02 +0000 (Thu, 01 Nov 2018)");

  script_name("Debian: Security Advisory (DSA-4274-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4274-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4274-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4274");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xen' package(s) announced via the DSA-4274-1 advisory.");
