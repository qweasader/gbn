...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1071-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1071-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1071-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qemu-kvm' package(s) announced via the DLA-1071-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"kvm", ver:"1:1.1.2+dfsg-6+deb7u23", rls:"DEB7"))) {
    report += res;
  }
