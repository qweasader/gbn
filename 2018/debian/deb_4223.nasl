...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4223-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4223-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4223-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4223");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg1' package(s) announced via the DSA-4223-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gpgv1.4-udeb", ver:"1.4.21-4+deb9u1", rls:"DEB9"))) {
    report += res;
  }
