...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-896-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-896-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-896-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/Thunderbird");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icedove' package(s) announced via the DLA-896-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lightning", ver:"1:45.8.0-3~deb7u1", rls:"DEB7"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:45.8.0-3~deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-dbg", ver:"1:45.8.0-3~deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-dev", ver:"1:45.8.0-3~deb7u1", rls:"DEB7"))) {
    report += res;
  }
