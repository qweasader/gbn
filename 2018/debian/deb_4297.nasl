...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-30 14:43:21 +0000 (Wed, 30 Jan 2019)");

  script_name("Debian: Security Advisory (DSA-4297-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4297-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4297-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4297");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium-browser");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium-browser' package(s) announced via the DSA-4297-1 advisory.");
