...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1080-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1080-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1080-1");
  script_xref(name:"URL", value:"https://eprint.iacr.org/2017/627");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg' package(s) announced via the DLA-1080-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnupg-udeb", ver:"1.4.12-7+deb7u9", rls:"DEB7"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gpgv-udeb", ver:"1.4.12-7+deb7u9", rls:"DEB7"))) {
    report += res;
  }
