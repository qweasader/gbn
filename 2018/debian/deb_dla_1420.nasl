...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-09-04 17:02:32 +0000 (Tue, 04 Sep 2018)");

  script_name("Debian: Security Advisory (DLA-1420-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1420-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1420-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cinnamon' package(s) announced via the DLA-1420-1 advisory.");
