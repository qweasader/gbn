...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1026-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1026-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1026-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xorg-server' package(s) announced via the DLA-1026-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xserver-xorg-core-udeb", ver:"2:1.12.4-6+deb7u7", rls:"DEB7"))) {
    report += res;
  }
