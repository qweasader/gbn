...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-03-07 13:38:34 +0000 (Tue, 07 Mar 2017)");

  script_name("Debian: Security Advisory (DLA-869-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-869-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-869-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cgiemail' package(s) announced via the DLA-869-1 advisory.");
