...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-13 13:02:50 +0000 (Thu, 13 Dec 2018)");

  script_name("Debian: Security Advisory (DSA-4344-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4344-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4344-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4344");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/roundcube");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'roundcube' package(s) announced via the DSA-4344-1 advisory.");
