...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-03-21 16:54:21 +0000 (Tue, 21 Mar 2017)");

  script_name("Debian: Security Advisory (DLA-863-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-863-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-863-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'deluge' package(s) announced via the DLA-863-1 advisory.");
