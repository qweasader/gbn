...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-09-18 14:02:53 +0000 (Tue, 18 Sep 2018)");

  script_name("Debian: Security Advisory (DLA-1614-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1614-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1614-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjpeg2' package(s) announced via the DLA-1614-1 advisory.");
