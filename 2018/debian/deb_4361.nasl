...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-10 19:41:18 +0000 (Thu, 10 Jan 2019)");

  script_name("Debian: Security Advisory (DSA-4361-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4361-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4361-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4361");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libextractor");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libextractor' package(s) announced via the DSA-4361-1 advisory.");
