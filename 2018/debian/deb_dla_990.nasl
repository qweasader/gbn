...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-990-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-990-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-990-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'expat' package(s) announced via the DLA-990-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libexpat1-udeb", ver:"2.1.0-1+deb7u5", rls:"DEB7"))) {
    report += res;
  }
