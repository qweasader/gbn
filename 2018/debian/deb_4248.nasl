...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4248-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4248-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4248-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4248");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/blender");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'blender' package(s) announced via the DSA-4248-1 advisory.");
