...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-09-19 14:12:45 +0000 (Wed, 19 Sep 2018)");

  script_name("Debian: Security Advisory (DSA-4246-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4246-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4246-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4246");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mailman");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mailman' package(s) announced via the DSA-4246-1 advisory.");
