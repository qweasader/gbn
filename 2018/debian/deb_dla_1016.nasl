...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-19 16:32:53 +0000 (Wed, 19 Jul 2017)");

  script_name("Debian: Security Advisory (DLA-1016-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1016-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1016-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'radare2' package(s) announced via the DLA-1016-1 advisory.");
