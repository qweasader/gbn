...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4089-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4089-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4089-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4089");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/bind9");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bind9' package(s) announced via the DSA-4089-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns-export100-udeb", ver:"1:9.9.5.dfsg-9+deb8u15", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libirs-export91-udeb", ver:"1:9.9.5.dfsg-9+deb8u15", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libisc-export95-udeb", ver:"1:9.9.5.dfsg-9+deb8u15", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libisccfg-export90-udeb", ver:"1:9.9.5.dfsg-9+deb8u15", rls:"DEB8"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libdns-export162-udeb", ver:"1:9.10.3.dfsg.P4-12.3+deb9u4", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libirs-export141-udeb", ver:"1:9.10.3.dfsg.P4-12.3+deb9u4", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libisc-export160-udeb", ver:"1:9.10.3.dfsg.P4-12.3+deb9u4", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libisccc-export140-udeb", ver:"1:9.10.3.dfsg.P4-12.3+deb9u4", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libisccfg-export140-udeb", ver:"1:9.10.3.dfsg.P4-12.3+deb9u4", rls:"DEB9"))) {
    report += res;
  }
