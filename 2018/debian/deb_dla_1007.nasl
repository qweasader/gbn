...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1007-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1007-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1007-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icedove' package(s) announced via the DLA-1007-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lightning", ver:"1:52.2.1-1~deb7u1", rls:"DEB7"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"thunderbird", ver:"1:52.2.1-1~deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-dbg", ver:"1:52.2.1-1~deb7u1", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"thunderbird-dev", ver:"1:52.2.1-1~deb7u1", rls:"DEB7"))) {
    report += res;
  }
