...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-01-24 21:13:46 +0000 (Tue, 24 Jan 2017)");

  script_name("Debian: Security Advisory (DLA-835-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-835-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-835-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'cakephp' package(s) announced via the DLA-835-1 advisory.");
