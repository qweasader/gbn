...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-02-01 14:03:12 +0000 (Fri, 01 Feb 2019)");

  script_name("Debian: Security Advisory (DLA-1572-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1572-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1572-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nginx' package(s) announced via the DLA-1572-1 advisory.");
