...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-10-25 11:35:15 +0000 (Thu, 25 Oct 2018)");

  script_name("Debian: Security Advisory (DSA-4086-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4086-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4086-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4086");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libxml2");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxml2' package(s) announced via the DSA-4086-1 advisory.");
