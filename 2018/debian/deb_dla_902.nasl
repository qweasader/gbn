...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-04-15 01:09:01 +0000 (Sat, 15 Apr 2017)");

  script_name("Debian: Security Advisory (DLA-902-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-902-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-902-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imagemagick' package(s) announced via the DLA-902-1 advisory.");
