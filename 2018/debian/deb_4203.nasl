...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-01-02 18:38:46 +0000 (Tue, 02 Jan 2018)");

  script_name("Debian: Security Advisory (DSA-4203-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4203-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4203-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4203");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/vlc");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'vlc' package(s) announced via the DSA-4203-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libvlccore9", ver:"3.0.2-0+deb9u1", rls:"DEB9"))) {
    report += res;
  }
