...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4088-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4088-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4088-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4088");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/gdk-pixbuf");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gdk-pixbuf' package(s) announced via the DSA-4088-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgdk-pixbuf2.0-0-udeb", ver:"2.31.1-2+deb8u7", rls:"DEB8"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgdk-pixbuf2.0-0-udeb", ver:"2.36.5-2+deb9u2", rls:"DEB9"))) {
    report += res;
  }
