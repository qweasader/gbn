...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-09-26 17:41:52 +0000 (Tue, 26 Sep 2017)");

  script_name("Debian: Security Advisory (DLA-1493-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1493-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1493-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'xen' package(s) announced via the DLA-1493-1 advisory.");
