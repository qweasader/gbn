...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-06-09 14:35:52 +0000 (Fri, 09 Jun 2017)");

  script_name("Debian: Security Advisory (DLA-980-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-980-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-980-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ming' package(s) announced via the DLA-980-1 advisory.");
