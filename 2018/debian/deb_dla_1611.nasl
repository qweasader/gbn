...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-02-24 20:20:04 +0000 (Fri, 24 Feb 2017)");

  script_name("Debian: Security Advisory (DLA-1611-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1611-2");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1611-2");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libav' package(s) announced via the DLA-1611-2 advisory.");
...
The ff_frame_thread_init function in libavcodec/pthread_frame.c mishandled certain memory-allocation failures, ... [Please see the references for more information on the vulnerabilities]");
