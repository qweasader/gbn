...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-06-13 15:24:53 +0000 (Wed, 13 Jun 2018)");

  script_name("Debian: Security Advisory (DSA-4197-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4197-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4197-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4197");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/wavpack");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wavpack' package(s) announced via the DSA-4197-1 advisory.");
