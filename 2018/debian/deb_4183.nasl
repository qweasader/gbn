...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-03-27 17:56:54 +0000 (Tue, 27 Mar 2018)");

  script_name("Debian: Security Advisory (DSA-4183-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4183-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4183-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4183");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tor");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tor' package(s) announced via the DSA-4183-1 advisory.");
