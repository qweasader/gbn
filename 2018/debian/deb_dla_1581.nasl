...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-12 14:17:35 +0000 (Wed, 12 Dec 2018)");

  script_name("Debian: Security Advisory (DLA-1581-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1581-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1581-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'uriparser' package(s) announced via the DLA-1581-1 advisory.");
