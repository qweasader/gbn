...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-05-12 14:58:42 +0000 (Fri, 12 May 2017)");

  script_name("Debian: Security Advisory (DLA-995-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-995-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-995-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'swftools' package(s) announced via the DLA-995-1 advisory.");
