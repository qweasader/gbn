...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-03-23 18:47:15 +0000 (Fri, 23 Mar 2018)");

  script_name("Debian: Security Advisory (DLA-1343-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1343-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1343-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ming' package(s) announced via the DLA-1343-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libming-dev", ver:"1:0.4.4-1.1+deb7u8", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libming-util", ver:"1:0.4.4-1.1+deb7u8", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libming1", ver:"1:0.4.4-1.1+deb7u8", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libswf-perl", ver:"1:0.4.4-1.1+deb7u8", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ming-fonts-dejavu", ver:"1:0.4.4-1.1+deb7u8", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ming-fonts-opensymbol", ver:"1:0.4.4-1.1+deb7u8", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"php5-ming", ver:"1:0.4.4-1.1+deb7u8", rls:"DEB7"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python-ming", ver:"1:0.4.4-1.1+deb7u8", rls:"DEB7"))) {
    report += res;
  }
