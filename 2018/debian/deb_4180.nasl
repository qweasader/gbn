...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-09-18 18:17:22 +0000 (Tue, 18 Sep 2018)");

  script_name("Debian: Security Advisory (DSA-4180-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4180-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4180-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4180");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'drupal7' package(s) announced via the DSA-4180-1 advisory.");
