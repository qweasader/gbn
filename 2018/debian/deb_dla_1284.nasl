...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-05-25 12:15:35 +0000 (Fri, 25 May 2018)");

  script_name("Debian: Security Advisory (DLA-1284-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1284-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1284-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'leptonlib' package(s) announced via the DLA-1284-1 advisory.");
