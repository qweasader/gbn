...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-06-27 12:08:15 +0000 (Wed, 27 Jun 2018)");

  script_name("Debian: Security Advisory (DSA-4214-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4214-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4214-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'zookeeper' package(s) announced via the DSA-4214-1 advisory.");
