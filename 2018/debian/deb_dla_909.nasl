...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-04-25 00:44:42 +0000 (Tue, 25 Apr 2017)");

  script_name("Debian: Security Advisory (DLA-909-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-909-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-909-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libcroco' package(s) announced via the DLA-909-1 advisory.");
