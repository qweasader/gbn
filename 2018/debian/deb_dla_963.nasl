...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-06-08 13:55:04 +0000 (Thu, 08 Jun 2017)");

  script_name("Debian: Security Advisory (DLA-963-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-963-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-963-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'exiv2' package(s) announced via the DLA-963-1 advisory.");
