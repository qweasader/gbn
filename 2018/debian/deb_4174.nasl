...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-05-17 17:53:32 +0000 (Thu, 17 May 2018)");

  script_name("Debian: Security Advisory (DSA-4174-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4174-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4174-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4174");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/corosync");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'corosync' package(s) announced via the DSA-4174-1 advisory.");
