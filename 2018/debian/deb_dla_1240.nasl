...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-12-07 16:10:28 +0000 (Thu, 07 Dec 2017)");

  script_name("Debian: Security Advisory (DLA-1240-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1240-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1240-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ming' package(s) announced via the DLA-1240-1 advisory.");
