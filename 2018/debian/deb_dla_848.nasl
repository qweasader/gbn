...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-03-07 23:35:36 +0000 (Tue, 07 Mar 2017)");

  script_name("Debian: Security Advisory (DLA-848-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-848-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-848-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'freetype' package(s) announced via the DLA-848-1 advisory.");
...
if(release == "DEB7") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libfreetype6-udeb", ver:"2.4.9-1.1+deb7u4", rls:"DEB7"))) {
    report += res;
  }
