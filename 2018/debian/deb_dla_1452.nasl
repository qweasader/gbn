...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-08-20 15:44:45 +0000 (Mon, 20 Aug 2018)");

  script_name("Debian: Security Advisory (DLA-1452-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1452-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1452-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DLA-1452-1 advisory.");
