...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-03-01 16:12:41 +0000 (Thu, 01 Mar 2018)");

  script_name("Debian: Security Advisory (DSA-4152-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4152-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4152-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4152");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mupdf");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mupdf' package(s) announced via the DSA-4152-1 advisory.");
