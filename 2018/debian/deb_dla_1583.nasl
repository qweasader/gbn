...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-30 01:11:48 +0000 (Wed, 30 Aug 2017)");

  script_name("Debian: Security Advisory (DLA-1583-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1583-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1583-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jasper' package(s) announced via the DLA-1583-1 advisory.");
