...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-10-17 20:11:42 +0000 (Tue, 17 Oct 2017)");

  script_name("Debian: Security Advisory (DLA-1123-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1123-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1123-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'golang' package(s) announced via the DLA-1123-1 advisory.");
