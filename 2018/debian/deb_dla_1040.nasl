...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-08-15 19:33:00 +0000 (Tue, 15 Aug 2017)");

  script_name("Debian: Security Advisory (DLA-1040-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1040-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1040-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'resiprocate' package(s) announced via the DLA-1040-1 advisory.");
