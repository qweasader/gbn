...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-910-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-910-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-910-1");
  script_xref(name:"URL", value:"https://www.libreoffice.org/about-us/security/advisories/cve-2017-3157/");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libreoffice' package(s) announced via the DLA-910-1 advisory.");
