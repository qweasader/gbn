...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-05-26 13:11:49 +0000 (Fri, 26 May 2017)");

  script_name("Debian: Security Advisory (DLA-943-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-943-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-943-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'deluge' package(s) announced via the DLA-943-1 advisory.");
