...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-11-05 20:46:15 +0000 (Mon, 05 Nov 2018)");

  script_name("Debian: Security Advisory (DLA-1496-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1496-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1496-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'lcms2' package(s) announced via the DLA-1496-1 advisory.");
