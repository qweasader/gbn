...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-03-16 19:09:44 +0000 (Thu, 16 Mar 2017)");

  script_name("Debian: Security Advisory (DLA-870-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-870-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-870-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libplist' package(s) announced via the DLA-870-1 advisory.");
