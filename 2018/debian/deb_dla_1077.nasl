...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-06-30 17:56:37 +0000 (Fri, 30 Jun 2017)");

  script_name("Debian: Security Advisory (DLA-1077-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1077-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1077-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'faad2' package(s) announced via the DLA-1077-1 advisory.");
