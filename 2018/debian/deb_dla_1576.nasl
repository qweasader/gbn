...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-28 19:51:36 +0000 (Mon, 28 Jan 2019)");

  script_name("Debian: Security Advisory (DLA-1576-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1576-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1576-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ansible' package(s) announced via the DLA-1576-1 advisory.");
