...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4222-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4222-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4222-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4222");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg2' package(s) announced via the DSA-4222-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gpgv-udeb", ver:"2.1.18-8~deb9u2", rls:"DEB9"))) {
    report += res;
  }
