...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4101-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4101-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4101-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wireshark' package(s) announced via the DSA-4101-1 advisory.");
