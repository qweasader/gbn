...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4224-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4224-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4224-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4224");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gnupg' package(s) announced via the DSA-4224-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnupg-udeb", ver:"1.4.18-7+deb8u5", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gpgv-udeb", ver:"1.4.18-7+deb8u5", rls:"DEB8"))) {
    report += res;
  }
