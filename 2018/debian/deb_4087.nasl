...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-02-09 17:54:55 +0000 (Fri, 09 Feb 2018)");

  script_name("Debian: Security Advisory (DSA-4087-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4087-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4087-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4087");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/transmission");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'transmission' package(s) announced via the DSA-4087-1 advisory.");
