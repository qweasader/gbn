...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4306-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4306-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4306-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4306");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/python2.7");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python2.7' package(s) announced via the DSA-4306-1 advisory.");
