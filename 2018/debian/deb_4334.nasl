...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-01-17 16:28:18 +0000 (Wed, 17 Jan 2018)");

  script_name("Debian: Security Advisory (DSA-4334-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4334-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4334-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mupdf' package(s) announced via the DSA-4334-1 advisory.");
