...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-11-25 14:10:34 +0000 (Sun, 25 Nov 2018)");

  script_name("Debian: Security Advisory (DLA-1602-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1602-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1602-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nsis' package(s) announced via the DLA-1602-1 advisory.");
