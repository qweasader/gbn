...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-01-12 20:12:12 +0000 (Fri, 12 Jan 2018)");

  script_name("Debian: Security Advisory (DLA-1229-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1229-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1229-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imagemagick' package(s) announced via the DLA-1229-1 advisory.");
