...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-04-13 14:50:02 +0000 (Fri, 13 Apr 2018)");

  script_name("Debian: Security Advisory (DSA-4167-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4167-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4167-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4167");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/sharutils");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'sharutils' package(s) announced via the DSA-4167-1 advisory.");
