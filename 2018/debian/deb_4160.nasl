...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-06-17 13:21:19 +0000 (Wed, 17 Jun 2020)");

  script_name("Debian: Security Advisory (DSA-4160-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4160-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4160-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4160");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libevt");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libevt' package(s) announced via the DSA-4160-1 advisory.");
