...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-08-02 13:41:21 +0000 (Thu, 02 Aug 2018)");

  script_name("Debian: Security Advisory (DSA-4233-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4233-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4233-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4233");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/bouncycastle");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bouncycastle' package(s) announced via the DSA-4233-1 advisory.");
