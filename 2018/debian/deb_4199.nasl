...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4199-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4199-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4199-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'firefox-esr' package(s) announced via the DSA-4199-1 advisory.");
