...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-08 15:37:23 +0000 (Tue, 08 Jan 2019)");

  script_name("Debian: Security Advisory (DLA-1589-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1589-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1589-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'keepalived' package(s) announced via the DLA-1589-1 advisory.");
