...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-07-16 11:09:21 +0000 (Sun, 16 Jul 2017)");

  script_name("Debian: Security Advisory (DLA-1034-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1034-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2017/DLA-1034-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php5' package(s) announced via the DLA-1034-1 advisory.");
