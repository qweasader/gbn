...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"fixincludes", ver:"1:4.9.2-10+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lib32gcc1", ver:"1:4.9.2-10+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"lib64gcc1", ver:"1:4.9.2-10+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgcc1", ver:"1:4.9.2-10+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libn32gcc1", ver:"1:4.9.2-10+deb8u1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libx32gcc1", ver:"1:4.9.2-10+deb8u1", rls:"DEB8"))) {
    report += res;
  }
