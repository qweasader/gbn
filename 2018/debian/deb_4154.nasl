...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4154-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4154-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4154-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4154");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/net-snmp");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'net-snmp' package(s) announced via the DSA-4154-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsnmp-dev", ver:"5.7.2.1+dfsg-1+deb8u1+b1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsnmp-perl", ver:"5.7.2.1+dfsg-1+deb8u1+b1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsnmp30", ver:"5.7.2.1+dfsg-1+deb8u1+b1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libsnmp30-dbg", ver:"5.7.2.1+dfsg-1+deb8u1+b1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-netsnmp", ver:"5.7.2.1+dfsg-1+deb8u1+b1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snmp", ver:"5.7.2.1+dfsg-1+deb8u1+b1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snmpd", ver:"5.7.2.1+dfsg-1+deb8u1+b1", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"snmptrapd", ver:"5.7.2.1+dfsg-1+deb8u1+b1", rls:"DEB8"))) {
    report += res;
  }
