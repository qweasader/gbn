...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4296-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4296-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4296-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4296");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mbedtls");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mbedtls' package(s) announced via the DSA-4296-1 advisory.");
