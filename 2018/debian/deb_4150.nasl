...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-11-07 17:54:19 +0000 (Wed, 07 Nov 2018)");

  script_name("Debian: Security Advisory (DSA-4150-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4150-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4150-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4150");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/icu");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'icu' package(s) announced via the DSA-4150-1 advisory.");
