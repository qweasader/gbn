...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-09-05 18:58:04 +0000 (Tue, 05 Sep 2017)");

  script_name("Debian: Security Advisory (DLA-1241-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1241-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1241-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libkohana2-php' package(s) announced via the DLA-1241-1 advisory.");
