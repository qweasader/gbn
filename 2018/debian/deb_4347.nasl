...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-30 01:34:38 +0000 (Sun, 30 Dec 2018)");

  script_name("Debian: Security Advisory (DSA-4347-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4347-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4347-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4347");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/perl");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'perl' package(s) announced via the DSA-4347-1 advisory.");
