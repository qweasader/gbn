...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-06-12 18:28:05 +0000 (Tue, 12 Jun 2018)");

  script_name("Debian: Security Advisory (DSA-4189-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4189-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4189-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4189");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/quassel");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'quassel' package(s) announced via the DSA-4189-1 advisory.");
