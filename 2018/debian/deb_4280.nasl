...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4280-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4280-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4280-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4280");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openssh");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssh' package(s) announced via the DSA-4280-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-client-udeb", ver:"1:7.4p1-10+deb9u4", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"openssh-server-udeb", ver:"1:7.4p1-10+deb9u4", rls:"DEB9"))) {
    report += res;
  }
