...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4178-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4178-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2018/DSA-4178-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4178");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libreoffice");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libreoffice' package(s) announced via the DSA-4178-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"uno-libs3", ver:"4.3.3-2+deb8u11", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"uno-libs3-dbg", ver:"4.3.3-2+deb8u11", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ure", ver:"4.3.3-2+deb8u11", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ure-dbg", ver:"4.3.3-2+deb8u11", rls:"DEB8"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"uno-libs3", ver:"5.2.7-1+deb9u4", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ure", ver:"5.2.7-1+deb9u4", rls:"DEB9"))) {
    report += res;
  }
