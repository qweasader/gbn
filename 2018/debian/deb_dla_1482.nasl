...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1482-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1482-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1482-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libx11' package(s) announced via the DLA-1482-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libx11-6-udeb", ver:"2:1.6.2-3+deb8u2", rls:"DEB8"))) {
    report += res;
  }
