...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-03-25 03:29:01 +0000 (Sun, 25 Mar 2018)");

  script_name("Debian: Security Advisory (DLA-1386-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1386-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1386-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ming' package(s) announced via the DLA-1386-1 advisory.");
