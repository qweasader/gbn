...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-02-27 19:21:48 +0000 (Tue, 27 Feb 2018)");

  script_name("Debian: Security Advisory (DLA-1282-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1282-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1282-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'graphicsmagick' package(s) announced via the DLA-1282-1 advisory.");
