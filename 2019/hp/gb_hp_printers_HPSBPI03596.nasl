...
if (description)
{
  ...
  script_tag(name:"summary", value:"Multiple HP printers are prone to a remote code execution (RCE)
  vulnerability in the solution application signature checking.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"HP LaserJet Enterprise, HP PageWide Enterprise, HP LaserJet
  Managed, and HP OfficeJet Enterprise Printers.");
