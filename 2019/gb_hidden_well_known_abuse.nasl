...
if(description)
{
  ...
  for various hacking and phishing campaigns.");
...
if( VULN ) {
  report = 'The following IOCs were identified. NOTE: Please take care when opening the files as these might contain malicious code:\n' + report;
