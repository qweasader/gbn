...
if(description)
{
  ...
  script_name("Tenable Nessus <= 8.7.0 DoS Vulnerability (TNS-2019-06)");
  ...
  vulnerability due to improper validation of specific imported scan types.");
  ...
  script_tag(name:"solution", value:"Update to version 8.7.0 or later.");
