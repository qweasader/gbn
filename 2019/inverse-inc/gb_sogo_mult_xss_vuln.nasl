...
if (description)
{
  ...
  script_tag(name:"summary", value:"Multiple cross-site scripting (XSS) vulnerabilities in the View
  Raw Source page in the Web Calendar in SOGo allow remote attackers to inject arbitrary web script
  or HTML via the Description, Location, URL or Title field.");
