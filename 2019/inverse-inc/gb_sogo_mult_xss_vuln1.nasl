...
if (description)
{
  ...
  script_tag(name:"summary", value:"Multiple cross-site scripting (XSS) vulnerabilities in the Web
  Calendar in SOGo allow remote attackers to inject arbitrary web script or HTML via the title of
  an appointment or contact fields.");
