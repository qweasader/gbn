...
if(description)
{
  ...
  script_name("TP-Link Megapixel Surveillance Camera Default Credentials (HTTP)");
  script_dependencies("gb_tp_link_wireless_megapixel_surveillance_camera_detect.nasl", "gb_default_credentials_options.nasl");
  ...
  script_tag(name:"summary", value:"The remote installation of TP-Link's Megapixel surveillance camera software is using known default credentials.");
