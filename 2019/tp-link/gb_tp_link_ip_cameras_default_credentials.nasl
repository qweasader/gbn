...
if(description)
{
  ...
  script_name("TP-Link IP Cameras Default Credentials (HTTP)");
  ...
  script_tag(name:"summary", value:"The remote installation of TP-Link's IP camera software is using known default credentials.");
