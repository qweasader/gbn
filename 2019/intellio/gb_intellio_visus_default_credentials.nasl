...
if(description)
{
  ...
  script_name("Intellio Visus Default Credentials (HTTP)");
  ...
  script_tag(name:"summary", value:"The remote installation of Intellio Visus is using known default credentials.");
