...
if(description)
{
  ...
  script_name("Pearl IP Cameras Default Credentials (HTTP)");
  ...
  script_tag(name:"summary", value:"The remote installation of Pearl's IP camera software is using known default credentials.");
