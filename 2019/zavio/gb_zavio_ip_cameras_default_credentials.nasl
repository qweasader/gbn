...
if(description)
{
  ...
  script_name("Zavio IP Cameras Default Credentials (HTTP)");
  script_dependencies("gb_zavio_ip_cameras_detect.nasl", "gb_default_credentials_options.nasl");
  ...
  script_tag(name:"summary", value:"The remote installation of Zavio's IP camera software is using known default credentials.");
