...
if (description)
{
  ...
  script_name("Apache ZooKeeper < 3.4.10, 3.5.0-alpha - 3.5.3-beta Quorum Peer Mutual Authentication Vulnerability");
  ...
  script_tag(name:"insight", value:"No authentication/authorization is enforced when a server
  attempts to join a quorum. As a result an arbitrary end point could join the cluster and begin
  propagating counterfeit changes to the leader.");

  script_tag(name:"affected", value:"Apache ZooKeeper prior to version 3.4.10 and version
  3.5.0-alpha through 3.5.3-beta.");
