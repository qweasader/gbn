...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-03-27 19:10:44 +0000 (Wed, 27 Mar 2019)");

  script_name("Debian: Security Advisory (DSA-4414-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4414-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4414-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4414");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libapache2-mod-auth-mellon");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libapache2-mod-auth-mellon' package(s) announced via the DSA-4414-1 advisory.");
