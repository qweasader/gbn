...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-08-19 16:20:48 +0000 (Mon, 19 Aug 2019)");

  script_name("Debian: Security Advisory (DSA-4498-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4498-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4498-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4498");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/python-django");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DSA-4498-1 advisory.");
