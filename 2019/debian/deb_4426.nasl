...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-08 17:14:59 +0000 (Mon, 08 Apr 2019)");

  script_name("Debian: Security Advisory (DSA-4426-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4426-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4426-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tryton-server' package(s) announced via the DSA-4426-1 advisory.");
