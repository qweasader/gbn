...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2042-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2042-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-2042-1");
  script_xref(name:"URL", value:"https://www.djangoproject.com/weblog/2019/dec/18/security-releases/");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DLA-2042-1 advisory.");
