...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-05-09 19:20:31 +0000 (Thu, 09 May 2019)");

  script_name("Debian: Security Advisory (DSA-4445-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4445-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4445-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'drupal7' package(s) announced via the DSA-4445-1 advisory.");
