...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-05-20 16:04:18 +0000 (Mon, 20 May 2019)");

  script_name("Debian: Security Advisory (DLA-1792-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1792-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1792-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ghostscript' package(s) announced via the DLA-1792-1 advisory.");
...
For Debian 8 Jessie, this problem has been fixed in version 9.26a~dfsg-0+deb8u3.
