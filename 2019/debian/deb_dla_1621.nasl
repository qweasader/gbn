...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-31 18:17:36 +0000 (Thu, 31 Jan 2019)");

  script_name("Debian: Security Advisory (DLA-1621-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1621-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2018/DLA-1621-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'c3p0' package(s) announced via the DLA-1621-1 advisory.");
