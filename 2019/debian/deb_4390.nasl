...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-02-21 19:56:21 +0000 (Thu, 21 Feb 2019)");

  script_name("Debian: Security Advisory (DSA-4390-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4390-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4390-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4390");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/flatpak");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'flatpak' package(s) announced via the DSA-4390-1 advisory.");
