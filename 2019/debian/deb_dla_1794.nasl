...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-10 18:04:36 +0000 (Wed, 10 Apr 2019)");

  script_name("Debian: Security Advisory (DLA-1794-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1794-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1794-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libspring-security-2.0-java' package(s) announced via the DLA-1794-1 advisory.");
