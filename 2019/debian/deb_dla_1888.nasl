...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-07-08 19:15:43 +0000 (Mon, 08 Jul 2019)");

  script_name("Debian: Security Advisory (DLA-1888-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1888-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1888-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imagemagick' package(s) announced via the DLA-1888-1 advisory.");
