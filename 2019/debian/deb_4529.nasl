...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4529-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4529-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4529-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php7.0' package(s) announced via the DSA-4529-1 advisory.");
