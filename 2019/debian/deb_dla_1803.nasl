...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-05-06 16:49:04 +0000 (Mon, 06 May 2019)");

  script_name("Debian: Security Advisory (DLA-1803-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1803-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1803-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php5' package(s) announced via the DLA-1803-1 advisory.");
