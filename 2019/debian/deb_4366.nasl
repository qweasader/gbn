...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-12-27 17:00:11 +0000 (Thu, 27 Dec 2018)");

  script_name("Debian: Security Advisory (DSA-4366-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4366-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4366-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4366");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/vlc");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'vlc' package(s) announced via the DSA-4366-1 advisory.");
