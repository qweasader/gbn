...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4528-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4528-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4528-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4528");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/bird");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'bird' package(s) announced via the DSA-4528-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bird", ver:"1.6.3-2+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"bird-bgp", ver:"1.6.3-2+deb9u1", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"bird-doc", ver:"1.6.3-2+deb9u1", rls:"DEB9"))) {
    report += res;
  }
