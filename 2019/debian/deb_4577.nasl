...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-12-16 17:02:25 +0000 (Mon, 16 Dec 2019)");

  script_name("Debian: Security Advisory (DSA-4577-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4577-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4577-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4577");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/haproxy");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'haproxy' package(s) announced via the DSA-4577-1 advisory.");
