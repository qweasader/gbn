...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-10-22 16:16:16 +0000 (Tue, 22 Oct 2019)");

  script_name("Debian: Security Advisory (DSA-4559-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4559-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4559-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4559");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/proftpd-dfsg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'proftpd-dfsg' package(s) announced via the DSA-4559-1 advisory.");
