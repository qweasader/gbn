...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-07-30 13:07:40 +0000 (Tue, 30 Jul 2019)");

  script_name("Debian: Security Advisory (DSA-4488-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4488-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4488-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4488");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'exim4' package(s) announced via the DSA-4488-1 advisory.");
