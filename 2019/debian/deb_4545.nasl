...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-09-26 16:16:50 +0000 (Thu, 26 Sep 2019)");

  script_name("Debian: Security Advisory (DSA-4545-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4545-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4545-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4545");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/mediawiki");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DSA-4545-1 advisory.");
