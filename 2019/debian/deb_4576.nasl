...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-05-06 17:16:16 +0000 (Mon, 06 May 2019)");

  script_name("Debian: Security Advisory (DSA-4576-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4576-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4576-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'php-imagick' package(s) announced via the DSA-4576-1 advisory.");
