...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-10-04 19:07:36 +0000 (Fri, 04 Oct 2019)");

  script_name("Debian: Security Advisory (DSA-4534-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4534-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4534-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4534");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/golang-1.11");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'golang-1.11' package(s) announced via the DSA-4534-1 advisory.");
