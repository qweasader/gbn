...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-06-04 17:47:05 +0000 (Tue, 04 Jun 2019)");

  script_name("Debian: Security Advisory (DSA-4502-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4502-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4502-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4502");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ffmpeg");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ffmpeg' package(s) announced via the DSA-4502-1 advisory.");
