...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4501-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4501-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4501-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4501");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/libreoffice");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libreoffice' package(s) announced via the DSA-4501-1 advisory.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"uno-libs3", ver:"6.1.5-3+deb10u3", rls:"DEB10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ure", ver:"6.1.5-3+deb10u3", rls:"DEB10"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"uno-libs3", ver:"5.2.7-1+deb9u10", rls:"DEB9"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ure", ver:"5.2.7-1+deb9u10", rls:"DEB9"))) {
    report += res;
  }
