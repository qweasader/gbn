...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-03-27 16:22:11 +0000 (Wed, 27 Mar 2019)");

  script_name("Debian: Security Advisory (DLA-1671-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1671-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1671-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'coturn' package(s) announced via the DLA-1671-1 advisory.");
