...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-06-16 18:25:27 +0000 (Tue, 16 Jun 2020)");

  script_name("Debian: Security Advisory (DLA-1846-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1846-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1846-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'unzip' package(s) announced via the DLA-1846-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"David Fifield discovered a way to construct non-recursive zip bombs that achieve a high compression ratio by overlapping files inside the zip container. However the output size increases quadratically in the input size, reaching a compression ratio of over 28 million (10 MB -> 281 TB) at the limits of the zip format which can cause a denial-of-service. Mark Adler provided a patch to detect and reject such zip files for the unzip program.

For Debian 8 Jessie, this problem has been fixed in version 6.0-16+deb8u4.
