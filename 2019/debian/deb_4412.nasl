...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-03-27 16:38:19 +0000 (Wed, 27 Mar 2019)");

  script_name("Debian: Security Advisory (DSA-4412-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4412-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4412-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4412");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'drupal7' package(s) announced via the DSA-4412-1 advisory.");
