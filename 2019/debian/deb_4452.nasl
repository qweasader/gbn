...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-01-10 13:50:29 +0000 (Thu, 10 Jan 2019)");

  script_name("Debian: Security Advisory (DSA-4452-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4452-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4452-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4452");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/jackson-databind");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'jackson-databind' package(s) announced via the DSA-4452-1 advisory.");
