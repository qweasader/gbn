...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4496-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4496-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4496-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4496");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/pango1.0");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'pango1.0' package(s) announced via the DSA-4496-1 advisory.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libpango1.0-udeb", ver:"1.42.4-7~deb10u1", rls:"DEB10"))) {
    report += res;
  }
