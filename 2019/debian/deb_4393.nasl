...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4393-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4393-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4393-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4393");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/systemd");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'systemd' package(s) announced via the DSA-4393-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libudev1-udeb", ver:"232-25+deb9u9", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"udev-udeb", ver:"232-25+deb9u9", rls:"DEB9"))) {
    report += res;
  }
