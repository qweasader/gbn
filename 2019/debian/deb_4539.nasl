...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4539-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4539-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4539-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4539");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/openssl");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openssl' package(s) announced via the DSA-4539-1 advisory.");
...
For the detailed security status of openssl please refer to its security tracker page at: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on Debian 9, Debian 10.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libcrypto1.1-udeb", ver:"1.1.1d-0+deb10u1", rls:"DEB10"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl1.1-udeb", ver:"1.1.1d-0+deb10u1", rls:"DEB10"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libcrypto1.1-udeb", ver:"1.1.0l-1~deb9u1", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl1.1-udeb", ver:"1.1.0l-1~deb9u1", rls:"DEB9"))) {
    report += res;
  }
