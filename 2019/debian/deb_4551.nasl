...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-10-30 18:30:23 +0000 (Wed, 30 Oct 2019)");

  script_name("Debian: Security Advisory (DSA-4551-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4551-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4551-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4551");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/golang-1.11");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'golang-1.11' package(s) announced via the DSA-4551-1 advisory.");
