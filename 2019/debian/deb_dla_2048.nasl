...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-03 17:30:09 +0000 (Fri, 03 Jan 2020)");

  script_name("Debian: Security Advisory (DLA-2048-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2048-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-2048-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libxml2' package(s) announced via the DLA-2048-1 advisory.");
