...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1789-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1789-2");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'intel-microcode' package(s) announced via the DLA-1789-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"This update ships updated CPU microcode for most types of Intel CPUs. It provides microcode support for the kernel to implement mitigations for the MSBDS, MFBDS, MLPDS and MDSUM hardware vulnerabilities.
