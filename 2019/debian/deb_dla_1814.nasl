...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-06-03 18:56:30 +0000 (Mon, 03 Jun 2019)");

  script_name("Debian: Security Advisory (DLA-1814-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1814-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1814-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'python-django' package(s) announced via the DLA-1814-1 advisory.");
