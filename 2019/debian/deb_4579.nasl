...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2020-01-13 16:19:02 +0000 (Mon, 13 Jan 2020)");

  script_name("Debian: Security Advisory (DSA-4579-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4579-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4579-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4579");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/nss");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'nss' package(s) announced via the DSA-4579-1 advisory.");
