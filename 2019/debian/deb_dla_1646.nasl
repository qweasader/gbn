...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2018-11-28 19:40:56 +0000 (Wed, 28 Nov 2018)");

  script_name("Debian: Security Advisory (DLA-1646-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1646-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1646-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'qemu' package(s) announced via the DLA-1646-1 advisory.");
