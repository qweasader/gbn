...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1886-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1886-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1886-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'openjdk-7' package(s) announced via the DLA-1886-1 advisory.");
...
For Debian 8 Jessie, these problems have been fixed in version 7u231-2.6.19-1~deb8u1.
