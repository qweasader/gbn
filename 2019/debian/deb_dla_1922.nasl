...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1922-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1922-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1922-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wpa' package(s) announced via the DLA-1922-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"hostapd", ver:"1:2.3-1+deb8u9", rls:"DEB8"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"wpasupplicant-udeb", ver:"2.3-1+deb8u9", rls:"DEB8"))) {
    report += res;
  }
