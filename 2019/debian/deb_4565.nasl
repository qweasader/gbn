...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-12-31 18:05:24 +0000 (Tue, 31 Dec 2019)");

  script_name("Debian: Security Advisory (DSA-4565-2)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4565-2");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4565-2");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4565");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/intel-microcode");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'intel-microcode' package(s) announced via the DSA-4565-2 advisory.");
...
if(release == "DEB10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20191115.2~deb10u1", rls:"DEB10"))) {
    report += res;
  }
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"intel-microcode", ver:"3.20191115.2~deb9u1", rls:"DEB9"))) {
    report += res;
  }
