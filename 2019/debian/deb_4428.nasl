...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-11 02:48:01 +0000 (Thu, 11 Apr 2019)");

  script_name("Debian: Security Advisory (DSA-4428-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4428-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4428-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4428");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/systemd");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'systemd' package(s) announced via the DSA-4428-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libudev1-udeb", ver:"232-25+deb9u11", rls:"DEB9"))) {
    report += res;
  }
  ...
  if(!isnull(res = isdpkgvuln(pkg:"udev-udeb", ver:"232-25+deb9u11", rls:"DEB9"))) {
    report += res;
  }
