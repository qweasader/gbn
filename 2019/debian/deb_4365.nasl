...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-02-19 18:58:41 +0000 (Tue, 19 Feb 2019)");

  script_name("Debian: Security Advisory (DSA-4365-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4365-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4365-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4365");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/tmpreaper");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tmpreaper' package(s) announced via the DSA-4365-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tmpreaper", ver:"1.6.13+nmu1+deb9u1+b1", rls:"DEB9"))) {
    report += res;
  }
