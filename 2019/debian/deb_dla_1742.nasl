...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-03-15 14:48:21 +0000 (Fri, 15 Mar 2019)");

  script_name("Debian: Security Advisory (DLA-1742-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1742-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1742-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'wordpress' package(s) announced via the DLA-1742-1 advisory.");
