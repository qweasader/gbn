...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-2003-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2003-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-2003-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'isc-dhcp' package(s) announced via the DLA-2003-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"isc-dhcp-client-udeb", ver:"4.3.1-6+deb8u4", rls:"DEB8"))) {
    report += res;
  }
