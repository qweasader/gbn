...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4413-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4413-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4413-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4413");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/ntfs-3g");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ntfs-3g' package(s) announced via the DSA-4413-1 advisory.");
...
if(release == "DEB9") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ntfs-3g-udeb", ver:"1:2016.2.22AR.1+dfsg-1+deb9u1", rls:"DEB9"))) {
    report += res;
  }
