...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4457-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4457-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4457-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4457");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/evolution");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'evolution' package(s) announced via the DSA-4457-1 advisory.");
