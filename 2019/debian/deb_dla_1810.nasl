...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-05-30 14:14:36 +0000 (Thu, 30 May 2019)");

  script_name("Debian: Security Advisory (DLA-1810-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1810-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1810-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'tomcat7' package(s) announced via the DLA-1810-1 advisory.");
