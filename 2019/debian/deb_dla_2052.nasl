...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2017-01-17 18:34:55 +0000 (Tue, 17 Jan 2017)");

  script_name("Debian: Security Advisory (DLA-2052-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-2052-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-2052-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libbsd' package(s) announced via the DLA-2052-1 advisory.");
