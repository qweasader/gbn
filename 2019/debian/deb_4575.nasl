...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-11-27 15:30:20 +0000 (Wed, 27 Nov 2019)");

  script_name("Debian: Security Advisory (DSA-4575-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4575-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4575-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4575");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/chromium");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'chromium' package(s) announced via the DSA-4575-1 advisory.");
