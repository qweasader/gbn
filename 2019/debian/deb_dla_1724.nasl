...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1724-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1724-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1724-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'ntfs-3g' package(s) announced via the DLA-1724-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ntfs-3g-udeb", ver:"1:2014.2.15AR.2-1+deb8u4", rls:"DEB8"))) {
    report += res;
  }
