...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-07-24 19:34:16 +0000 (Wed, 24 Jul 2019)");

  script_name("Debian: Security Advisory (DLA-1894-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1894-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1894-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libapache2-mod-auth-openidc' package(s) announced via the DLA-1894-1 advisory.");
