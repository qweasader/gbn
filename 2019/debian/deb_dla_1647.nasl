...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1647-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1647-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1647-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'apache2' package(s) announced via the DLA-1647-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-macro", ver:"1:2.4.10-10+deb8u13", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libapache2-mod-proxy-html", ver:"1:2.4.10-10+deb8u13", rls:"DEB8"))) {
    report += res;
  }
