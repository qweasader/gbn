...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-05-03 14:49:34 +0000 (Tue, 03 May 2022)");

  script_name("Debian: Security Advisory (DLA-1721-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1721-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1721-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'otrs2' package(s) announced via the DLA-1721-1 advisory.");
