...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DSA-4409-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4409-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4409-1");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/DSA-4409");
  script_xref(name:"URL", value:"https://security-tracker.debian.org/tracker/neutron");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'neutron' package(s) announced via the DSA-4409-1 advisory.");
