...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1947-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1947-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1947-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libreoffice' package(s) announced via the DLA-1947-1 advisory.");
...
if(release == "DEB8") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"uno-libs3", ver:"4.3.3-2+deb8u13", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"uno-libs3-dbg", ver:"4.3.3-2+deb8u13", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ure", ver:"4.3.3-2+deb8u13", rls:"DEB8"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"ure-dbg", ver:"4.3.3-2+deb8u13", rls:"DEB8"))) {
    report += res;
  }
