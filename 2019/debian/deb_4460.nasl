...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-07-17 15:25:56 +0000 (Wed, 17 Jul 2019)");

  script_name("Debian: Security Advisory (DSA-4460-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-4460-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2019/DSA-4460-1");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'mediawiki' package(s) announced via the DSA-4460-1 advisory.");
