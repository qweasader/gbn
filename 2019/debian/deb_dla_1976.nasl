...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-09-09 17:43:19 +0000 (Mon, 09 Sep 2019)");

  script_name("Debian: Security Advisory (DLA-1976-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1976-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1976-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'imapfilter' package(s) announced via the DLA-1976-1 advisory.");
