...
if(description)
{
  ...
  script_name("Debian: Security Advisory (DLA-1753-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1753-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1753-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'proftpd-dfsg' package(s) announced via the DLA-1753-1 advisory.");
...
For Debian 8 Jessie, this problem has been fixed in version 1.3.5e-0+deb8u1.
