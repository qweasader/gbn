...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2022-04-06 18:27:14 +0000 (Wed, 06 Apr 2022)");

  script_name("Debian: Security Advisory (DLA-1702-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1702-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1702-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'advancecomp' package(s) announced via the DLA-1702-1 advisory.");
