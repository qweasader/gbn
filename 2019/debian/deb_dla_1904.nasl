...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-08-30 15:49:53 +0000 (Fri, 30 Aug 2019)");

  script_name("Debian: Security Advisory (DLA-1904-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DLA-1904-1");
  script_xref(name:"URL", value:"https://www.debian.org/lts/security/2019/DLA-1904-1");
  script_xref(name:"URL", value:"https://wiki.debian.org/LTS");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'libextractor' package(s) announced via the DLA-1904-1 advisory.");
