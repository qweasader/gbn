...
if(description)
{
  ...
  script_name("Grafana 4.1.0 < 4.6.5, 5.0 < 5.3.3 Information Disclosure Vulnerability");
  ...
  script_tag(name:"insight", value:"The vulnerability allows any users with Editor or Admin
  permissions in Grafana to read any file that the Grafana process can read from the filesystem.");

  script_tag(name:"impact", value:"Successful exploitation of these vulnerabilities could lead to
  disclosure of sensitive information or addition or modification of data.");
  ...
  script_xref(name:"URL", value:"http://www.securityfocus.com/bid/105994");
