...
if(description)
{
  ...
  script_name("Samsung iPolis Default Credentials (HTTP)");
  ...
  script_tag(name:"summary", value:"The remote installation of Samsung iPolis is using known default credentials.");
