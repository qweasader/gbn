...
if(description)
{
  ...
  script_name("Vivotek NVR Default Credentials (HTTP)");
  ...
  script_tag(name:"summary", value:"The remote installation of Vivotek NVR is using known default
  credentials for its web interface.");
