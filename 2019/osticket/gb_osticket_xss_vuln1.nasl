...
if (description)
{
  ...
  script_tag(name:"insight", value:"Unauthenticated Stored XSS allows a remote attacker to gain
  admin privileges by injecting arbitrary web script or HTML via arbitrary file extension while
