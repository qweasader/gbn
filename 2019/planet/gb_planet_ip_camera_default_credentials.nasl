...
if(description)
{
  ...
  script_name("Planet IP Camera Default Credentials (HTTP)");
  script_dependencies("gb_planet_ip_camera_detect.nasl", "gb_default_credentials_options.nasl");
  ...
  script_tag(name:"summary", value:"The remote installation of Planet's IP camera software is using known default credentials.");
