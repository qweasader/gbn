...
if(description)
{
  ...
  script_tag(name:"impact", value:"Successful exploitation will allow a remote attacker to elevate
  privileges, execute arbitrary code, read unauthorized information, bypass security restrictions
...
if(!fileVer = fetch_file_version(sysPath:sysPath, file_name:"inetcomm.dll"))
  exit(0);
