...
if(description)
{
  ...
  script_name("Microsoft Visual Studio Code < 1.32 RCE Vulnerability");

  script_tag(name:"summary", value:"This host is missing an important security update according to
  Microsoft Security Update March 2019.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The flaw exists due to an error in Visual Studio Code when it
  process environment variables after opening a project.");
