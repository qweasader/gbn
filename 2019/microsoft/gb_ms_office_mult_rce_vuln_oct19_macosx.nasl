...
if(description)
{
  ...
  script_name("Microsoft Office Multiple Remote Code Execution Vulnerabilities (Oct 2019) - Mac OS X");

  script_tag(name:"summary", value:"This host is missing a critical security
  update for Microsoft Office 2016 on Mac OS X according to
