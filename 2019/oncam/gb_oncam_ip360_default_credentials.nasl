...
if(description)
{
  ...
  script_name("Oncam IP 360 Default Credentials (HTTP)");
  ...
  script_tag(name:"summary", value:"The remote installation of Oncam IP 360 is using known default credentials.");
