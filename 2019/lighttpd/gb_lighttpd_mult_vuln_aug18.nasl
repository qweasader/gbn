...
if(description)
{
  ...
  script_tag(name:"summary", value:"Lighttpd is prone to multiple path traversal and use-after-free vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Successful exploitation might allow a remote attacker to execute
  arbitrary code on affected system or conduct path traversal attacks to get unauthorized access to
  files on the hosts filesystem.");

  script_tag(name:"affected", value:"Lighttpd versions before 1.4.50.");

  script_tag(name:"solution", value:"Update to version 1.4.50 or later.");
