...
if(description)
{
  ...
  script_tag(name:"insight", value:"The vulnerability allows remote authenticated attackers to
  inject arbitrary web script and HTML via the application 'Portal'.");
