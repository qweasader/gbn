...
if(description)
{
  ...
  script_name("Q-See IP Camera Default Credentials (HTTP)");
  script_dependencies("gb_qsee_ip_camera_http_detect.nasl", "gb_default_credentials_options.nasl");
  script_require_ports("Services/www", 8080);
  script_mandatory_keys("qsee/ip_camera/http/detected");
  ...
  script_tag(name:"summary", value:"The remote installation of Q-See's IP camera software is using
  known default credentials.");

  script_tag(name:"impact", value:"This issue may be exploited by a remote attacker to gain access
  to sensitive information or modify system configuration. The attacker would also be able to patch
  a custom firmware to further compromise the system.");

  script_tag(name:"insight", value:"The installation of Q-See's IP camera software is lacking a
  ...
  script_tag(name:"vuldetect", value:"Checks if a successful login to Q-See's IP camera software is
  possible.");

  script_tag(name:"solution", value:"Change the passwords for user and admin access or enable
  password protection.");
