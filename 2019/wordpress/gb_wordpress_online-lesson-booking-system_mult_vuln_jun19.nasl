...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Online Lesson Booking' is prone to multiple
  vulnerabilities.");
  ...
  - CVE-2019-5972: An arbitrary script may be executed on the web browser of the user with the
  administrative privilege.

  - CVE-2019-5973: If a user with the administrative privilege views a malicious page while logged in,
...
CPE = "cpe:/a:sukimalab:online_lesson_booking";
