...
if(description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'WP Editor' is prone to multiple
  vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"There is a CSRF vulnerability and an incorrect permissions
  vulnerability.");

  script_tag(name:"impact", value:"Successful exploitation would allow an attacker to perform actions
  in the context of another user or perform actions he would normally not be allowed to.");
...
CPE = "cpe:/a:wp_editor_project:wp_editor";
