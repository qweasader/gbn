...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'WP Google Maps' is prone to an unauthenticated SQL injection
  vulnerability.");
...
if (res =~ "^HTTP/1\.[01] 200" && marker >< res) {
  ...
  report += '\nIt was possible to inject the function user() in the SQL statement.\n\nResponse:\n\n' +
            res;
