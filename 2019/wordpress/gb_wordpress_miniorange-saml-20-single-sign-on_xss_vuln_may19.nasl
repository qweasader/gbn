...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'miniOrange SAML SP Single Sign On' is prone
  ...
  script_tag(name:"affected", value:"WordPress miniOrange SAML SP Single Sign On plugin through
  version 4.8.72.");
...
CPE = "cpe:/a:miniorange:saml_sp_single_sign_on";
