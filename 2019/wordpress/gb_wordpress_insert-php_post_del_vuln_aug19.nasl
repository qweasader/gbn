...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Woody Ad Snippets' is prone to a file
  ...
  remote attacker to delete a WordPress post.

  Posts in this context refers not just to blog posts, but to anything stored as a post, which
  includes pages and various data from plugins, like the snippet for this plugin.");
