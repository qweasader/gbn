...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'wpForo Forum' is prone to a privilege
  escalation vulnerability.");

  script_tag(name:"insight", value:"The plugin suffers from a privilege escalation vulnerability,
  whereby any registered forum user can escalate his privilege to become the forum administrator
  without any form of user interaction.");
...
CPE = "cpe:/a:gvectors:wpforo_forum";
