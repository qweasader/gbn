...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2023-03-03 17:32:00 +0000 (Fri, 03 Mar 2023)");
  ...
  script_name("WordPress Photo Gallery Plugin < 1.5.31 SQLi Vulnerability");
  ...
  unauthenticated SQL injection (SQLi) vulnerability in filemanager/model.php.");
