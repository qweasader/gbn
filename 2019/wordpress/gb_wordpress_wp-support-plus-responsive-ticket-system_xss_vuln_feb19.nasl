...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Support Plus Responsive Ticket System' is
  ...
  script_tag(name:"affected", value:"WordPress Support Plus Responsive Ticket System plugin prior to
  version 9.1.2.");
...
CPE = "cpe:/a:wpsupportplus:wp_support_plus_responsive_ticket_system";
