...
if(description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'WP SVG Icons' is prone to a cross-site
  request forgery (CSRF) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability exists because
  wp-admin/admin.php?page=wp-svg-icons-custom-set mishandles Custom Icon uploads.");
...
CPE = "cpe:/a:wp_svg_icons_project:wp_svg_icons";
