...
if (description)
{
  ...
  script_name("WordPress Import users from CSV with meta Plugin < 1.12.1 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Import users from CSV with meta' is prone
  to a cross-site scripting (XSS) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"WordPress Import users from CSV with meta plugin before version
  1.12.1.");
