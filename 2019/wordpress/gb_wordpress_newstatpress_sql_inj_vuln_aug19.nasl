...
if(description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'NewStatPress' is prone to an SQL injection
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Successful exploitation would allow an attacker to read or modify
  data in the database, and maybe even execute code on the target machine.");
...
CPE = "cpe:/a:newstatpress_project:newstatpress";
