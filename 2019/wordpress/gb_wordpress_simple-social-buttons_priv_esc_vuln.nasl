...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Simple Social Buttons' is prone to a
  privilege escalation vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"WordPress Simple Social Buttons plugin version 2.0.4 through
  2.0.21");
...
CPE = "cpe:/a:wpbrigade:simple_social_buttons";
