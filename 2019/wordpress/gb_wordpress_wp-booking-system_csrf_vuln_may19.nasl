...
if (description)
{
  ...
  script_tag(name:"severity_date", value:"2023-02-24 19:32:00 +0000 (Fri, 24 Feb 2023)");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'WP Booking System' is prone to a cross-site
  request forgery (CSRF) vulnerability with the possible result of SQL injection.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Successful exploitation would allow an attacker to craft a
  malicious webpage that once visited by an authenticated administrative user, will trigger the SQL
...
CPE = "cpe:/a:wpbookingsystem:wp_booking_system";
