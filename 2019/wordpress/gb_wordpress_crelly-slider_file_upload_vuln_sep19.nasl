...
if(description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Crelly Slider' is prone to an arbitrary
  file upload vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability is exploitable by uploading a ZIP archive
  containing a PHP file to wp_ajax_crellyslider_importSlider.");
