...
if (description)
{
  ...
  script_name("WordPress Form Maker Plugin < 1.13.3 SQLi Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Form Maker' is prone to an SQL injection
  (SQLi) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"In the Form Maker plugin for WordPress, it is possible to
