...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2021-11-02 14:09:00 +0000 (Tue, 02 Nov 2021)");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Easy Digital Downloads' is prone to a cross-site scripting (XSS) vulnerability.");
