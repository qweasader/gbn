...
if(description)
{
  ...
  script_name("WordPress WP Statistics Plugin < 12.0.8 SQLi Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'WP Statistics' is prone to an SQL injection (SQLi) vulnerability.");
