...
CPE = "cpe:/a:smackcoders:import_all_pages%2c_post_types%2c_products%2c_orders%2c_and_users_as_xml_%26_csv";
...
if(description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Import & Export WordPress Data to CSV' is
  ...
  script_tag(name:"affected", value:"WordPress Import & Export WordPress Data to CSV plugin through
  version 5.6.");
