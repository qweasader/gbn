...
if(description)
{
  ...
  script_name("WordPress Blog2Social Plugin < 5.9.0 XSS Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Blog2Social' is prone to a cross-site
