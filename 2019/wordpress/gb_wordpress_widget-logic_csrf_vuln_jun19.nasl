...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Widget Logic' is prone to a CSRF
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Successful exploitation allows remote attackers to execute PHP
  code via snippets (that are attached to widgets and then evalued to dynamically determine their
  visibility) by crafting a malicious POST request that tricks administrators into adding the code.");
