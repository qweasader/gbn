...
if (description)
{
  ...
  script_name("WordPress Two Factor Authentication Plugin < 1.3.13 CSRF Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Two Factor Authentication' is prone to a
  cross-site request forgery (CSRF) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"affected", value:"WordPress Two Factor Authentication plugin before version
  1.3.13.");
