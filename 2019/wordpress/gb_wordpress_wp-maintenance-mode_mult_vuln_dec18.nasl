...
if (description)
{
  ...
  script_name("WordPress WP Maintenance Mode Plugin < 2.0.7 Multiple Vulnerabilities");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'WP Maintenance Mode' is prone to multiple
  vulnerabilities.");
...
CPE = "cpe:/a:designmodo:wp_maintenance_mode";
