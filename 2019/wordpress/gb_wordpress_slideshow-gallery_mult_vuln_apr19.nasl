...
if (description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Slideshow Gallery' is prone to multiple
  vulnerabilities.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"impact", value:"Successful exploitation would allow an attacker to inject malicious
  content into an affected site or to execute arbitrary code via SQL injection.");
...
CPE = "cpe:/a:tribulant:slideshow_gallery";
