...
if(description)
{
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Simple 301 Redirects' is prone to multiple
  vulnerabilities.");
  ...
  data or inject arbitrary redirect rules.");
...
CPE = "cpe:/a:webcraftic:simple_301_redirects-addon-bulk_uploader";
