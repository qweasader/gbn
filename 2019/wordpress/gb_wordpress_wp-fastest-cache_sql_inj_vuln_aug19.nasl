...
if(description)
{
  ...
  script_name("WordPress WP Fastest Cache Plugin < 0.8.4.9 SQLi Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'WP Fastest Cache' is prone to an SQL
  injection (SQLi) vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"The vulnerability exists in
  wp-admin/admin-ajax.php?action=wpfc_wppolls_ajax_request via the poll_id parameter.");
