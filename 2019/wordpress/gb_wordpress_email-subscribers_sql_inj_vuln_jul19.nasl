...
if (description)
{
  ...
  script_name("WordPress Email Subscribers Plugin < 4.1.8 SQLi Vulnerability");
  ...
  script_tag(name:"affected", value:"WordPress Email Subscribers & Newsletters plugin before version
  4.1.8.");
