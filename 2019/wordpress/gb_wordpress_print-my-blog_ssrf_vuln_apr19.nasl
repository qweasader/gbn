...
if (description)
{
  ...
  script_name("WordPress Print My Blog Plugin < 1.6.6 SSRF Vulnerability");
  ...
  script_tag(name:"summary", value:"The WordPress plugin 'Print My Blog' is prone to an SSRF
  vulnerability.");
  ...
  script_tag(name:"affected", value:"WordPress Print My Blog plugin prior to version 1.6.6.");
  ...
  script_xref(name:"URL", value:"https://wpscan.com/vulnerability/9263");

  exit(0);
}

CPE = "cpe:/a:print_my_blog_project:print_my_blog";
...
if( version_is_less( version: version, test_version: "1.6.6" ) ) {
  report = report_fixed_ver( installed_version: version, fixed_version: "1.6.6", install_path: location );
