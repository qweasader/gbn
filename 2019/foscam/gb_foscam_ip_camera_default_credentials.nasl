...
if(description)
{
  ...
  script_name("Foscam IP Camera Default Credentials (HTTP)");
  script_dependencies("gb_foscam_ip_camera_detect.nasl", "gb_default_credentials_options.nasl");
  ...
  script_tag(name:"summary", value:"The remote installation of Foscam's IP camera software is using known default credentials.");
