...
if (description)
{
  ...
  script_name("Roundcube Webmail <= 0.5.4 DoS Vulnerability");
  ...
  script_tag(name:"summary", value:"Roundcube Webmail is prone to a denial of service (DoS)
  vulnerability.");
...
if (version_is_less_equal(version: version, test_version: "0.5.4")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "0.6", install_path: location);
