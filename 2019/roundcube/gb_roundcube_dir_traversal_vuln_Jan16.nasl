...
if (description)
{
  ...
  script_name("Roundcube Webmail < 1.0.6, 1.1.x < 1.1.2 Directory Traversal Vulnerability");
  ...
  script_tag(name:"summary", value:"Roundcube Webmail is prone to a directory traversal
  vulnerability.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"This absolute path traversal vulnerability in
  program/steps/addressbook/photo.inc allows remote authenticated users to read arbitrary files via
  a full pathname in the _alt parameter, related to contact photo handling.");
