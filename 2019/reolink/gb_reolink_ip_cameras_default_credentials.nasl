...
if(description)
{
  ...
  script_name("Reolink IP Cameras Default Credentials (HTTP)");
  ...
  script_tag(name:"summary", value:"The remote installation of Reolink's IP camera software is using known default credentials.");
