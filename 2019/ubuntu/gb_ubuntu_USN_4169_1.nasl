...
if(description)
{
  ...
  script_mandatory_keys("ssh/login/ubuntu_linux", "ssh/login/packages", re:"ssh/login/release=UBUNTU(14\.04\ LTS|16\.04\ LTS|18\.04\ LTS|19\.04)");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libarchive13", ver:"3.1.2-7ubuntu2.8+esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
