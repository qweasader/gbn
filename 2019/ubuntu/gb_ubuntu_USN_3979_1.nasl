...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2023-01-19 16:12:00 +0000 (Thu, 19 Jan 2023)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-azure, linux-gcp, linux-kvm, linux-raspi2' package(s) announced via the USN-3979-1 advisory.");
...
Marc Orr discovered that the KVM hypervisor ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux, linux-aws, linux-azure, linux-gcp, linux-kvm, linux-raspi2' package(s) on Ubuntu 19.04.");
