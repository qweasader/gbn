...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-gcp, linux-kvm, linux-oem, linux-oracle, linux-raspi2' package(s) announced via the USN-3931-1 advisory.");
