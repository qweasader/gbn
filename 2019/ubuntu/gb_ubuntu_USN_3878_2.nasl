...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-3878-2 advisory.");
...
(CVE-2018-19854)");
  ...
  script_tag(name:"affected", value:"'linux-azure' package(s) on Ubuntu 18.10.");
...
if(release == "UBUNTU18.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.18.0-1008-azure", ver:"4.18.0-1008.8", rls:"UBUNTU18.10"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"4.18.0.1008.9", rls:"UBUNTU18.10"))) {
    report += res;
  }
