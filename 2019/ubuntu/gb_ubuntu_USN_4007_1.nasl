...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-12 00:29:00 +0000 (Fri, 12 Apr 2019)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-aws, linux-gcp, linux-kvm, linux-oem, linux-oracle, linux-raspi2, linux-snapdragon' package(s) announced via the USN-4007-1 advisory.");
