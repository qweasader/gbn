...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-05-02 13:54:30 +0000 (Thu, 02 May 2019)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux, linux-azure, linux-gcp, linux-gke-5.0, linux-hwe, linux-kvm, linux-raspi2, linux-snapdragon' package(s) announced via the USN-4114-1 advisory.");
...
(CVE-2019-3900)");
  ...
  script_tag(name:"affected", value:"'linux, linux-azure, linux-gcp, linux-gke-5.0, linux-hwe, linux-kvm, linux-raspi2, linux-snapdragon' package(s) on Ubuntu 18.04, Ubuntu 19.04.");
