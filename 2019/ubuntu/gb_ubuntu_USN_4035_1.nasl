...
if(description)
{
  ...
  script_tag(name:"severity_date", value:"2019-04-03 11:52:16 +0000 (Wed, 03 Apr 2019)");
  ...
  script_mandatory_keys("ssh/login/ubuntu_linux", "ssh/login/packages", re:"ssh/login/release=UBUNTU(16\.04\ LTS|18\.10|19\.04)");
