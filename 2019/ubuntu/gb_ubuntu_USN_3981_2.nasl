...
if(description)
{
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-gcp, linux-hwe, linux-oracle' package(s) announced via the USN-3981-2 advisory.");
...
not properly limit DMA mappings. A local attacker could use this to cause ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-azure, linux-gcp, linux-hwe, linux-oracle' package(s) on Ubuntu 14.04, Ubuntu 16.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-4.15.0-1045-azure", ver:"4.15.0-1045.49~14.04.1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"4.15.0.1045.32", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
