...
if(release == "UBUNTU12.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cpio", ver:"2.11-7ubuntu3.3", rls:"UBUNTU12.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cpio", ver:"2.11+dfsg-1ubuntu1.2+esm1", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
