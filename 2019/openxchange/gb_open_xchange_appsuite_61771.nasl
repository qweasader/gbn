...
if (description)
{
  ...
  script_name("Open-Xchange (OX) App Suite Information Disclosure Vulnerability (Bug ID 61771)");
  ...
  script_tag(name:"summary", value:"Open-Xchange (OX) App Suite is prone to an information exposure vulnerability.");
  ...
  script_tag(name:"affected", value:"All Open-Xchange (OX) App Suite versions before 7.6.3-rev44, 7.8.3 before rev53, 7.8.4 before rev51, 7.10.0 before rev25 and 7.10.1 before rev7.");
...
if (version_is_less(version: version, test_version: "7.6.3.44")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.6.3.44", install_path: location);
