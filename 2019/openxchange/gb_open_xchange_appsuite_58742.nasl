...
if (description)
{
  ...
  script_name("Open-Xchange (OX) App Suite Multiple Vulnerabilities (58742, 56457)");
  ...
  script_tag(name:"affected", value:"Open-Xchange (OX) App Suite versions 7.8.4 and prior.");
...
if (version_in_range(version: version, test_version: "7.8.4", test_version2: "7.8.4.38")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.8.4.39", install_path: location);
  security_message(port: port, data: report);
  exit(0);
}
