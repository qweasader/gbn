...
if (description)
{
  ...
  script_name("Open-Xchange (OX) App Suite Multiple Vulnerabilities (58226, 58096)");
...
if (version_is_less(version: version, test_version: "7.6.3.33")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.6.3.33", install_path: location);
