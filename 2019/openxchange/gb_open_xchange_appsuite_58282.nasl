...
if (description)
{
  ...
  script_name("Open-Xchange (OX) App Suite Multiple Vulnerabilities (58282, 58256)");
...
if (version_is_less(version: version, test_version: "7.6.3.39")) {
  report = report_fixed_ver(installed_version: version, fixed_version: "7.6.3.39", install_path: location);
