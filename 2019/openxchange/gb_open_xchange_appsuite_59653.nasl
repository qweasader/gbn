...
if (description)
{
  ...
  script_name("Open-Xchange (OX) App Suite XSS Vulnerability (59653)");
...
victim uses 'mouse over' on the attachment.");
  ...
  script_tag(name:"affected", value:"Open-Xchange (OX) App Suite version 7.10.0.");
...
if (version =~ "^7\.10\.0" && version_is_less(version: version, test_version: "7.10.0.13")) {
