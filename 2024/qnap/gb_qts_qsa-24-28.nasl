...
if(description)
{
  ...
  script_name("QNAP QTS Multiple Vulnerabilities (QSA-24-28)");
  ...
  script_tag(name:"solution", value:"Update to version 5.2.0.2782 build 20240601 or later.");
...
if (version =~ "^5\.[12]\.") {
  if (version_is_less(version: version, test_version:"5.2.0.2782")) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "5.2.0.2782", fixed_build: "20240601");
    security_message(port: 0, data: report);
    exit(0);
  }

  if (version_is_equal(version: version, test_version: "5.2.0.2782") &&
     (!build || version_is_less(version: build, test_version: "20240601"))) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "5.2.0.2782", fixed_build: "20240601");
    security_message(port: 0, data: report);
    exit(0);
