...
if(description)
{
  ...
  script_name("QNAP QuTS hero Multiple Vulnerabilities (QSA-24-09)");
  ...
  script_tag(name:"affected", value:"QNAP QuTS hero version h4.5.x, h5.1.x.");

  script_tag(name:"solution", value:"Update to version h4.5.4.2626 build 20231225,
  h5.1.3.2578 build 20231110 or later.");
