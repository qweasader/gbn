...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.153043");
  script_version("2024-09-11T05:05:55+0000");
  script_tag(name:"last_modification", value:"2024-09-11 05:05:55 +0000 (Wed, 11 Sep 2024)");
  script_tag(name:"creation_date", value:"2024-09-10 03:14:38 +0000 (Tue, 10 Sep 2024)");
  ...
  script_name("QNAP QuTS hero curl Vulnerability (QSA-24-27)");
  ...
  script_tag(name:"summary", value:"QNAP QuTS hero is prone to a heap buffer overflow vulnerability
  in curl.");
