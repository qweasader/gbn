...
if(description)
{
  ...
  script_name("QNAP QTS Multiple Vulnerabilities (QSA-24-32)");
  ...
  script_tag(name:"solution", value:"Update to version 4.5.4.2790 build 20240605 or later.");
...
if (version =~ "^4\.5\.") {
  if (version_is_less(version: version, test_version:"4.5.4.2790")) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "4.5.4.2790", fixed_build: "20240605");
    security_message(port: 0, data: report);
    exit(0);
  }

  if (version_is_equal(version: version, test_version: "4.5.4.2790") &&
     (!build || version_is_less(version: build, test_version: "20240605"))) {
    report = report_fixed_ver(installed_version: version, installed_build: build,
                              fixed_version: "4.5.4.2790", fixed_build: "20240605");
    security_message(port: 0, data: report);
    exit(0);
