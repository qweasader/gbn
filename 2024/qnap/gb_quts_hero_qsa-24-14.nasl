...
if(description)
{
  ...
  script_name("QNAP QuTS hero Multiple Vulnerabilities (QSA-24-14)");
  ...
  prior to h5.1.8.2823.");

  script_tag(name:"solution", value:"Update to version h4.5.4.2626 build 20231225, h5.1.8.2823
  build 20240712 or later.");
