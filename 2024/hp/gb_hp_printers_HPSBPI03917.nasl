...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.151893");
  script_version("2024-03-12T05:06:30+0000");
  script_tag(name:"last_modification", value:"2024-03-12 05:06:30 +0000 (Tue, 12 Mar 2024)");
  script_tag(name:"creation_date", value:"2024-03-11 02:47:13 +0000 (Mon, 11 Mar 2024)");
  script_tag(name:"cvss_base", value:"9.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:P/A:P");

  script_cve_id("CVE-2024-0794");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("HP Printer RCE Vulnerability (HPSBPI03917)");
  ...
  vulnerability due to a buffer overflow when rendering fonts embedded in a PDF file.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"solution", value:"See the referenced vendor advisory for a solution.");

  script_xref(name:"URL", value:"https://support.hp.com/us-en/document/ish_10174031-10174074-16/hpsbpi03917");
...
if (cpe =~ "^cpe:/o:hp:laserjet_mfp_m527z?_firmware") {
...
if (cpe =~ "^cpe:/o:hp:laserjet_pro_mfp_430[1-3](dw|fdn|fdw|dwe|fdne|fdwe)_firmware" ||
    cpe =~ "^cpe:/o:hp:laserjet_pro_420[1-3](cdn|dn|dw|dne|dwe)_firmware") {
  if (version_is_less(version: version, test_version: "6.17.2.2-202312091658")) {
    report = report_fixed_ver(installed_version: version, fixed_version: "6.17.2.2-202312091658");
    security_message(port: 0, data: report);
    exit(0);
  }
}
