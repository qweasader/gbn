...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886683");
  ...
  script_name("Fedora: Security Advisory for filezilla (FEDORA-2024-0489e7ba1e)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EI2YYQOBUY3D7LJ2GVLAJNDLPTAK2N2P");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"filezilla", rpm:"filezilla~3.67.0~1.fc38", rls:"FC38"))) {
    report += res;
  }
