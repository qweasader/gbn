...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.100999719854441");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-dca1b54441)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-dca1b54441");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-dca1b54441");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2305324");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl' package(s) announced via the FEDORA-2024-dca1b54441 advisory.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~58.2.fc39", rls:"FC39"))) {
    report += res;
  }
