...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886484");
  ...
  script_name("Fedora: Security Advisory for python-aiohttp (FEDORA-2024-5dc487ee89)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-5dc487ee89");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/X4M5XZZONMS4DAZE3CNDFDRSB6JQCL6Y");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-aiohttp'
  package(s) announced via the FEDORA-2024-5dc487ee89 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-aiohttp", rpm:"python-aiohttp~3.9.3~3.fc38", rls:"FC38"))) {
    report += res;
  }
