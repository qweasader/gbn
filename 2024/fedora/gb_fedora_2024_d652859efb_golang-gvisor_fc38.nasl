...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886485");
  ...
  script_tag(name:"creation_date", value:"2024-05-27 10:41:32 +0000 (Mon, 27 May 2024)");
  script_name("Fedora: Security Advisory for golang-gvisor (FEDORA-2024-d652859efb)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-d652859efb");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/QXOU2JZUBEBP7GBKAYIJRPRBZSJCD7ST");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'golang-gvisor'
  package(s) announced via the FEDORA-2024-d652859efb advisory.");
...
machines.");
  ...
  script_tag(name:"affected", value:"'golang-gvisor' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"golang-gvisor", rpm:"golang-gvisor~20240408.0~1.20240418git9e5a99b.fc38", rls:"FC38"))) {
    report += res;
  }
