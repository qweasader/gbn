...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.1101610061028452");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-1e6d6f8452)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-1e6d6f8452");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-1e6d6f8452");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.9' package(s) announced via the FEDORA-2024-1e6d6f8452 advisory.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.9", rpm:"python3.9~3.9.20~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.9-debuginfo", rpm:"python3.9-debuginfo~3.9.20~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.9-debugsource", rpm:"python3.9-debugsource~3.9.20~1.fc40", rls:"FC40"))) {
    report += res;
  }
