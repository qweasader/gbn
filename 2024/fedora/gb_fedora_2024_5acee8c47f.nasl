...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-5acee8c47f)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-5acee8c47f");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2291363");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the FEDORA-2024-5acee8c47f advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"update to 126.0.6478.55
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~126.0.6478.55~1.fc40", rls:"FC40"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium-common", rpm:"chromium-common~126.0.6478.55~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-headless", rpm:"chromium-headless~126.0.6478.55~1.fc40", rls:"FC40"))) {
    report += res;
  }
