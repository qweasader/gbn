...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-89d685e856)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-89d685e856");
  script_xref(name:"URL", value:"https://wordpress.org/news/2024/06/wordpress-6-5-5/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'wordpress' package(s) announced via the FEDORA-2024-89d685e856 advisory.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wordpress", rpm:"wordpress~6.5.5~1.fc39", rls:"FC39"))) {
    report += res;
  }
