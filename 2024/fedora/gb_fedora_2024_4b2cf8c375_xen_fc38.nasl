...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885712");
  ...
  script_tag(name:"creation_date", value:"2024-02-15 02:03:06 +0000 (Thu, 15 Feb 2024)");
  script_name("Fedora: Security Advisory for xen (FEDORA-2024-4b2cf8c375)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-4b2cf8c375");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/JFVKWYQFRUU3CAS53THTUKXEOUDWI42G");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xen'
  package(s) announced via the FEDORA-2024-4b2cf8c375 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xen", rpm:"xen~4.17.2~6.fc38", rls:"FC38"))) {
    report += res;
  }
