...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-3f9eb3c86c)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-3f9eb3c86c");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'tor' package(s) announced via the FEDORA-2024-3f9eb3c86c advisory.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tor", rpm:"tor~0.4.8.12~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tor-debuginfo", rpm:"tor-debuginfo~0.4.8.12~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"tor-debugsource", rpm:"tor-debugsource~0.4.8.12~2.fc40", rls:"FC40"))) {
    report += res;
  }
