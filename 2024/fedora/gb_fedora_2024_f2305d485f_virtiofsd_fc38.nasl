...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885698");
  ...
  script_tag(name:"creation_date", value:"2024-02-14 02:05:24 +0000 (Wed, 14 Feb 2024)");
  script_name("Fedora: Security Advisory for virtiofsd (FEDORA-2024-f2305d485f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/NBG2YEIGFS6C62G75NCMRUFB665MDO3Q");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"virtiofsd", rpm:"virtiofsd~1.10.1~1.fc38", rls:"FC38"))) {
    report += res;
  }
