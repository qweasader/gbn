...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2023.10010010010119110104");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2023-ddde191e04)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2023-ddde191e04");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2023-ddde191e04");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'pypy3.10' package(s) announced via the FEDORA-2023-ddde191e04 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Automatic update for pypy3.10-7.3.12-1.3.10.fc39.
...
- Explicitly buildrequire OpenSSL 1.1, as Python 3.7 is not ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'pypy3.10' package(s) on Fedora 39.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"pypy3.10", rpm:"pypy3.10~7.3.12~1.3.10.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pypy3.10-debugsource", rpm:"pypy3.10-debugsource~7.3.12~1.3.10.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pypy3.10-devel", rpm:"pypy3.10-devel~7.3.12~1.3.10.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pypy3.10-libs", rpm:"pypy3.10-libs~7.3.12~1.3.10.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pypy3.10-libs-debuginfo", rpm:"pypy3.10-libs-debuginfo~7.3.12~1.3.10.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"pypy3.10-test", rpm:"pypy3.10-test~7.3.12~1.3.10.fc39", rls:"FC39"))) {
    report += res;
  }
