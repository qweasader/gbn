...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-12edb9dec8)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-12edb9dec8");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2275546");
  script_xref(name:"URL", value:"https://bugzilla.redhat.com/show_bug.cgi?id=2275816");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the FEDORA-2024-12edb9dec8 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"update to 124.0.6367.60
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~124.0.6367.60~2.fc39", rls:"FC39"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium-common", rpm:"chromium-common~124.0.6367.60~2.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-headless", rpm:"chromium-headless~124.0.6367.60~2.fc39", rls:"FC39"))) {
    report += res;
  }
