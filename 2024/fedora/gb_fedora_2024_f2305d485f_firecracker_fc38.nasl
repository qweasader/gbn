...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885701");
  ...
  script_tag(name:"creation_date", value:"2024-02-14 02:05:26 +0000 (Wed, 14 Feb 2024)");
  script_name("Fedora: Security Advisory for firecracker (FEDORA-2024-f2305d485f)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/KYYS2WIQXFMAWS5JH67ORNUMC3HUTJDJ");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firecracker", rpm:"firecracker~1.6.0~6.fc38", rls:"FC38"))) {
    report += res;
  }
