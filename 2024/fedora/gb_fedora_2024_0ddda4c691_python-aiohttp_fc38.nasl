...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885677");
  ...
  script_tag(name:"creation_date", value:"2024-02-10 02:03:11 +0000 (Sat, 10 Feb 2024)");
  script_name("Fedora: Security Advisory for python-aiohttp (FEDORA-2024-0ddda4c691)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-0ddda4c691");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ICUOCFGTB25WUT336BZ4UNYLSZOUVKBD");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-aiohttp'
  package(s) announced via the FEDORA-2024-0ddda4c691 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-aiohttp", rpm:"python-aiohttp~3.9.3~1.fc38", rls:"FC38"))) {
    report += res;
  }
