...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-41c1bf8de6)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-41c1bf8de6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xrdp' package(s) announced via the FEDORA-2024-41c1bf8de6 advisory.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"xrdp", rpm:"xrdp~0.10.1~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xrdp-debuginfo", rpm:"xrdp-debuginfo~0.10.1~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xrdp-debugsource", rpm:"xrdp-debugsource~0.10.1~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xrdp-devel", rpm:"xrdp-devel~0.10.1~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"xrdp-selinux", rpm:"xrdp-selinux~0.10.1~1.fc39", rls:"FC39"))) {
    report += res;
  }
