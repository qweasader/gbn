...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.102652468298");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-f652468298)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-f652468298");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f652468298");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.8' package(s) announced via the FEDORA-2024-f652468298 advisory.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.8", rpm:"python3.8~3.8.20~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.8-debuginfo", rpm:"python3.8-debuginfo~3.8.20~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.8-debugsource", rpm:"python3.8-debugsource~3.8.20~1.fc39", rls:"FC39"))) {
    report += res;
  }
