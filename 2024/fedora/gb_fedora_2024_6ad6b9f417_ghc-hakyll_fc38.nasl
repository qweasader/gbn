...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886392");
  ...
  script_name("Fedora: Security Advisory for ghc-hakyll (FEDORA-2024-6ad6b9f417)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/I2HTSS25CHGNTSWNIVZPCEOLYLSH4YTW");
...
as markdown or RST.");
  ...
  script_tag(name:"affected", value:"'ghc-hakyll' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghc-hakyll", rpm:"ghc-hakyll~4.16.2.0~1.fc38", rls:"FC38"))) {
    report += res;
  }
