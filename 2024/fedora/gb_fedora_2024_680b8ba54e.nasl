...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-680b8ba54e)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-680b8ba54e");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'roundcubemail' package(s) announced via the FEDORA-2024-680b8ba54e advisory.");
