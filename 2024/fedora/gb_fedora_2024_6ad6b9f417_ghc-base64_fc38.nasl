...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886370");
  ...
  script_tag(name:"creation_date", value:"2024-04-03 01:15:48 +0000 (Wed, 03 Apr 2024)");
  script_name("Fedora: Security Advisory for ghc-base64 (FEDORA-2024-6ad6b9f417)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/ALAPEGGJR65OJ2FABHYAIXVLFK33PATI");
...
(additional support for RFC 7049 standards).");
  ...
  script_tag(name:"affected", value:"'ghc-base64' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghc-base64", rpm:"ghc-base64~0.4.2.4~28.fc38", rls:"FC38"))) {
    report += res;
  }
