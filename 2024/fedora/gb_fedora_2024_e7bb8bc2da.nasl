...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.1017989889899210097");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-e7bb8bc2da)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-e7bb8bc2da");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-e7bb8bc2da");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-bartlett-PHP-CompatInfo' package(s) announced via the FEDORA-2024-e7bb8bc2da advisory.");
...
- update xdebug reference to version 3.3.2");
  ...
  script_tag(name:"affected", value:"'php-bartlett-PHP-CompatInfo' package(s) on Fedora 39.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"php-bartlett-PHP-CompatInfo", rpm:"php-bartlett-PHP-CompatInfo~7.1.4~3.fc39", rls:"FC39"))) {
    report += res;
  }
