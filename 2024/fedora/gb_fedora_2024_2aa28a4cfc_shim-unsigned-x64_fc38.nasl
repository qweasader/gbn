...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886231");
  ...
  script_name("Fedora: Security Advisory for shim-unsigned-x64 (FEDORA-2024-2aa28a4cfc)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/IB5ASIU3C7QRRG6DTKD6FZKNAPUGU4KA");
...
bootloader under secure boot environments.");
  ...
  script_tag(name:"affected", value:"'shim-unsigned-x64' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim-unsigned-x64", rpm:"shim-unsigned-x64~15.8~2", rls:"FC38"))) {
    report += res;
  }
