...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886262");
  ...
  script_tag(name:"creation_date", value:"2024-03-25 09:37:17 +0000 (Mon, 25 Mar 2024)");
  script_name("Fedora: Security Advisory for shim (FEDORA-2024-2aa28a4cfc)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/FY7XGJTRMEFKVCAS7NRLBESXDLINC6OA");
...
the UEFI signing service.");
  ...
  script_tag(name:"affected", value:"'shim' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim", rpm:"shim~15.8~2", rls:"FC38"))) {
    report += res;
  }
