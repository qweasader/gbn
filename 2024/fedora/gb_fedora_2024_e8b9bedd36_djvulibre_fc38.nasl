...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886434");
  ...
  script_name("Fedora: Security Advisory for djvulibre (FEDORA-2024-e8b9bedd36)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-e8b9bedd36");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/HN4JOIBNMJMW2NQSGT6DCDCQZJ2ROFM7");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'djvulibre'
  package(s) announced via the FEDORA-2024-e8b9bedd36 advisory.");
...
separate sub-package.");
  ...
  script_tag(name:"affected", value:"'djvulibre' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"djvulibre", rpm:"djvulibre~3.5.28~6.fc38", rls:"FC38"))) {
    report += res;
  }
