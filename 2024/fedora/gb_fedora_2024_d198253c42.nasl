...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-d198253c42)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-d198253c42");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'stalld' package(s) announced via the FEDORA-2024-d198253c42 advisory.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"stalld-debuginfo", rpm:"stalld-debuginfo~1.19.2~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"stalld-debugsource", rpm:"stalld-debugsource~1.19.2~1.fc40", rls:"FC40"))) {
    report += res;
  }
