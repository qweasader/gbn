...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-8b50ca2e22)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-8b50ca2e22");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'chromium' package(s) announced via the FEDORA-2024-8b50ca2e22 advisory.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromedriver", rpm:"chromedriver~124.0.6367.60~2.fc40", rls:"FC40"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"chromium-common", rpm:"chromium-common~124.0.6367.60~2.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"chromium-headless", rpm:"chromium-headless~124.0.6367.60~2.fc40", rls:"FC40"))) {
    report += res;
  }
