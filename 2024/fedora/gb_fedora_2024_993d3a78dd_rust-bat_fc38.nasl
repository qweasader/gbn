...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885758");
  ...
  script_tag(name:"creation_date", value:"2024-02-23 02:04:25 +0000 (Fri, 23 Feb 2024)");
  script_name("Fedora: Security Advisory for rust-bat (FEDORA-2024-993d3a78dd)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/I5BJQWXYVX6TOGCGBGZIO2TPE4P7WATZ");
  ...
  script_tag(name:"affected", value:"'rust-bat' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-bat", rpm:"rust-bat~0.24.0~3.fc38", rls:"FC38"))) {
    report += res;
  }
