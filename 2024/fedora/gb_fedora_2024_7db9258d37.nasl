...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.710098925810037");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-7db9258d37)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-7db9258d37");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-7db9258d37");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.9' package(s) announced via the FEDORA-2024-7db9258d37 advisory.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.9", rpm:"python3.9~3.9.20~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.9-debuginfo", rpm:"python3.9-debuginfo~3.9.20~1.fc39", rls:"FC39"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.9-debugsource", rpm:"python3.9-debugsource~3.9.20~1.fc39", rls:"FC39"))) {
    report += res;
  }
