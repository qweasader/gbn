...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.66980981009710035");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-66b0bdad35)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-66b0bdad35");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-66b0bdad35");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'yarnpkg' package(s) announced via the FEDORA-2024-66b0bdad35 advisory.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"yarnpkg", rpm:"yarnpkg~1.22.22~5.fc40", rls:"FC40"))) {
    report += res;
  }
