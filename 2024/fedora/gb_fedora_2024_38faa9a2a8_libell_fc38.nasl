...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886000");
  ...
  script_tag(name:"creation_date", value:"2024-03-08 02:16:42 +0000 (Fri, 08 Mar 2024)");
  script_name("Fedora: Security Advisory for libel (FEDORA-2024-38faa9a2a8)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-38faa9a2a8");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/TL2CFNWBL2E6AT2SIY2PR3IAWVCDYJZQ");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libel'
  package(s) announced via the FEDORA-2024-38faa9a2a8 advisory.");
...
limited to resource-constrained systems.");
  ...
  script_tag(name:"affected", value:"'libel' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libel", rpm:"libel~0.63~1.fc38", rls:"FC38"))) {
    report += res;
  }
