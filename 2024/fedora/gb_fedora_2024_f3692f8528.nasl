...
if(description)
{
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-f3692f8528)");
  ...
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-f3692f8528");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'microcode_ctl' package(s) announced via the FEDORA-2024-f3692f8528 advisory.");
...
if(release == "FC39") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"microcode_ctl", rpm:"microcode_ctl~2.1~58.1.fc39", rls:"FC39"))) {
    report += res;
  }
