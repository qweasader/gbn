...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.9.2024.610010110098995991029");
  ...
  script_name("Fedora: Security Advisory (FEDORA-2024-6dedbc5cf9)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-6dedbc5cf9");
  script_xref(name:"URL", value:"https://bodhi.fedoraproject.org/updates/FEDORA-2024-6dedbc5cf9");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the 'python3.8' package(s) announced via the FEDORA-2024-6dedbc5cf9 advisory.");
...
if(release == "FC40") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3.8", rpm:"python3.8~3.8.20~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.8-debuginfo", rpm:"python3.8-debuginfo~3.8.20~1.fc40", rls:"FC40"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3.8-debugsource", rpm:"python3.8-debugsource~3.8.20~1.fc40", rls:"FC40"))) {
    report += res;
  }
