...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.885767");
  ...
  script_tag(name:"creation_date", value:"2024-02-23 02:04:40 +0000 (Fri, 23 Feb 2024)");
  script_name("Fedora: Security Advisory for rust-vergen (FEDORA-2024-993d3a78dd)");
  ...
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/WSVI5EY3RQUHDRZKNPMPULM6ENDQJPM4");
...
code via the env! macro.");
  ...
  script_tag(name:"affected", value:"'rust-vergen' package(s) on Fedora 38.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"rust-vergen", rpm:"rust-vergen~5.1.17~8.fc38", rls:"FC38"))) {
    report += res;
  }
