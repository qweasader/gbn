...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.886234");
  ...
  script_tag(name:"creation_date", value:"2024-03-25 09:36:39 +0000 (Mon, 25 Mar 2024)");
  script_name("Fedora: Security Advisory for tcpreplay (FEDORA-2024-b3b2a95168)");
  ...
  script_xref(name:"Advisory-ID", value:"FEDORA-2024-b3b2a95168");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce%40lists.fedoraproject.org/message/EHUILQV2YJI5TXXXJA5FQ2HJQGFT7NTN");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tcpreplay'
  package(s) announced via the FEDORA-2024-b3b2a95168 advisory.");
...
if(release == "FC38") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tcpreplay", rpm:"tcpreplay~4.4.4~5.fc38", rls:"FC38"))) {
    report += res;
  }
