...
if (description)
{
  ...
  script_tag(name:"affected", value:"Apache Tomcat versions 9.0.0-M1 through 9.0.89, 10.x
  through 10.1.24 and 11.0.0-M1 through 11.0.0-M20.
...
if (version_in_range_exclusive(version: version, test_version_lo: "9.0.0.M1", test_version_up: "9.0.90")) {
