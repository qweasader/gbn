...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834436");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_13-2024-08) - Linux");
  ...
  127.0.6533.119 on Linux");

  script_tag(name: "solution", value:"Update to version 127.0.6533.119 or
  later.");
...
if(version_is_less(version:vers, test_version:"127.0.6533.119")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"127.0.6533.119", install_path:path);
