...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834494");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_10-2024-09) - Linux");
...
if(version_is_less(version:vers, test_version:"128.0.6613.137")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"128.0.6613.137", install_path:path);
