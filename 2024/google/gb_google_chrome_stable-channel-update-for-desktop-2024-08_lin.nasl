...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834289");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop-2024-08) - Linux");
  ...
  127.0.6533.99 on Linux");

  script_tag(name: "solution", value:"Update to version 127.0.6533.99 or
  later.");
...
if(version_is_less(version:vers, test_version:"127.0.6533.99")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"127.0.6533.99", install_path:path);
