...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834285");
  ...
  script_name("Google Chrome Security Update(stable-channel-update-for-desktop_30-2024-07) - Linux");
  ...
  127.0.6533.88 on Linux");

  script_tag(name: "solution", value:"Update to version 127.0.6533.88 or
  later.");
...
if(version_is_less(version:vers, test_version:"127.0.6533.88")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"127.0.6533.88", install_path:path);
