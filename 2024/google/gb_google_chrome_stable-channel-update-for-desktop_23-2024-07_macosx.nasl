...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834275");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_23-2024-07) - Mac OS X");
  ...
  127.0.6533.72 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 127.0.6533.72/73 or
  later.");
...
if(version_is_less(version:vers, test_version:"127.0.6533.72")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"127.0.6533.72/73", install_path:path);
