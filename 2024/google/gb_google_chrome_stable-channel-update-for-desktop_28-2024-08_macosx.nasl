...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834459");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_28-2024-08) - Mac OS X");
  ...
  128.0.6613.113 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 128.0.6613.113/.114 or
  later.");
...
if(version_is_less(version:vers, test_version:"128.0.6613.113")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"128.0.6613.113/.114", install_path:path);
