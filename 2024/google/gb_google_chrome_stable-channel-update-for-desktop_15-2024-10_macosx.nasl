...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834698");
  script_version("2024-10-18T15:39:59+0000");
  script_cve_id("CVE-2024-9954", "CVE-2024-9955", "CVE-2024-9956", "CVE-2024-9957",
  ...
  script_tag(name:"creation_date", value:"2024-10-16 12:22:04 +0530 (Wed, 16 Oct 2024)");
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_15-2024-10) - Mac OS X");
  ...
  130.0.6723.58 on Mac OS X");

  script_tag(name: "solution", value:"Update to version 130.0.6723.58/.59 or
  later.");
...
if(version_is_less(version:vers, test_version:"130.0.6723.58")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"130.0.6723.58/.59", install_path:path);
