...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834495");
  ...
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_10-2024-09) - Mac OS X");
  ...
  128.0.6613.137/.138 on Mac OS X");
