...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834064");
  script_version("2024-06-21T05:05:42+0000");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:N/I:N/A:P");
  script_tag(name:"last_modification", value:"2024-06-21 05:05:42 +0000 (Fri, 21 Jun 2024)");
  script_tag(name:"creation_date", value:"2024-06-14 12:09:54 +0530 (Fri, 14 Jun 2024)");
  script_name("Google Chrome Security Update (stable-channel-update-for-desktop_22-2024-02) - Windows");
  ...
  122.0.6261.69 on Windows");

  script_tag(name: "solution", value:"Update to version 122.0.6261.69/.70 or
  later.");
...
if(version_is_less(version:vers, test_version:"122.0.6261.69")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"122.0.6261.69/.70", install_path:path);
