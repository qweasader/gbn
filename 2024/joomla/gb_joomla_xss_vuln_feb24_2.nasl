...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.151800");
  script_version("2024-02-23T14:36:45+0000");
  script_tag(name:"last_modification", value:"2024-02-23 14:36:45 +0000 (Fri, 23 Feb 2024)");
  script_tag(name:"creation_date", value:"2024-02-23 03:23:23 +0000 (Fri, 23 Feb 2024)");
  script_tag(name:"cvss_base", value:"6.4");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:N");

  script_cve_id("CVE-2024-21725");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("Joomla! XSS Vulnerability (20240204)");
  ...
  in mail address outputs.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable version is present on the target host.");

  script_tag(name:"insight", value:"Inadequate escaping of mail addresses lead to XSS
  vulnerabilities in various components.");

  script_tag(name:"affected", value:"Joomla! version 4.0.0 through 4.4.2 and 5.0.0 through 5.0.2.");

  script_tag(name:"solution", value:"Update to version 4.4.3, 5.0.3 or later.");

  script_xref(name:"URL", value:"https://developer.joomla.org/security-centre/928-20240204-core-xss-in-mail-address-outputs.html");
