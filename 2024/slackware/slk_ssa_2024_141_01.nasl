...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.13.2024.141.01");
  script_cve_id("CVE-2024-21096");
  script_tag(name:"creation_date", value:"2024-05-21 04:09:50 +0000 (Tue, 21 May 2024)");
  ...
  script_name("Slackware: Security Advisory (SSA:2024-141-01)");
  ...
  script_xref(name:"Advisory-ID", value:"SSA:2024-141-01");
  script_xref(name:"URL", value:"http://www.slackware.com/security/viewer.php?l=slackware-security&y=2024&m=slackware-security.378992");
  script_xref(name:"URL", value:"https://www.cve.org/CVERecord?id=CVE-2024-21096");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb' package(s) announced via the SSA:2024-141-01 advisory.");
...
if(release == "SLK15.0") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mariadb", ver:"10.5.25-i586-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mariadb", ver:"10.5.25-x86_64-1_slack15.0", rls:"SLK15.0"))) {
    report += res;
  }
...
if(release == "SLKcurrent") {
  ...
  if(!isnull(res = isslkpkgvuln(pkg:"mariadb", ver:"10.11.8-i586-1", rls:"SLKcurrent"))) {
    report += res;
  }

  if(!isnull(res = isslkpkgvuln(pkg:"mariadb", ver:"10.11.8-x86_64-1", rls:"SLKcurrent"))) {
    report += res;
  }
