...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"mozjs115-debugsource", rpm:"mozjs115-debugsource~115.4.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"mozjs115-debuginfo", rpm:"mozjs115-debuginfo~115.4.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libmozjs-115-0-debuginfo", rpm:"libmozjs-115-0-debuginfo~115.4.0~150600.3.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
