...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-lxc-debuginfo", rpm:"libvirt-daemon-driver-lxc-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-nodedev-debuginfo", rpm:"libvirt-daemon-driver-nodedev-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-storage-logical-debuginfo", rpm:"libvirt-daemon-driver-storage-logical-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-plugin-lockd-debuginfo", rpm:"libvirt-daemon-plugin-lockd-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-log-debuginfo", rpm:"libvirt-daemon-log-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-interface-debuginfo", rpm:"libvirt-daemon-driver-interface-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-qemu-debuginfo", rpm:"libvirt-daemon-driver-qemu-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-libs-debuginfo", rpm:"libvirt-libs-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-storage-scsi-debuginfo", rpm:"libvirt-daemon-driver-storage-scsi-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-storage-core-debuginfo", rpm:"libvirt-daemon-driver-storage-core-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-common-debuginfo", rpm:"libvirt-daemon-common-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-nwfilter-debuginfo", rpm:"libvirt-daemon-driver-nwfilter-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-debugsource", rpm:"libvirt-debugsource~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-lock-debuginfo", rpm:"libvirt-daemon-lock-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-client-debuginfo", rpm:"libvirt-client-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-storage-gluster-debuginfo", rpm:"libvirt-daemon-driver-storage-gluster-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-plugin-sanlock-debuginfo", rpm:"libvirt-daemon-plugin-sanlock-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-storage-iscsi-direct-debuginfo", rpm:"libvirt-daemon-driver-storage-iscsi-direct-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"wireshark-plugin-libvirt-debuginfo", rpm:"wireshark-plugin-libvirt-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-network-debuginfo", rpm:"libvirt-daemon-driver-network-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-storage-iscsi-debuginfo", rpm:"libvirt-daemon-driver-storage-iscsi-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-proxy-debuginfo", rpm:"libvirt-daemon-proxy-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-secret-debuginfo", rpm:"libvirt-daemon-driver-secret-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-storage-mpath-debuginfo", rpm:"libvirt-daemon-driver-storage-mpath-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-debuginfo", rpm:"libvirt-daemon-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-nss-debuginfo", rpm:"libvirt-nss-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-storage-disk-debuginfo", rpm:"libvirt-daemon-driver-storage-disk-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-client-32bit-debuginfo", rpm:"libvirt-client-32bit-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-libxl-debuginfo", rpm:"libvirt-daemon-driver-libxl-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-daemon-driver-storage-rbd-debuginfo", rpm:"libvirt-daemon-driver-storage-rbd-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libvirt-devel-64bit", rpm:"libvirt-devel-64bit~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libvirt-client-64bit-debuginfo", rpm:"libvirt-client-64bit-debuginfo~10.0.0~150600.8.3.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
