...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnome-settings-daemon-debugsource", rpm:"gnome-settings-daemon-debugsource~41.0~150500.4.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"gnome-settings-daemon-debuginfo", rpm:"gnome-settings-daemon-debuginfo~41.0~150500.4.3.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
