...
if(release == "openSUSELeap15.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cups-filters-debugsource", rpm:"cups-filters-debugsource~1.25.0~150200.3.16.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"cups-filters-debuginfo", rpm:"cups-filters-debuginfo~1.25.0~150200.3.16.1", rls:"openSUSELeap15.6"))) {
    report += res;
  }
...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cups-filters-debugsource", rpm:"cups-filters-debugsource~1.25.0~150200.3.16.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"cups-filters-debuginfo", rpm:"cups-filters-debuginfo~1.25.0~150200.3.16.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
