...
if(release == "openSUSEBackportsSLE-15-SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libQt6NetworkAuth6", rpm:"libQt6NetworkAuth6~6.4.2~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qt6-networkauth-devel", rpm:"qt6-networkauth-devel~6.4.2~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qt6-networkauth-docs-html", rpm:"qt6-networkauth-docs-html~6.4.2~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qt6-networkauth-docs-qch", rpm:"qt6-networkauth-docs-qch~6.4.2~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qt6-networkauth-examples", rpm:"qt6-networkauth-examples~6.4.2~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"qt6-networkauth-private-devel", rpm:"qt6-networkauth-private-devel~6.4.2~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }
