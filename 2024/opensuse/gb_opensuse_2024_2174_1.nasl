...
if(release == "openSUSELeap15.5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"wget-debugsource", rpm:"wget-debugsource~1.20.3~150000.3.20.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"wget-debuginfo", rpm:"wget-debuginfo~1.20.3~150000.3.20.1", rls:"openSUSELeap15.5"))) {
    report += res;
  }
