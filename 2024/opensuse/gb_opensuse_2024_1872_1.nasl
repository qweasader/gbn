...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-tqdm-bash-completion", rpm:"python-tqdm-bash-completion~4.66.4~150400.9.12.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python311-tqdm", rpm:"python311-tqdm~4.66.4~150400.9.12.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
