...
if(release == "openSUSELeap15.4") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cosign-debuginfo", rpm:"cosign-debuginfo~2.2.4~150400.3.20.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"cosign", rpm:"cosign~2.2.4~150400.3.20.1", rls:"openSUSELeap15.4"))) {
    report += res;
  }
