...
if(release == "openSUSEBackportsSLE-15-SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"kmail-account-wizard", rpm:"kmail-account-wizard~22.12.3~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"kmail-account-wizard-lang", rpm:"kmail-account-wizard-lang~22.12.3~bp155.2.3.1", rls:"openSUSEBackportsSLE-15-SP5"))) {
    report += res;
  }
