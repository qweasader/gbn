...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.1.1.2024.5653");
  ...
  script_name("Debian: Security Advisory (DSA-5653-1)");
  ...
  script_xref(name:"Advisory-ID", value:"DSA-5653-1");
  script_xref(name:"URL", value:"https://www.debian.org/security/2024/DSA-5653-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the Debian 'gtkwave' package(s) announced via the DSA-5653-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"affected", value:"'gtkwave' package(s) on Debian 11, Debian 12.");
...
if(release == "DEB11") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gtkwave", ver:"3.3.104+really3.3.118-0+deb11u1", rls:"DEB11"))) {
    report += res;
  }
...
if(release == "DEB12") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gtkwave", ver:"3.3.118-0.1~deb12u1", rls:"DEB12"))) {
    report += res;
  }
