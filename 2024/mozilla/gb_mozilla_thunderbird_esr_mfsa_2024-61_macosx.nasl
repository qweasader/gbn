...
if(description)
{
  ...
  script_name("Mozilla Thunderbird ESR Security Update (mfsa_2024-61) - Mac OS X");
...
if(version_is_less(version:vers, test_version:"128.4.3")) {
  report = report_fixed_ver(installed_vers:vers, fixed_version:"128.4.3", install_path:path);
