...
if(description)
{
  ...
  script_name("Mozilla Thunderbird Security Update (mfsa_2024-52) - Mac OS X");
  ...
  script_tag(name: "solution" , value:"Update to version 131.0.1 or later.");
...
if(version_is_less(version:vers, test_version:"131.0.1")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"131.0.1", install_path:path);
