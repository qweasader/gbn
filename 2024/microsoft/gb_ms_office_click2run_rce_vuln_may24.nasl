...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832997");
  ...
  script_name("Microsoft Office 365 (2016 Click-to-Run) Remote Code Execution Vulnerability (May 2024)");

  script_tag(name:"summary", value:"This host is missing a critical security update according to
  Microsoft Office Click-to-Run update May 2024.");
...
if(UpdateChannel == "Monthly Channel") {
  if(version_is_less(version:officeVer, test_version:"16.0.17531.20152"))
    fix = "Version 2404 (Build 17531.20152)";
}
## Semi-Annual Channel (Targeted) renamed to Semi-Annual Enterprise Channel (Preview)
## Semi-Annual Enterprise Channel (Preview): Version 2402 (Build 17328.20346)
else if(UpdateChannel == "Semi-Annual Channel (Targeted)") {
  if(version_is_less(version:officeVer, test_version:"16.0.17328.20346"))
    fix = "Version 2402 (Build 17328.20346)";
}
...
## Semi-Annual Channel renamed to Semi-Annual Enterprise Channel
  ...
  if(version_in_range(version:officeVer, test_version:"16.0.16130.0", test_version2:"16.0.16130.20989")) {
    fix = "Version 2302 (Build 16130.20990)";
  }
  else if(version_in_range(version:officeVer, test_version:"16.0.16731.0", test_version2:"16.0.16731.20673")) {
      fix = "Version 2308 (Build 16731.20674)";
  }
}
