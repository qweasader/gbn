...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832697");
  ...
  script_name("Microsoft .NET Framework Remote Code Execution Vulnerability (KB5037034)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5037034");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5037034");
      ...
      foreach item (registry_enum_keys(key:key))
      {
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer1 || dllVer2)
            {
              if(dllVer2 && version_in_range(version:dllVer2, test_version:"3.0.6920.8600", test_version2:"3.0.6920.9060"))
              {
                VULN1 = TRUE ;
                vulnerable_range = "3.0.6920.8600 - 3.0.6920.9060";
                break;
              }

              else if(dllVer1 && version_in_range(version:dllVer1, test_version:"4.8", test_version2:"4.8.4717.0"))
              {
                VULN2 = TRUE ;
                vulnerable_range = "4.8 - 4.8.4717.0" ;
                break;
              }

              else if(dllVer1 && version_in_range(version:dllVer1, test_version:"4.7", test_version2:"4.7.4091"))
              {
                VULN2 = TRUE ;
                vulnerable_range = "4.7 - 4.7.4091" ;
                break;
              }
