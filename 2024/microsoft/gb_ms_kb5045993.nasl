...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834663");
  ...
  script_tag(name:"creation_date", value:"2024-10-09 16:53:27 +0530 (Wed, 09 Oct 2024)");
  script_name(".NET Core Multiple Vulnerabilities (KB5045993)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5045993.");
  ...
  - CVE-2024-38229: Remote Code Execution Vulnerability

  - CVE-2024-43483: Denial of Service Vulnerability

  - CVE-2024-43484: Denial of Service Vulnerability

  - CVE-2024-43485: Denial of Service Vulnerability");

  script_tag(name:"impact", value:"Successful exploitation will allow an attacker
  to conduct code execution and denial of service attacks.");

  script_tag(name:"affected", value:".NET Core runtime version 8.0.x prior to
  8.0.10 and .NET Core SDK version 8.0.x prior to 8.0.403.");

  script_tag(name:"solution", value:"Update .NET Core runtime to version 8.0.10
  or later and update .NET Core SDK to version 8.0.403 or later.");
...
if(corerunVer) {
  if(corerunVer =~ "^8\.0" && version_is_less(version:corerunVer, test_version:"8.0.10")) {
    fix = "8.0.10 or later";
  }
}

else if(codesdkVer) {
  if(codesdkVer =~ "^8\.0" && version_is_less(version:codesdkVer, test_version:"8.0.403")) {
    fix1 = "8.0.403 or later";
  }
}
