...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834521");
  ...
  script_name("Microsoft .NET Framework Multiple DoS Vulnerabilities (KB5044089)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5044090");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5044089");
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
      {
        foreach item (registry_enum_keys(key:key))
        {
          ...
          if(dllVer)
          {
            if(version_in_range(version:dllVer, test_version:"2.0.50727.5700", test_version2:"2.0.50727.9065"))
            {
              vulnerable_range = "2.0.50727.5700 - 2.0.50727.9065";
              break;
            }
            else if(version_in_range(version:dllVer, test_version:"4.7", test_version2:"4.7.4107"))
            {
              vulnerable_range = "4.7 - 4.7.4107" ;
              break;
            }

            else if(version_in_range(version:dllVer, test_version:"4.8", test_version2:"4.8.4761"))
            {
