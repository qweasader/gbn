...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834414");
  script_version("2024-08-20T05:05:37+0000");
  script_cve_id("CVE-2024-38172", "CVE-2024-38171", "CVE-2024-38170");
  ...
  script_name("Microsoft Office for Mac Multiple Remote Code Execution Vulnerabilities (Aug 2024) - Mac OS X");

  script_tag(name:"summary", value:"This host is missing an important security
  update for Microsoft Office 2021 for Mac according to Microsoft security update
  August 2024");
  ...
  script_tag(name:"affected", value:"Microsoft Office 2021 on Mac OS X prior to Version 16.88 (Build 24081116).");

  script_tag(name:"solution", value:"Upgrade to version 16.88 (Build 24081116)
...
if(vers =~ "^16\.")
{
  if(version_in_range(version:vers, test_version:"16.54.0", test_version2:"16.87.2")) {
    report = report_fixed_ver(installed_version:vers, fixed_version:"16.88 (Build 24081116)");
