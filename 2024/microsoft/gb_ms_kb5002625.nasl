...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834415");
  ...
  script_name("Microsoft Office 2016 Spoofing Vulnerability (KB5002625)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5002625");
  ...
  to conduct spoofing attack and access protected information.");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5002625");
...
if(officeVer =~ "^16\.") {
  ...
  foreach key(key_list)
  {
    ...
    if(propath) {
      ...
      if(version_is_less(version:offdllVer, test_version:"16.0.5461.1001")) {
        report = report_fixed_ver( file_checked:offPath + "\mso.dll",
                                   file_version:offdllVer, vulnerable_range:"Less than 16.0.5461.1001");
