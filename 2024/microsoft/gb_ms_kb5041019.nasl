...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834306");
  ...
  script_name("Microsoft .NET Framework Elevation of Privilege Vulnerability (KB5041019)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5041019");
  ...
  script_tag(name:"affected", value:"Microsoft .NET Framework 3.5, 4.8 and 4.8.1 on Microsoft Windows 10 Version 21H2 and Microsoft Windows 10 Version 22H2.");

  script_tag(name:"solution", value:"The vendor has released updates. Please see the references for more information.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5041019");
    ...
    foreach item (registry_enum_keys(key:key))
    {
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
      {
        foreach item (registry_enum_keys(key:key))
        {
          ...
          if(dllVer)
          {
            if(version_in_range(version:dllVer, test_version:"2.0.50727.5700", test_version2:"2.0.50727.9176"))
            {
              vulnerable_range = "2.0.50727.5700 - 2.0.50727.9176";
              break;
            }
            ...
            else if(version_in_range(version:dllVer, test_version:"4.8.9000", test_version2:"4.8.9255"))
            {
              vulnerable_range = "4.8.9000 - 4.8.9255" ;
              break;
            }
          }
        }
