...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834501");
  ...
  script_name("Microsoft Office Elevation of Privilege Vulnerability (Sep24) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Microsoft Office 2021 prior to version 16.89 (Build 24090815).");

  script_tag(name:"solution", value:"Update to version 16.89 (Build 24090815)
...
if(vers =~ "^16\.") {
  if(version_in_range(version:vers, test_version:"16.54.0", test_version2:"16.88.1")) {
    report = report_fixed_ver(installed_version:vers, fixed_version:"16.89 (Build 24090815)");
