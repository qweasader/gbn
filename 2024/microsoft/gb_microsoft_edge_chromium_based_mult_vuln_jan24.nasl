...
if(description)
{
  ...
  script_name("Microsoft Edge (Chromium-Based) Multiple Vulnerabilities (Jan 2024)");
  ...
  arbitrary code and conduct heap buffer overflow attacks on an affected system.");

  script_tag(name:"affected", value:"Microsoft Edge (Chromium-Based) prior to version
  120.0.2210.121.");
