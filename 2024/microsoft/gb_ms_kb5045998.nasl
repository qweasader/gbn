...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834664");
  ...
  script_name(".NET Core Multiple Vulnerabilities (KB5045998)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5045998.");
  ...
  script_tag(name:"affected", value:".NET Core runtime version 6.0.x prior to
  6.0.35 and .NET Core SDK version 6.0.x prior to 6.0.135.");

  script_tag(name:"solution", value:"Update .NET Core runtime to version 6.0.35
  or later and update .NET Core SDK to version 6.0.135 or later.");
...
if(corerunVer) {
  if(corerunVer =~ "^6\.0" && version_is_less(version:corerunVer, test_version:"6.0.35")) {
    fix = "6.0.35 or later";
  }
}

else if(codesdkVer) {
  if(codesdkVer =~ "^6\.0" && version_is_less(version:codesdkVer, test_version:"6.0.135")) {
    fix1 = "6.0.135 or later";
  }
}
