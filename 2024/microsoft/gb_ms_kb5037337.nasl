...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832924");
  ...
  script_name(".NET Core Privilege Escalation Vulnerability (KB5037337)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5037337.");
  ...
  script_tag(name:"affected", value:".NET Core runtime prior to version 7.0.18
  and .NET Core SDK prior to version 7.0.408.");

  script_tag(name:"solution", value:"Update .NET Core runtime to version 7.0.18
  or later and update .NET Core SDK to version 7.0.408 later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"registry");
  script_xref(name:"URL", value:"https://github.com/dotnet/core/blob/main/release-notes/7.0/7.0.18/7.0.18.md");
...
if(corerunVer) {
  if(corerunVer =~ "^7\.0" && version_is_less(version:corerunVer, test_version:"7.0.18")) {
    fix = "7.0.18 or later";
  }
}

else if(codesdkVer) {
  if(codesdkVer =~ "^7\.0" && version_is_less(version:codesdkVer, test_version:"7.0.408")) {
    fix1 = "7.0.408 or later";
  }
}
