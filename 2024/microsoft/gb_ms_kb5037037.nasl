...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832695");
  ...
  script_name("Microsoft .NET Framework Remote Code Execution Vulnerability (KB5037037)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5037037");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5037037");
        ...
        if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
        {
          foreach item (registry_enum_keys(key:key))
          {
            ...
            if(dllVer1 || dllVer2)
            {
              ...
              else if(dllVer1 && version_in_range(version:dllVer1, test_version:"4.8.9000", test_version2:"4.8.9235"))
              {
                VULN2 = TRUE ;
