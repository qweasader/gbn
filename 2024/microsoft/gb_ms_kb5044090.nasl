...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834514");
  ...
  script_name("Microsoft .NET Framework Multiple DoS Vulnerabilities (KB5044090)");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5044090");
      ...
      if(NetPath && "\Microsoft.NET\Framework" >< NetPath)
      {
        foreach item (registry_enum_keys(key:key))
        {
          ...
          if(dllVer)
          {
            ...
            else if(version_in_range(version:dllVer, test_version:"4.8.9000", test_version2:"4.8.9276"))
            {
