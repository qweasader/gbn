...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834519");
  ...
  script_name("Microsoft .NET Framework Multiple DoS Vulnerabilities (KB5044091)");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5044091");
