...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834517");
  ...
  script_name("Microsoft .NET Framework Multiple DoS Vulnerabilities (KB5044092)");

  script_tag(name:"summary", value:"This host is missing an important security
  update according to Microsoft KB5044092");
  ...
  script_xref(name:"URL", value:"https://support.microsoft.com/en-us/help/5044092");
