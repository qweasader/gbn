...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1661");
  ...
  script_name("Huawei EulerOS: Security Advisory for openssl098e (EulerOS-SA-2024-1661)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1661");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1661");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'openssl098e' package(s) announced via the EulerOS-SA-2024-1661 advisory.");
...
if(release == "EULEROSVIRT-3.0.6.6") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"openssl098e", rpm:"openssl098e~0.9.8e~29.3.h20.eulerosv2r7", rls:"EULEROSVIRT-3.0.6.6"))) {
    report += res;
  }
