...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2291");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-requests (EulerOS-SA-2024-2291)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2291");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2291");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-requests' package(s) announced via the EulerOS-SA-2024-2291 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-requests", rpm:"python-requests~2.6.0~1.h3", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
