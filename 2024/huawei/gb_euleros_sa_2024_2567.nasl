...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2567");
  ...
  script_name("Huawei EulerOS: Security Advisory for python-zipp (EulerOS-SA-2024-2567)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2567");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2567");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'python-zipp' package(s) announced via the EulerOS-SA-2024-2567 advisory.");
  ...
  script_tag(name:"affected", value:"'python-zipp' package(s) on Huawei EulerOS V2.0SP11.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python3-zipp", rpm:"python3-zipp~3.6.0~1.h2.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
