...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2267");
  ...
  script_name("Huawei EulerOS: Security Advisory for ghostscript (EulerOS-SA-2024-2267)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2267");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2267");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'ghostscript' package(s) announced via the EulerOS-SA-2024-2267 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ghostscript", rpm:"ghostscript~9.07~31.6.h23", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
