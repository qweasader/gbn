...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1284");
  ...
  script_name("Huawei EulerOS: Security Advisory for linux-firmware (EulerOS-SA-2024-1284)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1284");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1284");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'linux-firmware' package(s) announced via the EulerOS-SA-2024-1284 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libertas-sd8686-firmware", rpm:"libertas-sd8686-firmware~20180913~87.git44d4fca9.h6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libertas-sd8787-firmware", rpm:"libertas-sd8787-firmware~20180913~87.git44d4fca9.h6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libertas-usb8388-firmware", rpm:"libertas-usb8388-firmware~20180913~87.git44d4fca9.h6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libertas-usb8388-olpc-firmware", rpm:"libertas-usb8388-olpc-firmware~20180913~87.git44d4fca9.h6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"linux-firmware", rpm:"linux-firmware~20180913~87.git44d4fca9.h6.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
