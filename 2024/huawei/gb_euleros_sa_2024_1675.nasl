...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1675");
  ...
  script_name("Huawei EulerOS: Security Advisory for compat-openssl10 (EulerOS-SA-2024-1675)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1675");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1675");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'compat-openssl10' package(s) announced via the EulerOS-SA-2024-1675 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"compat-openssl10", rpm:"compat-openssl10~1.0.2o~3.h22.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }
