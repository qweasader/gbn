...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2260");
  script_cve_id("CVE-2023-32324", "CVE-2023-4504");
  ...
  script_name("Huawei EulerOS: Security Advisory for cups (EulerOS-SA-2024-2260)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2260");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2260");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'cups' package(s) announced via the EulerOS-SA-2024-2260 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"cups-libs", rpm:"cups-libs~1.6.3~35.h12", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
