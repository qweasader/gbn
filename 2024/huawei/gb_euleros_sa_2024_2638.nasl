...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2638");
  script_cve_id("CVE-2022-2309", "CVE-2024-25062");
  ...
  script_name("Huawei EulerOS: Security Advisory for libxml2 (EulerOS-SA-2024-2638)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2638");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2638");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libxml2' package(s) announced via the EulerOS-SA-2024-2638 advisory.");
...
if(release == "EULEROSVIRT-2.9.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libxml2", rpm:"libxml2~2.9.10~1.h35.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-libxml2", rpm:"python3-libxml2~2.9.10~1.h35.eulerosv2r9", rls:"EULEROSVIRT-2.9.1"))) {
    report += res;
  }
