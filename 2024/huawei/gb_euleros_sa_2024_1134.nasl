...
if(description)
{
  ...
  script_name("Huawei EulerOS: Security Advisory for compat-libtiff3 (EulerOS-SA-2024-1134)");
  ...
  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'compat-libtiff3' package(s) announced via the EulerOS-SA-2024-1134 advisory.");
