...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1706");
  ...
  script_name("Huawei EulerOS: Security Advisory for shim (EulerOS-SA-2024-1706)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1706");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1706");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'shim' package(s) announced via the EulerOS-SA-2024-1706 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim-aa64", rpm:"shim-aa64~15~7.h14.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }
