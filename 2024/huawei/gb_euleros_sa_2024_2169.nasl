...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2169");
  ...
  script_name("Huawei EulerOS: Security Advisory for libyaml (EulerOS-SA-2024-2169)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2169");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2169");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libyaml' package(s) announced via the EulerOS-SA-2024-2169 advisory.");
  ...
  script_tag(name:"affected", value:"'libyaml' package(s) on Huawei EulerOS Virtualization release 2.11.1.");
...
if(release == "EULEROSVIRT-2.11.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libyaml", rpm:"libyaml~0.2.5~2.h2.eulerosv2r11", rls:"EULEROSVIRT-2.11.1"))) {
    report += res;
  }
