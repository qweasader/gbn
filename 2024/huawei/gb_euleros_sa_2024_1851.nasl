...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1851");
  ...
  script_name("Huawei EulerOS: Security Advisory for dnsmasq (EulerOS-SA-2024-1851)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1851");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1851");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dnsmasq' package(s) announced via the EulerOS-SA-2024-1851 advisory.");
...
Certain DNSSEC aspects of the DNS protocol (in RFC 4033, 4034, 4035, 6840, and related RFCs) allow remote attackers to cause a denial of service (CPU consumption) via one or more DNSSEC responses, aka the 'KeyTrap' issue. One of the concerns is that, when there is a zone with many DNSKEY and RRSIG records, the protocol specification implies that an algorithm must evaluate all combinations of DNSKEY and RRSIG records.(CVE-2023-50387)");
  ...
  script_tag(name:"affected", value:"'dnsmasq' package(s) on Huawei EulerOS V2.0SP12.");
...
if(release == "EULEROS-2.0SP12") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsmasq", rpm:"dnsmasq~2.86~3.h7.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }
