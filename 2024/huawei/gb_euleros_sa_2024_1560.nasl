...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1560");
  ...
  script_name("Huawei EulerOS: Security Advisory for edk2 (EulerOS-SA-2024-1560)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1560");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1560");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'edk2' package(s) announced via the EulerOS-SA-2024-1560 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Tcg2MeasureGptTable() reads untrusted input from disk, and an attacker can set up a malicious GPT table that triggers an integer overflow that leads to a buffer overflow. This is due to a lack of validation of the GPT Primary Header.(CVE-2022-36763)
...
if(release == "EULEROSVIRT-2.10.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"edk2-aarch64", rpm:"edk2-aarch64~202011~2.10.0.5.21", rls:"EULEROSVIRT-2.10.1"))) {
    report += res;
  }
