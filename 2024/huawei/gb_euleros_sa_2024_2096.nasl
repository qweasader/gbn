...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2096");
  ...
  script_name("Huawei EulerOS: Security Advisory for tpm2-tss (EulerOS-SA-2024-2096)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2096");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2096");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'tpm2-tss' package(s) announced via the EulerOS-SA-2024-2096 advisory.");
...
if(release == "EULEROS-2.0SP11") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"tpm2-tss", rpm:"tpm2-tss~3.1.0~1.h6.eulerosv2r11", rls:"EULEROS-2.0SP11"))) {
    report += res;
  }
