...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2261");
  script_cve_id("CVE-2022-43552", "CVE-2023-27533", "CVE-2023-27534", "CVE-2023-27535", "CVE-2023-27536");
  ...
  script_name("Huawei EulerOS: Security Advisory for curl (EulerOS-SA-2024-2261)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2261");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2261");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'curl' package(s) announced via the EulerOS-SA-2024-2261 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"curl", rpm:"curl~7.29.0~46.h28", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
