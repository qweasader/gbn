...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2218");
  ...
  script_name("Huawei EulerOS: Security Advisory for libyaml (EulerOS-SA-2024-2218)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2218");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2218");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libyaml' package(s) announced via the EulerOS-SA-2024-2218 advisory.");
  ...
  script_tag(name:"affected", value:"'libyaml' package(s) on Huawei EulerOS V2.0SP12.");
...
if(release == "EULEROS-2.0SP12") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libyaml", rpm:"libyaml~0.2.5~4.h1.eulerosv2r12", rls:"EULEROS-2.0SP12"))) {
    report += res;
  }
