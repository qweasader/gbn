...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2259");
  ...
  script_name("Huawei EulerOS: Security Advisory for c-ares (EulerOS-SA-2024-2259)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2259");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2259");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'c-ares' package(s) announced via the EulerOS-SA-2024-2259 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.2.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"c-ares", rpm:"c-ares~1.10.0~3.h4", rls:"EULEROSVIRTARM64-3.0.2.0"))) {
    report += res;
  }
