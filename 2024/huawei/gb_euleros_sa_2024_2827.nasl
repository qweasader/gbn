...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2827");
  script_cve_id("CVE-2023-52426", "CVE-2024-45490", "CVE-2024-45491", "CVE-2024-45492");
  ...
  script_name("Huawei EulerOS: Security Advisory for expat (EulerOS-SA-2024-2827)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2827");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2827");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'expat' package(s) announced via the EulerOS-SA-2024-2827 advisory.");
...
if(release == "EULEROS-2.0SP9-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"expat", rpm:"expat~2.2.9~1.h14.eulerosv2r9", rls:"EULEROS-2.0SP9-x86_64"))) {
    report += res;
  }
