...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1674");
  script_cve_id("CVE-2021-46174", "CVE-2022-48063", "CVE-2022-48064", "CVE-2022-48065", "CVE-2023-45853");
  ...
  script_name("Huawei EulerOS: Security Advisory for binutils (EulerOS-SA-2024-1674)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1674");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1674");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'binutils' package(s) announced via the EulerOS-SA-2024-1674 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"binutils", rpm:"binutils~2.31.1~13.h35.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"binutils-devel", rpm:"binutils-devel~2.31.1~13.h35.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }
