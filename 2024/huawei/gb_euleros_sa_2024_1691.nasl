...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1691");
  ...
  script_name("Huawei EulerOS: Security Advisory for libXpm (EulerOS-SA-2024-1691)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1691");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1691");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'libXpm' package(s) announced via the EulerOS-SA-2024-1691 advisory.");
...
if(release == "EULEROSVIRTARM64-3.0.6.0") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libXpm", rpm:"libXpm~3.5.12~8.h3.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libXpm-devel", rpm:"libXpm-devel~3.5.12~8.h3.eulerosv2r8", rls:"EULEROSVIRTARM64-3.0.6.0"))) {
    report += res;
  }
