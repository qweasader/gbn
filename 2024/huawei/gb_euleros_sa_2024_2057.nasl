...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2057");
  ...
  script_name("Huawei EulerOS: Security Advisory for wpa_supplicant (EulerOS-SA-2024-2057)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2057");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2057");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'wpa_supplicant' package(s) announced via the EulerOS-SA-2024-2057 advisory.");
