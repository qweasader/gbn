...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.1796");
  ...
  script_name("Huawei EulerOS: Security Advisory for dnsmasq (EulerOS-SA-2024-1796)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-1796");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-1796");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'dnsmasq' package(s) announced via the EulerOS-SA-2024-1796 advisory.");
...
if(release == "EULEROS-2.0SP11-x86_64") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"dnsmasq", rpm:"dnsmasq~2.86~1.h15.eulerosv2r11", rls:"EULEROS-2.0SP11-x86_64"))) {
    report += res;
  }
