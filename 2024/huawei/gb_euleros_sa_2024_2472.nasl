...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2472");
  ...
  script_name("Huawei EulerOS: Security Advisory for haproxy (EulerOS-SA-2024-2472)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2472");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2472");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'haproxy' package(s) announced via the EulerOS-SA-2024-2472 advisory.");
...
if(release == "EULEROS-2.0SP8") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"haproxy", rpm:"haproxy~1.8.14~1.h4.eulerosv2r8", rls:"EULEROS-2.0SP8"))) {
    report += res;
  }
