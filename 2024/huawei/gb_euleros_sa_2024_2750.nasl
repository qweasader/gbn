...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.2.2024.2750");
  ...
  script_name("Huawei EulerOS: Security Advisory for glib2 (EulerOS-SA-2024-2750)");
  ...
  script_xref(name:"Advisory-ID", value:"EulerOS-SA-2024-2750");
  script_xref(name:"URL", value:"https://developer.huaweicloud.com/intl/en-us/euleros/securitydetail.html?secId=EulerOS-SA-2024-2750");

  script_tag(name:"summary", value:"The remote host is missing an update for the Huawei EulerOS 'glib2' package(s) announced via the EulerOS-SA-2024-2750 advisory.");
...
if(release == "EULEROSVIRT-2.12.1") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"glib2", rpm:"glib2~2.72.2~5.h17.eulerosv2r12", rls:"EULEROSVIRT-2.12.1"))) {
    report += res;
  }
