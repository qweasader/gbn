...
if (description)
{
  ...
  script_cve_id("CVE-2024-1874", "CVE-2024-3096");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("PHP < 8.1.28, 8.2.x < 8.2.18, 8.3.x < 8.3.6 Multiple Vulnerabilities - Windows");
  ...
  - CVE-2024-1874: Command injection via array-ish $command parameter of proc_open even if
  bypass_shell option enabled
