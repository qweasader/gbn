...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.170814");
  ...
  script_name("Python DoS Vulnerability (Mar 2024) - Mac OS X");
  ...
  Also, on macOS urllib.request no longer resolves the hostname before checking it against the
