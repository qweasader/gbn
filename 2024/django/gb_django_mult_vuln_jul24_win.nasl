...
if (description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.126873");
  script_version("2024-07-16T05:05:43+0000");
  script_tag(name:"last_modification", value:"2024-07-16 05:05:43 +0000 (Tue, 16 Jul 2024)");
  script_tag(name:"creation_date", value:"2024-07-12 11:24:33 +0000 (Fri, 12 Jul 2024)");
  ...
  script_name("Django 4.x < 4.2.14, 5.x < 5.0.7 Multiple Vulnerabilities - Windows");
