...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.128035");
  ...
  script_tag(name:"severity_date", value:"2024-02-13 19:44:56 +0000 (Tue, 13 Feb 2024)");

  script_cve_id("CVE-2024-0954");

  script_tag(name:"qod_type", value:"remote_banner");

  script_tag(name:"solution_type", value:"VendorFix");

  script_name("WordPress Essential Addons for Elementor Plugin < 5.9.8 XSS Vulnerability");
  ...
  supplied protocols allows Stored Cross-site Scripting vulnerability through editing context via
  the 'data-eael-wrapper-link' wrapper.");
  ...
  script_xref(name:"URL", value:"https://www.wordfence.com/threat-intel/vulnerabilities/id/875db71d-c799-40b9-95e1-74d53046b0a9?source=cve");
