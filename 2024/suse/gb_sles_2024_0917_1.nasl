...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240917-1/");
...
CVE-2023-39368: Protection mechanism failure of bus lock regulator
 ...
 potentially enable denial of service via network access CVE-2023-38575: Non-transparent sharing of return predictor targets
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debuginfo", rpm:"ucode-intel-debuginfo~20240312~134.1", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"ucode-intel-debugsource", rpm:"ucode-intel-debugsource~20240312~134.1", rls:"SLES12.0SP5"))) {
    report += res;
  }
