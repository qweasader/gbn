...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.4.2024.2801.1");
  ...
  script_name("SUSE: Security Advisory (SUSE-SU-2024:2801-1)");
  ...
  script_xref(name:"Advisory-ID", value:"SUSE-SU-2024:2801-1");
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20242801-1/");
  script_xref(name:"URL", value:"https://docs.docker.com/engine/release-notes/25.0/#2506");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'docker' package(s) announced via the SUSE-SU-2024:2801-1 advisory.");
