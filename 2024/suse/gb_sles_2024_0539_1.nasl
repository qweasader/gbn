...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20240539-1/");
...
Fixed build issue with MinGW ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'libssh' package(s) on SUSE Linux Enterprise High Performance Computing 12-SP5, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP Applications 12-SP5, SUSE Linux Enterprise Software Development Kit 12-SP5.");
...
if(release == "SLES12.0SP5") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh-debugsource", rpm:"libssh-debugsource~0.9.8~3.12.2", rls:"SLES12.0SP5"))) {
    report += res;
  }
  ...
  if(!isnull(res = isrpmvuln(pkg:"libssh4-debuginfo", rpm:"libssh4-debuginfo~0.9.8~3.12.2", rls:"SLES12.0SP5"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"libssh4-debuginfo-32bit", rpm:"libssh4-debuginfo-32bit~0.9.8~3.12.2", rls:"SLES12.0SP5"))) {
    report += res;
  }
