...
if(description)
{
  ...
  script_xref(name:"URL", value:"https://www.suse.com/support/update/announcement/2024/suse-su-20241461-1/");
...
Removed POST_PROCESS_PE_FLAGS=-N from the build command in shim.spec to
 ...
 and testing. (bsc#1205588)");
  ...
  script_tag(name:"affected", value:"'shim' package(s) on SUSE Linux Enterprise High Performance Computing 15-SP2, SUSE Linux Enterprise Server 15-SP2, SUSE Linux Enterprise Server for SAP Applications 15-SP2.");
...
if(release == "SLES15.0SP2") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"shim-debuginfo", rpm:"shim-debuginfo~15.8~150100.3.38.1", rls:"SLES15.0SP2"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"shim-debugsource", rpm:"shim-debugsource~15.8~150100.3.38.1", rls:"SLES15.0SP2"))) {
    report += res;
  }
