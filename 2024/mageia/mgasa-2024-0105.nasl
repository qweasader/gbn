...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2024.0105");
  script_cve_id("CVE-2023-38252", "CVE-2023-38253", "CVE-2023-4255");
  ...
  script_name("Mageia: Security Advisory (MGASA-2024-0105)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2024-0105");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2024-0105.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=33027");
  script_xref(name:"URL", value:"https://lists.fedoraproject.org/archives/list/package-announce@lists.fedoraproject.org/message/MKFZQUK7FPWWJQYICDZZ4YWIPUPQ2D3R/");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'w3m' package(s) announced via the MGASA-2024-0105 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"An out-of-bounds read flaw was found in w3m, in the Strnew_size function
...
(CVE-2023-4255)");
  ...
  script_tag(name:"affected", value:"'w3m' package(s) on Mageia 9.");
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"w3m", rpm:"w3m~0.5.3~13.git20230121.1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }
