...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2024.0126");
  ...
  script_name("Mageia: Security Advisory (MGASA-2024-0126)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2024-0126");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2024-0126.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=33091");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6728-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'squid' package(s) announced via the MGASA-2024-0126 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Affected versions of squid are subject to a a Use-After-Free bug which
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"squid", rpm:"squid~5.9~1.3.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"squid-cachemgr", rpm:"squid-cachemgr~5.9~1.3.mga9", rls:"MAGEIA9"))) {
    report += res;
  }
