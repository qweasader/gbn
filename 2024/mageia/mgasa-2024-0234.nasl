...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.10.2024.0234");
  ...
  script_name("Mageia: Security Advisory (MGASA-2024-0234)");
  ...
  script_xref(name:"Advisory-ID", value:"MGASA-2024-0234");
  script_xref(name:"URL", value:"https://advisories.mageia.org/MGASA-2024-0234.html");
  script_xref(name:"URL", value:"https://bugs.mageia.org/show_bug.cgi?id=33201");
  script_xref(name:"URL", value:"https://lwn.net/Articles/973069/");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6799-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-werkzeug' package(s) announced via the MGASA-2024-0234 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Werkzeug is a comprehensive WSGI web application library. The debugger
...
if(release == "MAGEIA9") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"python-werkzeug", rpm:"python-werkzeug~3.0.3~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }

  if(!isnull(res = isrpmvuln(pkg:"python3-werkzeug", rpm:"python3-werkzeug~3.0.3~1.mga9", rls:"MAGEIA9"))) {
    report += res;
  }
