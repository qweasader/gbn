...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834092");
  ...
  script_name("Foxit PhantomPDF Multiple Vulnerabilities (June-6 2024)");
  ...
  12.1.2.15332, 11.x through 11.2.6.53790, 10.1.12.37872 and prior on
  Windows.");

  script_tag(name:"solution", value:"Update to version 11.2.7 or 12.1.3 or
  later.");
...
if(version_is_less_equal(version:vers, test_version:"10.1.12.37872") ||
   version_in_range(version:vers, test_version:"11.0", test_version2:"11.2.6.53790")) {
  fix = "11.2.7";
}

if(version_in_range(version:vers, test_version:"12.0", test_version2:"12.1.2.15332")) {
  fix = "12.1.3";
}
