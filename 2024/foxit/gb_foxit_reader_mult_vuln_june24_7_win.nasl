...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834099");
  ...
  script_name("Foxit Reader Multiple Vulnerabilities (June-6 2024)");
  ...
  script_tag(name:"affected", value:"Foxit Reader version 2023.2.0.21408 and
  prior on Windows.");

  script_tag(name:"solution", value:"Update to version 2023.3 or later.");
...
if(version_is_less(version:vers, test_version:"2023.3")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"2023.3", install_path:path);
