...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834083");
  ...
  script_name("Foxit Reader Multiple Vulnerabilities (June-2 2024)");
  ...
  script_tag(name:"affected", value:"Foxit Reader version 12.1.0.15250 and
  prior on Windows.");

  script_tag(name:"solution", value:"Update to version 12.1.1 or later.");
...
if(version_is_less(version:vers, test_version:"12.1.1")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"12.1.1", install_path:path);
