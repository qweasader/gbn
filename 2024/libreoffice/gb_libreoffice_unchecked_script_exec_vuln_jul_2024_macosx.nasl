...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834250");
  ...
  script_name("LibreOffice Unchecked Script Execution Vulnerability (Jul 2024) - Mac OS X");
  ...
  24.2.x prior to 24.2.3 on Mac OS X.");
