...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834691");
  ...
  script_name("Oracle Java SE Security Update (Oct24-2) - Linux");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 23 on Linux.");
