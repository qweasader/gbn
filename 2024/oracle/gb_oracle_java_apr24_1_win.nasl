...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832952");
  script_version("2024-04-25T05:05:14+0000");
  script_cve_id("CVE-2024-21011", "CVE-2024-21094");
  ...
  script_name("Oracle Java SE Security Update (Apr 2024) -01 - Windows");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 8u401 and prior,
  17.0.x through 17.0.10, 11.0.x through 11.0.22, 21.0.x through 21.0.2 and
  22.0 on Windows.");
