...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834688");
  script_version("2024-10-18T15:39:59+0000");
  script_cve_id("CVE-2023-42950", "CVE-2024-25062");
  ...
  script_name("Oracle Java SE Security Update (Oct24-1) - Windows");
  ...
  script_tag(name:"affected", value:"Oracle Java SE version 8u421 and prior on
  Windows.");
