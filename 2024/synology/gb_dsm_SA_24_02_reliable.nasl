...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) < 7.2.1-69057-2 Open Redirect Vulnerability (Synology-SA-24:02) - Remote Known Vulnerable Versions Check");
  ...
  script_tag(name:"affected", value:"Synology DSM prior to version 7.2.1-69057-2.");
