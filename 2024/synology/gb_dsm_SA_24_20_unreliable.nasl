...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) < 7.2.1-69057-6, 7.2.2 < 7.2.2-72806-1 Multiple Vulnerabilities (Synology-SA-24:20) - Unreliable Remote Version Check");
