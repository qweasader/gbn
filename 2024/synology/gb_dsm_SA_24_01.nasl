...
if(description)
{
  ...
  script_name("Synology DiskStation Manager (DSM) < 7.2-64561 ACE Vulnerability (Synology-SA-24:01)");
  ...
  script_tag(name:"affected", value:"Synology DSM prior to version 7.2-64561.");
