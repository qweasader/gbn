...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834676");
  ...
  script_name("Wireshark Security Update (wnpa-sec-2024-12) - Linux");
  ...
  script_tag(name:"affected", value:"Wireshark version 4.4.0 on Linux.");
