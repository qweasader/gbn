...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834258");
  ...
  script_name("Wireshark Multiple Vulnerabilities (Jul 2024) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Wireshark version 4.2.0 on Mac OS X.");
