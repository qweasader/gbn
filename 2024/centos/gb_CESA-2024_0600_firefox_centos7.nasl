...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884314");
  ...
  script_tag(name:"creation_date", value:"2024-03-05 14:32:32 +0000 (Tue, 05 Mar 2024)");
  script_name("CentOS: Security Advisory for firefox (CESA-2024:0600)");
  ...
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2024-February/099220.html");
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~115.7.0~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
