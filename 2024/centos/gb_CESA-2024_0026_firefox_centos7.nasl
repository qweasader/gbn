...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.884323");
  script_version("2024-04-11T05:05:26+0000");
  script_cve_id("CVE-2023-6856", "CVE-2023-6864", "CVE-2023-6865", "CVE-2023-6857", "CVE-2023-6858", "CVE-2023-6859", "CVE-2023-6860", "CVE-2023-6861", "CVE-2023-6862", "CVE-2023-6867", "CVE-2023-6863");
  ...
  script_tag(name:"creation_date", value:"2024-03-05 14:33:07 +0000 (Tue, 05 Mar 2024)");
  script_name("CentOS: Security Advisory for firefox (CESA-2024:0026)");
  ...
  script_xref(name:"Advisory-ID", value:"CESA-2024:0026");
  script_xref(name:"URL", value:"https://lists.centos.org/pipermail/centos-announce/2024-January/099172.html");
...
Security Fix(es):
  ...
  * Mozilla: Potential exposure of uninitialized data in &lt, code&gt, EncryptingOutputStream&lt, /code&gt, (CVE-2023-6865)
...
if(release == "CentOS7") {
  ...
  if(!isnull(res = isrpmvuln(pkg:"firefox", rpm:"firefox~115.6.0~1.el7.centos", rls:"CentOS7"))) {
    report += res;
  }
