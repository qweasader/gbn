...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834059");
  ...
  script_name("Adobe Photoshop Arbitrary Code Execution Vulnerability (APSB24-27) - Windows");
  ...
  prior and Adobe Photoshop 2024 version 25.x through 25.7 on Windows.");
