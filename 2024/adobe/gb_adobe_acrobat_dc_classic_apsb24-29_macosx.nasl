...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833924");
  ...
  script_tag(name:"creation_date", value:"2024-05-16 16:10:07 +0530 (Thu, 16 May 2024)");
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB24-29) - Mac OS X");
  ...
  script_tag(name:"affected", value:"Adobe Acrobat Classic 2020 20.005.30574
  and earlier versions on Mac OS X.");

  script_tag(name:"solution", value:"Update to version 20.005.30635 or
  later.");

  script_tag(name:"solution_type", value:"VendorFix");
  script_tag(name:"qod_type", value:"executable_version");
  script_xref(name:"URL", value:"https://helpx.adobe.com/security/products/acrobat/apsb24-29.html");
...
if(version_in_range(version:vers, test_version:"20.0", test_version2:"20.005.30574")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"20.005.30635", install_path:path);
