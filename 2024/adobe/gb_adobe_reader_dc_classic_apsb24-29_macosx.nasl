...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833928");
  ...
  script_tag(name:"creation_date", value:"2024-05-16 16:49:42 +0530 (Thu, 16 May 2024)");
  script_name("Adobe Reader Classic 2020 Security Update (APSB24-29) - Mac OS X");
  ...
  20.005.30574 and earlier on Mac OS X.");
