...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833920");
  ...
  script_name("Adobe Illustrator Multiple Vulnerabilities (APSB24-30) - Mac OS X");
  ...
  Adobe Illustrator 2024 prior to 28.5 on Mac OS X.");
