...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833926");
  ...
  script_tag(name:"creation_date", value:"2024-05-16 16:21:08 +0530 (Thu, 16 May 2024)");
  script_name("Adobe Acrobat DC Continuous Security Update (APSB24-29) - Mac OS X");
  ...
  24.002.20736 and earlier on Mac OS X.");
