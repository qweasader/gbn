...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.832938");
  ...
  script_name("Adobe Illustrator Multiple Vulnerabilities (APSB24-25) - Mac OS X");
  ...
  Adobe Illustrator 2024 prior to 28.4 on Mac OS X.");
