...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.833923");
  ...
  script_name("Adobe Acrobat Classic 2020 Security Update (APSB24-29) - Windows");
  ...
  script_tag(name:"solution", value:"Update to version 20.005.30636 or
  later.");
...
if(version_in_range(version:vers, test_version:"20.0", test_version2:"20.005.30574")) {
  report = report_fixed_ver(installed_version:vers, fixed_version:"20.005.30636", install_path:path);
