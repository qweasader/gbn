...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.0.834603");
  ...
  script_name("Adobe Acrobat Reader DC Continuous Security Update (APSB24-70) - Windows");
  ...
  24.003.20054 and earlier on Windows.");
...
if(version_is_less_equal(version:vers, test_version:"24.003.20054")) {
