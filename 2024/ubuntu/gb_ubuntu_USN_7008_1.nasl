...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7008.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7008-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7008-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7008-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lowlatency-hwe-6.8' package(s) announced via the USN-7008-1 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-44-lowlatency", ver:"6.8.0-44.44.1~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-44-lowlatency-64k", ver:"6.8.0-44.44.1~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency-64k-hwe-22.04", ver:"6.8.0-44.44.1~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency-hwe-22.04", ver:"6.8.0-44.44.1~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
