...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7015.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-7015-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7015-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7015-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python2.7, python3.5' package(s) announced via the USN-7015-4 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7015-1 fixed several vulnerabilities in Python. This update provides the
...
Original advisory details:
 ...
 service. (CVE-2024-8088)");
  ...
  script_tag(name:"affected", value:"'python2.7, python3.5' package(s) on Ubuntu 14.04.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python2.7", ver:"2.7.6-8ubuntu0.6+esm20", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python2.7-minimal", ver:"2.7.6-8ubuntu0.6+esm20", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3.5", ver:"3.5.2-2ubuntu0~16.04.4~14.04.1+esm3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3.5-minimal", ver:"3.5.2-2ubuntu0~16.04.4~14.04.1+esm3", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
