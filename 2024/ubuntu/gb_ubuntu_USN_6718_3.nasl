...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6718.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6718-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6718-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6718-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'curl' package(s) announced via the USN-6718-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6718-1 fixed vulnerabilities in curl. This update provides the
...
Original advisory details:
 ...
 to a denial of service. (CVE-2024-2398)");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"curl", ver:"8.5.0-2ubuntu10.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libcurl3t64-gnutls", ver:"8.5.0-2ubuntu10.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libcurl4t64", ver:"8.5.0-2ubuntu10.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
