...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6909.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6909-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6909-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6909-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind9' package(s) announced via the USN-6909-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6909-1 fixed vulnerabilities in Bind. This update provides
...
Original advisory details:
 ...
 Bind to consume resources, leading to a denial of service. (CVE-2024-1975)");
  ...
  script_tag(name:"affected", value:"'bind9' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.10.3.dfsg.P4-8ubuntu1.19+esm9", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
