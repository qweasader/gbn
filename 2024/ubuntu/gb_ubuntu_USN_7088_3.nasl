...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7088.3");
  ...
  script_tag(name:"creation_date", value:"2024-11-07 04:07:49 +0000 (Thu, 07 Nov 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7088-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7088-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7088-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws-5.4, linux-oracle-5.4' package(s) announced via the USN-7088-3 advisory.");
...
CVE-2024-41070, CVE-2024-46829, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-aws-5.4, linux-oracle-5.4' package(s) on Ubuntu 18.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1134-oracle", ver:"5.4.0-1134.143~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1135-aws", ver:"5.4.0-1135.145~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.4.0.1135.145~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"5.4.0.1134.143~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
