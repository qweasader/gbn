...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6629.2");
  ...
  script_tag(name:"severity_date", value:"2022-01-11 18:03:24 +0000 (Tue, 11 Jan 2022)");

  script_name("Ubuntu: Security Advisory (USN-6629-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6629-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6629-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ujson' package(s) announced via the USN-6629-2 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-ujson", ver:"1.35-4ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
