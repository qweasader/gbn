...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6681.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-6681-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6681-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6681-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-aws-5.4' package(s) announced via the USN-6681-4 advisory.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1120-aws", ver:"5.4.0-1120.130~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws", ver:"5.4.0.1120.98", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1120-aws", ver:"5.4.0-1120.130", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-20.04", ver:"5.4.0.1120.117", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
