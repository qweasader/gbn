...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7042.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7042-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7042-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7042-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups-browsed' package(s) announced via the USN-7042-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Simone Margaritelli discovered that cups-browsed could be used to create
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups-browsed", ver:"2.0.0-0ubuntu10.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
