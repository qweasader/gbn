...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7052.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7052-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7052-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7052-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'gnome-shell' package(s) announced via the USN-7052-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that GNOME Shell mishandled extensions that fail to
...
was locked. (CVE-2019-3820)");
  ...
  script_tag(name:"affected", value:"'gnome-shell' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"gnome-shell", ver:"3.18.5-0ubuntu0.3+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
