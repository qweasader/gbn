...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7007.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7007-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7007-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7007-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-ibm-5.15, linux-oracle-5.15' package(s) announced via the USN-7007-2 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - SoC Audio for Freescale CPUs ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-ibm-5.15, linux-oracle-5.15' package(s) on Ubuntu 20.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1062-ibm", ver:"5.15.0-1062.65~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1067-oracle", ver:"5.15.0-1067.73~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm", ver:"5.15.0.1062.65~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle", ver:"5.15.0.1067.73~20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
