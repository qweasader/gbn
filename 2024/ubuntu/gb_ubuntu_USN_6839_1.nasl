...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6839.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6839-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6839-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6839-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'mariadb, mariadb-10.6' package(s) announced via the USN-6839-1 advisory.");
...
new features, and possibly incompatible changes.");
  ...
  script_tag(name:"affected", value:"'mariadb, mariadb-10.6' package(s) on Ubuntu 22.04, Ubuntu 23.10, Ubuntu 24.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mariadb-server", ver:"1:10.6.18-0ubuntu0.22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mariadb-server", ver:"1:10.11.8-0ubuntu0.23.10.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"mariadb-server", ver:"1:10.11.8-0ubuntu0.24.04.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
