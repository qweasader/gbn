...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7009.2");
  ...
  script_tag(name:"creation_date", value:"2024-09-25 12:28:29 +0000 (Wed, 25 Sep 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7009-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7009-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7009-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-fde-5.15' package(s) announced via the USN-7009-2 advisory.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1072-azure-fde", ver:"5.15.0-1072.81~20.04.1.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde", ver:"5.15.0.1072.81~20.04.1.49", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
