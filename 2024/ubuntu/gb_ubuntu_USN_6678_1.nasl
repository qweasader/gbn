...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6678.1");
  script_cve_id("CVE-2020-12278", "CVE-2020-12279", "CVE-2023-22742", "CVE-2024-24575", "CVE-2024-24577");
  ...
  script_name("Ubuntu: Security Advisory (USN-6678-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6678-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6678-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libgit2' package(s) announced via the USN-6678-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that libgit2 mishandled equivalent filenames on NTFS
...
arbitrary code. (CVE-2024-24577)");
  ...
  script_tag(name:"affected", value:"'libgit2' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04, Ubuntu 23.10.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgit2-24", ver:"0.24.1-2ubuntu0.2+esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgit2-26", ver:"0.26.0+dfsg.1-1.1ubuntu0.2+esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgit2-28", ver:"0.28.4+dfsg.1-2ubuntu0.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgit2-1.1", ver:"1.1.0+dfsg.1-4.1ubuntu0.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libgit2-1.5", ver:"1.5.1+ds-1ubuntu1.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
