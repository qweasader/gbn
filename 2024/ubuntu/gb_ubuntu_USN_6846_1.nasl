...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6846.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6846-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6846-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6846-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ansible' package(s) announced via the USN-6846-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Ansible incorrectly handled certain inputs when using
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ansible", ver:"2.0.0.2-2ubuntu1.3+esm2", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ansible", ver:"2.5.1+dfsg-1ubuntu0.1+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ansible", ver:"2.9.6+dfsg-1ubuntu0.1~esm2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ansible", ver:"2.10.7+merged+base+2.10.8+dfsg-1ubuntu0.1~esm4", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
