...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6736.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6736-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6736-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6736-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'klibc' package(s) announced via the USN-6736-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6736-1 fixed vulnerabilities in klibc. This update provides the
...
Original advisory details:
 ...
 (CVE-2022-37434)");
  ...
  script_tag(name:"affected", value:"'klibc' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"klibc-utils", ver:"2.0.13-4ubuntu0.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libklibc", ver:"2.0.13-4ubuntu0.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
