...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6587.5");
  script_cve_id("CVE-2023-6478", "CVE-2023-6816", "CVE-2024-0229", "CVE-2024-0408", "CVE-2024-21885", "CVE-2024-21886");
  ...
  script_name("Ubuntu: Security Advisory (USN-6587-5)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6587-5");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6587-5");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'xorg-server' package(s) announced via the USN-6587-5 advisory.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"xserver-xorg-core", ver:"2:1.15.1-0ubuntu2.11+esm9", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
