...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6970.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6970-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6970-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6970-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'exfatprogs' package(s) announced via the USN-6970-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that exfatprogs incorrectly handled certain memory
...
execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'exfatprogs' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"exfatprogs", ver:"1.1.3-1ubuntu0.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
