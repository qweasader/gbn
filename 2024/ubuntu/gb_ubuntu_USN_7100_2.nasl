...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7100.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7100-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7100-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7100-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws' package(s) announced via the USN-7100-2 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - USB sound devices,
(CVE-2024-42288, CVE-2024-41098, CVE-2024-43849, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1072-aws", ver:"5.15.0-1072.78", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-22.04", ver:"5.15.0.1072.72", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
