...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6633.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6633-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6633-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6633-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'bind9' package(s) announced via the USN-6633-1 advisory.");
...
(CVE-2023-5679)");
  ...
  script_tag(name:"affected", value:"'bind9' package(s) on Ubuntu 22.04, Ubuntu 23.10.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.18.18-0ubuntu0.22.04.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"bind9", ver:"1:9.18.18-0ubuntu2.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
