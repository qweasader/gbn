...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6895.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6895-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6895-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6895-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure-6.5, linux-gcp-6.5' package(s) announced via the USN-6895-2 advisory.");
...
CVE-2024-26697, CVE-2024-26694, CVE-2024-26685, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-azure-6.5, linux-gcp-6.5' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1024-azure", ver:"6.5.0-1024.25~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1024-azure-fde", ver:"6.5.0-1024.25~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-1024-gcp", ver:"6.5.0-1024.26~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"6.5.0.1024.25~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde", ver:"6.5.0.1024.25~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gcp", ver:"6.5.0.1024.26~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
