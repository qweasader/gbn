...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6673.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6673-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6673-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6673-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-cryptography' package(s) announced via the USN-6673-2 advisory.");
...
Original advisory details:
 ...
 confidential or sensitive information. (CVE-2023-50782)");
  ...
  script_tag(name:"affected", value:"'python-cryptography' package(s) on Ubuntu 16.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python-cryptography", ver:"1.2.3-1ubuntu0.3+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"python3-cryptography", ver:"1.2.3-1ubuntu0.3+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
