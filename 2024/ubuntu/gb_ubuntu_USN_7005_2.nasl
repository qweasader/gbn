...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7005.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7005-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7005-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7005-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-nvidia-6.8' package(s) announced via the USN-7005-2 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-nvidia-6.8' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1013-nvidia", ver:"6.8.0-1013.14~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1013-nvidia-64k", ver:"6.8.0-1013.14~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-6.8", ver:"6.8.0-1013.14~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-nvidia-64k-6.8", ver:"6.8.0-1013.14~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
