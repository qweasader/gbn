...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6727.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6727-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6727-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6727-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'nss' package(s) announced via the USN-6727-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that NSS incorrectly handled padding when checking PKCS#1
...
bundle and other security improvements.");
  ...
  script_tag(name:"affected", value:"'nss' package(s) on Ubuntu 20.04, Ubuntu 22.04, Ubuntu 23.10.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnss3", ver:"2:3.98-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnss3", ver:"2:3.98-0ubuntu0.22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU23.10") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libnss3", ver:"2:3.98-0ubuntu0.23.10.1", rls:"UBUNTU23.10"))) {
    report += res;
  }
