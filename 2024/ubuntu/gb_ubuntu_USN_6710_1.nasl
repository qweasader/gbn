...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6710.1");
  script_cve_id("CVE-2024-29943", "CVE-2024-29944");
  script_tag(name:"creation_date", value:"2024-03-25 08:40:03 +0000 (Mon, 25 Mar 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-6710-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6710-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6710-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'firefox' package(s) announced via the USN-6710-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Manfred Paul discovered that Firefox did not properly perform bounds
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"firefox", ver:"124.0.1+build1-0ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
