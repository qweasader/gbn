...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7089.6");
  ...
  script_tag(name:"creation_date", value:"2024-11-18 04:08:40 +0000 (Mon, 18 Nov 2024)");
  ...
  script_name("Ubuntu: Security Advisory (USN-7089-6)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7089-6");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7089-6");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gke' package(s) announced via the USN-7089-6 advisory.");
...
CVE-2024-42121, CVE-2024-41025, CVE-2024-42231, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1013-gke", ver:"6.8.0-1013.17", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"6.8.0-1013.17", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
