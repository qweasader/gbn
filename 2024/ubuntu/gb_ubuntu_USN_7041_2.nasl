...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7041.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7041-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7041-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7041-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups' package(s) announced via the USN-7041-2 advisory.");
...
Original advisory details:
 ...
 used.");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on Ubuntu 18.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups", ver:"2.2.7-1ubuntu2.10+esm6", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
