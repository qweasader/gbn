...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6913.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6913-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6913-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6913-1");
  script_xref(name:"URL", value:"https://github.com/apereo/phpCAS/blob/master/docs/Upgrading");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'php-cas' package(s) announced via the USN-6913-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Filip Hejsek discovered that phpCAS was using HTTP headers to determine
...
[link moved to references]");
  ...
  script_tag(name:"affected", value:"'php-cas' package(s) on Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"php-cas", ver:"1.3.8-1ubuntu0.20.04.1", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"php-cas", ver:"1.3.8-1ubuntu0.22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
