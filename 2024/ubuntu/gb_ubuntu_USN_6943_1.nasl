...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6943.1");
  script_cve_id("CVE-2020-9484", "CVE-2021-25122", "CVE-2021-41079", "CVE-2022-23181", "CVE-2022-29885");
  ...
  script_name("Ubuntu: Security Advisory (USN-6943-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6943-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6943-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'tomcat8, tomcat9' package(s) announced via the USN-6943-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that Tomcat incorrectly handled certain uncommon
...
Ubuntu 20.04 LTS and Ubuntu 22.04 LTS (CVE-2022-29885)");
  ...
  script_tag(name:"affected", value:"'tomcat8, tomcat9' package(s) on Ubuntu 16.04, Ubuntu 18.04, Ubuntu 20.04, Ubuntu 22.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat8-java", ver:"8.0.32-1ubuntu1.13+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat8", ver:"8.0.32-1ubuntu1.13+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat8-java", ver:"8.5.39-1ubuntu1~18.04.3+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libtomcat9-java", ver:"9.0.16-3ubuntu0.18.04.2+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat8", ver:"8.5.39-1ubuntu1~18.04.3+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat8-docs", ver:"8.5.39-1ubuntu1~18.04.3+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat9", ver:"9.0.16-3ubuntu0.18.04.2+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat9-docs", ver:"9.0.16-3ubuntu0.18.04.2+esm2", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libtomcat9-java", ver:"9.0.31-1ubuntu0.6", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat9", ver:"9.0.31-1ubuntu0.6", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"tomcat9-docs", ver:"9.0.31-1ubuntu0.6", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"tomcat9-docs", ver:"9.0.58-1ubuntu0.1+esm2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
