...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6744.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6744-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6744-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6744-3");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'pillow' package(s) announced via the USN-6744-3 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6744-1 fixed a vulnerability in Pillow. This update
...
Original advisory details:
 ...
 to cause a denial of service or execute arbitrary code.");
  ...
  script_tag(name:"affected", value:"'pillow' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-pil", ver:"10.2.0-1ubuntu1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
