...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7057.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7057-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7057-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7057-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'ruby-webrick' package(s) announced via the USN-7057-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"It was discovered that WEBrick incorrectly handled having both a Content-
...
possibly use this issue to perform a HTTP request smuggling attack.");
  ...
  script_tag(name:"affected", value:"'ruby-webrick' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"ruby-webrick", ver:"1.8.1-1ubuntu0.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
