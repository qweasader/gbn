...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6663.3");
  ...
  script_name("Ubuntu: Security Advisory (USN-6663-3)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6663-3");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6663-3");
  script_xref(name:"URL", value:"https://launchpad.net/bugs/2054090");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'openssl' package(s) announced via the USN-6663-3 advisory.");
...
Original advisory details:
 ...
 to prevent its use in possible Bleichenbacher timing attacks.");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libssl-doc", ver:"3.0.13-0ubuntu3.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"libssl3t64", ver:"3.0.13-0ubuntu3.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"openssl", ver:"3.0.13-0ubuntu3.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
