...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7089.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7089-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7089-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7089-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-gcp, linux-ibm' package(s) announced via the USN-7089-2 advisory.");
...
CVE-2024-42247, CVE-2024-39487, CVE-2024-42229, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-azure, linux-gcp, linux-ibm' package(s) on Ubuntu 24.04.");
