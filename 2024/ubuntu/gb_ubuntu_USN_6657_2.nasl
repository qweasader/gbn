...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6657.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6657-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6657-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6657-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'dnsmasq' package(s) announced via the USN-6657-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-6657-1 fixed several vulnerabilities in Dnsmasq. This update provides
...
Original advisory details:
 ...
 Ubuntu 23.10. (CVE-2023-28450)");
  ...
  script_tag(name:"affected", value:"'dnsmasq' package(s) on Ubuntu 16.04, Ubuntu 18.04.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-base", ver:"2.90-0ubuntu0.16.04.1+esm1", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"dnsmasq-base", ver:"2.90-0ubuntu0.18.04.1+esm1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
