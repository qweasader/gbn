...
if(description)
{
  ...
  script_name("Ubuntu: Security Advisory (USN-7123-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7123-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7123-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure' package(s) announced via the USN-7123-1 advisory.");
...
This update corrects flaws in the following subsystems:
 ...
 - SCTP protocol,
 - Sun RPC ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1075-azure", ver:"5.15.0-1075.84", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-22.04", ver:"5.15.0.1075.73", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
