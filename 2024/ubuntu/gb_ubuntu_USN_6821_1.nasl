...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6821.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6821-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6821-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6821-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-gke, linux-ibm, linux-intel-iotg, linux-oracle' package(s) announced via the USN-6821-1 advisory.");
...
CVE-2024-26782, CVE-2024-27388, CVE-2024-26748, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-gke, linux-ibm, linux-intel-iotg, linux-oracle' package(s) on Ubuntu 22.04.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1056-ibm", ver:"5.15.0-1056.59", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1058-intel-iotg", ver:"5.15.0-1058.64", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1060-gke", ver:"5.15.0-1060.66", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1061-oracle", ver:"5.15.0-1061.67", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke", ver:"5.15.0.1060.59", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-gke-5.15", ver:"5.15.0.1060.59", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-ibm", ver:"5.15.0.1056.52", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-intel-iotg", ver:"5.15.0.1058.58", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-lts-22.04", ver:"5.15.0.1061.57", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
