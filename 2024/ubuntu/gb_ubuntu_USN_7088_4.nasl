...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7088.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-7088-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7088-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7088-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-aws, linux-azure-5.4, linux-kvm, linux-oracle, linux-xilinx-zynqmp' package(s) announced via the USN-7088-4 advisory.");
...
CVE-2024-44999, CVE-2024-46817, ... [Please see the references for more information on the vulnerabilities]");

  script_tag(name:"affected", value:"'linux-aws, linux-azure-5.4, linux-kvm, linux-oracle, linux-xilinx-zynqmp' package(s) on Ubuntu 18.04, Ubuntu 20.04.");
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1140-azure", ver:"5.4.0-1140.147~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure", ver:"5.4.0.1140.147~18.04.1", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1054-xilinx-zynqmp", ver:"5.4.0-1054.58", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1123-kvm", ver:"5.4.0-1123.131", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1134-oracle", ver:"5.4.0-1134.143", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.4.0-1135-aws", ver:"5.4.0-1135.145", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-aws-lts-20.04", ver:"5.4.0.1135.132", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-kvm", ver:"5.4.0.1123.119", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-oracle-lts-20.04", ver:"5.4.0.1134.127", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-xilinx-zynqmp", ver:"5.4.0.1054.54", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
