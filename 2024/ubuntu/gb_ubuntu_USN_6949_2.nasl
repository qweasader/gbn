...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6949.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-6949-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6949-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6949-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-lowlatency, linux-raspi' package(s) announced via the USN-6949-2 advisory.");
...
CVE-2024-36966, CVE-2024-38547, CVE-2024-38594, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'linux-lowlatency, linux-raspi' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-1009-raspi", ver:"6.8.0-1009.10", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-40-lowlatency", ver:"6.8.0-40.40.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.8.0-40-lowlatency-64k", ver:"6.8.0-40.40.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency", ver:"6.8.0-40.40.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-lowlatency-64k", ver:"6.8.0-40.40.1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-raspi", ver:"6.8.0-1009.10", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
