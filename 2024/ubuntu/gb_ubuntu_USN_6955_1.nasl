...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6955.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6955-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6955-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6955-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-oem-6.8' package(s) announced via the USN-6955-1 advisory.");
...
CVE-2024-38588, CVE-2024-38579, CVE-2024-38617, ... [Please see the references for more information on the vulnerabilities]");
