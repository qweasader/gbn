...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6965.1");
  ...
  script_tag(name:"severity_date", value:"2021-12-07 14:02:37 +0000 (Tue, 07 Dec 2021)");

  script_name("Ubuntu: Security Advisory (USN-6965-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6965-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6965-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'vim' package(s) announced via the USN-6965-1 advisory.");
...
if(release == "UBUNTU14.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"vim", ver:"2:7.4.052-1ubuntu3.1+esm17", rls:"UBUNTU14.04 LTS"))) {
    report += res;
  }
