...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7001.2");
  ...
  script_name("Ubuntu: Security Advisory (USN-7001-2)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7001-2");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7001-2");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libxmltok' package(s) announced via the USN-7001-2 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7001-1 fixed vulnerabilities in xmltol library. This update
...
Original advisory details:
 ...
 or possibly execute arbitrary code. (CVE-2024-45491)");
  ...
  script_tag(name:"affected", value:"'libxmltok' package(s) on Ubuntu 24.04.");
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libxmltok1t64", ver:"1.2-4.1ubuntu2.24.0.4.1+esm1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
