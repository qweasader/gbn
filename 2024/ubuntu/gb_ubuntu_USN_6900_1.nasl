...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6900.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-6900-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6900-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6900-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-hwe-6.5' package(s) announced via the USN-6900-1 advisory.");
...
CVE-2024-26723, CVE-2024-26703, CVE-2024-26822, ... [Please see the references for more information on the vulnerabilities]");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-44-generic", ver:"6.5.0-44.44~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-6.5.0-44-generic-64k", ver:"6.5.0-44.44~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-64k-hwe-22.04", ver:"6.5.0.44.44~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-generic-hwe-22.04", ver:"6.5.0.44.44~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-virtual-hwe-22.04", ver:"6.5.0.44.44~22.04.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
