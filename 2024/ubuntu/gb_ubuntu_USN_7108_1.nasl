...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7108.1");
  ...
  script_name("Ubuntu: Security Advisory (USN-7108-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7108-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7108-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'python-asyncssh' package(s) announced via the USN-7108-1 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"Fabian Baumer, Marcus Brinkmann, and Jorg Schwenk discovered that AsyncSSH
...
(CVE-2023-46446)");
  ...
  script_tag(name:"affected", value:"'python-asyncssh' package(s) on Ubuntu 20.04, Ubuntu 22.04, Ubuntu 24.04.");
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-asyncssh", ver:"1.12.2-1ubuntu0.2", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-asyncssh", ver:"2.5.0-1ubuntu0.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU24.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"python3-asyncssh", ver:"2.10.1-2ubuntu0.1+esm1", rls:"UBUNTU24.04 LTS"))) {
    report += res;
  }
