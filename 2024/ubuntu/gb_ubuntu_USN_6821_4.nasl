...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6821.4");
  ...
  script_name("Ubuntu: Security Advisory (USN-6821-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6821-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6821-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'linux-azure, linux-azure-fde' package(s) announced via the USN-6821-4 advisory.");
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1065-azure-fde", ver:"5.15.0-1065.74.1", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-5.15.0-1066-azure", ver:"5.15.0-1066.75", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-fde-lts-22.04", ver:"5.15.0.1065.74.43", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"linux-image-azure-lts-22.04", ver:"5.15.0.1066.64", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
