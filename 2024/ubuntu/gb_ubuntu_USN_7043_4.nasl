...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.7043.4");
  script_cve_id("CVE-2024-47076", "CVE-2024-47176");
  script_tag(name:"creation_date", value:"2024-10-10 04:07:56 +0000 (Thu, 10 Oct 2024)");
  script_version("2024-10-10T07:25:31+0000");
  script_tag(name:"last_modification", value:"2024-10-10 07:25:31 +0000 (Thu, 10 Oct 2024)");
  script_tag(name:"cvss_base", value:"5.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:N/A:N");

  script_name("Ubuntu: Security Advisory (USN-7043-4)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-7043-4");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-7043-4");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'cups-filters' package(s) announced via the USN-7043-4 advisory.");

  script_tag(name:"vuldetect", value:"Checks if a vulnerable package version is present on the target host.");

  script_tag(name:"insight", value:"USN-7043-1 fixed vulnerabilities in cups-filters. This update improves the
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups-browsed", ver:"1.27.4-1ubuntu0.4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"cups-filters", ver:"1.27.4-1ubuntu0.4", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"cups-browsed", ver:"1.28.15-0ubuntu1.4", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }

  if(!isnull(res = isdpkgvuln(pkg:"cups-filters", ver:"1.28.15-0ubuntu1.4", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
