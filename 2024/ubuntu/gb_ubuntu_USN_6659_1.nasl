...
if(description)
{
  script_oid("1.3.6.1.4.1.25623.1.1.12.2024.6659.1");
  script_cve_id("CVE-2022-43244", "CVE-2022-43245", "CVE-2022-43249", "CVE-2022-43250", "CVE-2022-47665", "CVE-2023-24751", "CVE-2023-24752", "CVE-2023-24754", "CVE-2023-24755", "CVE-2023-24756", "CVE-2023-24757", "CVE-2023-24758", "CVE-2023-25221");
  ...
  script_name("Ubuntu: Security Advisory (USN-6659-1)");
  ...
  script_xref(name:"Advisory-ID", value:"USN-6659-1");
  script_xref(name:"URL", value:"https://ubuntu.com/security/notices/USN-6659-1");

  script_tag(name:"summary", value:"The remote host is missing an update for the 'libde265' package(s) announced via the USN-6659-1 advisory.");
...
if(release == "UBUNTU16.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libde265-0", ver:"1.0.2-2ubuntu0.16.04.1~esm3", rls:"UBUNTU16.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU18.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libde265-0", ver:"1.0.2-2ubuntu0.18.04.1~esm3", rls:"UBUNTU18.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU20.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libde265-0", ver:"1.0.4-1ubuntu0.3", rls:"UBUNTU20.04 LTS"))) {
    report += res;
  }
...
if(release == "UBUNTU22.04 LTS") {
  ...
  if(!isnull(res = isdpkgvuln(pkg:"libde265-0", ver:"1.0.8-1ubuntu0.2", rls:"UBUNTU22.04 LTS"))) {
    report += res;
  }
